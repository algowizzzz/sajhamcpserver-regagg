...
source_url: "http://www.osfi-bsif.gc.ca/sites/default/files/documents/accrsk_EN.pdf"
version: "1"
---
...
Standards 17 
Insurance Contracts (IFRS 17) and the 
...
1.2 As noted in OSFI’s Strategic Plan 2019-2022
2, OSFI applies 
...
the capital returns
3 to indicate verification of the return 
...
i) 
The development of assurance expectations  
...
sized deposit-taking institutions (SMSBs)
4 include 
...
the relevant standards for such assurance engagements. The MCT Guideline 
requires P&C insurers to obtain an annual audit report for 
page 30.61 of the P&C quarterly return. The MICAT Guideline 
requires mortgage insurers to obtain an annual audit report for 
...
8
not always be at the level suitable for OSFI’s use 
...
those listed in T ables 1 and 2, and/or ii) 
...
QUESTION 5 
ALL STAKEHOLDERS 
Should i) any regulatory ratios other than those listed in T ables 1 and 2, and/or ii) controls testing be 
