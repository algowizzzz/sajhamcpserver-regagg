---
title: "191120 Level 1 Document for ICS Version 2.0 for the monitoring period1"
regulator: "iais"
doc_type: "announcement"
status: "final"
source_kind: "policy_pdf"
source_url: "https://www.iais.org/uploads/2022/01/191120-Level-1-Document-for-ICS-Version-2.0-for-the-monitoring-period1.pdf"
version: "1"
---
...
the monitoring period;  Level 3 buil ds on the information in  Levels 1 and 2,  with additional 
...
of the I CS – from 2014 to 2019. Each quantitative ICS Field Testing exercise has been  
...
has agreed to collect data from interested j urisdictions relevant to the development of the 
...
quantitative and qualitative supervisory requirements tailored to the complexi ty and 
...
In order to fac ilitate the monitoring period and discussion within supervisory colleges, 
...
ICS, based on the entity type and whether or not the entity is subject to a sector al capital 
...
general-purpose GAAP or Statutory Accounting Princ iples ( SAP) accounts, and includes 
...
curve relevant for the currency and bucket of each liability.  The three bucket s to which 
...
45. Further details regarding the recognition of management actions in the current 
...
48. For each currency, the transition from the first to the second segment occurs at the 
...
inflation target. 
50. For the purpose of determining the expected real interest rate, jurisdictions are 
...
53. The list of currencies for which risk -free yield curves are determi ned, as well as 
...
60. All stress-based calculations include only current estimates for determining the pre-  
and post-stress Net Asset Value (NAV) , ie the MOCE remains constant during t he stress. 
...
63. Qualifying capital resources are de termined on a consolidated basis for all financial 
...
up; and 
• Tier 2 capital resources comprise financial instrument s and capital elements , other 
...
reinsurance; 
h) Encumbered as sets in excess of the on -balance sheet liabilities secured by the 
...
80. When an IAIG holds encumbered assets in excess of the liabilities and associated 
...
the risk mitigation techniques are accurately and appropriately reflected within the risk 
charges. 
95. In addition, there are certain conditions that must be met regarding the renewal of risk 
mitigation ar rangements. The conditions vary depending on whether the risk mitigation 
...
the prescribed stress to the level of mortality rates.  The prescribed stress es, based on the 
...
The prescribed stresses, based on the geographic segmentati on, benefit segments and 
contract length, are specified in the Level 2 document. 
108. Similar Morbidity/Disability benefits may be classified as life or non -life; however, the 
...
regions, as specified in the Level 2 do cument. The Claims Reserve risk factors include the 
...
119. Catastrophe risk is segmented at the risk/peril level. Perils  cover both naturally 
...
125. The calculation of the Interest Rate risk charge is based on a combination of five 
...
document. 
127. The impact of the scenarios listed above is calculated for all currencies in which the 
...
131. The characteristics of the stres ses to apply, as well as  the rules governing the 
identification of those assets and liabilities  to which the stress applies , are specified in the 
Level 2 document. 
7.3.4 Equity risk 
132. The Equity risk charge is calculated as the change in net asset value following the 
...
141. The prescribed stresses for each currency pair, the aggregation for mula, as well as 
...
144. The Credit risk charge is the determined by applying prescribed stress factors to 
...
146. In determining the net exposure value, collateral and guarantees may be taken into 
...
147. External credit ratings may be used for the calculation of  the Credit risk charge, 
...
processes for the purpose of cal culating an IAIG’s Credit risk charge is recognised in the 
...
11 Other methods refer to alternative methods of calculating the I CS capital requirement, outside of 
...
requirement. 
167. As stated in the KL Agreement, “ The reference ICS and additional reporting at the 
...
International Accounting Standards B oard (IASB) and other jurisdictional standard setters. 
...
172. Other me thods that will be permitted for additional reporting during the monitoring 
period, at the option of the GWS are: 
• Internal models; 
• Dynamic hedging; and 
• Supervisor-owned and controlled credit assessment processes : the  decision on 
whether SOCCA processes wil l be part of the ICS standard method as a national
