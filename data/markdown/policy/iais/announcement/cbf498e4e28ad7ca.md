---
title: "220615 Explanatory note on the draft criteria for the Aggregation Method comparability consultation 1"
regulator: "iais"
doc_type: "announcement"
status: "final"
source_kind: "policy_pdf"
source_url: "https://www.iais.org/uploads/2022/06/220615-Explanatory-note-on-the-draft-criteria-for-the-Aggregation-Method-comparability-consultation-1.pdf"
version: "1"
---

PUBLIC 
Explanatory note on the draft criteria for the Aggregation 
...
ICS that achieves comparable outcomes across jur isdictions.1 The agreement acknowledges the 
...
been developed in such a way that the AM is neither pr ecluded at the outset as an outcome 
...
for clarity in ce rtain areas2. Annex 1 sets out how that feedback is reflected in the draft criteria for 
...
PUBLIC 
The task of designing the comparability assessment  is a complex one, given that the ICS and the 
...
As such, s takeholder feedback on the draft criteria is particularly important to provide a range of 
...
oversight role of the ICS and Comparability Task Force 3 (ICSTF) and how each criterion will be 
...
assessment team will comprise S ecretariat employees who meet the above- mentioned principles 
...
PUBLIC 
Annex I: How draft criteria address previous consultation feedback 
...
2021, the IAIS published a s ummary and resolution of comments received during the public 
...
public disclosure will also apply to AM.   General 
Comments 
