---
title: "Report on Supervisors Use of Key Indicators to Assess Insurer Conduct"
regulator: "iais"
doc_type: "announcement"
status: "final"
source_kind: "policy_pdf"
source_url: "https://www.iais.org/uploads/2022/06/Report-on-Supervisors-Use-of-Key-Indicators-to-Assess-Insurer-Conduct.pdf"
version: "1"
---
...
Supervisors’ use of key indicators to 
...
(MCWG), surveyed members
1 to obtain a view of current supervisory approaches and challenges 
...
PUBLIC 
crisis, but most respondents reported having no plans to change their general approach to conduct 
supervision.     
...
outcomes by insurers, including data collected primarily for prudential or other pur poses but which 
...
collection from insurers, entrenched in primary or subordinate legislation. In many cases, thes e 
...
PUBLIC 
manually. Some exceptions were noted with regard to the analysis of purely quantitative data and 
complaints information.  
Respondents appear to be at markedly different stages of maturity regarding the deployment of more 
sophisticated business intelligence (BI) and other t echnology-based tools to help identify potential 
...
respondents) being slightly mor e relied upon than quantitative analysis (used by 80%, or 41 
...
40%
60%
10 and below 11 to 20 21 to 30 31 to 40
Percentage of 
respondents
Number of indicators collected by each supervisor

PUBLIC 
3.3 Types of indicators: classified by focus area 
...
PUBLIC 
Aside from the catch-all groupings of ‘Other’ and ‘Industry-wide indicators’, the focus areas with the 
...
Complaints
Pricing & cost structure - fees, commissions, expenses
Persistency, renewals and alterations
Claims
Industry-wide indicators
Other
No. of indicators collected under each sub-group

PUBLIC 
Chart 3: The total number of indicators collected, classified by the conduct outcome 
...
Other
Number of indicators collected: by conduct outcome
...
• “Proactive supervision”  refers to measures that seek t o identify issues before they are 
...
Ten respondents in total reported using conduct data for other purposes. Other purpose s cited by 
...
PUBLIC 
Chart 4: Supervisory purpose(s) for which conduct-related data is used 
...
framework. Additional or “Other” purposes highli ghted by a minority of respondents (16%, or 8) 
...
80%
100%
Reactive supervision Proactive supervision Preventive supervision Other
Percentage of respondents
Supervisory purpose(s) for using conduct-related data
92% (n=47)
76% (n=39) 75% (n=38)
67% (n=34)
35% (n=18)
...
Other
Percentage of respondents
Day-to-day supervisory activities using analysed conduct 
data

PUBLIC 
4.3 Usage of data analysis for other actions or initiatives 
...
Other
Percentage of respondents
Other actions based on the results of conduct data analysis

PUBLIC 
Chart 7: Top 5 challenges 
...
Perception of high compliance burden by insurers
Poor data quality
Lack of resources (supervisor)
Poor prioritisation of conduct-related issues by insurers
Number of supervisors
(total number of supervisors who responded was 51)
Top 5 challenges experienced by supervisors
#1 challenge #2 challenge #3 challenge #4 challenge # 5 challenge

PUBLIC 
• Insurers view data r equests as a burden: insurers may hesitate to provide data viewing it as a 
...
certain supervisory challenges for m aintaining effective oversight of conduct risks that have 
...
specific in formation on policy terms and coverage exclusions for pandemic related losses, 
specifically in relation to business interruption, event cancellation, health and travel insurance.  
Additionally, in several instances supervisors required information pertaini ng to payment and other 
...
supervision, or that they were not yet in a position to determine whether such c hanges are in fact 
...
PUBLIC 
Chart 8: Influence of Covid-19 on supervisors’ approach to assessing insurer conduct 
...
Whether supervisors have changed, or are planning to 
change, their approach to assessing insurers’ conduct in light 
of Covid-19
Yes No Unsure or too early to determine

PUBLIC 
Annex 1: Further details on the IAIS survey respondents 
Respondents 
...
jurisdictions included in the survey analysis indicated the mandate for conduc t and prudential 
supervision was split between different authorities.

PUBLIC 
Financial inclusion9 mandate 
...
treatment of customers” in the same way, or similar to, the IAIS definition 11. A slightly lower 
...
insurance from formal service providers. ‘Effective access’ involves convenient and responsible service de livery, at a cost 
...
PUBLIC 
percentage (82%, or 42) have a formal framework in place defining what is meant by “conduct of 
...
PUBLIC 
Annex 3: Full ranking of challenges faced by supervisors 
...
Other
Lack of supervisory data collection powers
Poor analytical skills (supervisor)
Poor analytical skills (insurer)
Infrastructure costs (supervisor)
Infrastructure costs (insurer)
Lack of resources (insurer)
Poor understanding of conduct by insurers
Perception of high compliance burden by insurers
Poor data quality
Lack of resources (supervisor)
Poor prioritisation of conduct-related issues by insurers
Percentage of supervisors 
Challenges faced by supervisors ranked from highest (1) to 
lowest (12)
# 1 challenge # 2 challenge # 3 challenge # 4 challenge # 5 challenge # 6 challenge
# 7 challenge # 8 challenge # 9 challenge # 10 challenge # 11 challenge # 12 challenge