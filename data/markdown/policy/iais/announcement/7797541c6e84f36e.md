---
title: "181115 All adopted ICPs updated November 2017"
regulator: "iais"
doc_type: "announcement"
status: "final"
source_kind: "policy_pdf"
source_url: "https://www.iais.org/uploads/2022/01/181115-All-adopted-ICPs-updated-November-2017.pdf"
version: "1"
---
...
organization of insurance supervisors and regulators from more t han 200 jurisdictions in 
...
safe and stable insurance markets for the benefit and protec tion of policyholders and to 
...
insurance markets.  
The IAIS coordinates its work with other international financial pol icymakers and 
...
international standard setting bodies for input on insurance i ssues as well as on issues 
...
these developments. Insurance and other financial sector supervisors and r egulators 
...
3. The nature of insurance activity - covering risks for the economy, f inancial and 
...
4. In addi tion to business risks, significant risks to insurers are generated on the 
...
from asset -liability mismatches. Life insurers also offer products of life c over with a 
...
material is the lowest level in the hierarchy and typically s upports the ICP statement 
...
- Guidance material – linked to a particular ICP statement and/or s tandard. 
...
8 The ICPs apply to insurance supervisi on in all jurisdictions regardless of the level 
...
controlled insurers that compete with private enterprises, wherev er their business is 
...
insurance sector (referred to as “the supervisor”) rather than necessarily by onl y one 
...
legal authority is not sufficient to demonstrate observance with an ICP: the super visor 
...
functions contribute to its le gitimacy and credibility. A critical element of transparency is 
...
apply to the supervision of insurance legal entities and, unless ot herwise specified, to 
...
effect, the outcome is similar to having the supervisory requiremen ts applied directly on 
...
will vary across jur isdictions, and while established implementation practices should be 
...
legislative con sent) and secondary and other forms of legislation, including rules and 
...
in practice. Therefore, w here shortcomings exist, the supervisor should make the 
...
the effectiveness of super vision. The supervisor should have the necessary powers to 
...
the accounts provi de a true and fair view of the financial position of the 
...
• the availability (to the superv isor, financial services and public) of basic 
...
corporate governance frameworks and ensuring that accurate, meaningful, tr ansparent 
...
question to be addressed by the relevant authorities, particularly if it may res ult in a 
...
strategies. When t he financial market loses its efficiency, assessment of financial and 
...
• a well developed public infrastructure; 
• effective market discipline in financial markets;  
• mechanisms for providing an appropriate lev el of systemic protection (or 
...
6. A factual review of the public infrast ructure should focus on elements relevant to 
...
following elements: an analysis of the functions of the various enti ties involved such as 
...
issues, index -linked as well as conventional g overnment bonds) and the spread of 
...
misleading c onclusions due to their lack of sector specific knowledge. Therefore, 
...
requirements. Thi s information should be provided and analysed in advance to the 
...
these requirements ar e implemented. Having the necessary resources is essential for 
...
not meet with a satisfactory level of observance in practice cannot provi de the basis for 
...
supervisor’s ability to achieve observance. An ICP wil l be considered not observed 
...
multiple authorities responsible for insuranc e supervision (e. g. 
...
has adequate power and authority over the regul ated insurer to 
...
power in order to coordinate and dissem inate the essential 
...
1.2.7 At a jurisdiction al level, it is important that legislation supports the 
...
objective may change and, where requeste d, this should be 
explained. 
...
- as well as to those it supervises and the public at larg e. It should 
...
2.4.2 In the ordinary course of business, the sup ervisor should not 
...
2.6.1 Significant changes to the supervisor’s regulatory requirement s and 
...
2.7.2 Transparency reinfor ces accountability of supervisors. The 
...
regulatory and supervisory deci sions are made within the law as 
...
lawsuits for actions taken in good faith while di scharging their duties, 
...
a temporary basis as well as provide opportunities for s upervisory 
...
are subject to the same confidentiality rules and professional stand ards as 
...
• information on prospective and actual i nsurer transactions 
...
institutions both within the jurisdicti on and in other 
jurisdictions; 
...
• anti-money laundering or combating the fi nancing of 
terrorism (AML/CFT). 
...
• the entities’ activities are limited t o a certain geographical 
...
arrangements, information technology s ystems, policies and 
procedures. 
...
include information on the types of business to be wr itten and 
...
where appropriate. If the licence is denied, conditional or restr icted, the 
...
scope of activities that an insurance legal entity is permitted t o 
...
activities that the i nsurance legal entity is licensed to conduct. 
...
application. 
4.8.2 Before making a d ecision to grant the licence, the host supervisor 
...
supervisor should inform the home supervisor of the scope of t he 
...
Control Functions and Significant Owners of an insurer t o be and remain suitable 
...
Senior Management, Key Persons in Control Functions and S ignificant 
Owners. 
...
individual’s professional or formal qualif ications and knowledge, 
...
ICP 7 (Corporate Governance) with r egard to competence and 
...
5.2.3 The supervisor should require the i nsurer to take the necessary 
...
to: 
• financial soundness demonstrated by
 sources o f 
...
it h as conducted such assessments and demonstrate how it 
...
• evidence that the individual has s ufficient relevant 
...
Management, Key Person in Control Functions and S ignificant 
...
− incurred by the individual as a c onsequence of 
unpaid debts. 
...
− financial problems or bankruptcy in hi s/her private 
capacity; or 
...
determine a person’s s uitability. All relevant indicators, such as the 
...
5.3.9 In det ermining the financial soundness of Significant Owners, the 
...
• Financial statements and exhibits. If t he Significant Owner 
...
judgment, debt or order that remains outstanding or ha s 
...
pattern of behaviour, should be considered in a suitability 
assessment. If the Significa nt Owner is regulated by another 
...
outside its jurisdiction where necessary t o check the suitability of Board 
Members, Senior Management, Key Persons in Control Functions and 
...
6.2 The supervisor requires the insurer to pr ovide notification of any proposed 
...
supervisor requires appropri ate notification from insurers in the case of a 
...
demutualising or transferring some of its policy liabiliti es to another 
...
expectations and existi ng policy values will not normally be 
...
whether the transaction is between reinsure rs. Legislation should 
...
The board and senior management should know and underst and 
...
different board structures (s uch as one- tier or two -tier 
Boards);  
...
• effective c ommunication within the group and adequate 
...
7.1.1 The Board should ensur e that the insurer has a well -defined 
...
7.1.3 The allocation of responsibiliti es to individual Board members (for 
...
required to carry out the func tions of the particular committee.  The 
...
expertise remain appropr iate given the nature of the 
...
objectives and strategies, taking into account the long ter m financial 
...
adequately documented and communicated these object ives and
...
performance goals and measures, ta king due account of, among 
...
and support ed by professional standards and codes of ethics that 
...
implemented and that t hey remain appropriate in light of any
...
new type or class of risk or product or a decision to mar ket products 
...
objectives and strategies) or the int erests of its policyholders or 
other stakeholders.  
...
efficient, objective and independent judgment and deci sion making 
by the Board; and 
...
Board effectiveness 
7.3.3 The Board should review, at least annually, its own perform ance to 
...
periodically reviewed to asses s their effectiveness and adequacy. 
...
agenda items, especially if they involve st rategic or policy decisions 
...
Board is permitted to ass ume executive duties, the insurer should
...
Board, the Board should assess whether t he establishment of 
...
committees are combined, the Board should ensure suc h a 
...
this purpose, the independence criteria should also take account o f 
...
challenge of proposals and decisions; ask for inform ation when the 
...
the insurer (such as the constitution, articles of i ncorporation, by -
...
are distinguished from outsourcing of busines s activities by the 
...
the Board not being abl e to discharge its own roles and 
...
discharged properly and for due purposes by the deleg ate, 
...
members of t he Board and those of the insurer and policyholders. 
...
the functions that oversee them are operating eff ectively and as 
...
• adopt and oversee the effective implementati on of a written 
...
of remuneration policies with the long term interests of insure rs to 
...
suitability of an i nsurer’s remuneration policy. Such competencies 
...
• any r eports or disclosures on the insurer’s remuneration 
...
provide input to the Board on the incentives c reated by the 
...
7.6.8 Where any control function is outsourced, the remuner ation terms 
...
A variable component linked to performance that i s too 
...
for the material current and future risks associ ated with 
...
depending on the level of seniority or respon sibility of the 
...
under the remuneration policy that are consistent with the ins urer’s 
...
the group; and  
• not treat growth or volume as a criterion i n isolation from 
...
a minimum specified per iod after their award (“holding 
restrictions”); and 
...
the financial repor ting process, including actions taken to 
...
required to conduct the audit and specify the level of audi t 
fees to be paid;  
...
which is rele vant to the audit, and any areas in which the 
...
relationship that inc ludes appropriate communication channels for 
...
be duly protected from liability for any inf ormation disclosed to the 
...
to ensure appropr iate, timely and effective communications with the 
...
will be achieved; 
• the insurer’s governance structures, such as all ocation of 
...
policies and strategies s hould enable such information to be 
...
Management and Internal Controls for conflic ts of interest 
provisions); 
...
carried out at least annually, preferably by an i ndependent party, a 
...
an ad-hoc basis (see also Standar d 7.7). Communication may also 
...
appropriate, particul arly to reinforce expectations relating 
...
elements, closer superv isory scrutiny of those policy and practices 
...
commissioning an ind ependent assessment of the insurer’s 
...
governance framework, effective systems of risk management and i nternal 
...
furtherance of the safe and sound operation of the i nsurer and the 
...
8.0.4 The nature of the sy stems that the insurer has is dependent on 
...
obligation;  
• policies defining the procedures and ot her requirements 
...
governance requirements, the group should take into account t he 
...
the group takes, i.e., a more centrali sed or a more decentralised 
...
in which its control functions are organised and operat ed. 
...
It takes into account t he probability, potential impact and time 
horizon of risks. 
...
takes in to account the insurer’s overall business strategy  
...
standards and the specifi c obligations of employees and 
...
techniques. 
8.1.4 The risk management system should be aligned with the i nsurer’s 
...
Identification 
8.1.5 The risk management system should tak e into account all 
...
8.1.6 Significant new or changed activities and product s that may 
...
to transfer the ri sk to a third party. If risks are not acceptable within 
...
the risk. 
Reporting 
8.1.10 Risks, the overall assessment of risk s and the related action plans 
...
process should allow for reportin g on risk issues within established 
...
should therefore cover the c ontent, form and frequency of reporting 
...
8.2.1 The internal controls system should ensure effective and effici ent 
...
the insurer and should be an integral part of the daily activiti es of an 
...
deemed to “own” the controls, and the other lines of defence are there to help ensure their applicati on and viability. 
...
for such a process or policy an appropr iate control exists 
...
and operation; 
• up-to-date policies regarding who can sign f or or commit 
...
• appropriate controls for all key business proc esses and 
...
processes and policies and of the c ontrols in place in 
...
the adequacy, completeness and effect iveness of the 
...
allow its staff to: 
• serve as a component of the ins urer’s checks and 
balances;  
...
8.3.14 The head of each control function should review regular ly the 
...
standards. Higher expectations apply to the he ad of each control 
...
Board access and reporting by the c ontrol functions; Board assessment of 
control functions 
...
of s uch reporting so as to permit timely and meaningful 
...
assessing the insurer’s capacity to absorb risk w ith due 
...
from different perspectives, such as by territory or by l ine 
of business; 
...
sustaining a compliance culture within the insurer are equal ly 
...
and external obligations; this inc ludes communicating and 
...
obligations, or ethical considerations; this incl udes 
...
8.6.4 The actuarial function evaluates and provides a dvice to the insurer 
...
insurer; 
• the fair treatment of policyholders wit h regard to 
...
Board. 
8.6.5 Where required, the ac tuarial function may also provide to the 
...
actuary has any potential conflicts of intere st, such as if his or her 
...
any disagreements with the former Appoint ed Actuary over the 
...
replace an Appointed Actuary when such person fails t o adequately 
...
the quality and effectiveness of the insurer’s corporate governance 
framework. 
...
needed; and 
• decline doing an audit or r eview, or taking on any other 
...
In any such case, the internal audit function s hould inform 
...
authorised to communicate directly, and meet per iodically, with the 
...
auditors. 
8.7.8 In carrying out the above tasks, the inter nal audit function should 
...
• market, underwriting, credit, liquidity, operat ional, conduct 
...
8.8.3 The supervis or should require the Board to have review and 
...
8.8.6 In choosing an outsourcing prov ider, the Board or Senior 
...
in full to each authority, although they apply in full to t he jurisdiction 
...
to supervisory review and reporting, to enable it to carr y out a 
...
services or act ivities that are not outsourced and are performed by 
...
apply an indirect approach, through the ent ities that it supervises in 
...
9.2.1 The supervisor should establish both qualitative and quant itative 
...
manner.  
9.2.2 As an overall objective of the framewor k is to assess the insurer’s 
...
impact that an insurer’s fail ure would have on its policyholders, the 
...
should allow for the appr opriate level or depth of review 
...
determine the key areas of risk to which ins urers are exposed or 
...
horizontal reviews, previ ous risk and conduct assessments, and 
...
the identification and quantification of risks, and evaluate whet her 
...
• requires that inaccurate reporting is correcte d as soon as possible; 
and 
...
a stateme nt of comprehensive income if appropriate) and reviews 
...
between the need for information for supervisory purposes and t he 
...
of the insu rance group. The description of the reporting structure 
...
transactions. The supervisor may require information on the impact 
...
relationship among entities within the group, includi ng participation 
...
9.6 The supervisor periodically reviews its reporting requirements to ascert ain 
...
monitoring of non -regulated entities, including a hol ding company, 
...
independent experts.
21 If it does so, the supervisor should: 
...
• analysis of the relati onships with external entities, such as 
...
9.9.2 The insurer’s willingness to address identi fied issues and the action 
...
• reviewing and analysing the minutes of the Board and its commit tees, the 
...
(fitness and propriety) of the Boar d Members, Senior Management and 
...
• analysing organisational charts, the group structures and the int ragroup 
links; 
...
into unsound bu siness practices and the supervisor detects 
...
wide supervision, the primary communication will be with the Boar d 
...
10.6 The supervisor initiates measur es designed to prevent a breach of the 
...
11.2.1 At a minimum, the supervisor should have the power to i ssue the 
following: 
...
• barring individuals acting in responsible capacities from 
...
requirements. The supervisor has the power t o take control of the insurer, 
...
ICP is on insolvency and run -off under distressed condit ions; 
...
policyholder protec tion fund provides additional or alternative 
protection.  
...
the underlying risk in the same way as, for example, a novat ion. 
...
from the ceding insurer to the reinsurer, it also creates other risks. In 
...
• the risk conc entration levels and ceding limits as defined 
...
reinsurance programmes can vary signifi cantly in complexity, levels 
...
13.1.5 Senior Management develops t he reinsurance related elements of 
...
with. The Board is responsible f or approving the strategy and 
...
• use of alternative risk transfer, including capital markets 
...
13.2.2 The ceding insurer should ensure that the charac teristics of its 
...
processes for dealing with situations where there is a need to 
...
security and size of the reinsurer , in r elation to its maximum 
...
coverage bought should be linked to the procedures for 
...
a risk would not exc eed maximum net capacity and/or risk limits, 
...
reinsurance c ontract without undue delay, ideally prior to the 
...
the supervisor should be able to assess the impac t that the ceding 
...
which may change over the duration of the contrac t. Only the 
...
the jurisdiction of the reinsur er. Benefits may include, for example, 
...
supervisory authorities, they should c onsider putting a formal 
...
13.5.2 Reinsurance contracts do not remove t he ceding insurer’s 
...
measures to manag e their liquidity risk, including funding 
...
ways in wh ich liquidity risk may be mitigated. For example, some 
...
funds as needed. Use of such arrangements is a commercial matter 
...
transferred via a reinsurance contract with simi lar terms and 
...
arrangements is the direct funding of the r einsurance risk exposure 
...
sector are often broadly classifi ed into four groups: 1) catastrophe 
...
credit risk mitigation feature of certain insurance transac tions 
...
• sidecars refer to a legal entity created ‘on the side’ of an 
...
transactions transferring insurance r isk to the capital markets have 
...
Initial assessment 
13.6.6 Insurance risk transfer to the capital mar kets usually entails the 
...
special purpose reinsur ance vehicles, or special purpose insurers; 
...
the exposure by raising funds in the capital mar kets, and to be 
...
should be appropriately tailored to take int o consideration the 
...
• the investors in the SPE have no recourse to the ceding 
insurer in the event of an economic loss.  
13.6.9 In order to be able to understand and assess whether an SPE 
structure meets the c riteria above, the supervisor should take the 
...
critical to understanding the underlying ri sks, particularly as these 
...
to what extent this could have immediate ramificat ions for the 
...
where the ceding insurer  will remain exposed to its underly ing 
policyholders without having recourse to the SPE.

Page 124 of 403 
 
13.6.16 Basis risk should be considered with reference either to the amount 
...
insurance. The supervi sor should understand these accounting 
...
the ongoing supervi sion of SPEs and their use. Consideration 
...
of invested assets (e.g. matc h/mismatch between collateral 
...
There is a distinction between unwinding in the event of a loss and 
...
• whether the ri sk transfer taking place involves an SPE that is 
...
provided fo r the identification, assessment and management 
...
general purpose financial reports and published regul atory reports 
...
solvency purposes. 
14.0.3 To the extent that f inancial reporting standards, including IFRS, are 
...
that the determination of availab le and required capital is based on 
...
judgment to various measures and estimates of an insurer’s c urrent 
...
statements which may differ from those used for g eneral purpose 
...
value in capital resources. Alterna tively, a capital requirement may 
...
These adjustments are show n separately from asset values in the 
...
asset-liability p ositions of an insurer and an understanding of the 
...
values of ass ets and liabilities can be explained in terms of the 
...
a reli able manner, so that a valuation is not influenced
...
factual informat ion, by applying professional standards and 
...
technical risk s. Company -specific information may be appropriate, 
...
value is selected by applying judgment. A met hod that produces a 
...
Supervisory comparisons or benchmarking of modell ing practices 
...
appropriate to i nclude estimates of time value and risk in the 
...
14.5.5 It may be appropr iate to use market -consistent values for the 
...
consistent valuation. W here a range of assessments and 
...
arise, supervisors should provi de guidance as to the appropriate 
...
deep liquid market from which to determine a m arket consistent 
...
the price paid reflects the risk of the instrument at the tim e of 
...
impairment. For liabilities, the value should be t ested at least 
...
should not reflect an insurer’s own credit standing. Insu rance 
...
directly.  
14.6.3 The valuation of l iabilities, other than technical provisions, should 
...
may reflect the l ower probability of repayment under subordinated 
...
14.7.1 Technical provi sions are assets or liabilities that represent the 
...
insurer’s portfolio of insurance policies. This includes a margi n 
...
reference to a sufficiently deep and liquid market may be expec ted 
...
However, in this c ase, supervisors should consider whether the 
...
current estimate an d MOCE should be disclosed and justified so 
...
fulfilment of the obligations under that cont ract. This encompasses 
...
lapse and prem ium rate guarantees. The current estimate should 
...
has an option to continue or incr ease the contract, if it requires the 
...
14.8.8 When establishing the future cash f lows to include in the 
...
criteria appropriate to their jurisdictions for the al lowance of 
...
those that apply more specifically to t echnical provisions, as 
...
inflation rates. Where as sumptions are derived from observed 
...
relevant industry experience where appropriate, should b e 
...
market valuations. 
14.8.16 With respect to expenses, the insurer’s own expense ex perience in 
...
cash flows that arise in fulfill ing insurance obligations over the full time 
horizon thereof.
...
with fulfilling an insurer’s insuran ce obligations. To achieve a 
...
obligations i.e. the variabil ity of all relevant future cash flows to the 
...
MOCE. Other risks should be reflected in regulatory capi tal 
...
MOCE; 
• For the same level of probabilit y, risks with higher impact 
...
14.9.9 Consideration should be given to t he segmentation of the insurance 
...
MOCEs for the total business of the insurer would si mply be the 
...
14.10.1 The solvency regime allows for the ti me value of money to be 
...
In developing these cr iteria, the supervisor should consider the 
following: 
...
14.10.4 As the discount rates should reflect the economics of the ins urance 
...
14.10.6 In principle, if an investment has a reliable market value and ful ly 
...
provisions. The risks of lapse and surr ender need to be considered 
...
• the way in which the quality of c apital resources is 
...
applied directly to the investments or lead to charge s to or 
...
supervisors, as ther e is limited scope for different interpretations of 
...
insurance companies, a uniform rule -based regulatory requirem ent 
...
investment strategy to best manage its inves tment risks. Another 
...
the extent possible, in order to prevent groups from t ransferring
...
However, such requirements should take into accoun t the 
...
comparisons with other solvency require ments. The openness and 
...
members of the group and its corres ponding group-wide solvency 
assessment. 
...
should monitor
28 investment risk exposures on an aggregate basis 
...
intra-group investments (for example if there is explici t or implicit 
...
investments or partic ipations which have particular regard to their 
...
investee’s investment activities are consis tent with its own 
investment policy. 
Security 
...
should be awar e of the limits of using credit ratings and, where 
...
15.3.10 For those assets which are lacking in transparency, the ris k profile 
...
15.3.14 The supervisor should make appropriate allow ance for the 
...
ability to settl e obligations towards policyholders. Similar 
...
15.3.18 The legal and prac tical impediments to cross -border movement of 
...
type of risk the investments are suffici ently uncorrelated so that – 
...
15.4.1 The assets that are held to cov er policyholder liabilities and
 those 
...
may not other wise be possible for the mismatching risk to be 
...
investments to the und erlying assets, the insurer should consider 
...
of their risk s may be subjective. This is particularly relevant where 
...
classes of asset s and investment in markets or instruments that are 
...
sheet vehicles have led to losses ari sing from implicit obligations of 
...
15.6.3 Supervisors should therefore establish quantitative and qualitati ve 
...
investment r egime or if the investment was set up in order to 
...
securities (ILS). In these cases, i t may be very difficult for the 
...
prime mortgages). Where the o riginator is another insurer, the 
...
information on the insurer’s policies and procedures on the us e of 
...
16.0.3 This ICP re cognises the importance of an enterprise risk 
...
spreading of r isk so as to mitigate the risk of adverse financial 
...
efficiently. A purpose of both risk and capital management i s to 
...
and relevant material risks that an ins urer faces and their
...
efficiency and, from a supervisory viewpo int, the adequate 
...
29  The scale of the business is a relevant factor. Some insurers may be less well diversif ied and more susceptible 
...
corporate objectives and circumstances and, wher e appropriate, 
...
reduced if this is cost effective, or inc reased, if justified by the 
...
requirements will, over time, be developed towards conformit y with 
...
appropriate to the nature, scale and compl exity of the risks the insurer 
...
16.1.2 After identi fication of risks, an insurer should highlight significant 
...
weaknesses in gov ernance, business and control functions and 
...
external risk factors w hich, if they were to crystallise, could pose a 
...
appropriate timing of those ac tions. Risk measurement techniques 
...
assess its risks overall wher e this cannot be done appropriately by 
external models.  
...
operational failure. Such analysis is expected t o inform an insurer’s 
...
16.1.19 Group risk may arise, for example, through contagion, leveragin g, 
...
impact of risks on group members and s hould therefore be taken 
...
example, legally enforceable c apital and risk transfer instruments 
...
particular, investment and produc t benchmarks may need to be 
...
group. Such risks may arise from t he widest group of which the 
...
the responsibility of  the Board and S enior Management of the 
...
stress, due to reputa tional damage to the insurer if the 
...
strategies adopted by the insurer allow for the interact ion between 
...
practised for each business segment separately, t his is likely to 
...
from life insurance business and a separate fund of assets m ay be 
...
asset allocation strategies and authorities for inv estment activities 
...
assess reliably. In t erms of market regulation, investments in an 
...
(including under writing guarantees for such complex securities) 
...
with comple x structured products, especially new forms of 
...
testing, as well as contingency planni ng for stressed situations, is 
...
There are also hybrid instrum ents that embed derivatives such as 
...
• the prot ection provided by the reinsurer is secure. This 
...
withheld
33 ), limiting exposure to par ticular reinsurers or 
...
possibility that it wi ll provide support to the reinsurer in 
such circumstances. 
...
• embed its def ined risk tolerance limits in its day -to-day operations 
...
16.8.2 The risk tolerance statement should define the insurer's ‘toler ance 
...
operations. Stress testing can also pr ovide an insurer with a tool to 
...
relevant and material to the insurance group an d the relationships 
...
insurance group during the course of its business. It i s the 
...
feedback loop, base d on appropriate and good quality information, 
...
appropriate and good quality information about changes i n the 
...
making processes. The insurer should regularly r eassess the 
...
conjunction with consideration of the effec tiveness of applicable 
...
future, solvency position. T he nature of the assessment should be 
...
16.13.4 Similarly, the insurance legal ent ity’s ORSA should include all 
...
16.13.6 Given the level of co mplexity at insurance group level compared 
...
economic capital and the regul atory capital requirements set by the 
supervisor. 
...
each other. Theref ore, an insurer should determine the overall 
...
requirements into an i nsurer's ORSA and risk and capital 
...
enable insurers t o issue capital instruments even in stressed 
...
supervisory req uirements are met. The insurance group’s risk 
...
16.14.12 Where an internal model is used for t he ORSA, it is likely to be an 
...
of the risks faced w ithin its business and the determination of the 
...
factors in order to determine the modelling criteri a used to 
...
fall due, at a confidence level appropri ate to its business objectives. 
...
are required to segregate the assets ba cking the liabilities of different classes of insurance into separate funds and 
...
35 It would be expected to 
calibrate the model according to its own modelling criteria. As well 
as i nternal review, the insurer may wish to consider an external 
...
cause of business failure (e.g. where busines s would become 
...
insurers to maintain contingency plans and proc edures for use in a 
...
cash flow position after some futur e stress event and assess 
...
its ability to continue to exist as an insurance group, potent ial 
...
and to meet any other anticipated liabilit ies as they fall due. 
...
16.15.12 The insurance group’s continuity analysi s should also consider the 
...
requirements, a shortfall in ec onomic capital, or for other business 
...
need to be taken (e.g. int ra-group movements of resources, other 
...
validation processes, as a source of insight into the r isk exposure 
...
management and risk and solvency assess ments from each insurer 
...
addition, an insurer sh ould have a duty to report a breach in 
...
require ins urers to perform them when circumstances are 
...
sector to economic o r market stresses or other stresses that apply 
...
comparing risk assessments against st ress test outcomes, risk 
...
contingency planning. Such information enabl es supervisors to 
...
future plans so as to reduce any projected financi al inadequacies, 
...
towards the IAIS's objec tive of improving the transparency and 
...
information for ex ternal and internal stakeholders which is useful 
...
solvency and financial condition r eport, should be carefully 
...
16.16.12 Where an insurer's risk mana gement practices and processes are 
...
management p rocesses and financial condition of the insurance 
...
processes, as appropriat e to the nature, scale and complexity of 
...
non-regulated entities w ithin the group. Risk mitigation measures 
...
• How we ll is the group’s ERM framework tailored to the 
group? 
...
recognition of diversificati on across the insurance group, the 
...
entity or an insurance group to use internal models to car ry out its 
...
so that insure rs can absorb significant unforeseen losses and to provide for 
...
relevant material risks on an insurer’s overall financi al position are 
...
and consistent definition of both elem ents. Technical provisions 
...
the term regulatory c apital requirements refers to financial 
...
17.1.4 Technical provisions and regulatory capital requi rements should be 
...
as quantitative limits, asset eli gibility criteria or “prudential filters”) 
...
subordination and pri ority), the extent of the permanent and/or 
...
subsidiaries and assess the capital adequac y for the combined 
...
More specifically, undertaking a capital adeq uacy assessment of an 
...
17.1.10 The c hoice of approach would depend on the preconditions in a 
...
consideration is given to the extent to whi ch a group is considered 
...
supervision and group -wide su pervision, without implying that the 
...
for intra-group holdings and further adjust ments may then need to 
...
allowed to behave as one single entity 41. This is particularly the 
...
consideration should b e given to consistency of valuation and 
...
41 Consolidated accounts may be those used for accounting purposes or may differ (e.g. in terms of the ent ities included 
in the consolidation).

Page 198 of 403 
 
17.2 The supervisor establishes regulatory capital requirements at a sufficient 
level so that, in adversit y, an insurer’s obligations to policyholders will 
...
the insurer fails. 
17.2.2 From a regulatory perspecti ve, the purpose of capital is to ensure 
...
17.2.4 From a macro- economic perspective, requiring insurers to mai ntain 
...
beyond its economic value to policyholders or unduly inhibit ing an 
...
resources and should supplement the indivi dual capital adequacy 
...
the insur ance group but this does not necessarily imply setting
...
and supervisor. Hence they should be set at a lev el that allows 
...
levels should be transparent. This is particularly important wher e 
...
supervisory action. 
17.3.5 Supervisors may need to consider dif ferent solvency control levels 
...
• the accounting and actuarial framework that applies in t he 
...
• overall level of capit alisation in the insurance sector in the 
jurisdiction; 
...
whole or of particular parts of a group, whic h may, for example, 
...
mitigation of a weakening of the financial posit ion of a group may 
...
supervisor depending on the event or concern that trigg ers the 
...
Prescribed C apital Requirement (PCR), will be set at the level at 
...
17.4.3 The regulatory objective to req uire that, in adversity, an insurer’s  
...
its strongest actions, if further capital is not made available
46 . 
...
such as weaknesses in the ris k management or governance of the insurer. Nor does it preclude the supervisor from 
...
which the assets of the insurer were sti ll expected to be sufficient to 
...
determined on the basis of an insurer’s internal model 47 approved 
...
include partial models which capture a subset of the r isks borne by the insurer using an internally developed 
...
repurchase of equity or other i nstruments and/or dividend 
payments; 
...
had for these possibilities and the scope fo r an insurer with capital 
...
define the relationship between these solvency control level s and 
...
weight placed on group- wide supervision and leg al entity 
...
necessary or appropriate. Suc h an approach may assist, for 
...
group-wide PCR is determined, i t may differ from the sum of 
...
triggered. The supervisor should consider t he appropriate 
...
models), which are subject to appr oval by the relevant 
supervisors.
...
Standardised approach es may differ in level of complexity 
...
(i.e. to provide the ultimate safety net for the protect ion of 
...
50 It i s noted that the capacity for a supervisor  to allow the use of internal models will need to take account of the 
...
such as fi nancial guarantors, is adversely correlated to the credit 
...
may choose to base regulat ory capital requirements for these less 
...
appropriate risk m itigant and it may be more appropriate for the 
...
and controls.  
17.7.6 However, the IAIS envisages that the ability to quantify s ome risks 
...
standardised approach. Where the supervi sor allows the use of approved 
...
that a supervisor should take into account in determini ng the 
...
approaches. In par ticular, where a supervisor  allows the use of 
...
to which regulatory capital requirements are calibrated, the I AIS 
...
compensation) in one year (the shock period) may hav e permanent 
...
MCR. It is also the level used for the calculation of the risk -based Solvency Capital Requiremen t under the European 
Solvency II regime.
...
of the technical provisions would allow for t he impact of the shock 
...
of regulatory capital requirements:  
Figure 17.3: Illustration of determination of reg ulatory capital 
requirements 
...
predefined shocks or stress scenarios that are assumed t o occur 
...
17.8.9 The risk of measurement error inherent in any approach us ed to 
...
that exacerbate the economic crises, thus leading to an advers e 
...
and to invest in less risky assets in order to decr ease their 
...
effects.  
17.8.13 It could be contemplated whether further explicit pr ocyclicality-
...
basis for c alculating group- wide capital requirements or the 
...
within the group which are loc ated in other jurisdictions or whether 
...
notably contagion risk (fi nancial, reputational, legal), concentration 
...
automatically in an assess ment of group- wide capital adequacy. It 
...
17.8.22 An assessment of group diversification benefits is necess ary under 
...
of an insurance legal entity and other en tities within the group in 
...
automatically at the level of the c onsolidated group. In this case, 
...
insurance legal entity and group level. In a g roup-wide context, 
...
wide supervision.  
17.8.25 Risks from non -regulated entities  are typicall y difficult to measure 
...
mitigation measures. Measures ta ken to address risks from non -
...
activities (e.g. certain credit enhancement mechanism s as 
...
accounting treatment may provide a star ting point. Consideration 
...
consideration of a decreas e in their regulatory capital requirement. 
...
complexity in term s of the target criteria. The supervisor may, for 
...
following s upervisory review from those calculated using 
...
17.10.1 The following outlines a number of approaches a super visor could 
...
eligible to meet regulatory capital r equirements and their 
...
its capital resources to meet r egulatory capital requirements and 
...
17.10.11) ;  
• the treatment of assets which may not be fully realisable in 
...
supervisor. Other liabilities t hat are not subordinated would not be 
...
according to crit eria specified by the supervisor. Such contingent 
...
Treatment of asse ts which may not be fully realisable on a going- concern or 
wind-up basis 
...
significantly lower than the economic value which i s attributable 
...
55 However, adequate recognition should be given to contractual feat ures of the debt such as embedded options which 
...
• company-related assets: certain assets carried i n the 
...
need to reflect an adjustment to its economic value. Generally, suc h 
...
The risk associated with the asset –  i.e. a potential deteriorati on of 
...
difficulties may also ar ise where there is a high concentration of 
...
for example the possibility that the assumptions and parameters used in the valuation are incorrect, or that the v aluation 
methodology itself is deficient.

Page 228 of 403 
 
17.10.19 A supervisor should choose the approach which is best suited to the 
organisation and sophistication of t he insurance sector  and the 
...
consistently applied. It is also import ant that any material double 
...
• policyholder priority and status under the legal framework 
relative to other creditors in the jurisdiction; 
• overall quali ty of risk management and governance 
frameworks in the insurance sector in the jurisdiction;
...
capital resour ces include multiple gearing, intra -group creation of 
...
17.11.1 In v iew of the two objectives of capital resources set out in  
...
• To what extent can the capital el ement be used to absorb 
...
an ongoing basis, are permanently available and rank as the m ost 
...
the amount and timing of distributions. Consequent ly, common 
...
by the supervisor . Where such an approach is chosen, the c riteria 
...
• the period for w hich the capital element is available 
(permanence); and 
...
both going-concern and winding -up; tak en together, they could be 
...
repayment, dividends or interest once ins olvency or winding -up 
Loss absorbency 
...
they owe the insurer against the subordinated capital instrument
59. 
...
and credito rs in insolvency. While policyholders are often given a 
...
element to be treat ed as fully paid without prior approval by the 
...
solvency assessment, it may also be relevant for the supervis ion of 
...
minimum period that capital should be outstanding to be r egarded 
...
coupon rate which increases from its initial level at a specified da te 
...
servicing costs th at cannot be waived or deferred before maturity . 
...
17.11.32 To determine the amount of an insurer’s c apital resources, 
...
approaches); 
• approaches whic h rank capital elements on the basis of 
...
To accomm odate the quality of assets and quality of capital 
...
capital resourc es is based on the categorisation of elements of 
...
example, one broad categorisation may be as follows;
61 
...
interacts with the various sol vency control levels . A separation into 
...
divides the tiers. It permits great er recognition within a given tier for 
...
restrict the range of instruments that may be included i n capital 
...
and principles under lying the determination of regulatory capital 
...
determination of capital resources would need to lay sufficien t 
...
winding-up). 
Additional guidance for insurance groups and ins urance legal entities that are 
members of groups 
17.11.45 The considerations set out in Guidance 17.11.1 -  17.11.44 above 
apply equally to insurance legal entity and group- wide supervision. 
See Guidance 17.10.22 for addi tional guidance on the criteria for 
...
intra-group transactions and consequently multi ple gearing and 
...
which are ineligible as regulato ry capital or the eligibility of which is 
...
location of capital and takes into account legally enf orceable intra-
...
governance is vital to the effecti ve use of internal models. If the 
...
Among other uses, internal models c an be used to determine the 
...
model that is to be used for regulat ory capital purposes should 
...
17.12.3 Where t he supervisor allows a range of standardised and m ore 
...
they can be a more realistic, ri sk-responsive method of calculating 
...
risks it bears. However, in such circumstances the superv isor 
...
calibration of the standardised approach to deter mining regulatory 
...
account the main objective of the MCR (i.e. to provide t he ultimate 
...
determining the MCR, particular care should be tak en so that the 
...
which is comparable with a minimum investment grade level. S ome 
...
to have a degree of comparability to enable s upervisors to make a 
...
use partial internal models. If, fo r example, this is to ease transition 
...
should be revi ewed by the supervisor, who may decide to impose 
...
supervisor establishes should require b road consistency between 
...
17.12.19 The IAIS rec ognises that modelling criteria may differ among 
...
resources needed to cover t hose risks and to allocate capital resources across the group. Group- wide internal models 
include partial models which capture a subset of the risks to the group and/or all the risks of a subset of the group. 
Group-wide internal models also include combina tions of models in respect of different parts of the group. An insurer’s 
internal model may be part of a broader group-wide model rather than a standalone model.

Page 247 of 403 
 
17.12.20 Each supervisor should set out for which gr oup-wide regulatory 
...
internal m odels for the purpose of determining group -wide 
...
assess different model s fairly and facilitate comparison between 
...
17.13.3 The supervisor should require t hat in granting approval for the use 
...
model) which m ay need to be developed. In addition, it may be 
...
internal model within its business. T he “calibration test” would be 
...
internal model for re gulatory capital purposes. If so, it may improve 
...
72 Validation should be carried out by a different department or personnel to those that creat ed the internal model to 
...
on the branch operat ions. The home supervisor, however, does not 
...
supervisors involved. If more than one jurisdiction is conc erned, 
...
such circumstances, it may be necessary for the group t o upgrade 
...
generally be constructed to deliver a probability distribut ion of the 
...
capital requirements by the internal model should cons ider 
...
instances where an insurer lac ks fully credible data it may rely on 
...
market. It is, however, important to consider that suc h industry data 
...
hence, confirm the validity of using its internal model fo r that 
purpose. 
...
confidence specified by the super visor. Where an insurer uses 
...
the internal model by the i nsurer for its own risk and capital 
management. 
...
therefore have the flex ibility to use the most appropriate risk 
...
demonstrate that its internal model is integrated within its r isk and 
...
design and implementation of the internal model, in order t o ensure 
...
the overall enterprise risk management framework agreed to by t he 
...
17.16.7 Various business units wit hin the insurer may be involved in the 
...
and technical ability of staff inv olved in the construction and 
...
require sig nificant IT resources and costs, which should be a 
...
including an outline of t he rationale and assumptions underlying its 
...
internal models, including the statistical quality test, calibrati on test and 
...
documentation should incl ude justifications for and details of the 
...
provide thorough documentat ion of the scope of an internal model, 
...
17.17.5 As a minimum, the documentati on of the group -wide internal model 
should include: 
...
• the effect of these instrument s, either on individual 
...
• justifications for specific decisions taken in terms o f 
...
the use of st ress testing and scenario analysis and the 
...
• the allocation of capital to insurance legal entities impli ed 
...
positions are o ffset or increased by other risks or positions. The 
...
• the insurer to notify the supervisor of material changes t o the 
...
17.18.2 The insurer should be required to notify the supervisor of mat erial 
...
require parallel reporting of regulatory capital det ermined by both 
...
for regulatory c apital purposes. It may be necessary to introduce 
...
17.18.12 The level of information on int ernal models necessar y to allow 
...
services to customers. O ther Standards apply to the organisation 
...
provider), 
provided that the purpose of that professiona l activity is not to 
...
of policies, processes and procedures that rel ate to individual 
...
jurisdictions’ tradition, culture, legal regi me and the degree of 
...
intermediaries.  
18.0.10 The nature of the custome rs with which an intermediary interacts 
...
than professional ones; life products with an investment element are 
...
activity performed. I n some jurisdictions, i t may be possible for an 
...
institutions, or as part of  non-financial organisations. I nsurance 
...
including cost. This understanding helps consumers to c ompare 
...
through formal education initiatives and targeted awareness 
...
when dealing with more complex financial products, par ticularly 
...
play in consumer protection. Other stakeholders, using v arious 
...
material which gives re levant information, or publishing 
...
• participating in educational initiatives such as traini ng 
seminars. 
...
this ICP addresses other aspects of supervisi on that are specific to 
...
permits the insurance intermediary to undertake, taking into account, 
...
will be incapabl e of delivering fair consumer outcomes or where it 
...
indemnity insurance and the level of opera ting expenses, to ensure 
...
18.1.9 The supervisor should consider what licensing requirements ar e 
...
an informed decision when choosing to deal with inter mediaries 
...
with this authority. 
18.2.2 The supervisor may choose to take a ris k-based approach in 
...
ICP 9 Supervisor y Review and Reporting, but may require 
...
intermediaries in the m arket, as well as the supervisor’s resources. 
...
as part of the insurer’s regular reporting responsibi lities is sufficient, 
...
for that advice; and 
• other relevant elements such as the strate gy, business 
...
supervisor’s responsibility that intermediaries are effect ively 
supervised. 
...
intermediaries to perform this work and supply the documenta tion 
required. 
...
18.2.16 A self -regulatory organisat ion (SRO) can be described as a non-
...
• establishes and maintains standards that are sufficiently 
robust; and 
...
for the type of business being intermediat ed. Once prof essional 
...
there are supervisory or statutory requirem ents that individuals 
...
18.3.3 The s upervisor may consider recognising the qualifications of 
...
18.3.7 The supervisor may establish i ts own expectations on integrity 
...
18.3.14 In j urisdictions where there is reliance on the membership of a 
...
sound level of gover nance is achieved and that there are no 
...
other authorities, professional bodies and SROs, by publishi ng 
...
and 
• compliance wi th all relevant legislation, including non-
insurance legislation such as in respect of anti -money 
laundering, fraud, etc.

Page 279 of 403 
 
18.4.4 Relevant to governance, intermediaries are required to establish 
...
at a minimum: 
• the terms and conditions of business be tween themselves and the 
customer; 
...
18.5.1 In addition to disclosing matters relating to int ermediaries 
...
• whether they are independent or act on behalf of one or 
more insurers; 
• information on the basis on which they are remunerated; 
• the services provided, including whether they offer 
products from a full range of insurers, from a limit ed range 
...
point of arranging the contract. In such situati ons the information 
...
18.5.8 It is particularly important that ins urance intermediaries provide 
...
authorised to conclude insuranc e contracts on behalf of an insurer 
or not. 
...
its importance, this information may also be highlighted verbal ly to 
the customer. 
Remuneration 
...
Communication should be clear and not misleading. In view of the 
...
procedures in place to identify and avoid, or manage, conflic ts of 
...
as prof essional support, IT support, or corporate entertainment at 
...
may: 
• receive monies from a client for the payment of pr emiums 
...
cash flows where monies are transferred via an inter mediary from 
...
18.6.7 Where insurance intermediaries operate client accounts, t he 
...
18.7 Where appropriate, the supervisor takes super visory measures against 
...
18.7.3 In some instances, the super visor may need to work with other 
...
requirements, or wher e consumers may otherwise be at risk, the 
...
unlicensed insurance intermediation is being carried out. Exam ples 
...
after the point of sale that is accurate, c lear, and not 
misleading; 
...
customers. T he fair treatment of customers encompasses 
...
Reinsurance and Other Forms of Ri sk Transfer). Nonetheless, 
...
insurance lif e-cycle, as it is the insurer that is the ultimate risk 
...
and their good conduct in per forming the services in which they 
...
expected to result in fair treatment of customer s; the insurer 
...
the supervision of conduct of business by i nsurers and 
...
19.0.14 Supervisors should be aware of the conduct o f business 
...
19.0.15 In some jurisdictions responsibility for the supervis ion of insurers 
...
prudential supervision. Where this is the case, t he relevant 
...
coordination arrangements to deal wit h conduct of business 
...
19.2 The supervisor requires insurers and intermediar ies to establish and 
...
policies and procedures in place to achieve the fair t reatment of 
...
procedures as well as ot her situations that jeopardise the 
...
insurers and intermediaries to make relevant policies and 
...
19.3 The supervisor requires insurers and i ntermediaries to avoid or properly 
...
with the insurer’s or intermediary’s dut y of care  towards its 
customers.  
...
the insurer, an intermediary is more likely than an insure r to 
...
• where the intermediary is likely to make a financi al gain, or 
...
empowers c onsumers to identify and challenge or avoid 
...
has limitations, inclu ding where the customer does not fully 
...
19.4.1 The supervisor should require insurers to conduct business only 
...
mechanisms to handle complaints ag ainst intermediaries. This 
...
against insurers in the case of di rect sales or where an insurer 
...
• any other matters rel ated to the relationship with 
customers. 
...
19.5.5 Where superv isors follow a more principles -based approach, 
...
include the use of adequat e information to assess the 
...
related disclosure doc uments by every appropriate 
...
and regulations and i ts risk management approach. In 
...
and 
−  monitor a product after its launch to ensu re it still 
...
action. 
• Insurers should provide relevant informati on to 
...
• The intermediary should, in return, pr ovide information to 
...
products complies with the legislated principles at any time, 
...
19.6.1 The insurer should be responsible for providing promoti onal 
...
that prepared or designed it. For example, where promoti onal 
...
product in order that the customer can make an informed decision 
...
consumers generally to buy. A n unusual exclusion or 
...
sheet containing information on key product featur es that are of 
...
customer that the information is not exhaustive. Insof ar as the 
...
19.7.16 Retail customers, in particular, often have only l imited knowledge 
...
• General provisions – including applicabl e law governing  
the contract; 
...
customer may be as ked clear questions about any matter 
...
insurers and int ermediaries should take into account the 
...
• the jurisdictions in whi ch the insurer or intermediary is 
...
19.8.1 Advice goes beyond the provisi on of product information and 
...
are no options. Even i f no advice is given the supervisor may 
...
19.8.8 In addition, insurer s and intermediaries  should review the “client 
files” of those under their responsibility to exercise control after

Page 304 of 403 
 
the fact on the quality of the advice given, take any necessary 
...
innovations and modifications made to the produc ts and 
services; 
...
• know the requirements for the communicati on of 
...
• service policies appropriately t hrough to the point at which all 
...
19.9.2 Supervisors should require insurers to satisf y obligations under a 
policy in an appropriate manner and in accordance with the 
contractually agreed terms and legal provisions. This should

Page 305 of 403 
 
include fair treatment in the case of switching between products or 
...
particularly w here there is an ongoing relationship between the 
...
• premiums for each benef it, both main benefits and 
...
19.9.8 Additional information provided to the policyholder r egarding 
...
• for unit-linked life insurance, a repor t from the investment 
...
appropriate. 
19.10 The supervisor requires insurers to handl e claims in a timely, fair and 
transparent manner.
...
procedures in place.  
Claims handling 
19.10.2 Insurers should maintain written document ation on their claims 
...
19.10.11 Supervisors may encourage insurers to have mechanisms in 
place to review c laims disputes within the insurer to promote fair 
...
oversight and ultimat e responsibility for the provision of fair and 
...
their independence. 
19.12 The supervisor requires insure rs and intermediaries to have policies and 
...
business. I t is important that they have in place policies and 
...
physical or electronic). Hence safeguarding personal information 
...
management of the risks. Exam ples of areas that might be 
covered include: 
...
mechanisms that support the objectives of protect ing the 
...
where a failure to protect the pri vacy of personal 
information occurs, including matters such as timely

Page 311 of 403 
 
notification to affected customers and competent 
authorities. 
...
customers for a variety of purposes within the c ourse of business 
...
information. 
In assessi ng policies and procedures to prevent the use of 
...
19.12.8 Insurers and i ntermediaries should be aware of outsourcing risk, 
...
resolution and liquidation should, s ubject to data protection 
...
informed decisions. 
19.13.5 The supervisor should have requirements rega rding the public 
...
participants a clear view of their business activities, performan ce and financial 
...
managed. 
Introductory Guidance 
20.0.1 It is important to improve and maintain the quali ty, timeliness and 
...
information precisely in acco rdance with these standards, the 
...
material, should be disclosed. It is appropriate if i nformation is 
...
triangulations). 
20.0.8 Information is decision useful if t here is a substantial likelihood that 
...
20.0.9 Excessive disclosure req uirements will not lead to effective 
...
financial reports (“repor ting entities”) may largely comply with the 
...
calculating items for public disclosure can be used fo r, or are 
...
may not be possible or appropriate in all res pects, considering the 
...
purpose financial repo rting because a consolidated group as 
...
entity w ithin the group offering the product to the policyholder. A 
...
insurance legal entiti es can cross -refer to these group level 
...
qualitative information in a way that is accessible to mar ket participants on 
...
• timely s o as to be available and up -to-date at the time those 
decisions are made; 
...
relative costs of different methods o f dissemination. One method of 
...
disaggregated so t hat the effect of distinct material items 
...
reliability aga inst those of decision usefulness and timeliness. For 
...
analysis of the insurer’s sensitivi ty to changes in key assumptions 
...
future changes. Information may also be disclosed about sig nificant 
...
period, it would be useful if the insurer discloses the reasons fo r the 
change. 
...
whether fut ure profits on existing business have been recognised 
would be useful. 
...
unearned premiums and prov ision for unexpired risks also 
...
20.2.19 It is suggested that insurers pr ovide information on the run off 
...
relating t o insurance events covered by the unearned 
...
on an ac cident year or underwriting year basis and reconcile to 
...
requirements of the jurisdiction(s) in whi ch the insurer operates and the 
...
purposes of gener al purpose financial reporting and supervision as 
...
in those jurisdicti ons more information will need to be disclosed 
...
20.4.8 Guidance 20.4.6 lists key risks related to investment acti vities. It 
...
exposure includes exposure arising f rom both an insurer’s assets 
and its liabilities. 
...
and types of credi t issuers described in Guidance 20.4.11, it is 
...
have to be disclosed, e.g. the number of contract s or of 
policyholders. 
...
Insurance Country X, Ins urance Country Y, Insurance 
...
account present information. The length of the time period m ay 
...
Disclosure of investment performance i s therefore essential to 
market participants. 
...
belonging to st atutory or notionally segregated portfolios, assets 
...
debt securities, properties and loans, an insur er may disclose a 
...
be consist ent with how the risks are being managed, including 
...
risks. 
20.7.4 Since reinsurance pr ograms are often very complex and highly 
...
that the reinsurance result –  the cost of reinsurance less rec overy 
...
• the credit quality of t he reinsurers, for example, by 
...
would be appr opriate for insurers to disclose their highest premium 
...
20.3.4), it is suggested that a description o f the entities constituting 
...
and the risks that could have an impact on the insurer’s objecti ves. 
...
20.8.9 Disclosures coul d include a quantitative analysis of the insurer’s 
...
Table 20.4 for an example of the type of sensitivity analysi s that 
could be disclosed). 
...
in whole to external parties (including outsourcing to related ent ities 
...
infrastructure. Such a discussion also demonstrat es how the key 
...
legal provi sions against fraud in insurance. In many jurisdictions, 
...
21.0.9 The supervisor should consider the applic ation of these standards, 
...
reporting and remedying f raud in insurance includes guidance on 
...
• to confiscate assets which are, or are beli eved to be, the 
proceeds of fraud. 
...
sector and requires insurers and intermediaries to take effectiv e measures 
...
assessments. They will chang e over time, depending on how 
...
21.3.1 The supervisor should i ssue anti -fraud requirements by way of 
...
training on count ering fraud. Examples of issues to be covered 
...
21.3.5 The su pervisor should take account of the risk of fraud at each 
...
caused by fraud. At a minimum the supervis or should assess 
...
21.3.8 As particular fraud r isks arise from claims, the supervisor should 
...
fraud occurri ng in the underwriting process, the supervisor should 
...
and remedial action w here insurers and intermediaries do not 
...
insurer or intermediary it should ensure that relevant informati on is 
...
• whether t he number and content of on- site inspections 
...
effectiveness of training and implementation by ins urers 
...
• the number and natur e of requests for information from 
...
Such r eviews should enable the supervisor to identify any 
...
concerns express ed by insurers and intermediaries and to obtain 
...
supervisor ta kes effective measures to combat money laundering and the 
...
ML/FT, consider whet her or not and to what extent this ICP and 
...
terrorist financing
79  provides instructive information on what the 
...
FATF standards require that t he jurisdiction considers applying the 
...
supervisor is a designated AML/CFT c ompetent authority or acts on 
...
authority 
22.1 The supervisor has a thorough and comprehensive understandi ng of the 
...
22.1.1 The supervisor should have a thoroug h and comprehensive 
...
22.1.2 The following features may increase the ML/FT ri sk profile of an 
...
• products with cooling off provisions 81 where the request is 
...
over the c ourse of a long -term insurance contract and are not 
...
ML/FT risks
82  to the insurance sector in their jurisdiction and 
...
and how risks evolve. For this reason risk assessments s hould be 
...
supervisor should participate in such an assessment t o inform the 
...
trends (typologies), sanitised exampl es of actual ML/FT, examples 
...
stage of the supervisory proces s, where relevant, including the 
licensing stage. 
...
cases where supervi sory action is resisted by insurers or 
intermediaries. 
...
of th e information arising from such monitoring and any other 
...
on: 
• the ML/FT risks and the policies, internal co ntrols and 
...
particular their number and diver sity and the degree of 
...
22.4 The supervisor regularly reviews the eff ectiveness of the measures that 
...
• the risks of ML/FT in t he insurance sector and whether 
these are adequately addressed by the risk -based 
approach of the supervisor; 
• the adequacy of the supervisor’s resources and training; 
...
inspections relating to AML/CFT measures and on sanc tions it has 
...
authorities, such as the f inancial intelligence unit, as well as with 
...
22.5.5 The exchange of information is subject to confident iality 
...
22.6.1 Where another body is the AML/CFT designated com petent 
...
by the insurer or intermediary. The contents of this inf ormation may 
...
ICP 23 Group-wide Supervision86 
...
ensure that gaps or duplic ation in regulatory oversight between 
...
supervision rests with the gr oup-wide supervisor. Decisions should 
...
group and scope of group supervision should be reviewed reg ularly 
...
this results in only one identified entity, this en tity is the head of the 
...
In addition to considering the consolidat ed accounts, the supervisor 
...
23.1.4 The ICPs’ definition of “insurance gr oup” may be different from the 
...
within the insurance group may var y depending on factors such as 
...
qualitative supervisory requirem ents applied to an insurance legal 
...
the identi fication of the insurance group or the scope of group- wide 
...
applies appropriate tools tha t take into account the nature, scale and 
...
not limited to, level of interest ra tes, financial market indices, 
...
to conduct regular market analys es. This enables the supervisor to 
...
World Bank)
 which might have a b roader perspective on 
...
to Senior Management. Where app ropriate, some higher 
...
insurance and financial markets, t he analysis is not limited to 
...
24.5.1 Supervisors should monitor insurers’ connections wi th financial 
...
24.6 The supervisor has an establ ished process to assess the potential 
...
ICP 25 Supervisory Cooperation and Coordination 87 
...
• It provides an efficient platfor m for information sharing 
...
supervisors; and 
• It facilitates the application of coordinated dec isions when 
appropriate. 
...
a group -wide supervisor can be f urther enhanced through 
...
college is usually based on the conclusion o f a MoU between all 
parties involved. 
...
25.1.4 Coordination arrangements for group -wide supervis ion include 
...
complexity of the group including it s legal and organisational 
...
particular c ircumstances, such as emergency circumstances. In 
...
by one supervisor on the work of another supervisor (a limi ted form 
...
supervisors grows. (Refer to ICP 13 Reinsuranc e and Other Forms
...
avoid unnecessary duplication;  possible joint inspect ions 
...
• Agree on whether the supervisory col lege should set out 
...
jurisdiction. Depending on the purpos e of the recognition, and the 
...
25.1.22 The different perspectives (and any dif ferent issues to take into 
...
delegation of tasks. If supervi sory recognition is achieved, the 
...
• Unilateral recognition refers to a situation w here a 
...
recognition i s to provide insurance supervisors with sufficient 
...
supervisor with suffi cient confidence in the supervision 
...
of group- wide supervi sion in its own jurisdiction, an 
...
25.1.38 While the precise form of a superv isory recognition assessment is a 
...
on a continuous basis inc luding the ability to supervise the 
...
internal controls including ri sk management and 
governance. 
...
• is able to ensure the adherence with laws, r egulations and 
...
occurring; and 
• is able to cooperate with other relevant authorit ies when 
...
requirements that wil l lead to an orderly winding -up to protect 
...
insurers in order to exercise effective supervi sion. This may be at 
...
Process for establishing supervis ory recognition - identification of existing 
agreements 
...
to regularly exc hange information in respect of changes to their 
regulatory regime. 
...
legal entity with a branch in another jurisdiction in accor dance with their 
...
role of group- wide supervisor for a parti cular group. However, 
...
placed on non l egislative means - through agreements and/or other 
...
exchange among involved supervisors. Also, effec tiveness and 
...
supervisors in the supervisory colleg e, including 
...
25.6.4 In all of these ar eas, while the group -wide supervisor would be 
...
extent possi ble, agreement among involved supervisors. In this 
...
important measure of the effectiveness of the supervisor y college. 
...
consistent with applicable confidentiality r equirements. Interim 
...
and proportionality should be applied in this de termination. Further, 
...
the form and operational structure of that college, its mem bership 
...
on how each supervisor carries out its supervision of legal enti ties 
...
significant entities is critical to the effective operation of that c ollege. 
...
the terms may be defined for particular pur poses and so take 
different meanings. 
...
25.7.15 In the case of a large group with ent ities operating in many 
...
considered where for example, participation in the s upervisory 
...
multiple tier structure of supervisory colleges, wit h subgroups of 
...
25.7.19 The membership and participation approach of a superv isory 
...
operational structure of the subgroup col lege, having regard to the 
...
terms of reference could generally cov er the following matters (this 
...
college. (This would typicall y but not necessarily be the 
...
• Frequency and locati ons of meetings –  The supervisory 
...
25.8 The designated group -wide supervisor establ ishes the key tasks of the 
...
purpose of facilit ating the effectiveness of supervision of entities 
...
supervisory pr actices, which may contribute to enhanced 
...
the group and of the jurisdi ctions in which it operates. Appropriate 
...
to such aggregate d information, a supervisory college may also 
...
a supervisory college facilitates the transfer of knowl edge and 
...
given its role, and t he allocation of those functions among the 
...
establishment and ongoing operati on of the supervisory college, 
...
protecting confidential information s o that the group can be 
...
greater cooperation. 
25.8.18 The ability of each supervisor to share i nformation should be 
...
the effectiveness of the supervisory college. J urisdictions that are 
...
25.8.20 It is important for the invol ved supervisors to have a group- wide 
...
supervisors, subject to any legislativ e requirements/restrictions. An 
...
supervisors, the opportunity to discuss iss ues with management at 
...
crisis prevention that contributes to the sa feguarding of overall 
...
efficient action in times of crisis. Wh ere a crisis situation arises, an 
...
of cooperation and coordination during emergency sit uations in 
...
the group should be clearly established in cas e a crisis emerges. 
...
responds to a cris is or a crisis management team. Alternatively, the 
...
supervisor could take in meeting its overall responsibil ities to 
...
25.10.6 The designated gr oup-wide supervisor is expected to take the 
...
supervisor, the key functions of a group -wide supervis or which 
...
compliance of corporate governance of the group. I n cases where 
...
Internal control 
25.10.11 The group -wide supervisor m onitors whether the group provides 
...
• reporting processes  
which are i mplemented and functioning consistently on a group-
wide basis. 
...
Group-wide risk analysis  
25.10.16 The group- wide superv isor monitors the risk assessment, risk 
...
Capital Adequacy.  
Information sharing and key contact point function  
25.10.19 To operate most effectively, the group -wide superv isor should 
...
insurance group or en tities belonging to the insurance 
group; 
...
The supervisor cooperates and coordinates with other relevant supervisor s and 
...
policyholders and to prevent serious domestic or internat ional 
...
through appropriate mechanisms for inf ormation exchange. 
...
26.1 The supervisor meets regularly with ot her relevant supervisors and 
...
of interest and possible bar riers to coordinated action in a crisis 
...
26.1.3 The group-wide supervisor o f the insurer will facilitate this process 
...
insurer is of systemic importance) are k ept informed of the crisis 
