---
title: "IAIS Senior Data Analyst"
regulator: "iais"
doc_type: "announcement"
status: "final"
source_kind: "policy_pdf"
source_url: "https://www.iais.org/uploads/2023/07/IAIS-Senior-Data-Analyst.pdf"
version: "1"
---
...
Un  
Career Opportunity with the IAIS – Senior Data Analyst 
...
We are inviting applications for the position of Senior Data Analyst to join the IAIS secretariat.  
By joining the IAIS 
...
Job description 
In this role, you will support IAIS’ data collection and quantitative analysis activities, which includes 
the following primary activities: 
• Collecting data (quantitative/qualitative) from various sources and performing consistency 
checks 
• Interpreting data, analysing results using statistical tools and providing on-going reports 
• Developing and managing databases, data collection templates, validation and analytical 
tools 
• Providing recommendation on data strategies 
• Performing financial market analyses 
...
recommendations  
• Contributing to the assessment of key risks and trends and the potential build-up of systemic 
risk in the insurance sector, as part of the IAIS’ annual Global Monitoring Exercise (GME) 
• Assisting with the IAIS’ contribution to the activities of the Financial Stability Board as well as 
IAIS cooperation with the BIS on data collection and analysis 
• Coordinating data meetings with member representatives 
• Drafting IAIS reports for Members and stakeholders including   public reports (such as the 
IAIS Global Insurance Market Report), notably on topics of risk assessment and financial 
stability in the global insurance sector 
• Providing expert advice and recommendations, as well as policy options 
• Contributing to the IAIS relevant stakeholder engagement and communications  plan, as 
relevant.

Page 2 of 3 
 
Un  
The general duties of the role may also include the following: 
...
• Good knowledge of the insurance business and/or supervision 
...
delivery of project objectives including in time -constrained and/or information constrained 
circumstances. 
