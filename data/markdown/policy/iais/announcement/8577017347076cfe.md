---
title: "210129 IAIS Comment Letter to IAASB Consultation Fraud and Going Concern"
regulator: "iais"
doc_type: "announcement"
status: "final"
source_kind: "policy_pdf"
source_url: "https://www.iais.org/uploads/2022/01/210129-IAIS-Comment-Letter-to-IAASB-Consultation-Fraud-and-Going-Concern.pdf"
version: "1"
---
...
changes in the audit environment (eg, digitali sation, ability to forge documents).  The IAASB 
...
We are also supportive of the proc ess that the IAASB has outlined in the discussion 
...
• Focus on audit quality: The IAIS suggests that a key focus of the IAASB’s review 
...
the IAASB’s role. I f the focus of the IAASB’s review is a perceived expectation gap 
...
communication is likely t o be less useful if it uses ‘boilerplate’ wording. Setting out 
...
seems clear from the requirement of an audit “to obtai n reasonable assurance about 
...
procedures and states that “…proportionality and scalability are important consider ations, particularly 
...
nevertheless strive to ensure that both are detected 2. The IAASB shou ld therefore 
...
is not adequately explained, and so i t is not clear that this is a helpful or necessary 
...
a balance between what auditors can reasonabl y accomplish considering their 
...
report is signed. However, it m ay be more difficult to expect auditors to make 
