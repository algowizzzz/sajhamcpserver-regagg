...
source_url: "https://www.iosco.org/library/pubdocs/pdf/IOSCOPD778.pdf"
version: "1"
---

CR/11/24 November 2024 
...
iosco.org 
© International Organization of Securities Commissions 2024. 
All rights reserved. Brief excerpts may be reproduced or translated 
provided the source is stated. 
iosco.org iosco.org iosco.org iosco.org iosco.org iosco.org iosco.org iosco.org iosco.org iosco.org iosco.org iosco.org
...
Comments may be submitted through the following survey: LINK. - on or before 21
st
 February, 2025 
...
Chapter 3. Jurisdictional Practices & Misconduct Cases 13 
Chapter 4. Industry Practices & Standards 17 
Survey responses 17 
Industry codes and standards 20 
Chapter 5. Definition of Pre-hedging 22 
Chapter 6.  Recommendations for Determining When Pre-hedging is 
Acceptable 25 
Genuine risk management purpose 26 
Act fairly and honestly 29 
To the benefit of the client 29 
Minimising market impact 30 
Chapter 7. Management of Conduct Risk from Pre-hedging 32 
Policies and procedures 33 
Disclosure and consent 34 
Compliance and supervisory arrangements 39 
Manage information and conflicts 40 
Record-keeping 41 
Chapter 8. Considerations for Clients 42 
Chapter 9. List of Recommendations and Consultation Questions 43 
Appendix 47 
External publications 48

Pre-hedging is used by dealers to manage the risk of anticipated wholesale 1 
...
(ii) the trades are executed after the receipt of information about a n 
...
these recommendations to dealers in their jurisdiction s, taking into account 
...
hedging and provides a schematic of pre -hedging t hat enables readers to 
...
for the m anagement of potential conduct risk from pre -hedging and seeks 
...
Clients 7  seek prices from dealers in a range of financial instruments (e.g., 
...
information to the dealer about the interest to trade, such as the securit y or 
...
behalf) has an irrevocable agreement on a deal or accept ed an executable 
...
associations indicate that despite the develop ment of industry codes and 
...
(ii) the trades are executed after the receipt of information about a n 
anticipated client transaction and before the client (or an intermediary 
on the client ’s behalf) has agreed on the terms of the transaction 8 
and/or irrevocably accepted an executable quote; and  
(iii) the trades are executed to manage the risk related to the anticipated 
...
disclosure and consent in ensuring transparency, but opinions differ ed on 
...
protocol, others argued against a narrow focus and recommend ed a holistic 
...
market abuse regulation s with a focus on in sider dealing, including  front 
...
requesting international coordination among regulators of any fu ture ESMA 
...
suspicious trading reports regarding pre -hedging activity. For example, t he 
...
(Front Running of Block Transactions). For example, i n October 2016, FINRA 
...
purchased contracts of calls for, and sold shares from, it s own proprietary 
...
to the conduct, together with  AUD $8 million fo r ASIC’s  litigation and 
__________________________ 
13  Mostly bonds for 49%, CDS for 8% and interest rate swaps for 5% and FX derivatives 3% (out 
of 64% in total) 
14  In re ference with  Nomura Securities International, Inc. (2016) :  
...
increase to the price of the swap transaction wou ld involve a cost to 
...
matters17  to understand market practice in relation to pre -hedging and to 
...
The industry r espondents generally  believe that pre -hedging is a long -
...
Industry r espondents noted their views that t here are various factors that 
...
Principle 7  that for d ealing with large orders , pre-hedging should only be 
undertaken where:  
...
The FX G lobal Code,21 developed from a partnership between central banks 
...
expressed the view that there remain s significant uncertainty for dealers, 
...
Any trading activity after the acceptance of the firm quote by the liquidity c onsumer is 
...
anticipated client transaction and before the client (or an intermediary 
on the client ’s behalf) has agreed on the terms of the transaction 26 
and/or irrevocably accepted an executable quote; and  
(iii) the trades are executed to manage the risk related to the anticipated 
client transaction.” 
...
Period after the receipt of information about 
an anticipated client transaction and before 
the client (or an intermediary on the client’s 
behalf) has agreed on the terms of the 
transaction and/or irrevocably accepted an 
executable quote 
Pre-hedging (PH) 
...
transaction and/or irrevocably accepted an 
executable quote 
Figure 1: Pre-hedging schematic 
 
 
 
 Hedging 
 
If terms of possible anticipated transaction 
have been agreed with the client and/or client 
has irrevocably accepted an executable 
quote (or unwinding process if the possible 
anticipated transaction has been declined) 
...
Yes, with recommended controls 
Inventory 
management 
Is pre-hedging activity 
...
Pre-hedging in the right circumstances, according to the dealer’s risk appetite 
...
reasonable size  of pre -hedging activity. IOSCO believes that p re-hedging 
should not move prices against the client’s interest and should be use d with 
...
benefit and at the expense of the client . F or example, a dealer could use 
information about a n anticipated transaction by taking a risk position or  
...
benefit of the information about a prospective t rade). In a competitive RFQ 
...
➢ Recommendation B1: The dealer should document and implemen t 
...
at that point in time. Where Large Trades are contemplated, t he dealer is responsible for 
...
and capacity in which the dealer is actin g; (ii.) execution strategy, e.g. timing or potential 
...
trading platforms are generally sophisticated institutio nal investors who may 
...
electronic means such as single or multiple dealer platforms or applicatio n 
...
conduct a post -trade review of pre -hedging activity , and the execu tion 
...
clients.37  The report  states that when dealers rec eive requests from clients 
...
believes that i t is important that these processes seek to cover the 
...
IOSCO believes that e ffective record  keeping practices of pre -hedging 
activities support effective front office s upervisory oversight and monitoring 
...
4. If a client does not want pre -hedging to be used , the c lient could 
