---
title: "Thematic Review Process Document"
regulator: "iosco"
doc_type: "announcement"
status: "final"
source_kind: "policy_pdf"
source_url: "https://www.iosco.org/about/assessment_committee/pdf/Thematic-Review-Process-Document.pdf"
version: "1"
---
...
4. The objective of Thematic Reviews 2 is to contribute to the full, effective and consistent 
...
Page 2 of 16 
o Difficulties and issues which have been identified in implementation; and 
...
 Provide a stimulus to IOSCO members who have no t implemented IOSCO Principles 
...
revision or where further IOSCO work may be necessary (by  Committees and T ask 
Forces (TFs)); and 
...
 Adoption Monitoring Reviews : Reviews which measure the prog ress jurisdictions 
...
3 “Level 1 ” style reviews are timeliness reviews.  They consider w hether jurisdictions have completed the 
...
Memorandum of Understanding (MMoU). In this regard, the Screening Group’s wo rk includes assigning 
...
Page 3 of 16 
 Conducting Thematic Reviews of IOSCO Principles and Standards (including 
...
close partner ship with Committees and TFs.  This is intended to ensure the Thematic 
...
sufficient time has elapsed s ince the IOSCO Principle or Standard was approved 
...
by non -implementation (or differing implementation s) are seen as significant to 
the following: 
 Investor protection; 
...
 The priorities will then be discussed an d agreed with Committee and TF Chairs.  The 
...
 Where relevant, n on-participation of  IOSCO members from FSB jurisdictions,  
IOSCO Board and AC members from jurisdictions in which there is sig nificant 
...
the significance threshold.  The significance th reshold for each project will be set out in the Assessment 
Methodology (see paragraph 29).

Page 6 of 16 
 When considering whether to apply for nomination as RT leader, members should 
...
position of sufficient seniority appropriate to the compositio n of the RT and the 
project. 
...
 RT members shoul d be selected according to their expertise in the subject matter of 
the Thematic Review or their experience in undertaking peer reviews. 
 RT members will act in a n impartial and objective manner, which is what the AC 
means when it calls on RT members to par ticipate in their  personal capacity in a 
Thematic Review.   
...
17. Thematic Reviews will be conducted applying the steps set out in para graphs 21 to 64 
below. 
...
Page 7 of 16 
20. Thematic Reviews of G20 and FSB priority reforms to which the CFIM 7 applies will be 
...
Committee or TF. 
24. The ToR will be approve d by the AC after meaningful consultation with relevant 
...
 The type of Thematic R eview (for instance whether it is an Adoption Monitoring 
...
Page 8 of 16 
 How the Thematic Review will be conducted (outlining the key elements of an 
...
where appropriate, comment on planned but yet to be impl emented initiatives.  Where 
...
guidance.   
These measures will be considered in scope for all  Thematic R eviews.  For 
Implementation Assessment Reviews , the assessment and any ratings  will take into 
account measures jurisdict ions effectively take to achieve the policy objectives 
...
application of nationa l laws and regulations (compared to the agreed scope), and the 
...
Page 9 of 16 
 Contain, when appropriate, other information that may be r elevant for assessing 
...
institutional practices), including feedback from the industry and the p ublic, provided 
...
 A description of the rating scale to be used in reporting findings .  M ore guidance on 
...
up. 
31. The RT will also generally use IOSCO developed online survey software to facilitat e the 
...
 Where appropriate and relevant, any issues experie nced in adopting or implementing 
regulation; 
...
Page 11 of 16 
36. The RT will need to consider the following  factors in deciding whether to include this 
...
Ratings 
37. In principle, every Adoption Monitoring Review  and Implementation Assessment Revi ew 
...
43. Where the Assessment Methodology touches on Committee and TF responsi bilities, the 
...
47. There might be a need to collect confident ial information in the framework of certain 
Thematic R eviews.  In such cases, the AC and RT members, as appropriate, will be 
...
Page 13 of 16 
 A review of the progress made in adopting the relevant IOSCO Principles or 
Standards; 
...
fairness and efficiency of market s (including the risk of regulatory arbitrage) or 
...
 Country-by-country implementation comparison co vering the scope of application 
...
 Consideration of re commendations to address major impediments to, or gaps in, 
implementation.

Page 14 of 16 
52. A face-to-face meeting of the RT is particularly encouraged at this stage.  This will enable 
the RT to discuss the key takeaways from its analysis of the questionnaire responses an d 
...
 The draft final report should, at the very least, co mprise an introduction or executive 
...
according t he type of review.  For instance, Adoption Monitoring Reviews  will 
...
reporting by participating juri sdictions to the AC and IOSCO Board.  The nature of 
...
Page 15 of 16 
58. For Thematic Reviews to which the CFIM applies, the AC Chair will engage with the 
...
64. The decision whether to delete jurisdiction specific information from a final report p rior 
...
which may be made in the final report for each Thematic R eview.  The AC also 
...
Page 16 of 16 
addressing identified gaps, the AC will develop processes (with the CT) to collect, 
