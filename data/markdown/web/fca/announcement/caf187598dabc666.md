...
status: "final"
source_kind: "web"
source_url: "https://www.fca.org.uk/news/statements/uk-financial-regulators-overseeing-critical-third-parties-announced-treasury"
version: "1"
---
...
This regime complements, but does not replace, existing outsourcing and [operational resilience rules](/publications/policy-statements/ps21-3-building-operational-resilience "PS21/3 Building operational resilience") for regulated firms who remain responsible for managing their own third-party arrangements including due diligence, risk management and contingency planning.
...
1. The regulations will come into effect on Monday 13 July 2026. Please refer to the government’s website for [Treasury’s press release](https://www.gov.uk/government/news/uk-financial-system-strengthened-with-new-safeguards-for-major-technology-providers) and [CTP regulations](https://www.legislation.gov.uk/uksi/2026/777/regulation/2/made) published.
2. You can find more information on the regulators’ oversight regime on FCA’s [website](/firms/critical-third-parties-strengthening-uk-financial-services "Critical Third Parties: Strengthening UK Financial Services") and [PRA’s website](https://www.bankofengland.co.uk/financial-stability/operational-resilience-of-the-financial-sector/critical-third-parties).
3. Treasury is responsible for deciding which third party suppliers should fall under the CTP regime, generally based on recommendations from the regulators. The scope of entities under the regime will continue to evolve as further designations are considered.
4. Designation under this regime is not the same as authorisation by the regulators. Oversight is limited to the resilience of the services they provide to UK financial firms.
5. Financial Services and Markets Act (FSMA) 2000 as amended by FSMA 2023 gave the Bank, PRA and FCA new powers to oversee critical third parties, strengthening the resilience of the services they provide to regulated firms and financial market infrastructures.
6. In November 2024, the FCA, the Bank and PRA [introduced the final rules and policy](/news/statements/new-rules-strengthen-resilience-uks-financial-sector "New rules to strengthen resilience of UK’s financial sector") for the CTP regime. These came into effect on 1 January 2025 and apply immediately to CTPs once designated by Treasury.
7. Alongside the final rules and policy, the regulators published their [approach to regulatory oversight](https://www.bankofengland.co.uk/prudential-regulation/publication/approach-to-the-oversight-of-critical-third-parties) and a [supervisory statement](https://www.bankofengland.co.uk/prudential-regulation/publication/2024/november/operational-resilience-critical-third-parties-to-the-uk-financial-sector-supervisory-statement) setting out expectations for CTPs on how to interpret and comply with the regulators’ new rules.
8. CTPs may also be regulated under similar regimes in other jurisdictions, including the EU’s Digital Operational Resilience Act (DORA). The regulators have signed a [Memorandum of Understanding](/news/statements/uk-and-eu-regulators-sign-memorandum-understanding-strengthen-oversight-critical-third-parties "UK and EU regulators sign Memorandum of Understanding to strengthen oversight of critical third parties") to support coordination and information sharing on oversight of CTPs.
