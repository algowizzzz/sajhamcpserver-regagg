---
title: "General insurance value measures data 2025"
regulator: "fca"
doc_type: "announcement"
status: "final"
source_kind: "web"
source_url: "https://www.fca.org.uk/data/general-insurance-value-measures-data-2025"
version: "1"
---

This is our fourth full year of general insurance (GI) value measures data, covering January to December 2025.

We publish this data each year to improve market transparency and give firms, consumer groups and other stakeholders a common set of indicators across a range of general insurance products. These indicators include claims frequency, claims acceptance rates, average claims payout, claims complaints rates and the proportion of premiums paid out in claims. This publication is a factual summary only. We explain any data challenges and limitations, and our approach to data quality below. Please note that our post-implementation review of the value measures rules is ongoing - we plan to publish our findings later this year, which will enable us to draw attention to the known data issues we are tackling (for example, the inconsistencies in how firms report claims acceptance data for home insurance).

This data supports our wider work, including:

* Our ongoing commitment to the recommendations in our July 2025 retail insurance [publication](https://www.fca.org.uk/publications/corporate-documents/roadmap-retail-insurance). In that work, we examined the reasons for increases in motor insurance premiums, with a focus on claims costs, and looked at claims handling in home and travel insurance.
* Our [expanded work](https://www.fca.org.uk/news/statements/fca-expands-insurance-work-response-which-super-complaint) to improve standards in the home and travel insurance markets following Which?’s super complaint.

These issues remain priorities for us and feature in our [Regulatory Priorities: Insurance report](https://www.fca.org.uk/publication/regulatory-priorities/insurance-report.pdf), published earlier this year.
...
* As an example, the value measures data informed our previous action on GAP insurance from which firms agreed to pause selling until they could show that their products provide fair value to customers. The data was also used to form part of our response to the Which? super complaint. In our [2023 value measures publication](https://www.fca.org.uk/data/general-insurance-value-measures-data-2023), we set out actions for firms and our expectations under PROD4 and the Consumer Duty, which remain unchanged.

## What the 2025 data shows

### Home and travel insurance

The data for home and travel insurance continues to reflect the trends we focused on in our [response](https://www.fca.org.uk/news/statements/fca-expands-insurance-work-response-which-super-complaint) to the Which? super complaint and our [Regulatory Priorities: Insurance report](https://www.fca.org.uk/publication/regulatory-priorities/insurance-report.pdf). We expect to see these measures improve through firms’ actions in response to our ongoing work. In particular:
...
[Download GI value measures 2025 (XLSX)](/publication/data/gi-value-measures-data-2025.xlsx "gi-value-measures-data-2025.xlsx")
...
Some factors that are not visible in the value measures data may also affect the results for a given period. These include business mix, product age, policy duration, target market and business volumes. External factors such as climate, inflation and wider societal issues may also have an impact.
...
In Policy Statement [PS20/9](https://www.fca.org.uk/publication/policy/ps20-9.pdf) we said that we would not require firms to report claims cost information for legal expenses insurance or vehicle breakdown insurance. The data does not include related metrics for these products.

### Read next

[Previous general insurance value measures data](/data/previous-general-insurance-value-measures-data)
[Thematic Review 24/2: General insurance and pure protection product governance](/publications/thematic-reviews/tr24-2-general-insurance-pure-protection-product-governance)