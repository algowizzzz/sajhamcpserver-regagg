---
title: "Asset allocation survey"
regulator: "fca"
doc_type: "announcement"
status: "final"
source_kind: "web"
source_url: "https://www.fca.org.uk/data/asset-allocation-survey"
version: "1"
---
...
* [FCA survey results](#section-fca-survey-results)

A similar exercise was conducted by [The Pensions Regulator looking at master trust (MT) schemes](https://www.thepensionsregulator.gov.uk/document-library/research-and-analysis/master-trust-asset-allocation-2026).

Using that combined data, the following assessment of the combined market has been produced.

Table 1: Key asset class allocation - trust (MT) and contract-based multi-employer arrangements
...
Table 2: Contract-based multi-employer default arrangements asset allocation
...
1. The Private markets figures above include private equity. Private credit/debt. Real estate and infrastructure.
2. All figures are rounded to 1 decimal place.
3. Our survey sought asset allocation data at a more granular level, in some areas we have combined categories for simplification.
...
22/07/2026
:  Technical update for accessibility