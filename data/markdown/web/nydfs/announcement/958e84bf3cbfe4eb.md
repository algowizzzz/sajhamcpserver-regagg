---
title: "Pharmacy Benefit Managers | Department of Financial Services"
regulator: "nydfs"
...
* See a list of [PBMs currently licensed in New York](/apps_and_licensing/pharmacy_benefit_managers/Licensed-PBMs).

### DFS Connect

DFS has launched DFS Connect for New York consumers to file complaints regarding PBMs and reporting drug price spikes. Through this portal, consumers can receive real-time status updates from DFS about their complaints. DFS Connect is also where PBMs and Drug Manufacturers can review complaints, correspond with the Department, and upload documentation relevant to cases.

Regulated entities [access DFS Connect](https://dfsconnect.dfs.ny.gov/) through DFS ID. For more information about DFS ID, visit our [DFS ID webpage.](https://www.dfs.ny.gov/DFSID)

* Consumers can create a DFS account or file a PBM complaint at [dfsconnect.dfs.ny.gov/complaint](https://dfsconnect.dfs.ny.gov/complaint "https://dfsconnect.dfs.ny.gov/complaint").

Detailed instructions on how to access and respond to consumer complaints, can be found in the [Responding to Consumer Complaints in DFS Connect User Guide](/apps-and-licensing/pharmacy-benefit-managers/responding-to-consumer-complaints-user-guide) (PDF).
...
[Insurance Law Article 29](https://www.nysenate.gov/legislation/laws/ISC/A29) (NYSenate.gov) and [Section 280-a of the Public Health Law](https://www.nysenate.gov/legislation/laws/PBH/280-A) (NYSenate.gov) authorize the Department of Financial Services to regulate Pharmacy Benefit Managers operating in New York.

### Regulations

To view recently proposed and adopted regulations, visit our [Regulatory and Legislative Activities](https://www.dfs.ny.gov/industry_guidance/regulations) section.
...
DFS Connect is where PBMs and Drug Manufacturers can review complaints, correspond with the Department, and upload documentation relevant to cases.

* Entities [access DFS Connect](https://dfsconnect.dfs.ny.gov/) via DFS ID. For more information about DFS ID, visit [DFS ID.](/DFSID)
* Consumers can create a DFS account or file a PBM complaint at [dfsconnect.dfs.ny.gov/complaint](https://dfsconnect.dfs.ny.gov/complaint "https://dfsconnect.dfs.ny.gov/complaint").

Detailed instructions on how to access and respond to consumer complaints, can be found in the [Responding to Consumer Complaints in DFS Connect User Guide](/apps-and-licensing/pharmacy-benefit-managers/responding-to-consumer-complaints-user-guide) (PDF).

Drug manufacturers looking to report drug price increases to the Department should visit the [Prescription Drug Manufacturer Filings](https://www.dfs.ny.gov/apps_and_licensing/drug_manufacturers) page.
...
The 2025 Annual Report (Reporting Period: January 1, 2025 to December 31, 2025) consists of three separate documents that must be reviewed and/or completed:

* [2025 Annual Report (Reporting Period: January 1, 2025 to December 31, 2025) Instructions](/apps_and_licensing/pharmacy_benefit_managers/annual-report-instructions_2025)
* [2025 Annual Report (Reporting Period: January 1, 2025 to December 31, 2025) Spreadsheet](/apps_and_licensing/pharmacy_benefit_managers/annual-report-spreadsheet-2025) (.xlsm)
* [2025 Annual Report (Reporting Period: January 1, 2025 to December 31, 2025) Attestation](/apps_and_licensing/pharmacy_benefit_managers/annual-report-attestation-2025) (PDF)
...
**How to Submit the 2025 Annual Report (Reporting Period: January 1, 2025 to December 31, 2025)**

To submit the 2025 Annual Report (Reporting Period: January 1, 2025 through December 31, 2025) combine your submission documents into one "zipped" file, visit the [Pharmacy Benefit Managers dropbox](https://mysend.ny.gov/nys/send/to/dropbox/pharmacy-benefit-managers) on the New York State MySend platform, and follow the [2025 Annual Report Instructions](/apps_and_licensing/pharmacy_benefit_managers/annual-report-instructions_2025).

**Note**: Follow the instructions for each question carefully, including the naming convention.

If you have any questions, check our [FAQs About PBM Annual Reporting](/apps_and_licensing/pharmacy_benefit_managers/FAQs). If you still need help, email [[email protected]](/cdn-cgi/l/email-protection).
