---
title: "Contact Us | Department of Financial Services"
regulator: "nydfs"
...
The DFS Hotline is staffed Monday - Friday, from 8:30 AM to 4:30 PM.
...
* Use our general **Consumer Complaint form** to file a general complaint with DFS about an insurance company, bank, student loan, mortgage or foreclosure, bail agent, or any other financial service or product.
* Use **DFS Connect** to file a complaint about a Pharmacy Benefit Manager or drug price spike.
* Healthcare providers should use our online **Healthcare Provider Complaint Form** to file a complaint about prompt payment, no fault, or workers compensation claims.

Learn [how to file a Consumer or Provider Complaint](/complaint).
...
If your insurer or HMO denies health care services as not medically necessary, experimental/investigational or out-of-network, you have the right to appeal to the Department of Financial Services. This is known as an External Appeal. Health care providers also have the right to an appeal when services are denied.

* Learn [how to file an External Appeal](/complaints/file_external_appeal).
...
* Learn [how to dispute a Surprise Medical Bill](/IDR).
...
* Learn [how to file for No-Fault Arbitration](/complaints/file_no_fault_arbitration).
...
Looking for help finding which DFS Secure Platform to use to manage a particular notification, filing or exam? Visit [DFS Secure Platforms and Applications](https://www.dfs.ny.gov/contact-us/apps-and-platforms) to see if the application you are looking for is on DFS Portal, DFS Connect, or NY LINX.

### Browsers and Blockers

When using any DFS application:

* **Use a supported browser**: Use the latest version, or one previous version, of Edge, Firefox, Chrome, and Safari.
* **Disable “Pop-up Blockers”** in your browser settings before using a DFS application.
* **Maintenance**: An application may be unavailable from 7:30 a.m. to 7:45 a.m., our daily maintenance window.
* Some DFS apps **may not be compatible with smart phones and tablets**.

### Help with DFS ID

* If you can’t access DFS ID, or do not know who your Entity Administrator is, use the [DFS ID Help Form](https://dfsidauth.dfs.ny.gov/as/authorize?client_id=508455ad-d9c5-419a-a113-284054094593&response_type=code&redirect_uri=https://dfsidauth.dfs.ny.gov/&scope=openid&acr_values=8a7ee12321207e0df7224c45b4e6ad1b) to request assistance. [Learn more about using DFS ID](/DFSID) to access DFS applications, including DFS Connect, NY LINX, and DFS Portal.

### Help with DFS Portal

* Learn [how to get help with a Portal application.](/Portal-Help)

### Help with DFS Connect

* Learn about using [DFS Connect](https://www.dfs.ny.gov/dfsconnect) for exams, industry filings and certain consumer complaints.
...
* If you need help with My NY.gov, [visit MY NY.Gov](https://my.ny.gov/LoginV4/login.xhtml).
...
The Freedom of Information Law (FOIL) provides the public right to access to records maintained by government agencies with certain exceptions.

* Learn more about [requesting DFS records under the Freedom of Information Law.](/foil_request)
...
The Department encourages anyone interested in a proposed regulation to use the public comment period to submit a written comment on a proposed regulation. Comments can be submitted to the Agency Contact noted next to [the proposed regulation](/industry_guidance/regulations). Questions regarding the content of a specific proposed regulation may also be sent via email to the listed Agency Contact.
...
Insurance companies are required to send you a notice about a proposed premium rate increase when they file their application with DFS to increase the rate. The notice should state that an application has been filed and that you can review the application on this website, where you can also [learn more about rate increases or submit comments about a proposed premium increase](/consumers/health_insurance/health_insurance_premiums).
...
If you suspect that insurance fraud has been committed learn [how to report insurance fraud to DFS](/complaints/report_fraud).
...
1399 Franklin Avenue, Suite 203  
