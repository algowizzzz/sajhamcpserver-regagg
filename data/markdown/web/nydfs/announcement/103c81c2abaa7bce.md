---
title: "Healthcare in New York | Department of Financial Services"
regulator: "nydfs"
...
* Learn more about [Insurance Discounts and Savings](https://www.dfs.ny.gov/consumer-insurance-discounts-savings).
...
* Learn more about [how New York State is working to build a more equitable and accessible health care system](/industry_guidance/health-equity).
...
* Learn more about [Health Coverage for Transgender New Yorkers](/consumers/health_insurance/transgender_healthcare)
...
* Learn more about [COBRA, Age 29 and Continued Coverage Information](/consumers/health_insurance/cobra_and_premium_assistance)
...
* Learn more about health insurance [confidentiality for victims of domestic violence](/apps_and_licensing/insurance_companies/confidentiality_domestic_violence).
* See a sample [confidential communication request form](/apps_and_licensing/insurance_companies/confidentiality_domestic_violence/request_form) that a health insurer may ask you to submit.
* Visit the OPDV website to download and print a [Reference Guide for Health Insurance Rights for Victims and Survivors of Domestic Violence](https://opdv.ny.gov/health-insurance-dv-rights-reference-guide).
...
* Learn more about [Paid Family Leave in New York State](/consumers/health_insurance/Paid-Family-Leave)
...
* Learn more about how to get [Help For the Seriously Ill and Their Caregivers](/consumers/health_insurance/help_seriously_ill).

### Child Health Plus

Every child in New York under the age of 19 who does not have health insurance is eligible for the Child Health Plus program. Visit the [Department of Health](https://www.health.ny.gov/) for more information on Child Health Plus or call (800) 698-4543 or your local department of social services.

### Healthy NY

DFS oversees the Healthy NY program which, in partnership with HMOs and other insurance companies in New York State, offers comprehensive [health insurance for small businesses](/consumers/small_businesses#healthy-ny).
...
* Learn more about [Protections for Medicare Beneficiaries Residing in New York State](/consumers/health_insurance/information_for_medicare_beneficiaries)
...
* Learn how to [file an External Appeal](https://www.dfs.ny.gov/complaints/file_external_appeal).
* Search prior appeal decisions using our [External Appeals Database](https://www.dfs.ny.gov/public-appeal/search).
...
* Learn [how to protect yourself from a surprise medical bill and the patient-provider dispute resolution process](/consumers/health_insurance/surprise_medical_bills).
...
If you need assistance with a preauthorization request, complaint, grievance, or appeal with your health insurer, you can designate a person or persons or organization to assist you by completing the [New York Standard Health Insurance Designee Form](https://www.dfs.ny.gov/consumers/New-York-Standard-Health-Insurance-Designee-Form) and submitting it to the address or fax number on your member identification card or by the method specified by your insurer.

* This form is available in other languages on the [File a Complaint](https://www.dfs.ny.gov/complaint) page.
...
* Read [more detailed information on each of these important protections](/consumers/health_insurance/rights_responsibilities). Also, be sure to check your health insurance contract for the terms and conditions of your coverage.
...
* Read more detailed information about these [important health care provider rights and responsibilities](/consumers/health_insurance/rights_responsibilities).
...
* [Learn more about drug prices](https://www.dfs.ny.gov/consumers/healthcare/drug-prices) and what to do if you experience a significant increase or “spike” in the price of a prescription drug.
* Drug manufacturers needing to report a drug price increase, should visit the [Prescription Drug Manufacturer Filings](https://www.dfs.ny.gov/apps_and_licensing/drug_manufacturers) page.
...
* Learn more [about Pharmacy Benefit Managers](https://www.dfs.ny.gov/consumers/health_insurance/pharmacy-benefits-drug-prices).
...
* [Understanding Long Term Care and LTC Insurance Policies](https://www.dfs.ny.gov/consumers/health-insurance/long-term-care)
...
* Learn more about [Health Insurance Premiums and Applications for Rate Increases](https://www.dfs.ny.gov/consumers/health_insurance/health_insurance_premiums).
...
* See previous years' versions of the [New York State Consumer Guide to Health Insurers](/consumers/health_insurance/health_insurance_complaint_rankings).
