---
title: "Health Equity | Department of Financial Services"
regulator: "nydfs"
...
DFS remains committed to closing the health equity gap and reducing health disparities. To help identify disparities that exist in the quality and utilization of care experienced by underrepresented populations and inform data-driven public policymaking, [DFS adopted regulation 11 NYCRR § 52.52](https://www.dfs.ny.gov/industry_guidance/regulatory_activity/insurance) in April 2025.
...
A [Sample Form Template: Questionnaire to Support Health Equity](/industry_guidance/health-equity/sample-template-questionnaire) has been developed by DFS to collect demographic data through the regulation. Insurers may use this form to comply with the requirements of the regulation. Insurers must use the [CSV File for the Submission of Health Equity Data](/industry_guidance/health-equity/health-equity-data) to report demographic data to DFS. Instructions on how to file the report are available in the [Instructions for Submitting Health Equity Data](/apps-and-licensing/health-insurers/health-equity-data-submission-instructions)(PDF).

This initiative builds upon the Department's efforts to advance health equity in the state of New York and increase access and affordability to critical services, including through strengthening the [Governor’s initiative to eliminate cost-sharing for insulin](/reports_and_publications/press_releases/pr202401021), [regulations to increase access to mental health and substance use disorder services](/reports_and_publications/press_releases/pr20250226), and [regulations to increase access to prescription drugs](/reports_and_publications/press_releases/pr20241120).
...
The Department has provided a [Sample Form Template: Questionnaire to Support Health Equity](/industry_guidance/health-equity/sample-template-questionnaire) that lists the demographic information that insurers must request.
...
Insurers should use a questionnaire that requests that insureds voluntarily provide the demographic information. The Department has provided a [Sample Form Template: Questionnaire to Support Health Equity](/industry_guidance/health-equity/sample-template-questionnaire) that insurers may use to collect the demographic information to comply with the regulation.
...
* [CSV File for the Submission of Health Equity Data](/industry_guidance/health-equity/health-equity-data) (CSV)
* [Instructions for Submitting Health Equity Data](/apps-and-licensing/health-insurers/health-equity-data-submission-instructions) (PDF)
* [Sample Form Template: Questionnaire to Support Health Equity](/industry_guidance/health-equity/sample-template-questionnaire) (MS Word)
* [Insurer Attestation Regarding Use of Demographic Data](/industry_guidance/health-equity-attestation-demographic-data "Insurer Attestation Regarding Use of Demographic Data") (PDF)
* [Health insurance information for consumers](/consumers/health_insurance/home)
* [Health insurance information for insurers](/apps_and_licensing/health_insurers)
