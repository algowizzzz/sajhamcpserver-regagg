...
* a completed [High Level Questionnaire](/about/pdf/High-Level-Questionnaire.pdf); and
* an [application to the MMoU](/library/pubdocs/pdf/IOSCOPD386.pdf).

## Associate Membership

If the application is for associate membership, it must include a description of the applicant, its mission and (if applicable) a completed [High Level Questionnaire](/about/pdf/High-Level-Questionnaire.pdf) and [Action Plan](/about/pdf/Action-Plan-for-signing-IOSCO-MMoU.pdf) for signing IOSCO MMoU.
