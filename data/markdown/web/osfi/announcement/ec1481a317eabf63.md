---
title: "Supervisory Framework - Office of the Superintendent of Financial Institutions"
regulator: "osfi"
doc_type: "announcement"
status: "final"
source_kind: "web"
source_url: "http://www.osfi-bsif.gc.ca/en/supervision/supervisory-practices/supervisory-framework-0"
version: "1"
---
# Supervisory Framework

[Generate PDF](/en/print/pdf/node/2090)

## On this page

* [Overview](#overview)
* [The foundations of our supervisory approach](#foundation)
* [Key principles of supervision](#principle)
* [How we supervise institutions](#supervise-institution)
* [Supervisory ratings for institutions](#rating-institution)
* [How we supervise pension plans](#supervise-pension)
* [Supervisory ratings for pension](#rating-pension)

## Overview

The Supervisory Framework guides our oversight of federally regulated financial institutions (institutions) and private pension plans (pension plans). Our primary goal is to protect depositors, policyholders, institution creditors, and pension plan beneficiaries. In doing so we contribute to public confidence in the Canadian financial system.
...
The Framework applies to institutions and pension plans. It is differentiated where necessary to reflect the specific characteristics of deposit-taking institutions, insurers, and pension plans.
...
* the Basel Committee on Banking Supervision’s [Core Principles for Effective Banking Supervision](https://www.bis.org/publ/bcbs230.htm)
* the International Association of Insurance Supervisors’ [Insurance Core Principles and Methodology (PDF, 4.02 MB)](https://www.iaisweb.org/uploads/2022/01/191115-IAIS-ICPs-and-ComFrame-adopted-in-November-2019.pdf)
* The International Organisation of Pension Supervisors’ [Principles of Private Pension Supervision (PDF, 280 KB)](https://www.iopsweb.org/principlesguidelines/IOPS-principles-private-pension-supervision.pdf)

## The foundations of our supervisory approach

### While our supervision reduces risk, it does not eliminate it

We recognize that management, boards of directors, and pension plan administrators are ultimately responsible for risk decisions and that institutions can fail, and pension plans can experience financial difficulties resulting in the loss of benefits.
...
## How we supervise institutions

### Our supervisory process

* the work we do to [identify risks at institutions](#risk_identification_dti)
* how we [assess risks and assign ratings](#risk_assessment_dti)
* our [response to risks and the monitoring of remediation activity](#risk_response_dti)
* how we [report the results of our supervisory work](#supervisory_reporting_dti)

### Risk identification

#### Factoring in size, complexity, and potential system impact

We're guided by our [risk appetite](/en/about-osfi/progress-our-initiatives/refining-we-approach-risk "Refining how we approach risk") in terms of the supervisory work that we carry out. We recognize that it is not cost-effective or realistic for us to intervene on all risks facing institutions. We have a high appetite for early corrective action to address risks that could jeopardize the public's confidence in the Canadian financial system.

The type of supervisory work that we do to identify risks considers an institution's size, complexity, and potential impact on the financial system. This is reflected in an [institution's Tier Rating](#tier_rating_dti).
...
The risks facing institutions are more volatile, complex, and interconnected than ever before. These broader risks set the context for our supervision of individual institutions.
...
The Overall Risk Rating (ORR) reflects the level of risk to the viability of a financial institution and has a 1 to 8 scale ([ORR scale](#orr_scale_dti "financial institution's risk rating scale")).

Ratings reflect our assessment of residual risk and issues that we want an institution to address. We follow a structured approach in assessing risk and use our judgment to assign ratings, supported by data and other evidence.
...
You can read more about each category in the section on [ORR categories](#orr_categories_dti "financial institution's risk rating categories").

#### We do not expect perfection for the strongest ratings

An ORR of 1 reflects minimal residual risk, and a 2 reflects low residual risk to viability. Ratings of 1 or 2 may result from strong controls, risk management practices, and/or low-risk exposure from business activities.

Institutions identify risks through their own oversight and governance processes. Greater transparency around their processes helps us to develop and maintain confidence in institutions' risk oversight.
...
We developed a flexible approach to respond to new risks as well as the interplay between financial and integrity and security risks.
...
Foreign entities operating in Canada on a branch basis are supervised in accordance with the statutory regimes set out in the [Bank Act](https://laws-lois.justice.gc.ca/eng/acts/b-1.01/) and the [Insurance Companies Act](https://laws-lois.justice.gc.ca/eng/acts/I-11.8/). A branch is not a separate legal entity, but rather an extension or presence of the foreign entity in Canada.
...
Our guideline [Foreign Entities Operating in Canada on a Branch Basis](/en/guidance/guidance-library/foreign-entities-operating-canada-branch-basis-guideline-2021 "Foreign Entities Operating in Canada on a Branch Basis – Guideline (2021)") communicates our expectations for foreign entities operating in Canada on a branch basis.
...
For example, the [Financial Institutions Supervisory Committee](/en/about-osfi/osfi-story/financial-institutions-supervisory-committee "Financial Institutions Supervisory Committee: Oversight of Canada’s Financial System") is a committee whose members include OSFI, the Department of Finance, the Bank of Canada, the Canada Deposit Insurance Corporation, Financial Transactions and Reports Analysis Centre of Canada (FINTRAC), and the Financial Consumer Agency of Canada. It meets at least quarterly to share information on matters relating to supervising institutions.

## Supervisory ratings for institutions
...
The Tier Rating guides the type of work that we carry out to identify risks, and it helps us apply our [risk appetite](/en/about-osfi/progress-our-initiatives/refining-we-approach-risk "Refining how we approach risk").
...
The Tier Rating is different from the [criteria we use to segment small and medium-sized banks](/en/guidance/guidance-library/small-medium-sized-deposit-taking-institutions-smsbs-capital-liquidity-requirements-guideline-2023 "Small and Medium-Sized Deposit-Taking Institutions (SMSBs) Capital and Liquidity Requirements – Guideline (2023)") (SMSBs) into three categories to determine their capital and liquidity requirements. While there is often a correlation between the two assessments, this is not always the case.
...
There are no weights in the Framework. For institutions in Tiers 1 to 4, any category has the potential to drive the ORR. We rate each category according to the level of risk it poses to the viability of the institution . In this way, the rating combines an assessment of risk and importance.

For institutions that receive ratings for individual categories, the category with the weakest rating is the starting point for the ORR. In exceptional circumstances and subject to supervisory judgment and established guardrails, the ORR can be better than the category with the weakest rating. This approach enables ratings by category to highlight specific areas of risk needing attention while ensuring that the ORR appropriately reflects the overall risk to viability.

Risks are often connected, and some issues will impact more than one category. For example, the supervisor may determine that risk governance is the root cause of an issue that impacts an institution's operational resilience. In these situations, we use the category ratings to reflect risk implications and spotlight where change is needed.
...
Our [Corporate Governance guideline](/node/592) sets out expectations around corporate governance, including in relation to an institution's business plan, strategy, and risk appetite.

#### Financial resilience

Our assessment of financial resilience reflects the institution's ability to withstand financial stress. It considers its financial risk profile, capital, liquidity, as well as the institution's exposure to catastrophic risk.
...
For insurers, we pay particular attention to the management of insurance risk. This includes liability valuation and provisioning, as well as underwriting, reinsurance, and other risk management practices. Our analysis of insurers also includes investment risk and asset and liability management.
...
Financial resilience also includes consideration of liquidity adequacy, funding risk, and the strength of liquidity management. This is a particularly important consideration for deposit-taking institutions. Finally, our assessment of financial resilience evaluates the institution's ability to absorb losses arising from catastrophic risks, including weather-related events and earthquakes.

Tables 2, 3, and 4 list some of the key guidelines that relate to financial resilience. You can find a complete list of guidelines here: [Table of Guidelines](/en/guidance/guidance-library "Guidance library").

Table 2: Key guidelines for deposit taking institutions concerning financial resilience

| OSFI guideline | Area of relevance |
| --- | --- |
| [Capital Adequacy Requirements (CAR)](/en/guidance/guidance-library/capital-adequacy-requirements-car-guideline-2026 "Capital Adequacy Requirements (CAR) – Guideline (2026)") | Capital requirements for deposit-taking institutions |
| [Leverage Requirements Guideline (LR)](/en/guidance/guidance-library/leverage-requirements-guideline-2023 "Leverage Requirements - Guideline (2023)") | Leverage requirements for deposit-taking institutions |
| [Internal Capital Adequacy Assessment Process (ICAAP) (E-19)](/en/guidance/guidance-library/internal-capital-adequacy-assessment-process-icaap-deposit-taking-institutions-guideline-2010 "Internal Capital Adequacy Assessment Process (ICAAP) for Deposit-Taking Institutions – Guideline (2010)") | ICAAP expectations for deposit-taking institutions |
| [Liquidity Adequacy Requirements (LAR)](/en/guidance/guidance-library/liquidity-adequacy-requirements-lar-guideline-2025 "Liquidity Adequacy Requirements (LAR) - Guideline (2025)") | Liquidity requirements for deposit-taking institutions |
| [Interest Rate Risk Management (B-12)](/en/guidance/guidance-library/interest-rate-risk-management-guideline-2019 "Interest Rate Risk Management - Guideline (2019)") | Expectations for managing interest rate risk in the banking book |

Table 3: Key guidelines for insurers concerning financial resilience

| OSFI guideline | Area of relevance |
| --- | --- |
| [Life Insurance Capital Adequacy Test (LICAT)](/en/guidance/guidance-library/life-insurance-capital-adequacy-test-guideline-2025 "Life Insurance Capital Adequacy Test – Guideline (2025)") | Capital requirements for life insurers |
| [Minimum Capital Test (MCT)](/en/guidance/guidance-library/minimum-capital-test-guideline-2024 "Minimum Capital Test - Guideline (2024)") | Capital requirements for property and casualty insurers |
| [Mortgage Insurer Capital Adequacy Test (MICAT)](/en/guidance/guidance-library/mortgage-insurer-capital-adequacy-test-guideline-2025 "Mortgage Insurer Capital Adequacy Test - Guideline (2024)") | Capital requirements for mortgage insurers |
| [Own Risk and Solvency Assessment (ORSA) (E-19)](/en/guidance/guidance-library/own-risk-solvency-assessment "Own Risk and Solvency Assessment") | Expectations for insurers Own Risk and Solvency Assessment |
| [Sound Reinsurance Practices and Procedures (B-3)](/en/guidance/guidance-library/sound-reinsurance-practices-procedures-guideline-2025 "Sound Reinsurance Practices and Procedures – Guideline (2025)") | Expectations for effective reinsurance practices and procedures for insurers |

Table 4: Key guidelines applicable for both deposit-taking institutions and insurers concerning financial resilience

| OSFI guideline | Area of relevance |
| --- | --- |
| [Stress Testing (E-18)](/en/guidance/guidance-library/stress-testing-guideline-2009 "Stress Testing – Guideline (2009)") | Stress testing expectations for deposit-taking institutions and insurers |
| [IFRS 9 Financial Instruments and Disclosures](/en/guidance/guidance-library/ifrs-9-financial-instruments-disclosures "IFRS 9 Financial Instruments and Disclosures") | Expectations around the accounting and disclosure of financial assets and liabilities |
| [Residential Mortgage Underwriting Practices and Procedures (B-20)](/en/guidance/guidance-library/residential-mortgage-underwriting-practices-procedures-guideline-2017 "Residential mortgage underwriting practices and procedures – Guideline (2017)") | Expectations for prudent residential mortgage underwriting |
| [Derivatives Sound Practices (B-7)](/en/guidance/guidance-library/derivatives-sound-practices-guideline-2014 "Derivatives Sound Practices – Guideline (2014)") | Expectations around derivative activities |
| [Model Risk Management (E-23/draft)](/en/guidance/guidance-library/guideline-e-23-model-risk-management-2027 "Guideline E-23 – Model Risk Management (2027)") | Expectations around enterprise-wide model risk management |
| [Climate Risk Management (B-15)](/en/guidance/guidance-library/climate-risk-management "Climate Risk Management") | Expectations around management of climate-related risks |
...
Table 5 lists some of the key guidelines that relate to operational resilience. You can find a complete list of guidelines here: [Table of guidelines](/en/guidance/guidance-library "Guidance library").

Table 5: Key guidelines concerning operational resilience

| OSFI guideline | Area of relevance |
| --- | --- |
| [Operational Resilience and Operational Risk Management (E-21)](/en/guidance/guidance-library/operational-risk-management-resilience-guideline "Operational Risk Management and Resilience – Guideline") | Expectations for operational resilience and operational risk management |
| [Integrity and Security Guideline](/en/guidance/guidance-library/integrity-security-guideline "Integrity and Security - Guideline") | Sets expectations for integrity and security |
| [Technology and Cyber Risk Management (B-13)](/en/guidance/guidance-library/technology-cyber-risk-management "Technology and Cyber Risk Management") | Expectations for technology and cyber risk management |
| [Third-Party Risk Management (B-10)](/en/guidance/guidance-library/third-party-risk-management-guideline "Third-Party Risk Management Guideline") | Expectations for third-party risk management |
...
| OSFI guideline | Area of relevance |
| --- | --- |
| [Corporate Governance](/en/guidance/guidance-library/corporate-governance-guideline-2018 "Corporate Governance – Guideline (2018)") | Expectations for corporate governance |
| [Culture Risk Management](/en/guidance/guidance-library/regulatory-notice-culture-risk-management "Regulatory notice - Culture Risk Management") | Expectations for management of culture risk |
| [Regulatory Compliance Management (E-13)](/en/guidance/guidance-library/regulatory-compliance-management-rcm-guideline-2014 "Regulatory Compliance Management (RCM) – Guideline (2014)") | Expectations for management of regulatory compliance risk |

### Overall Risk Rating scale

ORRs map directly to OSFI's existing Intervention Stage ratings as shown in Table 7. You can read more about our approach to intervention in our [Guide to Intervention](/en/supervision/supervisory-practices/guides-intervention "guides to intervention for financial institutions").
...
For institutions categorized as Stage 0 (or not staged), we have not identified significant risks. We split Stage 0 into four distinct ORR categories to give institutions a better sense of how we view their risk profile. The expanded scale also helps us signal when an institution needs to take early action to address supervisory concerns.

We assign an ORR 1 to reflect minimal residual risk. The institution exhibits strong levels of performance, resilience, and risk governance and is well aligned with our expectations. Controls and management actions effectively mitigate the inherent risk of the institution's business activities.

An ORR 2 means that an institution has low residual risk. The institution demonstrates a solid level of performance, resilience, and risk governance. The institution meets our expectations and remains resilient to foreseeable stress. Residual risk is low as controls and management actions are generally effective in mitigating the inherent risk of the institution's business activities.

An ORR 3 means that an institution has a moderate residual risk. The institution maintains a satisfactory level of performance, resilience, and risk governance. The institution generally meets our expectations and is resilient to foreseeable stress. Residual risk is moderate due to elevated inherent risk from its business activities and/or deficiencies that require attention to prevent escalation.

An ORR 4 is described as watchlist to make it clear that residual risk is elevated even though the institution meets minimum performance, resilience, and governance requirements. The heightened residual risk could be driven by inherent risk from the institution's business activities and/or identified issues that could materially impact stability if not addressed promptly. Without prompt attention, the institution is likely to be subject to formal intervention (an Intervention Stage Rating of 1 or higher).

### For higher ratings, we think about how quickly threats are developing

An ORR 5 is assigned to an institution that is at Stage 1 when there are warning signs of safety and soundness concerns that could affect its viability, concerns with its ability to protect itself against threats to its integrity or security, or a combination of these concerns. Residual risk is significant, driven by inherent risk in the institution's business activities and/or weaknesses in oversight and controls, and signals vulnerabilities that could affect viability over time. Based on available information, we do not expect the potential impact to viability to occur within two years. In the context of integrity and security, we focus more on an institution's ability to address concerns and on the potential materiality of concerns rather than on the impact's time horizon. We expect the institution  to take corrective measures related to the identified concerns.

An ORR 6 corresponds to Stage 2. At this level, residual risk is material; the institution poses material safety and soundness concerns that could affect its viability, and/or it has evidenced a failure to protect itself from threats to its integrity or security . Without effective remediation, safety and soundness concerns could affect viability within two years. In the context of integrity and security, the failure to safeguard against threats might not have led to material impacts on an institution's safety and soundness yet, but the likelihood and potential impact of the failure require timely remediation by the institution.

An ORR 7 is assigned to an institution at Stage 3. Residual risk is severe**.**The institution poses severe safety and soundness concerns that put its future viability in serious doubt, and/or it demonstrates persistent and significant failures to protect itself from threats to integrity or security. At this rating level, safety and soundness concerns could threaten viability within a year. In the context of integrity and security, failures require urgent correction due to their potential severity and likelihood of impact.

An ORR 8 is assigned to an institution at Stage 4. At this point, the statutory conditions for taking control are met or will be met in a short period of time. This includes situations where we determine that an institution is experiencing severe financial difficulties, and/or the continued operation of an institution by its existing board or senior management would be materially prejudicial to its integrity and security or would pose a risk to national security.

We recognize that there can be significant uncertainty in assessing timelines for risks to viability. Evidence and analyses inform our ratings, but ultimately assigned ratings reflect supervisory judgment. We update ratings when new information indicates that risks are changing.
...
You can read more here about the [foundations of our supervisory approach](#foundation) and our [key principles of supervision](#principle).

### Our supervisory process

In the following sections we describe the main elements in our supervisory process:

* the work we do to [identify risks affecting pension plans](#risk_identification_pp)
* how we [assess  pension plan’s  risks and assign ratings](#risk_assessment_pp)
* our [response to  pension plan’s  risks and the monitoring of remediation activity](#risk_response_pp)
* how we [report the results of our supervisory work  to pension plan administrators](#supervisory_reporting_pp)

### Risk identification

#### Factoring in size and complexity

We’re guided by our risk appetite in terms of the supervisory work that we carry out to identify risk. The type of regular supervisory work that we do to identify risks considers a pension plan’s size and complexity, and this is reflected in the [pension plan’s Tier Rating](#tier_rating_pp).
...
The Overall Risk Rating (ORR) reflects the level of risk to the security of rights and benefits for pension plan members, retirees, and beneficiaries. It has a 1 to 8 scale ([ORR scale  for pension plans](#orr_scale_pp "pension plan's overall risk rating scale")).
...
A pension plan’s ORR and [its Tier](#tier_rating_pp) drive the intensity of our supervisory activity.
...
You can read more about each category in the section on  [pension plan's  ORR categories](#orr_categories_pp "pension plan's overall risk rating categories").
...
Our approach to intervention is explained in our [Guide to Intervention for Federally Regulated Private Pension Plans](/en/supervision/pensions/administering-pension-plans/guidance-topic/guide-intervention-federally-regulated-private-pension-plans "Guide to Intervention for Federally Regulated Private Pension Plans"). The objective is to intervene as early as possible to minimize problems before they escalate and to reduce the risk of loss to pension plan members, retirees, and other beneficiaries.
...
You can find more information about the legislation, regulations and directives that apply to pension plans here: [Pension Plans](/en/supervision/pensions "Pensions").
...
The category with the weakest rating becomes the starting point for the ORR.
...
The risk governance rating reflects the ability of a pension plan administrator to identify significant risks to rights and benefits and to assess and manage their potential impact. We also assess the impact of any identified issues relating to non-compliance with the [Pension Benefits Standards Act, 1985](https://laws-lois.justice.gc.ca/eng/acts/P-7.01/) or the [Pooled Registered Pension Plans Act](https://laws-lois.justice.gc.ca/eng/acts/P-15.3/index.html).
...
ORRs map directly to OSFI’s existing Intervention Stage ratings as shown in Table 9. You can read more about our approach to intervention in our [Guide to Intervention for Federally Regulated Private Pension Plans](/en/supervision/pensions/administering-pension-plans/guidance-topic/guide-intervention-federally-regulated-private-pension-plans "Guide to Intervention for Federally Regulated Private Pension Plans").
...
* [Summary report: Supervisory Framework post-implementation review](/en/about-osfi/reports-publications/summary-report-supervisory-framework-post-implementation-review "Summary report: Supervisory Framework post-implementation review")
