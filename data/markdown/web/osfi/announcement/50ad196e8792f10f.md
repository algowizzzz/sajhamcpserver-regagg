---
title: "Rapport sur les nouveaux prêts et existants (A4) | Bureau du surintendant des institutions financières"
regulator: "osfi"
doc_type: "announcement"
status: "final"
source_kind: "web"
source_url: "http://www.osfi-bsif.gc.ca/fr/donnees-formulaires/rapports-releves/produire-releve-financier/guides-production-releves-financiers/rapport-sur-nouveaux-prets-existants-a4"
version: "1"
---
...
[A4 - Exemple de relevé (XLSX, 49,43 Ko)](/sites/default/files/import-media/data_and_forms/sample-return/2023-07/fr/A4_2019.xlsx "A4_2019.xlsx") [A4 - Règles de validation (XLSX, 184,85 Ko)](/sites/default/files/documents/a4-validation-fr.xlsx "a4-validation-fr.xlsx") [Relevé des modifications](/fr/donnees-formulaires/rapports-releves/produire-releve-financier/guides-production-releves-financiers/rapport-sur-nouveaux-prets-existants-a4-releve-modifications "Rapport sur les nouveaux prêts et existants (A4) - Relevé des modifications")
...
5. Prêts hypothécaires résidentiels assurés
...
6. Prêts hypothécaires résidentiels non assurés

   L'expression « prêts hypothécaires résidentiels » est définie à l'annexe 1 ci-dessous.

   * **Déclarer**
     + les avances
7. Prêts hypothécaires non résidentiels
...
8. Total – prêts personnels et prêts hypothécaires
...
4. Prêts hypothécaires résidentiels

   L'expression « prêts hypothécaires résidentiels » est définie à l'annexe 1 ci-dessous.

   Déclarer les prêts hypothécaires résidentiels assurés et non assurés
5. Prêts hypothécaires non résidentiels
...
6. Total – prêts à des entreprises
...
Le terme « entreprisesv» est défini à l'annexe 2.
...
* Immeubles à bureaux
* Immeubles en copropriété (résidentiels ou bureaux)[Note de bas de page 4](#fnb4)
...
* Höpitaux
* Centres de soins
* Maisons de retraite[Note de bas de page 1](#fnb1)
* Garderies
* Églises
* Immeubles agricoles
* Autres
...
* Chantiers de construction pour immeubles résidentiels de 1 à 4 logements[Note de bas de page 2](#fnb2)

#### Immeubles résidentiels de plus de 4 logements (immeubles résidentiels à logements multiples)[Note de bas de page 3](#fnb3)
...
* Chantiers de construction pour des immeubles résidentiels de plus de 4 logements[Note de bas de page 2](#fnb2)
...
| Sociétés en nom collectif[Note de bas de page 5](#fnb5) | Sociétés en nom collectif[Note de bas de page 5](#fnb5) |
| vide | Fiducies |
...
:   Conformément au principe de la contrepartie de crédit, les sociétés en nom collectif dont le dernier garant est un particulier doivent être classées dans la catégorie des particuliers et celles dont le dernier garant est une société, dans la catégorie des sociétés.
    ...
    [Retour à la référence de la note de bas de page 5](#fnb5a-ref)
