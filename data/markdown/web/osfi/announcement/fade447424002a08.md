---
title: "Prêts non hypothécaires (A2) | Bureau du surintendant des institutions financières"
regulator: "osfi"
doc_type: "announcement"
status: "final"
source_kind: "web"
source_url: "http://www.osfi-bsif.gc.ca/fr/donnees-formulaires/rapports-releves/produire-releve-financier/guides-production-releves-financiers/prets-non-hypothecaires-a2"
version: "1"
---
...
[A2 - Exemple de relevé (version en vigueur) (XLSX, 64,7 Ko)](/sites/default/files/import-media/data_and_forms/sample-return/2023-07/fr/A2_2018.xlsx "A2_2018.xlsx") [A2 - Règles de validation (XLSX, 76,49 Ko)](/sites/default/files/documents/a2-validation-fr.xlsx "a2-validation-fr.xlsx") [Relevé des modifications](/fr/donnees-formulaires/rapports-releves/produire-releve-financier/guides-production-releves-financiers/releve-modifications-a2 "Relevé des modifications (A2)")

## Prêts non hypothécaires

### Objet

Le présent relevé renferme une répartition détaillée des prêts non hypothécaires consentis par les institutions de dépôt.
...
2. Institutions de dépôt
   ...
   * **Ne pas inclure** 
     + les institutions de dépôt publiques, comme ATB Financial (classe 7029, division K de la CTI), dont les données figurent au poste 1 g);
...
Une institution de dépôt n'est pas tenue de déposer les données si la société mère est également une institution de dépôt qui dépose ses rapports sur une base consolidée.
...
1. Institutions de dépôt explicite.
2. Autres institutions de dépôt : comprend les caisses de crédit et les caisses populaires, les sociétés de fiducie et les sociétés de prêts hypothécaires.
