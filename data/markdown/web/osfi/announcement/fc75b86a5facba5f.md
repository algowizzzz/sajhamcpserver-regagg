---
title: "Termination of Business in Canada of an Authorized Foreign Bank - Office of the Superintendent of Financial Institutions"
regulator: "osfi"
...
* Section 599 of the [Bank Act](https://laws-lois.justice.gc.ca/eng/acts/b-1.01/) (the “Act”)
...
2. details regarding the level of internal approval required to make application for the release of the applicant’s assets in Canada[Footnote 1](#fnb1) (e.g., senior management), based on the applicant’s policies, as well as a confirmation that the application was approved at that level;
...
6. confirmations from the principal officer that:
   ...
   1. the applicant will promptly inform OSFI of the nature and amount of any liabilities that arise after the date of the Audited Statements, until the Superintendent has authorized the release of the applicant’s assets in Canada (the “Release Order”)[Footnote 2](#fnb2),
...
3. The applicant must provide a completed [OSFI 298 Form](/en/data-forms/applications-approvals/procedures-completing-osfi-form-298 "Procedures for Completing OSFI Form 298") to OSFI’s Securities Administration Unit to obtain the release of its remaining assets in Canada.
4. The following is an example of a Notice (a French language example of this Notice is available in the [French language version of this document](/fr/node/1226)):
   ...
   **[Name of the applicant and, if applicable, other name under which it is authorized to carry on business in Canada]**
   ...
   Any depositor or creditor in respect of [name of the applicant]’s business in Canada opposing that release is invited to file an opposition by mail to the Office of the Superintendent of Financial Institutions (Canada), Regulatory Affairs Division, 255 Albert Street, Ottawa, Ontario K1A 0H2, or by email at [approvals-approbations@osfi-bsif.gc.ca](mailto:approvals-approbations@osfi-bsif.gc.ca), on or before [same date as above].
