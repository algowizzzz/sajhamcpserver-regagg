---
title: "Life Supplementary Quarterly Return (LF4) – Instructions - Office of the Superintendent of Financial Institutions"
regulator: "osfi"
doc_type: "announcement"
status: "final"
source_kind: "web"
source_url: "http://www.osfi-bsif.gc.ca/en/data-forms/reporting-returns/filing-financial-returns/financial-reporting-instructions/life-supplementary-quarterly-return-lf4-instructions"
version: "1"
---
...
* [Life Supplementary Quarterly Return - Letter (2022)](/en/guidance/guidance-library/life-supplementary-quarterly-return-letter-2022)
* [Life Supplementary Quarterly Return (LF4) - Change Control Log](/en/data-forms/reporting-returns/filing-financial-returns/financial-reporting-instructions/life-supplementary-quarterly-return-lf4-change-control-log)

## Return files

[LF4 - Supplementary quarterly return (XLSX, 860 KB)](/sites/default/files/documents/2024-lf4-rtn-quarterly-rtn-rlv-trimestriel-en_0.xlsx "2024-lf4-rtn-quarterly-rtn-rlv-trimestriel-en_0.xlsx")
...
* Asia
* Reinsurance (where reinsurance is a business unit)
...
Loans at the end of the current quarter should be defined consistently with LF2, Page 21012, Line 810, Column 40. Commercial real estate loans are included in loans. Where there is an external rating, use it. If no external rating exists, use your internal rating and if no internal rating exists, classify the loan as unrated. In Column 01, record the balance sheet value by rating category. In column 02 the percent of the total loans that each rating category represents is automatically calculated.
...
The investment lines should include all investment impacts not related to surplus. In addition:

* Quarter to quarter impact from market movement (including discount rates) should be reported under “investment” **on page 20040 and 20050**. Changes in assumptions (for example, adjustment due to the difference in the liquidity characteristics between the reference portfolio and the insurance contracts) used to derive discount rates should be reported under “investment” **on page 20060 and 20070**.
...
OCI impacts should be included in this page.
...
Information on ancillary accounts related to demutualized closed blocks should be included.
...
For each component, input a positive number if the amount increases a profit (or reduces a loss) or input a negative number if it decreases a profit (or increases a loss).
...
The unwind of the discount rates should not reflect market movements.
