---
title: "Relevé afférent à la capacité totale d’absorption des pertes par établissement | Bureau du surintendant des institutions financières"
regulator: "osfi"
...
* [Le BSIF publie la version à l’étude des cadres par établissement pour consultation publique - Communiqué](/fr/nouvelles/bsif-publie-version-letude-cadres-etablissement-pour-consultation-publique)
* [Cadre de capacité totale d’absorption des pertes par établissement des sociétés mères de banques d’importance systémique intérieure - Ligne directrice](/fr/consignes/repertoire-consignes/cadre-capacite-totale-dabsorption-pertes-etablissement-societes-meres-banques-dimportance-systemique)

## Relevés

[OSFI969 - Relevé afférent à la capacité totale d'absorption des pertes par établissement des sociétés mères de banques d'importance systémique intérieure (XLSX, 217.41 Ko)](/sites/default/files/documents/osfi969-bsif969-dsib-tlac-tape-bisi-fr.xlsx "osfi969-bsif969-dsib-tlac-tape-bisi-fr.xlsx")
...
* On peut consulter le guide de production sur le site Web du BSIF sous [Produire un relevé financier](/fr/donnees-formulaires/rapports-releves/produire-releve "Produire un relevé") – Système de déclaration réglementaire (SDR) – Guide d’utilisation – Gestion des relevés financiers (PDF).
...
La BISi doit appliquer la méthode de comptabilisation de mise en équivalence pour déterminer la valeur de la filiale (paragraphe 12).

Pour chaque filiale réglementée par un organisme étranger, la BISi doit ajouter toutes les marges sur services contractuels (MSC) qui ont été incluses dans la mesure de la TLAC consolidée à l’échelle du groupe aux fins du calcul de l’exposition de la BISi à ces filiales.

La BISi peut déduire de cette valeur tout montant déjà déduit de la mesure de la TLAC (p. ex., écarts d’acquisition) conformément à la ligne directrice NFP ou TLAC. Ceci permet d’éviter l’application d’une double exigence de fonds propres.
...
* Actifs de tiers de la succursale étrangère déclarés dans son bilan individuel; ceci exclut les actifs qui sont éliminés lors de la consolidation comptable, mais inclut les actifs placés en fiducie.
...
La valeur nette des actifs de tiers correspond à la valeur des actifs de tiers, rajustée pour tenir compte des éléments susmentionnés, moins les éléments de passif de tiers.

Lorsque la valeur nette des actifs de tiers est négative, l’institution doit rajuster la valeur de l’exposition en ajoutant les montants versés à la succursale canadienne et qui demeurent à la disposition de la succursale canadienne de la BISi, déduction faite des montants transférés par la succursale canadienne à ses succursales réglementées par un organisme étranger. Cet ajustement ne doit pas être supérieur à la valeur absolue nette des actifs de tiers.
...
Il faut déclarer dans ce tableau les garanties de fonds propres et les garanties autres que de fonds propres de la société mère (paragraphes 16 à 22) dont bénéficient les filiales réglementées par un organisme étranger.
...
La colonne H fait référence à la note de risque de la société mère originaire au Canada et ne doit être remplie que si une note est entrée dans la colonne G.
