---
title: "Directives - Rapport BSIF-590 | Bureau du surintendant des institutions financières"
regulator: "osfi"
...
14. Le formulaire en ligne contient le rapport nul et le rapport de signalement. Cependant, seuls les rapports de signalement doivent être soumis au BSIF. Les utilisateurs sont priés d’envoyer leurs questions par courriel à [RA-RRS.Support@osfi-bsif.gc.ca.](mailto:RA-RRS.Support@osfi-bsif.gc.ca)
15. Vous trouverez des instructions sur la production électronique des relevés dans le guide d’utilisation du SDR (Système de déclaration réglementaire (SDR) – Guide d’utilisation gestion des relevés financiers) se trouvant sur le site Web du BSIF.

## Liens utiles

* [Formulaire de déclaration BSIF-590 (XLSX, 96 Ko)](/sites/default/files/2023-11/OSFI590_form%20%281%29.xlsx)
