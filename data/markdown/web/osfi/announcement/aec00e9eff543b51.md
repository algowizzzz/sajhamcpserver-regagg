---
title: "Relevé des valeurs mobilières détenues | Bureau du surintendant des institutions financières"
regulator: "osfi"
doc_type: "announcement"
status: "final"
source_kind: "web"
source_url: "http://www.osfi-bsif.gc.ca/fr/donnees-formulaires/rapports-releves/produire-releve-financier/guides-production-releves-financiers/releve-valeurs-mobilieres-detenues"
version: "1"
---
...
[Formulaire de déclaration (XLSX, 24,62 Ko)](/sites/default/files/documents/shr-tmp-frm-2025-fr.xlsx "shr-tmp-frm-2025-fr.xlsx") [Exemples de relevés (XLSX, 18,2 Ko)](/sites/default/files/documents/shr-ex-2025-fr.xlsx "shr-ex-2025-fr.xlsx") [Exemple de disposition de fichier (XLSX, 19,41 Ko)](/sites/default/files/documents/shr-file-layout-exmaple-03-25-fr.xlsx "shr-file-layout-exmaple-03-25-fr.xlsx") [Postes pour mémoire rattachés à la déclaration de valeurs globales (XLSX, 13,39 Ko)](/sites/default/files/documents/shr-memo-2025-fr.xlsx "shr-memo-2025-fr.xlsx") [Cellules surlignées du relevé H4 pour la collecte de données sur les valeurs mobilières (XLSX, 354 Ko)](/sites/default/files/documents/shr-h4-securities-data-collection-03-25-fr.xlsx "shr-h4-securities-data-collection-03-25-fr.xlsx")[Règles de validation détaillées](/fr/donnees-formulaires/rapports-releves/produire-releve-financier/guides-production-releves-financiers/releve-valeurs-mobilieres-detenues-regles-validation-detaillees "Relevé des valeurs mobilières détenues - Règles de validation détaillées")[Relevé des changements](/fr/donnees-formulaires/rapports-releves/produire-releve-financier/guides-production-releves-financiers/releve-changements-releve-valeurs-mobilieres-detenues "Relevé des changements (Relevé des valeurs mobilières détenues)")
...
* Les données seront dans un premier temps transmises au format CSV, puis une transition vers format plus facilement lisible par machine suivra (par exemple, en 2026-2027) (auparavant XML).
...
3. Valeur marchande totale des titres de participation du relevé H4 [égale à 3 a)+3 b)]
:   Cette valeur totale doit correspondre à la somme de 3 a) et 3 b).

3 a) Valeur de marché totale (auparavant théorique - voir le journal des modifications) des portefeuilles de couverture d’actions delta 1 (comprend les positions sur swaps sur rendement total et les positions sur contrats à terme sur indice, mais pas les positions sur options)\*\*
:   Il s’agit de’ la valeur de marché totale (auparavant théorique - voir le journal des modifications) des portefeuilles de couverture d’actions delta 1 dans le contexte où elle doit comprendre les portefeuilles de couverture delta 1 de swaps sur rendement total, de contrats à terme sur indice et de tout autre produit similaire, mais pas les portefeuilles de couverture delta 1 de positions sur options. De plus, les institutions déclarantes peuvent agréger et compenser la valeur de marché (auparavant théorique - voir le journal des modifications) de toutes les couvertures d’actions delta 1, en supposant une corrélation parfaite avec les indices boursiers sous-jacents.
