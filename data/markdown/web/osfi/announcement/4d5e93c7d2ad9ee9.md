---
title: "Réassurance avec apparenté | Bureau du surintendant des institutions financières"
regulator: "osfi"
doc_type: "announcement"
status: "final"
source_kind: "web"
source_url: "http://www.osfi-bsif.gc.ca/fr/donnees-formulaires/demandes-approbations/instructions-relatives-operations/reassurance-avec-apparente"
version: "1"
---
...
* Articles 523 et 597 de la [Loi sur les sociétés d’assurances](https://laws-lois.justice.gc.ca/fra/lois/i-11.8/) (LSA)
...
2. des précisions concernant la diligence raisonnable dont fait preuve le demandeur à l’égard de l’apparenté avec lequel il propose de se réassurer[note 1](#fnb1) (le réassureur), notamment une confirmation que la diligence raisonnable appliquée est conforme à la [ligne directrice B-3](/fr/consignes/repertoire-consignes/saines-pratiques-procedures-reassurance-ligne-directrice-2025 "Saines pratiques et procédures de réassurance – Ligne directrice (2025)"), et le cas échéant, à la PGRR du demandeur.

*Réassureur proposé*

De façon générale, le demandeur doit fournir :

3. le nom du réassureur;
4. une analyse pour appuyer sa conclusion à l’effet que le réassureur est un apparenté[note 2](#fnb2) du demandeur, à laquelle est joint un organigramme à jour (avec pourcentages de propriété) du demandeur, du réassureur et de toutes les sociétés de leur groupe;
5. un résumé des services financiers offerts et des autres activités importantes menées par le réassureur, y compris une liste des territoires dans lesquels le réassureur exerce ses activités et la nature du régime réglementaire de surveillance et le degré de surveillance dont fait preuve ses services financiers dans son pays d’attache;[note 3](#fnb3)
6. le nom et les coordonnées d’une personne-ressource de l’organisme de réglementation du pays d’attache du réassureur qui est au courant des activités de celui-ci;
7. une copie du plus récent :
...
8. pour chacune des trois dernières années, une copie :
   ...
   2. des états financiers du réassureur (bilan, état des résultats, état des fluctuations de l’avoir des actionnaires);[note 4](#fnb4)
9. une confirmation à l’effet que le réassureur rencontre les exigences minimales de capital requis dans son pays d’attache;
10. des détails à savoir si le réassureur a déjà fait l’objet d’une poursuite criminelle ou de sanctions administratives;
11. une description de toutes les conventions importantes d’assurance directe, de réassurance et de rétrocession et des autres conventions commerciales importantes entre le réassureur et les entités ou personnes qui lui sont affiliées ou apparentées.

*Convention de réassurance proposée*

De façon générale, le demandeur doit fournir :

12. une description de l’objectif visé par le demandeur quand il cherche à conclure la convention de réassurance proposée avec le réassureur, y compris des détails sur les avantages que le demandeur devrait en retirer;
13. une version provisoire de chaque contrat de réassurance que le demandeur et le réassureur ont l’intention de conclure et une description de ce qui suit :
    ...
    6. les mesures à prendre en cas d’insolvabilité de l’une ou l’autre des parties;[note 5](#fnb5)
14. une description sous forme de tableau de l’ensemble du programme de réassurance du demandeur, notamment la convention de réassurance proposé avec le réassureur, qui renferme à tout le moins l’information suivante concernant chaque contrat de réassurance :
...
15. une confirmation à l’effet que le demandeur a l’intention de réclamer des crédits sur le capital (dans le cas d’une société) ou des crédits sur l’actif (dans le cas d’une société étrangère) en ce qui concerne sa convention de réassurance avec le réassureur;
16. lorsque le demandeur a l’intention de participer à des conventions de réassurance avec le réassureur auxquelles d’autres sociétés de leur groupe participeront (p. ex., conventions mondiales), une description des processus relatifs au règlement des comptes par rapport à ces conventions;
17. une confirmation de la part d’un cadre dirigeant[note 6](#fnb6) ou de l’agent principal du demandeur à l’effet que tous les contrats de réassurance que le demandeur conclura avec le réassureur :
    1. seront conformes à la [ligne directrice B-3](/fr/consignes/repertoire-consignes/saines-pratiques-procedures-reassurance-ligne-directrice-2025 "Saines pratiques et procédures de réassurance – Ligne directrice (2025)") et à la PGRR du demandeur,
    ...
    4. n’auront pas pour effet de faire en sorte que le réassureur garantisse au Canada des risques;[note 7](#fnb7)
18. si le demandeur est une société étrangère (c.-à-d., une succursale), une confirmation à l’effet que les paiements des sinistres par le réassureur seront versés au Canada à l’agent principal.
...
2. La présente instruction relative aux opérations énonce les exigences en matière d’information et les directives administratives en ce qui a trait aux demandes d’agrément du surintendant aux termes des articles 523 et 597 de la LSA. Il convient de souligner que la présente instruction relative aux opérations et l’agrément sur lequel elle porte ne limitent, modifient ou remplacent pas les attentes du BSIF concernant les saines pratiques et procédures de réassurance énoncées dans la [ligne directrice B-3](/fr/consignes/repertoire-consignes/saines-pratiques-procedures-reassurance-ligne-directrice-2025 "Saines pratiques et procédures de réassurance – Ligne directrice (2025)").
...
7. Si sa demande est agréée, le demandeur devra produire annuellement auprès du BSIF des renseignements spécifiques au sujet de sa réassurance auprès du réassureur (la déclaration annuelle). En règle générale, la déclaration annuelle comprend ce qui suit :
   1. une analyse pour appuyer la conclusion du demandeur à l’effet que le réassureur demeure un apparenté du demandeur, à laquelle est joint un organigramme à jour (avec pourcentages de propriété) du demandeur, du réassureur et de toutes les sociétés de leur groupe,[note 8](#fnb8)
   2. une confirmation de la part d’un cadre dirigeant ou de l’agent principal à l’effet que chaque convention de réassurance entre le demandeur et le réassureur :
      1. était conforme à la [ligne directrice B-3](/fr/consignes/repertoire-consignes/saines-pratiques-procedures-reassurance-ligne-directrice-2025 "Saines pratiques et procédures de réassurance – Ligne directrice (2025)") et à la PGRR du demandeur,
   ...
   3. une copie de la déclaration annuelle sur la réassurance[note 9](#fnb9) d’un cadre dirigeant ou de l’agent principal du demandeur;
   4. des précisions concernant :
      ...
      3. la diligence raisonnable appliquée par le demandeur à l’égard de la pertinence soutenue du réassureur, y compris un renvoi à la [ligne directrice B-3](/fr/consignes/repertoire-consignes/saines-pratiques-procedures-reassurance-ligne-directrice-2025 "Saines pratiques et procédures de réassurance – Ligne directrice (2025)") et à la PGRR du demandeur,
...
11. Aucun droit n’est exigé en contrepartie de cet agrément.[note 10](#fnb10)
...
Note 5
:   Se reporter au principe 4 de la [ligne directrice B-3](/fr/consignes/repertoire-consignes/saines-pratiques-procedures-reassurance-ligne-directrice-2025 "Saines pratiques et procédures de réassurance – Ligne directrice (2025)") pour des précisions sur les attentes du BSIF à ce chapitre.

    [réintégrer note 5](#fnb5-ref)
...
:   Dans la présente instruction relative aux opérations, « cadre dirigeant » s’entend du chef de la direction ou d’une personne qui relève de celui-ci ou du conseil d’administration.
    ...
    [réintégrer note 6](#fnb6-ref)

Note 7
:   À cet égard, se reporter au [Préavis no 2007-01-R1 (Garantie au Canada de risques)](/fr/consignes/repertoire-consignes/garantie-au-canada-risques " Garantie au Canada de risques ") du BSIF.

    [réintégrer note 7](#fnb7-ref)
...
:   Veuillez noter que l’agrément et ses conditions cessent d’être en vigueur lorsque le réassureur cesse d’être un apparenté du demandeur.
    ...
    [réintégrer note 8](#fnb8-ref)

Note 9
:   Se reporter à la section portant sur l’administration de la [ligne directrice B-3](/fr/consignes/repertoire-consignes/saines-pratiques-procedures-reassurance-ligne-directrice-2025 "Saines pratiques et procédures de réassurance – Ligne directrice (2025)") pour des précisions sur la déclaration annuelle de réassurance.

    [réintégrer note 9](#fnb9-ref)
