---
title: "Intérêt de groupe financier* assujetti à l’agrément du ministre – entités admissibles | Bureau du surintendant des institutions financières"
regulator: "osfi"
...
* paragraphes 468(5) et 930(5) de la [Loi sur les banques](https://laws-lois.justice.gc.ca/fra/lois/b-1.01/) (LB)
* paragraphe 453(5) de la [Loi sur les sociétés de fiducie et de prêt](https://laws-lois.justice.gc.ca/fra/lois/t-19.8/) (LSFP)
* paragraphes 495(7), 554(5) et 971(5) de la [Loi sur les sociétés d’assurances](https://laws-lois.justice.gc.ca/fra/lois/i-11.8/) (LSA)
* paragraphe 390(5) de la [Loi sur les associations coopératives de crédit](https://laws-lois.justice.gc.ca/fra/lois/c-41.01/ ) (LACC)
...
9. si l'opération est importante pour le demandeur ou si elle aura pour effet de modifier de manière importante la stratégie d'affaires du demandeur :
   ...
   3. les projections financières triennales se rapportant au demandeur, y compris l'état des résultats, le bilan, les ratios de fonds propres et les principales hypothèses[Note de bas de page 5](#fnb5),
...
3. En règle générale, le demandeur qui acquiert le contrôle d'une entité admissible doit obtenir de celle-ci un engagement à fournir au surintendant un accès suffisant à ses livres.[Note de bas de page 7](#fnb7)
4. Le ministre pourrait vouloir déterminer si l'opération nuirait dans l'avenir à la mise en œuvre de mesures correctives et pourrait demander de l'information à ce sujet.
5. Nous rappelons aux demandeurs le protocole de présentation initiale de documents à l'appui d'une demande d'agrément.
6. Les demandes d'agrément visées dans le présent document ne sont pas assujetties à des frais de service.[Note de bas de page 8](#fnb8)
