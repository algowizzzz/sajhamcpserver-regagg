---
title: "Final Guideline B-2: Large Exposure Limits for D-SIBs - Office of the Superintendent of Financial Institutions"
regulator: "osfi"
doc_type: "guidance"
reference: "B-2"
status: "final"
source_kind: "web"
source_url: "http://www.osfi-bsif.gc.ca/en/guidance/guidance-library/final-guideline-b-2-large-exposure-limits-sibs"
version: "1"
---
...
[Generate PDF](/en/print/pdf/node/343)

Table of contents

Accompanying documents

* [Large Exposure Limits for Domestic Systemically Important Banks – Guideline (2019)](/en/guidance/guidance-library/large-exposure-limits-domestic-systemically-important-banks-guideline-2019)
* [B-2 Large Exposure Limits (D-SIBs) – Guideline impact analysis statement (2019)](/en/guidance/guidance-library/b-2-large-exposure-limits-sibs-guideline-impact-analysis-statement-2019)
...
In 2014, the Basel Committee on Banking Supervision (BCBS) published its standard on large exposure risk management:  *[Supervisory Framework for Measuring and Controlling Large Exposures](https://www.bis.org/publ/bcbs283.htm)*. OSFI's final guideline incorporates the BCBS guidance to reflect current risk management sound practices and provides additional guidance on methods OSFI expects D-SIBs to use for identifying, measuring, managing and monitoring large exposures.
...
Questions concerning the final guideline may be addressed to Lindsay Cheung, Senior Analyst, Capital Division by email at [lindsay.cheung@osfi-bsif.gc.ca](mailto:lindsay.cheung@osfi-bsif.gc.ca).
