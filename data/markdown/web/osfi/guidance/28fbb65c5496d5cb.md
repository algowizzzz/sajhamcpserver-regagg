---
title: "Regulatory notice - Culture Risk Management - Office of the Superintendent of Financial Institutions"
regulator: "osfi"
doc_type: "guidance"
status: "final"
source_kind: "web"
source_url: "http://www.osfi-bsif.gc.ca/en/guidance/guidance-library/regulatory-notice-culture-risk-management"
version: "1"
---
...
[Generate PDF](/en/print/pdf/node/2445)
...
* [Regulatory Notice on Culture Risk Management – letter](/en/guidance/guidance-library/regulatory-notice-culture-risk-management-letter)

## Purpose and scope

This Regulatory Notice sets expectations for managing culture risk. It applies to all federally regulated financial institutions including foreign bank branches and foreign insurance company branches to the extent it is consistent with applicable requirements and legal obligations related to their business in Canada.[Footnote 1](#fn1)
...
‘Culture’ refers to the commonly held values, mindsets, beliefs, and assumptions that guide what is important and how people should behave.[Footnote 2](#fn2)
...
**Senior management is responsible for culture risk management**[Footnote 3](#fn3) by:
...
Footnote 1
:   Expectations for branches are set out in [Guideline E-4 on Foreign Entities Operating in Canada on a Branch Basis](https://www.osfi-bsif.gc.ca/en/guidance/guidance-library/foreign-entities-operating-canada-branch-basis-guideline-2021). Foreign bank branches refer to foreign banks authorized to conduct business in Canada on a branch basis under Part XII.1 of the Bank Act. Foreign insurance company branches refer to foreign entities that are authorized to insure in Canada risks on a branch basis under Part XIII of the Insurance Companies Act.

    [Return to footnote 1  referrer](#fn1-rf)

Footnote 2
:   This Regulatory Notice focuses on culture more broadly, which encompasses risk culture, a subset of culture that specifically refers to the commonly held values, mindsets, beliefs, and assumptions about risks and risk-taking.

    [Return to footnote 2  referrer](#fn2-rf)

Footnote 3
:   Please refer to the [Corporate Governance Guideline](https://www.osfi-bsif.gc.ca/Eng/fi-if/rg-ro/gdn-ort/gl-ld/Pages/CG_Guideline.aspx) for our expectations of boards of directors.
