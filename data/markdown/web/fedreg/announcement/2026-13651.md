...
[FR Doc No: 2026-13651]

-----------------------------------------------------------------------

SECURITIES AND EXCHANGE COMMISSION

[Release No. 34-105833; File No. SR-NYSEARCA-2026-68]

Self-Regulatory Organizations; NYSE Arca, Inc.; Notice of Filing 
of a Proposed Rule Change To Amend Rules 5.32-O and 5.35-O

July 1, 2026.
    Pursuant to Section 19(b)(1) \1\ of the Securities Exchange Act of 
1934 (``Act'') \2\ and Rule 19b-4 thereunder,\3\ notice is hereby given 
that, on June 18, 2026, NYSE Arca, Inc. (``NYSE Arca'' or the 
...
Flexible Exchange (``FLEX'') Options.\4\ The proposed rule change is 
available on the Exchange's website at www.nyse.com and at the 
principal office of the Exchange.
---------------------------------------------------------------------------

    \4\ In addition, the Exchange proposes a non-substantive 
amendment to Rule 5.36-O to correctly align its reference to Rule 
5.35-O contained therein.
---------------------------------------------------------------------------
...
underlying equity security or Exchange-Traded Fund Share that is 
subject to the rules of Section 4.\5\
---------------------------------------------------------------------------
...
the underlying security,\6\ while all FLEX Index Options are settled in 
cash.\7\ In February 2020, however, the Exchange amended Rule 5.32-O to 
...
with the highest average daily volume.\8\
---------------------------------------------------------------------------

    \6\ See Rule 5.32-O(f)(3)(i).
    \7\ See Rule 5.32-O(e)(2) and (3). Similarly, pursuant to 
...
market.
    \8\ See Rule 5.32-O(e)(3)(ii). See also Securities Exchange 
...
---------------------------------------------------------------------------
    ...
    The Exchange proposes to: (i) amend paragraph (f)(3)(ii) of Rule 
5.32-O to permit cash settlement for up to 50 non-ETF FLEX Equity 
Options whose underlying security meets the same criteria currently 
applicable to ETF FLEX Equity Options noted above; and (ii) amend 
paragraph (f)(3)(ii)(A) of Rule 5.32-O to provide that, where more than 
50 underlying ETFs or 50 underlying non-ETFs qualify, the Exchange will 
...
---------------------------------------------------------------------------
    ...
    \9\ The Exchange acknowledges that this change will become moot 
...
---------------------------------------------------------------------------
    ...
    The Exchange proposes to amend Rule 5.32-O paragraph (f)(3)(ii), to 
...
measured over the prior six-month period.\10\ The Exchange believes 
that average daily notional value and national average daily volume 
are, collectively, an appropriate proxy for selecting underlying 
securities that are not readily susceptible to manipulation for 
purposes of establishing a settlement price. Average daily notional 
value considers both the trading activity and the price of an 
underlying security. As a general matter, the more expensive an 
underlying security's price, the less cost-effective manipulation could 
become. Further, manipulation of the price of a security encounters 
greater difficulty the more volume that is traded.
---------------------------------------------------------------------------
...
them. As noted in the proposed amendment to Rule 5.32-O(f)(ii)(A), 
however, only the FLEX Equity Options overlying the non-ETF securities 
with the highest average daily notional value would be eligible for 
cash settlement. The table below identifies the 50 non-ETF FLEX Equity 
Options that would qualify for cash settlement under the Exchange's 
most recent review, effective February 2, 2026.\11\ The table also 
includes, for each symbol, closing auction average daily volume and 
closing auction average daily notional value over the same six-month 
period, which reflect the depth of trading activity specifically at the

[[Page 41717]]

close and thereby illustrate each symbol's resilience to potential 
price manipulation at the time of settlement.
---------------------------------------------------------------------------

    \11\ The Exchange notes that, if approved after August 3, 2026, 
...
--------------------------------------------------------------------------------------------------------------------------------------------------------
                  ...
                  Symbol                                  Name                 National average    Average daily      average daily      average daily
                                                                                 daily volume      notional value         volume         notional value
--------------------------------------------------------------------------------------------------------------------------------------------------------
...
TSM......................................  Taiwan Semiconductor                      12,008,931      3,246,781,038            752,418        203,136,969
...
BMNR.....................................  BitMine Immersion Technologies,           45,742,244      2,114,623,207          1,538,644         62,322,489
                                            Inc.
...
settlement was first expanded to options overlying ETFs.\12\ 
...
value of $500 Million and average daily volume of 4,680,000 shares). As 
of December 31, 2025, however, 143 S&P 500 single stocks meet these 
same criteria, evidencing that the eligible single stocks are far 
deeper and more liquid than the ETF universe was at the time cash 
settlement for them was approved.
---------------------------------------------------------------------------

    \12\ See Securities Exchange Act Release No. 88131 (February 5, 
...
believes that the deep

[[Page 41718]]

liquidity and robust trading activity (in general and at the close) in 
the securities identified by the Exchange as meeting the criteria 
mitigate historic concerns regarding susceptibility to manipulation.
...
---------------------------------------------------------------------------
    ...
    \13\ Market participants have voiced additional concerns with 
...
that allow for the trading of cash-settled options \14\ and cash 
settled FLEX ETF Options.\15\
---------------------------------------------------------------------------

    \14\ See e.g. PHLX FX Options traded on Nasdaq PHLX and S&P 
...
these products, with certain modifications).
    \15\ See Securities Exchange Act Release Nos. 102839 (April 11, 
...
limits set forth in Rule 5.35-O. Accordingly, the Exchange proposes to 
amend Rule 5.35-O(b)(ii) to remove reference to Exchange-Traded Funds 
and would provide that positions for all FLEX Equity Options settled in 
cash pursuant to Rule 5.32-O(f)(3)(ii) would be subject to the limits 
set forth in Rule 5.35-O, and the exercise limits set forth in Rule 
5.36-O.\16\ Given that each of the underlying securities that would 
...
Accordingly, as of December 31, 2025, of the 143 non-ETF underlying 
securities that would currently be eligible to have cash settlement as 
a contract term, all 143 (and all 50 on the above chart) would have a 
position limit of 250,000 contracts pursuant to Rule 6.8, Commentary 
.06(e).\17\
---------------------------------------------------------------------------

    \16\ See proposed Rule 5.35-O(b)(ii).
    \17\ Rule 6.8, Commentary .06(e) provides that the position 
...
that it is fully able to clear and settle such

[[Page 41719]]

options.\18\ The Exchange has also analyzed its capacity and represents 
that it and The Options Price Reporting Authority (OPRA) have the 
necessary systems capacity to handle the additional traffic associated 
with the listing of cash-settled FLEX Equity Options. The Exchange 
believes any additional traffic that would be generated from the 
introduction of cash-settled FLEX non-ETF Equity Options would be 
manageable. The Exchange represents that OTP Holders will not have a 
capacity issue as a result of this proposed rule change.
---------------------------------------------------------------------------

    \18\ It is the Exchange's understanding that the OCC intends to 
...
regulatory program operated by, and overseen by NYSE Regulation,\19\ 
...
---------------------------------------------------------------------------
    ...
    \19\ The Exchange maintains regulatory services agreements with 
...
services.
    \20\ Such surveillance procedures generally focus on detecting 
...
(``ISG'').\21\ The ISG members work together to coordinate surveillance 
...
investors.
    The Exchange also proposes to amend paragraph (f)(3)(ii)(A) of Rule 
5.32-O to provide that, where more than 50 underlying ETFs or 50 
...
Commission that have not been previously addressed.\25\
---------------------------------------------------------------------------
...
of cash settlement as a contract term would give market participants an 
...
be able to compete more effectively with the OTC market. The Exchange 
...
of options currently trading in the OTC market to trading on the 
...
for trading only in the OTC market.
...
FLEX non-ETF Equity Options of all OTP Holders will be subject to the 
...
All submissions should refer to file number SR-NYSEARCA-2026-68. This 
...
2026-68 and should be submitted on or before July 28, 2026.
...
Sherry R. Haywood,
Assistant Secretary.
[FR Doc. 2026-13651 Filed 7-6-26; 8:45 am]
