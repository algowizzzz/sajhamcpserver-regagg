...
---------------------------------------------------------------------------
    ...
    \4\ Rule 6.9-O (Exercise Limits) references the position limits 
...
---------------------------------------------------------------------------
    ...
    The position limit for IBIT options is set by Rule 6.8-O, 
...
---------------------------------------------------------------------------
    ...
    \10\ See Securities Exchange Act Release No. 103567 (July 29, 
...
---------------------------------------------------------------------------
    ...
    \14\ Rule 6.8-O, Commentary .06(e) provides that, to be eligible 
