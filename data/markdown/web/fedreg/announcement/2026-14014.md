...
---------------------------------------------------------------------------
    ...
    \3\ See Securities Exchange Act Release No. 105199 (April 10, 
...
---------------------------------------------------------------------------
    ...
    \5\ See Securities Exchange Act Release No. 98878 (Nov. 7, 
...
---------------------------------------------------------------------------
    ...
    \10\ The Exchange's 23/5 Trading operations will include a one-
...
---------------------------------------------------------------------------
    ...
    \11\ Notification of the declaration and termination of the 
...
---------------------------------------------------------------------------
    ...
    \13\ The Nasdaq Closing Cross price is the Nasdaq Official 
Closing Price for NMS stocks that participate in the Nasdaq Closing 
Cross.
---------------------------------------------------------------------------

    Accordingly, the Exchange proposes to amend Rule 4120(a)(15) and 
...
---------------------------------------------------------------------------
    ...
    \14\ To extend the framework under Rule 4120(a)(15) to the 
...
---------------------------------------------------------------------------
    ...
    The Exchange then proposes to amend Rule 4120(a)(15) to enumerate, 
...
---------------------------------------------------------------------------
    ...
    \15\ As proposed, Rule 4120(a)(15)(A)(1) would define changes to 
...
---------------------------------------------------------------------------
    ...
    Specifically, proposed Rule 4120(a)(15)(A)(9) would require the 
...
---------------------------------------------------------------------------
    ...
    \24\ Such determination would be made by the Exchange's senior 
...
---------------------------------------------------------------------------
    ...
    \25\ See Exchange proposed Rule 4120(a)(15).
...
---------------------------------------------------------------------------
    ...
    \27\ See proposed Exchange Rule 4120(a)(15). See also Exchange 
...
---------------------------------------------------------------------------
    ...
    \30\ See Reverse Stock Split Approval Order, supra note 5, 88 FR 
at 78083.
---------------------------------------------------------------------------
...
---------------------------------------------------------------------------
    ...
    \31\ See proposed Rule 4120(a)(15).
---------------------------------------------------------------------------
...
---------------------------------------------------------------------------
    ...
    \34\ See, e.g., Exchange Rule 4120(a)(10)(A) (providing that 
...
---------------------------------------------------------------------------
    ...
    In all cases under proposed Rule 4120(a)(15), a mandatory 
...
---------------------------------------------------------------------------
    ...
    Similarly, the Exchange believes its proposal to move the reopening 
