---
title: "FINRA Certified Regulatory and Compliance Professional (CRCP)® Program"
regulator: "finra"
doc_type: "announcement"
status: "final"
source_kind: "web"
source_url: "https://www.finra.org/events-training/FINRA-crcp-program"
version: "1"
---

# FINRA Homepage

![Georgetown Campus](/sites/default/files/styles/crop_hero_image/public/2025-11/2025-Jun-DC-KST-Lifestyle-Proofs-01963%201.png?itok=RXN7kX1j)
...
**Update:** FINRA is accepting applications for the Small Firm CRCP® Scholarship, now through **Monday, August 24, 2026**. For more information, including eligibility requirements, the selection process and the online application, please see the Small Firm Scholarship tab below for more information.
...
[Learn More (PDF)](/sites/default/files/2025-11/CRCP_brochure_H48687.pdf)
...
[Learn More & Register](/events-training/FINRA-crcp-program/week-i-foundation)
...
[Learn More & Register](/events-training/FINRA-crcp-program/week-ii-capstone)
...
Coursework must be completed within two consecutive calendar years, but you can complete the program in the same calendar year if you want. Extensions beyond two years may be granted – requests should be submitted via [email](javascript:email(1173,'FINRA Institute at Georgetown CRCP Program');).
...
The cost for FINRA member firms and government or regulators is $6,500 and the cost for non-members is $7,500 **for each week**. Fees include tuition, materials, and room and board at Georgetown’s University Campus. Please visit the Week I and Week II web pages to view more information and to register.

**5. How do I enroll in the CRCP program?**

Visit [finra.org/crcp](/events-training/FINRA-crcp-program) to register online. Payment is due at the time of registration. The program is filled on a first-come, first-served basis with a maximum class size of 65 people.
...
FINRA offers a small firm scholarship program for firms with 150 or fewer registered representatives. Each year, the scholarship is awarded to five industry professionals from small firms and it covers the full tuition and room and board for the entire program. See [Small Firm Scholarship](/events-training/FINRA-crcp-program#scholarship) tab below for more information.

**12. Additional questions?**

Visit our web page at [finra.org/crcp](/events-training/FINRA-crcp-program) or [email](javascript:email(1173,'CRCP');) us.

Small Firm Scholarship

**The application period is now open.** To start the application process, navigate down to the “Application Period” section and click the “Small Firm Scholarship Application” link. If you have questions regarding the scholarship program, please contact FINRA at (800) 321-6273 or send us an [email](javascript:email(1029,'FINRA%20Small%20Firms');).

The FINRA Certified Regulatory and Compliance Professional (CRCP)® Small Firm Scholarship Program was developed to facilitate participation from small firms—those with 150 or fewer registered representatives into theCRCP® program. **Each year, FINRA awards scholarships to five industry professionals from small firms.**
...
Scholarship recipients are expected to complete the program within two consecutive years, starting the year after they received the scholarship. Participation in both Week I and Week II is required. Supervisors cannot formally nominate employees; however, they should encourage eligible compliance professionals at their firms to submit applications.

**Covered Costs**

The scholarship covers full tuition, meals and lodging for the entire program. Travel to and from Georgetown and all other incidental expenses are the responsibility of the recipient. For more details, see the [program cost page.](/sites/default/files/2025-11/CRCP_brochure_H48687.pdf#page=4)
...
Visit our [Upcoming Events page](/events-training/upcoming-events) for upcoming events and our [On-Demand Education page](/events-training/on-demand-education) to view available on-demand recordings.
...
| [Financial Learning Experience™ (FLEX™)](/events-training/flex/overview#flex-learning-catalog)\* | 25-30 Minutes | .5 |
...
For additional questions, please refer to the CRCP CE [frequently asked questions](/events-training/FINRA-crcp-program/reporting-faq) or contact us at (800) 321-6273 or [email us](javascript:email(1173,'FINRA CRCP');).
...
If you have additional questions about the using the CRCP designation or the registered certification marks, please [email us](javascript:email(1173,'CRCP');).
...
For questions regarding the FINRA CRCP CE Reporting System, please refer to the [frequently asked questions](/events-training/FINRA-crcp-program/reporting-faq). For additional questions, please [contact us](javascript:email(1173,'FINRA CRCP');) directly.