...
status: "final"
source_kind: "web"
source_url: "https://www.osc.ca/en/securities-law/orders-rulings-decisions/jones-heward-investment-counsel-inc-mrrs-decision-3"
version: "1"
---
...
• an exemption from subsection 4.1(1) of NI 81-102 to enable the Dealer Managed Funds to invest in the subordinated voting shares (the **Shares**) of Cogeco Cable Inc. (the **Issuer**) on the Toronto Stock Exchange (the **TSX**) during the 60-day period following the completion of a distribution (the **Prohibition Period**) of the Offering (defined below) notwithstanding that the Dealer Manager or its associates or affiliates act or have acted as an underwriter in connection with the offering Shares of the Issuer (the **Offering**) pursuant to a short form prospectus (the **Requested Relief**).
...
> 1. The Dealer Manager is a "dealer manager" with respect to the Dealer Managed Funds, and the Dealer Managed Funds are "dealer managed mutual funds", as such terms are defined in section 1.1 of NI 81-102.
>
...
>
> 5. The Issuer operates cable distribution systems in Ontario and Quebec. The Issuer is the second largest cable distributor in Ontario and Québec and ranks fourth in Canada in terms of the number of its basic service customers.
>
> 6. According to the Issuer's term sheet dated January 17, 2007 (the **Term Sheet**), the Offering is expected to consist of 4,500,000 Shares at a price of $38.50 per Share with gross proceeds of $173,250,000.
>
> 7. In addition, the Underwriters have been granted the option, exercisable until 30 days following the Closing Date, to increase the size of the Offering by up to an additional 500,000 Shares (the **Over-Allotment Option**). If the Underwriters opt to exercise the Over-Allotment Option, the gross proceeds of the Offering would be $192,500,000.
>
> 8. According to the Term Sheet, the Issuer will use the net proceeds of the Offering for repayment of indebtedness under the Term Facility (defined below) and for general corporate purposes.
>
> 9. According to the Term Sheet, the Issuer has made an application to the TSX for the listing of the Shares issued pursuant to the Offering. The Issuer's subordinate voting shares currently trade under the symbol "CCA" on the TSX.
>
> 10. According to the Issuer's preliminary short form prospectus dated January 19, 2007 (the **Preliminary Prospectus**), the Issuer may be a "connected issuer" as defined in National Instrument 33-105 -- *Underwriting Conflicts* (**NI 33-105**), of the Related Underwriter. As disclosed in the Preliminary Prospectus, the Related Underwriter is controlled by a Canadian bank (the **Related Bank**) which is a member of a syndicate of banks (the **Syndicate**) which is a lender to the Issuer and to which the Issuer is presently indebted. The Issuer is indebted to the Syndicate for a term facility of $900,000,000 (the **Term Facility**) under which the Issuer has borrowings of $657,760,000. The Issuer is in compliance with the terms of the Term Facility. The decision to distribute the Shares and the determination of the terms and conditions of the Offering were made through negotiation between the Issuer and the Underwriters without the involvement of the Related Bank.
>
...
>
> 12. The Dealer Managed Funds are not required or obligated to purchase any Shares during the Prohibition Period.
>
> 13. The Dealer Manager may cause the Dealer Managed Funds to invest in Shares during the Prohibition Period. Any purchase of the Shares will be consistent with the investment objectives of the Dealer Managed Funds and represent the business judgment of the Dealer Manager uninfluenced by considerations other than the best interests of the Dealer Managed Fund or in fact be in the best interests of the Dealer Managed Funds.
>
> 14. To the extent that the same portfolio manager or team of portfolio managers of a Dealer Manager manages two or more Dealer Managed Funds and other client accounts that are managed on a discretionary basis (the **Managed Accounts**), the Shares purchased for them will be allocated:
>
...
>
> 15. There will be an independent committee (the **Independent Committee**) appointed in respect of each Dealer Managed Fund to review the investments of the Dealer Managed Funds in Shares during the Prohibition Period.
>
...
>
> 19. The Dealer Manager has not been involved in the work of its Related Underwriter and the Related Underwriter has not been and will not be involved in the decisions of the Dealer Manager as to whether the Dealer Managed Funds will purchase Shares during the Prohibition Period.
...
>
> IV. Each Dealer Managed Fund has an Independent Committee to review the Dealer Managed Fund's investments in the Shares during the Prohibition Period;
>
...
>
> > (a) any determination by it that the condition set out in paragraph X(d) has not been satisfied with respect to any Purchase of the Shares by a Dealer Managed Fund;
> >
...
>
> XII. Each Purchase of Shares during the Prohibition Period is made on the TSX; and
>
