...
>
> 4. The Filer's trust units trade on the Toronto Stock Exchange under the symbols "GTU.UN" (Cdn. $) and "GTU.U" (US $) and on the NYSE Amex LLC under the symbol "GTU".
>
...
>
> 8. As part of the changeover to IFRS in Canada, the Canadian Accounting Standards Board (the "**AcSB**") has incorporated IFRS into the Handbook as Canadian GAAP for most publicly accountable enterprises. As a result, the Handbook contains two sets of standards for public companies:
>
...
>
> 10. if, notwithstanding this decision, the Filer decides not to rely on the Exemption Sought and files an interim financial report prepared in accordance with IFRS for an interim period in a deferred financial year, the Filer must, at the same time:
>
...
>
> 11. if, notwithstanding this decision, the Filer decides not to rely on the Exemption Sought and files annual financial statements prepared in accordance with IFRS for a deferred financial year, the Filer must, at the same time (unless previously done pursuant to paragraph 10 immediately above):
>
