...
The exchange has or requires its participants to have appropriate arrangements for the clearing and settlement of transactions for which clearing is mandatory through a clearing house.[{1}](#N_2_2_10_1_)
...
> [{1}](#N_2_2_10_1a_) For the purposes of these criteria, "clearing house" also means a "clearing agency".
