...
National Policy 11-203 Process for Exemptive Relief Applications in Multiple Jurisdictions -- An application for an order that the issuer is not a reporting issuer.
...
|  |  |
| --- | --- |
| **Re:** | **Coastal Energy Company (the Applicant) -- Application for a decision under the securities legislation of Ontario, Alberta, Saskatchewan, Manitoba, New Brunswick, Nova Scotia, Prince Edward Island, and Newfoundland and Labrador (the Jurisdictions) that the Applicant is not a reporting issuer** |
