...
Re: Northern Sun Mining Corp. (the Applicant) -- Application for a decision under the securities legislation of Alberta and Ontario (the Jurisdictions) that the Applicant is not a reporting issuer
...
Each of the Decision Makers is satisfied that the test contained in the Legislation that provides the Decision Maker with the jurisdiction to make the decision has been met and orders that the Applicant is not to a reporting issuer.
