...
status: "final"
source_kind: "web"
source_url: "https://www.osc.ca/en/securities-law/orders-rulings-decisions/alpha-ats-lp-s-151-ni-21-101-marketplace-operation-and-s-0"
version: "1"
---
...
**(Section 15.1 of National Instrument 21-101 *Marketplace Operation* (NI 21-101)**

**and section 6.1 of Rule 13-502 Fees)**

**UPON** the application (the "Application") of Alpha ATS LP (the "Applicant") to the Director for an order pursuant to section 15.1 of NI 21-101 exempting the Applicant from the requirement in subsection 6.4(2) to file an amendment to the information previously provided in Form 21-101F2 (the "Form") regarding Exhibit G (fees) 45 days before implementation of the fee changes (the "45 day filing requirement");

**AND UPON** the Applicant filing an updated Form F2 on December 13, 2010, describing a fee change to be implemented January 1, 2011 (the "Fee Change");
...
>
> 2. The Filer would like to implement changes to its fee schedule on January 1, 2011.
>
