...
status: "final"
source_kind: "web"
source_url: "https://www.osc.ca/en/securities-law/orders-rulings-decisions/national-bank-canada-0"
version: "1"
---
...
5.             to the extent that the Press Releases provide guidance in relation to compliance matters pertaining to a transaction counterparty's failure to obtain an LEI or to provide its LEI to the Applicant, the Applicant intends to reflect its understanding of such guidance in complying with the applicable Local Reporting Provisions;

 

6.             the Applicant has established or procured internal technology, systems and procedures that the Applicant believes should enable it to give effect to the Local Reporting Provisions;
...
9.             the Applicant has continued to engage in diligent efforts to solicit Required Counterparty Feedback through direct client outreach and through industry efforts; however, despite these efforts, the Applicant has not received Required Counterparty Feedback from all of its counterparties;
