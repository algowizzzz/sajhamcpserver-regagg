---
title: "Brazauro Resources Corporation -- s. 1(10) | OSC"
regulator: "osc"
doc_type: "announcement"
status: "final"
source_kind: "web"
source_url: "https://www.osc.ca/en/securities-law/orders-rulings-decisions/brazauro-resources-corporation-s-110"
version: "1"
---
# Brazauro Resources Corporation -- s. 1(10)
...
|  |  |
| --- | --- |
| **Re:** | **Brazauro Resources Corporation (the "Applicant") -- application for a decision under the securities legislation of Ontario and Alberta (the "Jurisdictions") that the Applicant is not a reporting issuer** |
...
>
> (c) the Applicant is applying for a decision that it is not a reporting issuer in all of the jurisdictions in Canada in which is it currently a reporting issuer; and
>
> (d) to the knowledge of the Applicant, it is not in default of any of its obligations under the Legislation as a reporting issuer,
