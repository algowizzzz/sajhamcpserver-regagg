...
version: "1"
---
# Unofficial consolidation of NP 12-203 as of January 1, 2011
...
[Download document](/sites/default/files/pdfs/irps/pol_20101210_12-203_unofficial-consolidated.pdf "Open document in new window")

This document is an unofficial consolidation of all amendments to National Policy 12 203 *Cease Trade Orders for Continuous Disclosure Defaults*, current to January 1, 2011. This document is for reference purposes only. Footnotes in this document are for explanatory purposes only and are not part of the Policy.
...
1. the chief executive officer (CEO) of the reporting issuer,
2. the chief financial officer (CFO) of the reporting issuer,
3. at the discretion of the PR, the members of the board of directors of the reporting issuer or other persons or companies who had, or may have had, access directly or indirectly to any material fact or material change with respect to the reporting issuer that has not been generally disclosed, and
4. in the case of a reporting issuer that does not have a CEO, CFO and/or a board of directors, individuals who perform similar functions to any of such positions;
...
2. an interim financial report;1
...
4. annual information form (AIF); or
5. certification of filings under Multilateral Instrument 52-109 *Certification of Disclosure in Issuers’ Annual and Interim Filings*.
...
1. identify the relevant specified requirement and the (anticipated) default;
2. disclose in detail the reason(s) for the (anticipated) default;
3. disclose the current plans of the reporting issuer to remedy the default, including the date it anticipates remedying the default;
...
6. subject to section 4.5 of this policy, disclose any other material information concerning the affairs of the reporting issuer that has not been generally disclosed.
...
1. any material changes to the information contained in the default announcement or subsequent default status reports, including a description of all actions taken to remedy the default and the status of any investigations into any events which may have contributed to the default;
...
3. information regarding any (anticipated) specified default subsequent to the default which is the subject of the default announcement; and
4. subject to section 4.5 of this policy, any other material information concerning the affairs of the reporting issuer that has not been generally disclosed.
...
1. the issuer retains title to its assets,
2. the issuer’s directors and officers continue to manage the affairs of the issuer, and
3. the issuer
   1. files a default announcement,
   2. files default status reports,
   3. files a report disclosing the information it provides to its creditors
   ...
   4. otherwise complies with this policy.
...
[Note: This consolidation does not include Part 7, which contained the historical effective date of the original version of the Policy.]
...
Appendix C – Sample Form of Consent
...
5. On or about [*identify the deadline for filing*] (the filing deadline), the Issuer will be required to file [*briefly describe the required filings, e.g.*,
   1. *audited annual financial statements for the year ended December 31, 2007, as required by Part 4 of NI 51-102;*
   2. *management’s discussion and analysis (MD&A) relating to the audited annual financial statements, as required by Part 5 of NI 51-102; and*
...
|  |  |
| --- | --- |
| DATED this day of [DATE] | by : \_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_   Name:  Title: |
