---
title: "Unofficial Consolidation: National Policy 11-203 Process for Exemptive Relief Applications in Multiple Jurisdictions | OSC"
regulator: "osc"
doc_type: "final_rule"
status: "final"
source_kind: "web"
source_url: "https://www.osc.ca/en/securities-law/instruments-rules-policies/1/11-203/unofficial-consolidation-national-policy-11-203-process-exemptive-relief-applications-multiple"
version: "1"
---
# Unofficial Consolidation: National Policy 11-203 Process for Exemptive Relief Applications in Multiple Jurisdictions
...
[Download document](/sites/default/files/2020-09/np_20160729_11-203_unofficial-consolidation.pdf "Open document in new window")

**Ontario Securities Commission**

**National Policy 11-203**

**Unofficial consolidation current to 2016-07-29.**
...
[**Part 1 Application**](#_Toc35342135)

[Application](#_Toc35342136)

[**Part 2 Definitions**](#_Toc35342137)

[Definitions](#_Toc35342138)

[Further definitions](#_Toc35342139)

[**Part 3 Overview, Principal Regulator and General Guidelines**](#_Toc35342140)

[Overview](#_Toc35342141)

[Passport application](#_Toc35342142)

[Dual application](#_Toc35342143)

[Coordinated review application](#_Toc35342144)

[Hybrid applications](#_Toc35342145)

[Principal regulator](#_Toc35342146)

[Discretionary change in principal regulator](#_Toc35342147)

[General guidelines](#_Toc35342148)

[**Part 4 Pre-Filings**](#_Toc35342149)

[General](#_Toc35342150)

[Procedure for passport application pre-filing](#_Toc35342151)

[Procedure for dual application pre-filing](#_Toc35342152)

[Procedure for coordinated review application pre-filing](#_Toc35342153)

[Disclosure in related application](#_Toc35342154)

[**Part 5 Filing Materials**](#_Toc35342155)

[Election to file under this policy and identification of principal regulator](#_Toc35342156)

[Materials to be filed with application](#_Toc35342157)

[Materials to be filed to make an exemption available in an additional passport jurisdiction under sections 4.7 and 4.8 of MI 11-102](#_Toc35342158)

[Request for confidentiality](#_Toc35342159)

[Filing](#_Toc35342160)

[Incomplete or deficient material](#_Toc35342161)

[Acknowledgment of receipt of filing](#_Toc35342162)

[Withdrawal or abandonment of application](#_Toc35342163)

[**Part 6 Review of Materials**](#_Toc35342164)

[Review of passport application](#_Toc35342165)

[Review and processing of dual application or coordinated review application](#_Toc35342166)

[**Part 7 Decision-Making Process**](#_Toc35342167)

[Passport application](#_Toc35342168)

[Dual application or coordinated review application](#_Toc35342169)

[**Part 8 Decision**](#_Toc35342170)

[Effect of decision made under passport application](#_Toc35342171)

[Effect of decision made under dual application](#_Toc35342172)

[Effect of decision made under coordinated review application](#_Toc35342173)

[Listing non-principal jurisdictions](#_Toc35342174)

[Form of decision](#_Toc35342175)

[Issuance of decision](#_Toc35342176)

[**Part 9 Effective Date and Transition**](#_Toc35342177)

[Effective date](#_Toc35342178)

[Exemptive relief applications filed before March 17, 2008](#_Toc35342179)

[Availability of passport for exemptions applied for before March 17, 2008](#_Toc35342180)

[Revocation or variation of MRRS decisions made before March 17, 2008](#_Toc35342181)

[**Annex A**](#_Toc35342182)

[**Annex B**](#_Toc35342183)

[**Annex C**](#_Toc35342184)

[**Annex D**](#_Toc35342185)

#### Part 1 Application

##### Application

**1.1** This policy describes the process for the filing and review of an application for exemptive relief in more than one Canadian jurisdiction.
...
1. 1. a passport application or dual application, and
   2. a coordinated review application;
...
**2.2** Terms used in this policy that are defined in MI 11-102 or National Instrument 14-101 *Definitions* have the same meanings as in those instruments.

#### Part 3 Overview, Principal Regulator and General Guidelines

##### Overview

**3.1** This policy applies to any application for exemptive relief in multiple jurisdictions. These are the possible types of applications:

1. 1. The principal regulator is a passport regulator and the filer does not seek an exemption in Ontario. This is a "passport application."
   2. The principal regulator is the OSC and the filer also seeks an exemption in a passport jurisdiction. This is also a "passport application."
   3. The principal regulator is a passport regulator and the filer also seeks an exemption in Ontario. This is a "dual application."
   4. An application for any type of exemptive relief not covered by Part 4 of MI 11-102. This is a "coordinated review application."
...
**3.4**         If the application is outside the scope of MI 11-102 (see section 4.1 of CP 11-102 for details on the types of applications that fall outside the scope of MI 11-102), the filer files the application and pays fees in each jurisdiction where the exemptive relief is required. The principal regulator reviews the application, and each non-principal regulator coordinates its review with the principal regulator. The decision of the principal regulator to grant exemptive relief evidences the decision of each non-principal regulator that has made the same decision as the principal regulator.

##### Hybrid applications

**3.5**         The processes and outcomes applicable to a passport application, dual application or a coordinated review application under this policy also apply to a hybrid application. For a hybrid application, the filer should follow the processes for both a coordinated review application and either a passport application or dual application, as appropriate.

##### Principal regulator

**3.6 (1)**    For any application under this policy, the principal regulator is identified in the same manner as in sections 4.1 to 4.5 of MI 11-102. This section summarizes sections 4.1 to 4.5 of MI 11-102 and provides guidance on identifying the principal regulator for an application under this policy.
...
1. for an application made for an investment fund, the regulator of the jurisdiction in which the investment fund manager's head office is located; or
2. for an application made for a person or company other than an investment fund, the regulator of the jurisdiction in which the person or company's head office is located.

**(4)**          Except as provided in subsections (6) to (9) and (11) of this section and in section 3.7 of this policy, the principal regulator for an application for exemptive relief from a provision of securities legislation related to insider reporting is the regulator in the jurisdiction in which the head office of the reporting issuer, not the insider, is located.

**(5)**          Except as provided in subsections (6) to (9) and (11) of this section and in section 3.7 of this policy, the principal regulator for an application for exemptive relief from a provision of securities legislation related to take-over bids is the regulator in the jurisdiction in which the head office of the issuer whose securities are subject to the take-over bid, not the person or company that is making the take-over bid, is located.

**(6)**          Except as provided in subsections (7), (8), (9) and (11) of this section and section 3.7 of this policy, if the jurisdiction identified under subsection (3), (4) or (5) is not a specified jurisdiction, the principal regulator for the application is the regulator of the specified jurisdiction with which

1. in the case of an application for exemptive relief from a provision of securities legislation related to insider reporting, the reporting issuer has the most significant connection,
2. in the case of an application for exemptive relief from a provision of securities legislation related to take-over bids, the issuer whose securities are subject to the take-over bid has the most significant connection, or
3. in any other case, the person or company or, in the case of an investment fund, the investment fund manager, has the most significant connection.

**(7)**          Except as provided in subsections (8), (9) and (11) of this section and section 3.7 of this policy, if a firm or individual makes an application for exemptive relief from a requirement in Parts 3 and 12 of NI 31-103 or Part 2 of NI 33-109 in connection with an application for registration in the principal jurisdiction, the principal regulator for the exemptive relief application is the principal regulator as determined under section 3.6 of NP 11-204. Under section 3.6 of NP 11-204 the securities regulatory authority or regulator of any jurisdiction can be a principal regulator.

**(8)**          Except as provided in subsections (9) and (11) of this section, and section 3.7 of this policy, if a person or company is not seeking exemptive relief in the jurisdiction of the principal regulator, as determined under subsections (3), (4), (5), (6) or (7), the principal regulator for the application is the regulator in the specified jurisdiction

1. in which the person or company is seeking exemptive relief, and
2. with which
   1. in the case of an application for exemptive relief from a provision of securities legislation related to insider reporting, the reporting issuer has the most significant connection,
   2. in the case of an application for exemptive relief from a provision of securities legislation related to take-over bids, the issuer whose securities are subject to the take-over bid has the most significant connection, or
   3. in any other case, the person or company or, in the case of an investment fund, the investment fund manager, has the most significant connection.
...
1. in which the person or company is seeking all of the exemptive relief, and
2. with which
   1. in the case of an application for exemptive relief from a provision of securities legislation related to insider reporting, the reporting issuer has the most significant connection,
   2. in the case of an application for exemptive relief from a provision of securities legislation related to take-over bids, the issuer whose securities are subject to the take-over bid has the most significant connection, or
   3. in any other case, the person or company or, in the case of an investment fund, the investment fund manager, has the most significant connection.
...
**(10)**        Except as provided in subsection (11) of this section, the factors a filer should consider in identifying the principal regulator for the application based on the most significant connection test are, in order of influential weight:

1. location of reporting issuer status or registration status,
2. location of management,
3. location of assets and operations,
4. location of majority of security holders or clients, and
5. location of trading market or quotation and trade reporting system in Canada.
...
**3.7 (1)**    If the principal regulator identified under section 3.6 of this policy thinks it is not the appropriate principal regulator, it will first consult with the filer and the appropriate regulator and then give the filer a written notice of the new principal regulator and the reasons for the change.

**(2)**          A filer may request a discretionary change of principal regulator for an application if

1. 1. the filer believes the principal regulator identified under section 3.6 of this policy is not the appropriate principal regulator,
   ...
   4. the filer withdraws its application in the principal jurisdiction because no exemptive relief is required in that jurisdiction.
...
**3.8 (1)**    A filer should identify the exemptive relief that is appropriate and necessary in the principal jurisdiction and each non-principal jurisdiction to which the filer applies or for which it gives notice under section 4.7(1)(c) of MI 11-102.
...
**4.1 (1)**    A filer should submit a pre-filing sufficiently in advance of an application to avoid any delays in the issuance of a decision on the application.

**(2)**          The principal regulator will treat the pre-filing as confidential except that it:

1. 1. may provide copies or a description of the pre-filing to other regulators for discussion purposes if the pre-filing involves a novel and substantive issue or raises a novel policy concern, and
   2. may have to release the pre-filing under freedom of information and protection of privacy legislation.

##### Procedure for passport application pre-filing

**4.2**         A filer should submit a pre-filing for a passport application by letter to the principal regulator and should

1. 1. identify in the pre-filing the principal regulator for the application and each passport jurisdiction for which the filer intends to give the notice referred to in section 4.7(1)(c) of MI 11-102, and
   2. submit the pre-filing to the principal regulator only.

##### Procedure for dual application pre-filing

**4.3 (1)**    A filer submitting a pre-filing for a dual application should identify in the pre-filing the principal regulator, each passport jurisdiction for which the filer intends to give the notice referred to in section 4.7(1)(c) of MI 11-102, and Ontario.
...
##### Procedure for coordinated review application pre-filing

**4.4 (1)**    A filer submitting a pre-filing for a coordinated review application should identify in the pre-filing the principal regulator and all non-principal jurisdictions where the filer intends to file the application.
...
**4.5**         The filer should include in the application that follows a pre-filing,
...
**5.1**         In its application, the filer should indicate whether it is filing a passport application, dual application, coordinated review application or hybrid application under this policy and identify the principal regulator for the application. If submitting a hybrid application, the filer should indicate whether it includes a passport application or a dual application.

##### Materials to be filed with application

**5.2 (1)**    For a passport application, the filer should remit to the principal regulator the fees payable under the securities legislation of the principal regulator, and file the following materials with the principal regulator only:

1. 1. a written application drafted in accordance with the procedures of the principal regulator as to format and content in which the filer:
      1. states the basis for identifying the principal regulator under section 3.6 of this policy,
      2. identifies whether another application in connection with the same transaction or matter has been filed in one or more jurisdictions, the reasons for that application, and the principal regulator for that application,
      3. sets out, for any related pre-filing, the information referred to in section 4.5 of this policy,
      4. sets out, under separate headings, each provision of securities legislation listed in Appendix D of MI 11-102 below the name of the principal jurisdiction from which the filer and other relevant party seek an exemption,
      5. gives notice of the non-principal passport jurisdictions for which section 4.7(1) of MI 11-102 is intended to be relied upon for each equivalent provision of the local jurisdiction,
      6. sets out any request for confidentiality,
      7. sets out references to previous decisions of the principal regulator or other regulators that would support granting the exemption, or indicates that the exemption sought is novel and has not been previously granted;
      ...
      9. states that the filer and other relevant party is not in default of securities legislation in any jurisdiction or, if the filer is in default, the nature of the default;
   2. supporting materials; and
   3. a draft form of decision with terms, conditions, restrictions or requirements, including
      1. a representation stating that the filer and other relevant party are not in default of securities legislation in any jurisdiction or, if the filer or other relevant party is in default, the nature of the default; and
      2. resale restrictions, if applicable, based on the securities legislation and securities directions of the principal jurisdiction.
...
1. 1. a written application drafted in accordance with the procedures of the principal regulator as to format and content in which the filer:
      1. states the basis for identifying the principal regulator under section 3.6 of this policy,
      2. identifies whether another application in connection with the same transaction or matter has been filed in one or more jurisdictions, the reasons for the application, and the principal regulator for that application,
      3. sets out, for any related pre-filing, the information referred to in section 4.5 of this policy,
      4. sets out, under separate headings, each provision of securities legislation listed in Appendix D of MI 11-102 below the name of the principal jurisdiction from which the filer and other relevant party seek an exemption, the relevant provisions of securities legislation in Ontario and an analysis of any differences between the applicable provisions in the principal jurisdiction and Ontario,
      5. gives notice of the non-principal passport jurisdictions for which section 4.7(1) of MI 11-102 is intended to be relied upon for each equivalent provision of the local jurisdiction,
      6. sets out any request for confidentiality,
      7. sets out any request to shorten the review period (see section 6.2(3) of this policy) or the opt-out period (see section 7.2(4) of this policy) and provides supporting reasons,
      8. sets out references to previous decisions of the principal regulator or other regulators that would support granting the exemption, or indicates that the exemption sought is novel and has not been previously granted;
      9. includes a verification statement that authorizes the filing of the application and confirms the truth of the facts in the application; and
      10. states that the filer and any relevant party are not in default of securities legislation in any jurisdiction or, if the filer or other relevant party is in default, the nature of the default;
   2. supporting materials; and
   3. a draft form of decision with terms, conditions, restrictions or requirements, including
      1. a representation stating that the filer and other relevant party are not in default of securities legislation in any jurisdiction or if the filer or relevant party is in default, the nature of the default; and
      2. resale restrictions, if applicable, based on the securities legislation and securities directions of the principal jurisdiction.
...
1. 1. a written application drafted in accordance with the procedures of the principal regulator as to format and content in which the filer:
      1. states the basis for identifying the principal regulator section 3.6 of this policy,
      2. identifies whether another application in connection with the same transaction or matter has been filed in one or more jurisdictions, the reasons for the application, and the principal regulator for that application,
      3. sets out, for any related pre-filing, the information referred to in section 4.5 of this policy,
      4. sets out, under separate headings, each provision of securities legislation in the principal jurisdiction from which the filer and other relevant party are seeking exemptive relief, the relevant provisions of securities legislation in each non-principal jurisdiction, and an analysis of any differences between the applicable provisions in the principal jurisdiction and each non-principal jurisdiction,
      5. sets out any request for confidentiality,
      6. sets out any request to shorten the review period (see section 6.2(3) of this policy) or the opt-out period (see section 7.2(4) of this policy) and provides supporting reasons,
      7. sets out references to previous decisions of the principal regulator or other regulators that would support granting the exemptive relief, or indicates that the exemptive relief sought is novel and has not been previously granted;
      8. includes a verification statement that authorizes the filing of the application and confirms the truth of the facts in the application; and
      9. states that the filer and any other relevant party are not in default of securities legislation in any jurisdiction or if the filer or other relevant party is in default, the nature of the default;
   2. supporting materials; and
   3. a draft form of decision with terms, conditions, restrictions or requirements, including
      1. a representation stating that the filer and any other relevant party are not in default of securities legislation in any jurisdiction or if the filer or other relevant party is in default, the nature of the default; and
      2. resale restrictions, if applicable, based on the securities legislation and securities directions of the principal jurisdiction.
...
1. 1. list each relevant non-principal passport jurisdiction for which notice is given that section 4.7(1) or 4.8(1) of MI 11-102 is intended to be relied upon,
   2. include the date of the decision of
      1. the principal regulator for the initial application, if the notice is given under section 4.7(1)(c) of MI 11-102, or
      2. the regulator of the specified jurisdiction that granted the application, if the notice is given under section 4.8(1)(c) of MI 11-102,
   3. include the citation for the regulator's decision,
   4. describe the exemption the regulator granted, and
   5. confirm that the exemption is still in effect.
...
**5.4 (1)**    A filer requesting that the regulators hold an application and supporting materials in confidence during the application review process should provide a substantive reason for the request in its application.
...
1. 1. in the principal jurisdiction, if the filer is making a passport application,
   2. in the principal jurisdiction and in Ontario, if the filer is making a dual application, or
   3. in each jurisdiction, if the filer is making a coordinated review application.
...
**5.5**         A filer should send the application materials in paper together with the fees to

1. 1. the principal regulator, in the case of a passport application,
   2. the principal regulator and the OSC, in the case of a dual application, or
   3. each regulator from which the filer seeks exemptive relief, in the case of a coordinated review application.

The filer should also provide an electronic copy of the application materials, including the draft decision document, by e-mail or on CD ROM. Filing the application concurrently in all required jurisdictions will make it easier for the principal regulator and non-principal regulators, if applicable, to process the application expeditiously. In British Columbia, an electronic filing system is available for filing and tracking exemptive relief applications. Filers should file an application in British Columbia using that system instead of e-mail. Filers should file applications related to National Instrument 81-102 *Investment Funds* on SEDAR. Filers should file applications related to individual proficiency requirements in NI 31-103 on NRD.
...
| Alberta | [[email protected]](/cdn-cgi/l/email-protection#670b0200060b0617170b0e0406130e08091427061404490406) |
| Saskatchewan | [[email protected]](/cdn-cgi/l/email-protection#e2879a878f92968b8d8c91a2858d94cc9189cc8183) |
| Manitoba | [[email protected]](/cdn-cgi/l/email-protection#e4819c818994908d8b8a97ca899787a4838b92ca8986ca8785) |
| Ontario | <https://www.osc.gov.on.ca/filings> |
| Québec | [[email protected]](/cdn-cgi/l/email-protection#094d607a796c677a6c7a2459687a7a6c79667b7d4965687c7d667b607d6c27786a276a68) |
| New Brunswick | [[email protected]](/cdn-cgi/l/email-protection#6f3f0e1c1c1f001d1b421f0e1c1c0a1f001d1b2f010d1c0c420c1902010d410c0e) |
| Nova Scotia | [[email protected]](/cdn-cgi/l/email-protection#b8d6cbcbdbddc0ddd5c8ccd1d7d6cbf8dfd7ce96d6cb96dbd9) |
| Prince Edward Island | [[email protected]](/cdn-cgi/l/email-protection#397a7a706a795e564f17495c175a58) |
| Newfoundland and Labrador | [[email protected]](/cdn-cgi/l/email-protection#d1a2b4b2a4a3b8a5b8b4a2b4a9b4bca1a5b8bebfa291b6bea7ffbfbdffb2b0) |
| Yukon | [[email protected]](/cdn-cgi/l/email-protection#65260a17150a17041100040303040c171625020a134b1c0e4b0604) |
| Northwest Territories | [[email protected]](/cdn-cgi/l/email-protection#b7e4d2d4c2c5dec3ded2c4e5d2d0dec4c3c5cef7d0d8c199d9c399d4d6) |
| Nunavut | [[email protected]](/cdn-cgi/l/email-protection#29454c4e4845075b4c4e405a5d5b404c5a694e465f07475c074a48) |

##### Incomplete or deficient material

**5.6**         If the filer's materials are deficient or incomplete, the principal regulator may ask the filer to file an amended application. This will likely delay the review of the application.

##### Acknowledgment of receipt of filing

**5.7 (1)**    After the principal regulator receives a complete and adequate application, the principal regulator will send the filer an acknowledgment of receipt of the application. The principal regulator will send a copy of the acknowledgement to any other regulator with whom the filer has filed the application. The acknowledgement will identify the name, phone number, fax number and e-mail address of the individual reviewing the application.
...
**5.8 (1)**    If a filer withdraws an application at any time during the process, the filer is responsible for notifying the principal regulator and any non-principal regulator with whom the filer filed the application and for providing an explanation of the withdrawal.
...
**6.1 (1)**    The principal regulator will review any passport application in accordance with its securities legislation and securities directions and based on its review procedures, analysis and considering previous decisions.
...
##### Review and processing of dual application or coordinated review application
...
1. 1. where exemptive relief is sought for a contested take-over bid and delay would prejudice the filer's position, and
   2. other situations in which the filer is responding to a critical event beyond its control and could not have applied for the exemptive relief earlier.
...
1. 1. the mailing of a management information circular for a scheduled meeting of security holders to consider a transaction,
   2. the filing of a prospectus where the receipt for the prospectus cannot evidence the exemptive relief,
   3. the closing of a transaction,
   4. the filing of a continuous disclosure document shortly before the date on which its filing is required, or
   5. other situations in which the deadline was known before filing the application and the filer could have filed the application earlier.
...
**7.1 (1)**    After completing the review process and after considering the recommendation of its staff, the principal regulator will determine whether to grant or deny the exemption a filer sought in a passport application.
...
1. 1. the expiry of the opt-out period, or
   2. receipt from a non-principal regulator with whom the filer filed the application of the confirmation referred to in subsection (2).
...
1. 1. the date that the OSC confirms that it has made the same decision as the principal regulator, or
   2. the date the opt-out period referred to in section 7.2(2) of this policy has expired.

##### Effect of decision made under coordinated review application

**8.3 (1)**    The decision of the principal regulator under a coordinated review application to grant exemptive relief from a provision of securities legislation in the principal jurisdiction is the decision of the principal regulator and evidences the decision of each non-principal regulator that has confirmed that it has made the same decision as the principal regulator.

**(2)**          The principal regulator will not issue the decision until the earlier of

1. 1. the date that the principal regulator has received confirmation from each non-principal regulator that it has made the same decision as the principal regulator, or
   2. the date the opt-out period referred to in section 7.2(2) of this policy has expired.
...
**8.5 (1)**    Except as described in subsection (2), the decision will be in the form set out in:

1. 1. Annex A, for a passport application,
   2. Annex B, for a dual application,
   3. Annex C, for a coordinated review application, or
   4. Annex D, for a hybrid application.
...
**8.6**         The principal regulator will send the decision to the filer and to all non-principal regulators.

#### Part 9 Effective Date and Transition

##### Effective date

**9.1**         This policy comes into effect on March 17, 2008.

##### Exemptive relief applications filed before March 17, 2008

**9.2**         The process set out in National Policy 12-201 *Mutual Reliance Review System for Exemptive Relief Applications* (MRRS) will continue to apply to an exemptive relief application and any related pre-filing filed in multiple jurisdictions before March 17, 2008.

##### Availability of passport for exemptions applied for before March 17, 2008

**9.3 (1)**    Section 4.8(1) of MI 11-102 provides that an exemption from the equivalent provision is automatically available in the local jurisdiction if

1. 1. an application was made in a specified jurisdiction before March 17, 2008 for an exemption from a provision of securities legislation that is now listed in Appendix D of MI 11-102,
   2. the regulator in the specified jurisdiction granted the exemption before, on or after March 17, 2008, and
   3. certain other conditions are met, including giving the required notice for the additional non-principal passport jurisdiction; refer to section 5.3 of this policy for information on where to give the required notice and what information the notice should contain.
...
##### Revocation or variation of MRRS decisions made before March 17, 2008

**9.4 (1)**    A filer that wants the regulators to revoke an MRRS decision made before March 17, 2008 should make a coordinated review application.
...
1. 1. the **[name of the principal regulator]** is the principal regulator for this application, and
   2. the Filer(s) has(have) provided notice that section 4.7(1) of Multilateral Instrument 11-102 *Passport System* (MI 11-102) is intended to be relied upon in **[names of non-principal passport jurisdictions].**
...
1. 1. the **[name of the principal regulator]** is the principal regulator for this application,
   2. the Filer(s) has(have) provided notice that section 4.7(1) of Multilateral Instrument 11-102 *Passport System* (MI 11-102) is intended to be relied upon in **[names of non-principal passport jurisdictions],** and
...
The securities regulatory authority or regulator in each of\_\_\_\_\_\_\_\_\_\_\_\_(the Jurisdictions) (Coordinated Exemptive Relief Decision Makers) has received an application from the Filer(s) for a decision under the securities legislation of the Jurisdictions (the Legislation) for **[describe the exemptive relief sought (the Coordinated Exemptive Relief) in words (e.g., that the filer is not a reporting issuer). Do not use statutory references. Include defined terms as necessary.]**

Under the Process for Exemptive Relief Applications in Multiple Jurisdictions (for a hybrid application):

1. 1. the **[name of the principal regulator]** is the principal regulator for this application,
   2. the Filer(s) has(ve) provided notice that section 4.7(1) of Multilateral Instrument 11-102 *Passport System* (MI 11-102) is intended to be relied upon in **[names of non-principal passport jurisdictions],**
   3. the decision is the decision of the principal regulator, **[if you are making a dual application, insert:** "and the decision evidences the decision of the securities regulatory authority or regulator in Ontario,"] and
