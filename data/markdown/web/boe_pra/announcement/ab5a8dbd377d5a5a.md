...
status: "final"
source_kind: "web"
source_url: "https://www.bankofengland.co.uk/news/2026/may/boe-fca-and-hm-treasury-joint-statement-on-frontier-ai-models-and-cyber-resilience"
...
The Government and UK financial authorities judge that firms should be taking active steps across several domains.[1](/news/2026/may/boe-fca-and-hm-treasury-joint-statement-on-frontier-ai-models-and-cyber-resilience#footnote)
...
**Response and Recovery**. Firms should be able to respond to and recover from disruption quickly. Firms should read and consider the [effective practices on cyber resilience](/prudential-regulation/publication/2025/october/effective-practices-cyber-response-and-recovery-capabilities) published by the Bank, PRA and FCA in October 2025.
...
Firms should also keep up to date with relevant publications in this space by CMORG and the NCSC, the UK’s technical cyber authority. For example, firms can watch [CMORG’s Frontier AI Risk Mitigation Webinar](https://www.cmorg.org.uk/news) (14 May 2026).
...
* [Preparing for a ‘vulnerability patch wave’ | National Cyber Security Centre](https://www.ncsc.gov.uk/blogs/prepare-for-vulnerability-patch-wave)
...
* [10 questions to ask when using AI models to find vulnerabilities | National Cyber Security Centre, NCSC vulnerability management](https://www.ncsc.gov.uk/collection/vulnerability-management).
