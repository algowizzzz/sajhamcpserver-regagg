---
title: "Cahier de transition pour la directrice et PDG de CANAFE - novembre 2020"
regulator: "fintrac"
...
1. [Introduction et contexte](#s1)
   * [Survol de CANAFE](#s1.1)
   * [Mandat et principaux partenaires](#s1.2)
   * [Plan stratégique pour 2019-2024](#s1.3)
   * [Loi sur le recyclage des produits de la criminalité et le financement des activités terroristes – Survol](#s1.4)
   * [Réponse à la pandémie](#s1.5)
2. [Survols](#s2)
   * [Aperçu financier de CANAFE](#s2.1)
   * [Aperçu financier du Bureau exécutif](#s2.2)
   * [Services juridiques – Survol](#s2.3)
   * [Conformité – Survol du secteur](#s2.4)
   * [Renseignement – Survol du secteur](#s2.5)
   * [Politiques organisationnelles, recherche et programmes – Survol du secteur](#s2.6)
   * [Personnes et culture – Survol du secteur](#s2.7)
   * [Gestion de l'information et technologies de l'information – Survol](#s2.8)
3. [Principaux enjeux et dossiers](#s3)
   * [Commission d'enquête sur le blanchiment d'argent en Colombie-Britannique (Commission Cullen)](#s3.1)
   * [Modernisation du système d'information central et du système d'analytique](#s3.2)
   * [Budget 2020 et mise à jour économique et fiscale de juillet](#s3.3)
   * [Déménagement de l'administration centrale](#s3.4)
   * [Mise en œuvre des modifications réglementaires](#s3.5)
...
Le Centre d'analyse des opérations et déclarations financières du Canada (CANAFE) est l'unité du renseignement financier au pays. Le Centre a pour mandat de faciliter la détection, la prévention et la dissuasion en matière de [blanchiment d'argent](/fintrac-canafe/1-fra#s1) et le [financement des activités terroristes](/fintrac-canafe/1-fra#s2), tout en assurant la protection des renseignements personnels en sa possession.
...
* Directrice et présidente-directrice générale
  ...
  + Ombuds  
    ...
    Mijanoux Beauchamp ACT
  + Avocate générale – Chef d’équipe  
    Services juridiques
  ...
  + Sous-directeur  
    ...
    Barry MacKillop
  + Sous-directrice et dirigeante principale des finances  
    Secteur des politiques organisationnelles, recherche et programmes

    Annette Ryan
  + Directrice adjointe et dirigeante principale des ressources humaines  
    Personnes et culture

    Karen Figuerola
  + Directrice adjointe et dirigeante principale de l'information  
    Gestion de l'information/Gestion de la technologie
...
* Veiller à la conformité avec la Loi sur le recyclage des produits de la criminalité et le financement des activités terroristes :
  1. Voir à ce que les entités déclarantes s'acquittent de leurs obligations légales.
  2. Recevoir des déclarations d'opérations financières transmises par les entités déclarantes.
  3. Fournir de la rétroaction et des directives.
* Produire et communiquer des renseignements financiers :
  1. Analyser les informations et les communiquer aux autorités concernées.
  2. Élaborer des produits de niveau stratégique traitant par exemple des tendances, des acteurs de la menace ou des vulnérabilités.
...
La version \ du plan stratégique 2019-2024 est publiée sur le site Web public de CANAFE : [https://fintrac-canafe.canada.ca/publications/plan/strategic\_plan-fra.pdf](/publications/plan/strategic_plan-fra.pdf).
...
Dépenses de l'exercice en cours (2020-2021)[Note de bas de page 1](#fn1)
...
Autorisations en attente pour l'exercice 2020-2021[Note de bas de page 2](#fn2) et prévisions du troisième trimestre

| Millions | Budget actuel | Autorisa-tions en attente | Budget prévu | Prévision des dépenses du troisième trimestre[Note de bas de page 3](#fn3) | Écart prévu ($) | Écart prévu (%) |
...
Autorisations de dépenser[Note de bas de page 2](#fn2) et prévisions des dépenses pour le T3 de l'exercice

|  | Budget actuel | Autorisations de dépenser | Budget prévu | Prévisions des dépenses pour le T3[Note de bas de page 3](#fn3) | Écart prévu ($) | Écart prévu (%) |
...
* Directrice et présidente-directrice générale  
  ...
  + Avocate-conseil  
    Services juridiques  
    Employée du ministère de la Justice
...
|  | Budget actuel | Autorisations en attente | Budget prévu | Prévision des dépenses du troisième trimestre[Note de bas de page 3](#fn3) | Écart prévu ($) | Écart prévu (%) |
...
* Directrice adjointe et DPRH, Personnes et culture  
  ...
  + Chef d'équipe, Programmes de mieux-être, rémunération et rapports  
    ...
    (Chantal Villeneuve – [Caviardé])
  + Chef d'équipe, Programmes et politiques des RH  
    HRD024 / FT-05 / (CBC)

    Sophie-Anne Tremblay
...
:   Les dépenses de l'exercice actuel sont les dépenses comptabilisées dans le système financier du Centre au 19 octobre 2020. Les autorisations en attente ne sont pas prises en compte.

    [Retour à la référence de la note de bas de page1](#fn1-1-rf)

Note de bas de page 2
:   Comprend toutes les autorisations de dépenser, y compris le Budget supplémentaire des dépenses B déposé le 22 octobre 2020.

    [Retour à la référence de la note de bas de page2](#fn2-1-rf)

Note de bas de page 3
:   Prévision des dépenses du troisième trimestre par secteur au 16 octobre 2020, notamment toutes les autorisations en attente.

    [Retour à la référence de la note de bas de page3](#fn3-1-rf)
