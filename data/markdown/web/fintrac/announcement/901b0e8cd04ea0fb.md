---
title: "Guide sur l'évaluation du tort causé pour les violations relatives à la tenue de documents"
regulator: "fintrac"
doc_type: "announcement"
status: "final"
source_kind: "web"
source_url: "https://fintrac-canafe.canada.ca/pen/guides/rk-fra.php"
version: "1"
---
...
2. [Violations relatives à la tenue de documents réglementaires](#s2)
   * 2.1 [Violations relatives aux relevés d'opérations importantes en espèces](#s2-1)
   * 2.2 [Violation relative aux documents sur l'objet et la nature projetée des relations d'affaires](#s2-2)
   * 2.3 [Violations relatives aux documents concernant les renseignements sur l'identité des clients](#s2-3)
   * 2.4 [Violations relatives aux documents concernant les renseignements sur les tiers](#s2-4)
   * 2.5 [Violation relative aux documents concernant les renseignements sur les fiducies entre vifs](#s2-5)
   * 2.6 [Violation relative aux documents faisant état des renseignements sur les bénéficiaires effectifs](#s2-6)
   * 2.7 [Violation relative aux documents sur la détermination quant au type d'organisme sans but lucratif](#s2-7)
   * 2.8 [Violations relatives aux documents concernant les personnes politiquement vulnérables et les dirigeants d'une organisation internationale](#s2-8)
   * 2.9 [Violations relatives aux documents concernant les relations de correspondant bancaire](#s2-9)
   * 2.10 [Violations relatives aux documents concernant les succursales ou filiales étrangères](#s2-10)
   * 2.11 [Violations relatives à la conservation d'une copie d'une déclaration transmise à CANAFE](#s2-11)
   * 2.12 [Violations relatives aux autres documents réglementaires](#s2-12)
   * 2.13 [Tort causé à l'égard de violations relatives à la tenue de documents réglementaires](#s2-13)
   * 2.14 [Détermination de la pénalité à l'égard de violations relatives à la tenue de documents réglementaires](#s2-14)
   * 2.15 [Facteurs atténuants](#s2-15)
   * 2.16 [Non-conformité à l'égard de documents qui servent à plus d'une fin](#s2-16)
3. [Violations relatives à la période de conservation des documents réglementaires](#s3)
   * 3.1 [Tort causé à l'égard de violations relatives à la période de conservation des documents réglementaires](#s3-1)
   * 3.2 [Détermination de la pénalité à l'égard de violations relatives à la période de conservation des documents réglementaires](#s3-2)
4. [Violation relative à l'exigence de produire un document auprès d'une personne autorisée](#s4)
   * 4.1 [Tort causé à l'égard de la violation relative à l'exigence de produire un document auprès d'une personne autorisée](#s4-1)
   * 4.2 [Détermination de la pénalité à l'égard de la violation relative à l'exigence de produire un document auprès d'une personne autorisée](#s4-2)
5. [Cas répétés d'une violation donnée](#s5)
...
Tableau 1 – Violations relatives aux relevés d'opérations importantes en espèces
...
Tableau 2 – Violation relative aux documents sur l'objet et la nature projetée des relations d'affaires
...
Tableau 3 – Violations relatives aux documents concernant les renseignements sur l'identité des clients
...
Tableau 4 – Violations relatives aux documents concernant les renseignements sur les tiers
...
Tableau 5 – Violations relatives aux documents concernant les renseignements sur les tiers soupçonnés
...
Tableau 6 – Violation relative aux documents concernant les renseignements sur les fiducies entre vifs
...
Tableau 7 – Violation relative aux documents faisant état des renseignements sur les bénéficiaires effectifs
...
Tableau 8 – Violation relative aux documents sur la détermination quant au type d'organisme sans but lucratif
...
Tableau 9 – Violations relatives aux documents concernant les personnes politiquement vulnérables et les dirigeants d'une organisation internationale

| Disposition de la Loi | Disposition du Règlement | Description | Nature de la violation |
| 6 | 14 | Fait de ne pas tenir les documents réglementaires (Nota : Pour les articles 14 et 14.1, particulièrement pour les alinéas 14n), 14o) et 14.1g).) | Mineure De 1 $ à 1 000 $ |
| 14.1 |
| 23 |
...
Veuillez consulter la [directive](/guidance-directives/guidance-directives-fra#s2) publiée par CANAFE pour en savoir davantage sur les exigences concernant les personnes politiquement vulnérables et les dirigeants d'une organisation internationale.
...
Tableau 10 – Violations relatives aux documents concernant les relations de correspondant bancaire
...
Tableau 11 – Violations relatives aux documents concernant les succursales ou filiales étrangères
...
Tableau 12 – Violations relatives à la conservation d'une copie d'une déclaration transmise à CANAFE

| Disposition de la Loi | Disposition du Règlement | Description | Nature de la violation |
| **6** | 43 | Fait de ne pas tenir les documents réglementaires (*Nota : particulièrement pour* l'alinéa 43g).) | Mineure De 1 $ à 1 000 $ |
| **6** | 12.1 (Règlement sur la déclaration des opérations douteuses[Note de bas de page 3](#fn3)) | Fait, pour toute personne ou entité visée, de ne pas conserver une copie de la déclaration réglementaire | Mineure De 1 $ à 1 000 $ |
...
Tableau 13 – Violations relatives aux autres documents réglementaires
...
Tableau 14 – Niveaux de tort des violations relatives à la tenue de documents réglementaires et pénalités correspondantes
...
Tableau 15 – Violations relatives à la période de conservation des documents réglementaires
...
| **6** | 12.3(1) (Règlement sur la déclaration des opérations douteuses[Note de bas de page 4](#fn4)) | Fait, pour toute personne ou entité, de ne pas conserver la copie de la déclaration réglementaire pendant la période visée | Mineure De 1 $ à 1 000 $ |
...
Tableau 16 – Violation relative à l'exigence de produire un document auprès d'une personne autorisée
...
:   L'article 70 du Règlement précise que la production des documents dans les trente jours s'applique à toute demande présentée « en vertu de l'article 62 de la Loi », soit aux fins d'examens en matière de conformité.
