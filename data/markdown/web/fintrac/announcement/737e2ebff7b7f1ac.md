---
title: "Voluntary self-declaration of non-compliance form"
regulator: "fintrac"
...
Voluntary self-declaration of non-compliance form (PDF, 1.1 mb)](vsdonc-form-eng.pdf)

This form is for reporting entities to declare their non-compliance in reporting specific scenarios of electronic funds transfers (EFT), as described in the [Notice on the Assessment of obligations coming into force on June 1, 2021](assessment-eng). As per the Proceeds of Crime (Money Laundering) and Terrorist Financing Regulations (the Regulations) in force on June 1, 2021, reporting entities have the obligation to submit an EFT report to FINTRAC in the following situations:
...
PLEASE SEND THE COMPLETED FORM TO [VSDONC.ADVNC@FINTRAC-CANAFE.GC.CA](mailto:VSDONC.ADVNC@FINTRAC-CANAFE.GC.CA).
