---
title: "Statement on FINTRAC’s use of artificial intelligence"
regulator: "fintrac"
...
In his role as FINTRAC's Chief Technology Officer, Mr. Alford has provided presentations to other federal departments and agencies, and within FINTRAC, on how FINTRAC is using generative AI to support its operations. As part of these presentations, Mr. Alford has used mPersona as an example as it is free and available for anyone to use, modify and/or distribute. This is consistent with the Government of Canada's [Directive on Service and Digital](https://www.tbs-sct.canada.ca/pol/doc-eng.aspx?id=32601), which states that open source software is encouraged and, where used, is contributing to the communities whose work is being leveraged.
