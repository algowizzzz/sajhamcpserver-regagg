---
title: "Allocution de Sarah Paquet, Directrice et présidente-directrice générale, devant le 21e Forum canadien annuel du Canadian Institute sur la lutte contre le blanchiment d’argent et le crime financier"
regulator: "fintrac"
doc_type: "announcement"
status: "final"
source_kind: "web"
source_url: "https://fintrac-canafe.canada.ca/new-neuf/ps-pa/2022-06-15-fra.php"
version: "1"
---
...
* Agression, agression sexuelle et profération de menaces;
* Tirer un avantage financier, matériel, en relation avec la traite d’une personne de moins de 18 ans;
* Conseiller l’exploitation sexuelle d’une jeune personne.
...
* Les entreprises de technologies financières et les géants du numérique proposent des services financiers en ligne connectés à de multiples canaux, réunissant ainsi la banque ouverte et le commerce;
* La technologie a apporté des défis nouveaux et en constante évolution, tels que l’anonymat, la rapidité et des volumes d’opérations beaucoup plus importants;
...
* Mettrons en œuvre de nouvelles réglementations qui ajoutent les entreprises offrant des plateformes de sociofinancement et certains fournisseurs de services de paiement en tant qu’entités réglementées en vertu de la Loi;
* Ferons progresser notre travail de modernisation de notre programme de conformité;
* Appuierons notre surveillance continue des institutions financières sous réglementation fédérale;
* Mettrons à niveau la suite analytique de notre Secteur du renseignement;
* Améliorerons notre capacité à soutenir les connaissances et l’approche du gouvernement du Canada en matière de monnaie virtuelle.
