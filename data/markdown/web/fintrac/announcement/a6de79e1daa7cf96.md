---
title: "FINTRAC Director and CEO transition binder - November 2020"
regulator: "fintrac"
...
1. [Introduction and Background](#s1)
   * [FINTRAC Overview](#s1.1)
   * [Mandate and Key Partners](#s1.2)
   * [FINTRAC Strategic Plan 2019-24](#s1.3)
   * [PCMLTFA Overview](#s1.4)
   * [Pandemic Response](#s1.5)
2. [Overviews](#s2)
   * [FINTRAC Financial Overview](#s2.1)
   * [Executive Office Financial Overview](#s2.2)
   * [Legal Services Overview](#s2.3)
   * [Compliance Overview](#s2.4)
   * [Intelligence Overview](#s2.5)
   * [Enterprise Policy, Research and Programs Overview](#s2.6)
   * [People and Culture Overview](#s2.7)
   * [Information Management and Information Technology Overview](#s2.8)
3. [Key Issues and Files](#s3)
   * [Commission of Inquiry into Money Laundering in British Columbia (Cullen Commission)](#s3.1)
   * [Business Information and Analytics System](#s3.2)
   * [Budget 2020 and July Economic and Fiscal Update](#s3.3)
   * [HQ on the Move](#s3.4)
   * [Regulatory Amendments](#s3.5)
...
The Financial Transactions and Reports Analysis Centre of Canada (FINTRAC) is Canada's Financial Intelligence Unit. The Centre's mandate is to facilitate the detection, prevention and deterrence of [money laundering](/fintrac-canafe/1-eng#s1) and the [financing of terrorist activities](/fintrac-canafe/1-eng#s2), while ensuring the protection of personal information under its control.
...
* Ensuring compliance with the PCMLTFA:
  1. Ensure reporting entities comply with their legal obligations;
  2. Receive financial transaction reports from reporting entities; and
  3. Provide feedback and guidance.
* Producing and disseminating financial intelligence:
  1. Analyze information and disclose it to appropriate authorities; and
  2. Develop strategic-level products on trends, patterns, threat actors, vulnerabilities, etc.
...
A PDF copy of the 2019–24 Strategic Plan is available on the FINTRAC public website: [https://fintrac-canafe.canada.ca/publications/plan/strategic\_plan-eng.pdf](/publications/plan/strategic_plan-eng.pdf)
...
![Historical Expenses (2017-18 to 2019-20)](images/graph1-e.png)
...
2020-21 Current Year Expenses[Footnote 1](#fn1)
...
2020-21 Pending Authorities[Footnote 2](#fn2) and Q3 Forecast

| Millions | Current Budget | Pending Authorities | Projected Budget | Q3 Forecast Spending[Footnote 3](#fn3) | Projected Variance ($) | Projected Variance (%) |
...
![Historical Expenses (2017-18 to 2019-20)](images/graph2-e.png)
...
|  | Current Budget | Pending Authorities | Projected Budget | Q3 Forecast Spending[Footnote 3](#fn3) | Projected Variance ($) | Projected Variance (%) |
...
![Historical Expenses (2017-18 to 2019-20)](images/graph-fin-e.png)
...
* Deputy Director   
  ...
  + Assistant Director   
    ...
    - Mgr, Montreal Office   
      ...
      Julie Leclerc
    - Mgr, Toronto Office & MR   
      CPL007 / FT-06 / (E)

      Nathalie Martineau
    - Mgr, Vancouver Office   
      CPL008 / FT-06 / (E)
  ...
  + Mgr, Compliance Support Unit   
    ...
    Elizabeth Yong
  + Mgr, Regional Support Unit   
    CPL004 / FT-06 / (CBC)

    Jaspal Matharu
  + Mgr, Relationship Mgmt Unit   
    CPL003 / FT-06 / (CBC)
...
![Historical Expenses (2017-18 to 2019-20)](images/graph-compliance-e.png)
...
* Deputy Director   
  ...
  + Assistant Director, Modernization, Integration & Trends Analysis Unit   
    INT002 / FT-07 / (CBC)

    Dan Lambert

    - Mgr, Operations Integration & Sup   
      INT003 / FT-06 / (CBC)

      VACANT
  + Mgr, Terrorist Financing   
     INT003 / FT-06 / (CBC)

    [REDACTED]
  + Mgr, ML, East. & West. Reg   
    INT004 / FT-06 / (CBC)

    [REDACTED]
  + Mgr, ML,Central Region   
    INT005 / FT-06 / (CBC)
...
![Historical Expenses (2017-18 to 2019-20)](images/graph-intel-e.png)
...
* Deputy Director & CFO   
  ...
  + Assistant Director, Policy, Collaboration & Reviews   
    FIN006 / FT-07 / (CBC)
    ...
    - Mgr, Strategic Policy & Reviews   
      CDR002/ FT-06 / (CBC)

      Bruce Wallace
  + Mgr, Strategic Intel, Research & Analysis   
    CDR005 / FT-06 / (CBC)

    [REDACTED]
  + Mgr, Finance & Admin. (DCFO)   
    CMS003 / FT-06 / (CBC)
  ...
  + Mgr, Security   
    ...
    [REDACTED]
  + Mgr, Corporate Bus. Planning & Mgmt   
    CMS006 / FT-06 / (CBC)
...
![Historical Expenses (2017-18 to 2019-20)](images/graph-eprp-e.png)
...
* Assistant Director & CHRO, People and Culture   
  HRD001/ FT-07 / (CBC)

  Karen Figuerola

  + TL, Wellness Programs, Compensation & Reporting   
    HRD031T / FT-05 / (CBC)

    (Chantal Villeneuve – [REDACTED])
  + TL, HR Programs & Policy   
    HRD024 / FT-05 / (CBC)

    Sophie-Anne Tremblay
  + TL, HRBP Services & Talent Strategies   
    HRD016 / FT-05 / (CBC)

    Anne Marie Gascon
  + TL, Employee Engagement, Change Management & Enterprise Learning   
     FT-05 / (CBC)

    Christina Shumacher [REDACTED]
...
![Historical Expenses (2017-18 to 2019-20)](images/graph-hr-e.png)
...
* Chief Information Officer   
  ...
  + Mgr, IMIT Strategy & Digital Enablement   
    CMS242 / FT-06 /(CBC)

    [REDACTED]
  + Mgr, Info & Data Management.Services   
    CMS011 / FT-06 / (CBC)

    [REDACTED]
  + Mgr, Solutions Service   
    CMS012 / FT-06 / (CBC)

    [REDACTED]
  + Mgr, IT Tech Security & Ops Serv   
    CMS013 / FT-06 /(CBC)

    [REDACTED]
  + Mgr, Strat Plan & Client relationship Mgt   
...
![Historical Expenses (2017-18 to 2019-20)](images/graph-imit-e.png)
...
Footnote 1
:   Current year expenses reflect those recorded in the departmental financial system as at October 19, 2020. Pending authorities are not reflected.

    [Return to footnote1](#fn1-1-rf)

Footnote 2
:   All pending authorities, including Supplementary Estimates B which was tabled on October 22, 2020.

    [Return to footnote2](#fn2-1-rf)

Footnote 3
:   Q3 forecast spending reported by sectors as at October 16, 2020, inclusive of all pending authorities.

    [Return to footnote3](#fn3-1-rf)
