---
title: "March 28, 2022 – FINTRAC Advisory: Financial transactions related to countries identified by the Financial Action Task Force (FATF)"
regulator: "fintrac"
doc_type: "announcement"
status: "final"
source_kind: "web"
source_url: "https://fintrac-canafe.canada.ca/notices-avis/avs/2022-03-28-eng.php"
version: "1"
---
...
* [Zimbabwe no longer subject to FATF monitoring process](#s7)
* [FATF action on the terrorist group Islamic State](#s8)
* [FATF Public Statement on the Situation in Afghanistan](#s9)
* [FATF Public Statement on the Situation in Ukraine](#s10)

On March 4, 2022, the FATF issued a statement on high-risk jurisdictions subject to a call for action and a statement on jurisdictions under increased monitoring. These statements are updated and released following every FATF Plenary.
...
As communicated in the FATF's [statement on high-risk jurisdictions subject to a call for action](https://www.fatf-gafi.org/publications/high-risk-and-other-monitored-jurisdictions/documents/call-for-action-march-2022.html) dated March 4, 2022:
...
As communicated in the [statement on high-risk jurisdictions subject to a call for action](http://www.fatf-gafi.org/publications/high-risk-and-other-monitored-jurisdictions/documents/call-for-action-february-2020.html) dated February 21, 2020, the FATF:
...
As communicated in the [statement on high-risk jurisdictions subject to a call for action](http://www.fatf-gafi.org/publications/high-risk-and-other-monitored-jurisdictions/documents/call-for-action-february-2020.html) dated February 21, 2020, the FATF welcomed Iran's high-level political commitment to address its strategic AML/CFT deficiencies in June 2016. However:
...
The FINTRAC has issued [guidance related to the Ministerial Directive](/obligations/dir-iri-eng), which can be found on its website. FINTRAC will assess compliance with the Ministerial Directive.

## Other jurisdictions

In its statement on [jurisdictions under increased monitoring](http://www.fatf-gafi.org/publications/high-risk-and-other-monitored-jurisdictions/documents/increased-monitoring-march-2022.html) dated March 4, 2022, the FATF brought to the attention of its members several jurisdictions that have strategic AML/CFT deficiencies.
...
As stated by the FATF, for information on countries that chose to defer reporting, please refer to the June 2021 and October 2021 statements on jurisdictions under increased monitoring. The FATF has noted, however, that information in these statements may not necessarily reflect the most recent status of the jurisdictions' AML/CFT regimes.
...
Accordingly, FINTRAC is reminding all reporting entities subject to the requirements of the PCMLTFA of their obligation[Footnote4](#fn4) to submit a terrorist property report (TPR) to FINTRAC without delay, once they have met the threshold to disclose under the Criminal Code or the Regulations Implementing the United Nations Resolutions on the Suppression of Terrorism (RIUNRST). [Guidance related to TPRs](/guidance-directives/transaction-operation/Guide5/5-eng) can be found on FINTRAC's website.[Footnote5](#fn5)
...
Reporting entities are also encouraged to undertake enhanced customer due diligence with respect to clients and beneficiaries involved in such financial transactions or attempted financial transactions.[Footnote6](#fn6)

## FATF Public Statement on the Situation in Afghanistan

On May 15, 2013, the Taliban was added to the Criminal Code list of terrorist entities.[Footnote7](#fn7)
...
Accordingly, FINTRAC is reminding reporting entities of their obligation[Footnote8](#fn8) to submit a TPR to FINTRAC without delay, once they have made a disclosure under the Criminal Code or the Regulations Implementing the United Nations Resolutions on the Suppression of Terrorism RIUNRST.
...
On March 4, 2022, the FATF issued a [statement on the situation in Ukraine](http://www.fatf-gafi.org/publications/fatfgeneral/documents/ukraine-2022.html).
...
Footnote 5
:   Section 3.1 of FINTRAC's TPR guidance describes terrorist property reporting requirements.
