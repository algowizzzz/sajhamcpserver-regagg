...
status: "final"
source_kind: "web"
source_url: "https://fintrac-canafe.canada.ca/intel/sintel-eng.php"
version: "1"
---
...
* [Search for FINTRAC publications](#s1)
* [Types of strategic intelligence publications](#s2)
* [Stay up to date](#s3)

## Search for FINTRAC publications

## Search results

| Topic(s) | Title of publication | Type of publication | Date published |
| --- | --- | --- | --- |
| DATATABLE | | | |

## Types of strategic intelligence publications
...
* [Subscribe to FINTRAC’s mailing list](/contact-contactez/list-liste-eng) to receive email notifications of new publications
* Consult the [FINTRAC news](/new-neuf/1-eng) page
