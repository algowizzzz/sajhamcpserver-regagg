---
title: "Directive sur la déclaration d’opérations : la règle de 24 heures"
regulator: "fintrac"
doc_type: "guidance"
status: "final"
source_kind: "web"
source_url: "https://fintrac-canafe.canada.ca/guidance-directives/transaction-operation/24hour/1-fra.php"
version: "1"
---
...
En ce qui concerne les télévirements ou les déboursements de casino, les entités déclarantes doivent continuer d’appliquer la règle de 24 heures telle qu’elle est décrite dans [le bulletin d’interprétation de CANAFE no 4 – La règle de 24 heures](/guidance-directives/overview-apercu/fins/1-fra#s4) (préalable au 1er juin 2021) jusqu’à ce que les nouveaux formulaires de déclaration soient disponibles.
...
* [2. La règle de 24 heures expliquée](#s2)
* [3. Détermination de la période de 24 heures](#s3)
* [4. Déclaration en vertu de la règle de 24 heures](#s4)
* [5. Exceptions à la règle de 24 heures](#s5)
* [Annexe A : Exemples de la règle de 24 heures visant les télévirements](#s6)
* [Annexe B : Exemples de la règle de 24 heures visant les opérations importantes en espèces](#s7)
* [Annexe C : Exemples de la règle de 24 heures visant les opérations importantes en monnaie virtuelle](#s8)
* [Annexe D : Exemples de la règle de 24 heures visant les déboursements de casino](#s9)
* [Détails et historique](#s10)
* [Pour obtenir de l’aide](#s11)
...
* [Règlement sur le recyclage des produits de la criminalité et le financement des activités terroristes](https://laws-lois.justice.gc.ca/fra/lois/p-24.501/)
...
Toutes les [entités déclarantes](/reporting-declaration/info/re-ed-fra) doivent se conformer à la règle de 24 heures comme l’exige la Loi sur le recyclage des produits de la criminalité et le financement des activités terroristes et les règlements connexes.
...
Pour obtenir plus d’informations sur les types de regroupement précis pour chaque type d’opération, veuillez consulter la partie  [4. Déclaration en vertu de la règle de 24 heures](#s4).
...
Comparaison du regroupement des opérations selon le montant, avant le 1er juin 2021 et à partir de cette date
...
* [Déclaration où toutes les opérations sont les mêmes](#s4.5)
* [Déclarations où certaines opérations sont les mêmes](#s4.6)
...
* [Déclaration d’opérations importantes en monnaie virtuelle à CANAFE](/guidance-directives/transaction-operation/lvctr/lvctr-fra)
* [Annexe C – Exemples de la règle de 24 heures visant les opérations importantes en monnaie virtuelle](#s8)
* [Exceptions à la règle de 24 heures – Déclaration d’opérations importantes en monnaie virtuelle](#s5.1)
...
* **amorcent** 2 ou plusieurs [télévirements internationaux](/guidance-directives/glossary-glossaire/1-fra#telinter) qui totalisent 10 000 $ ou plus au cours d’une période fixe de 24 heures, et que l’entité déclarante **sait**, selon le cas, que les opérations :
...
* Déclaration de télévirements à CANAFE (la date de publication de la nouvelle directive n’a pas encore été confirmée)
* [Annexe A : Exemples de la règle de 24 heures visant les télévirements](#s6)
* [Exceptions à la règle de 24 heures – Déclaration de télévirements](#s5.2)
...
* [Annexe B : Exemples de la règle de 24 heures visant les opérations importantes en espèces](#s7)  (exemples B.2 et B.5)
* [Annexe C : Exemples de la règle de 24 heures visant les opérations importantes en monnaie virtuelle](#s8) (exemples C.1 et C.2)
...
L’obligation de regrouper les opérations n’est pas déclenchée
...
L’obligation de regrouper les opérations est déclenchée
...
* une [personne morale ou fiducie dont l’actif est très important](/guidance-directives/glossary-glossaire/1-fra#pmd) qui, d’après son dernier bilan vérifié, possède un actif net d’au moins 75 millions de dollars canadiens. Les actions de la personne morale doivent être cotées sur une bourse de valeurs au Canada ou sur une bourse de valeurs étrangère désignée au paragraphe 262(1) de la Loi de l’impôt sur le revenu. La personne morale ou fiducie doit également exercer ses activités dans un pays membre du Groupe d’action financière (GAFI)
...
**Remarque :** D’autres obligations et exceptions connexes peuvent s’appliquer. Pour obtenir plus d’informations, consultez les [Obligations et directives](/guidance-directives/guidance-directives-fra).
...
**Remarque :** D’autres obligations et exceptions connexes peuvent s’appliquer. Pour obtenir plus d’informations, consultez les [Obligations et directives](/guidance-directives/guidance-directives-fra) (exigences en matière de « déclaration » et de « tenue de documents »).
...
* [Exemple B.1 : Réception d’espèces – règle de 24 heures – regroupement en fonction de la personne ou de l’entité qui effectue l’opération et du bénéficiaire lorsque les opérations sont supérieures à 10 000 $](#s7.1)
* [Exemple B.2 : Réception d’espèces – règle de 24 heures – regroupement en fonction de la personne ou de l’entité qui effectue l’opération et du bénéficiaire lorsque les opérations sont supérieures et inférieures à 10 000 $](#s7.2)
* [Exemple B.3 : Réception d’espèces – règle de 24 heures – regroupement en fonction de la personne ou de l’entité qui effectue l’opération et du bénéficiaire lorsqu’une opération est effectuée à l’extérieure de la période de 24 heures](#s7.3)
* [Exemple B.4 : Réception d’espèces – règle de 24 heures – regroupement en fonction du bénéficiaire – opérations effectuées dans différents fuseaux horaires](#s7.4)
* [Exemple B.5 : Réception d’espèces – règle de 24 heures – regroupement en fonction du tiers](#s7.5)
* [Exemple B.6 : Réception d’espèces – règle de 24 heures – regroupement en fonction de la personne ou de l’entité qui effectue l’opération](#s7.6)
...
Tableau résumant le scénario : Réception d’espèces – règle de 24 heures – regroupement en fonction de la personne qui effectue l’opération et du bénéficiaire lorsque les opérations sont supérieures à 10 000 $
...
![Infographie résumant le scénario et les exigences en matière de déclaration pour l’exemple B.1 : Réception d’espèces – règle de 24 heures – regroupement en fonction de la personne ou de l’entité qui effectue l’opération et du bénéficiaire lorsque les opérations sont supérieures à 10 000 $](images/lctr21-fra.png)![Infographie résumant le scénario et les exigences en matière de déclaration pour l’exemple B.1 : Réception d’espèces – règle de 24 heures – regroupement en fonction de la personne ou de l’entité qui effectue l’opération et du bénéficiaire lorsque les opérations sont supérieures à 10 000 $](images/lctr21-2-fra.png)

Infographie résumant le scénario et les exigences en matière de déclaration pour l’exemple B.1 : Réception d’espèces – règle de 24 heures – regroupement en fonction de la personne ou de l’entité qui effectue l’opération et du bénéficiaire lorsque les opérations sont supérieures à 10 000 $
...
Tableau résumant le scénario : Réception d’espèces – règle de 24 heures – regroupement en fonction de la personne qui effectue l’opération et du bénéficiaire lorsque les opérations sont supérieures et inférieures à 10 000 $
...
* [Opération(s) unique(s) de 10 000 $ ou plus dans une période de 24 heures](#s4.8)

#### Infographie résumant l’exemple B.2

![Infographie résumant le scénario et les exigences en matière de déclaration pour l’exemple B.2 : Réception d’espèces – règle de 24 heures – regroupement en fonction de la personne ou de l’entité qui effectue l’opération et du bénéficiaire lorsque les opérations sont supérieures et inférieures à 10 000 $](images/lctr22-fra.png)![Infographie résumant le scénario et les exigences en matière de déclaration pour l’exemple B.2 : Réception d’espèces – règle de 24 heures – regroupement en fonction de la personne ou de l’entité qui effectue l’opération et du bénéficiaire lorsque les opérations sont supérieures et inférieures à 10 000 $](images/lctr22-2-fra.png)

Infographie résumant le scénario et les exigences en matière de déclaration pour l’exemple B.2 : Réception d’espèces – règle de 24 heures – regroupement en fonction de la personne ou de l’entité qui effectue l’opération et du bénéficiaire lorsque les opérations sont supérieures et inférieures à 10 000 $
...
Tableau résumant le scénario : Réception d’espèces – règle de 24 heures – regroupement en fonction de la personne ou de l’entité qui effectue l’opération et du bénéficiaire avec une opération à l’extérieur de la période de 24 heures
...
![Infographie résumant le scénario et les exigences en matière de déclaration pour l’exemple B.3 : Réception d’espèces – règle de 24 heures – regroupement en fonction de la personne qui effectue l’opération et du bénéficiaire avec une opération à l’extérieur de la période de 24 heures ](images/lctr23-fra.png)![Infographie résumant le scénario et les exigences en matière de déclaration pour l’exemple B.3 : Réception d’espèces – règle de 24 heures – regroupement en fonction de la personne qui effectue l’opération et du bénéficiaire avec une opération à l’extérieur de la période de 24 heures ](images/lctr23-2-fra.png)

Infographie résumant le scénario et les exigences en matière de déclaration pour l’exemple B.3 : Réception d’espèces – règle de 24 heures – regroupement en fonction de la personne qui effectue l’opération et du bénéficiaire avec une opération à l’extérieur de la période de 24 heures
...
Tableau résumant le scénario : Réception d’espèces – règle de 24 heures – regroupement en fonction du bénéficiaire – opérations effectuées dans différents fuseaux horaires
...
![Infographie résumant le scénario et les exigences en matière de déclaration pour l’exemple B.4 : Réception d’espèces – règle de 24 heures – regroupement en fonction du bénéficiaire – opérations effectuées dans différents réseaux horaires](images/lctr24-fra.png)![Infographie résumant le scénario et les exigences en matière de déclaration pour l’exemple B.4 : Réception d’espèces – règle de 24 heures – regroupement en fonction du bénéficiaire – opérations effectuées dans différents réseaux horaires](images/lctr24-2-fra.png)

Infographie résumant le scénario et les exigences en matière de déclaration pour l’exemple B.4 : Réception d’espèces – règle de 24 heures – regroupement en fonction du bénéficiaire – opérations effectuées dans différents réseaux horaires
...
Tableau résumant le scénario : Réception d’espèces – règle de 24 heures – Regroupement en fonction du tiers
...
* [Opération unique de 10 000 $ ou plus dans une période de 24 heures](#s4.8)

#### Infographie résumant l’exemple B.5

![Infographie résumant le scénario et les exigences en matière de déclaration pour l’exemple B.5 : Réception d’espèces – règle de 24 heures – regroupement en fonction d’un tiers](images/lctr25-fra.png)![Infographie résumant le scénario et les exigences en matière de déclaration pour l’exemple B.5 : Réception d’espèces – règle de 24 heures – regroupement en fonction d’un tiers](images/lctr25-2-fra.png)

Infographie résumant le scénario et les exigences en matière de déclaration pour l’exemple B.5 : Réception d’espèces – règle de 24 heures – regroupement en fonction d’un tiers
...
Tableau résumant le scénario : Réception en espèces – règle de 24 heures – Regroupement en fonction de la personne qui effectue l’opération – entité
...
Tableau résumant le scénario : Réception d’espèces – règle de 24 heures – regroupement en fonction de la personne qui effectue l’opération – personne
...
![Infographie résumant le scénario et les exigences en matière de déclaration pour l’exemple B.6 : Réception d’espèces – règle de 24 heures – regroupement en fonction de la personne qui effectue l’opération – entité](images/lctr261-fra.png)![Infographie résumant le scénario et les exigences en matière de déclaration pour l’exemple B.6 : Réception d’espèces – règle de 24 heures – regroupement en fonction de la personne qui effectue l’opération – entité](images/lctr261-2-fra.png)

Infographie résumant le scénario et les exigences en matière de déclaration pour l’exemple B.6 : Réception d’espèces – règle de 24 heures – regroupement en fonction de la personne qui effectue l’opération – entité

![Infographie résumant le scénario et les exigences en matière de déclaration pour l’exemple B.6 : Réception d’espèces – règle de 24 heures – regroupement en fonction de la personne qui effectue l’opération – personne ](images/lctr262-fra.png)![Infographie résumant le scénario et les exigences en matière de déclaration pour l’exemple B.6 : Réception d’espèces – règle de 24 heures – regroupement en fonction de la personne qui effectue l’opération – personne ](images/lctr262-2-fra.png)

Infographie résumant le scénario et les exigences en matière de déclaration pour l’exemple B.6 : Réception d’espèces – règle de 24 heures – regroupement en fonction de la personne qui effectue l’opération – personne
...
* [Suppositions pour les 3 exemples](#s8.1)
* [Exemple C.1 : Réception de monnaie virtuelle – règle de 24 heures – regroupement en fonction de la personne qui effectue l’opération](#s8.2)
* [Exemple C.2 : Réception de monnaie virtuelle – règle de 24 heures – regroupement en fonction du bénéficiaire](#s8.3)
* [Exemple C.3 : Réception de monnaie virtuelle – règle de 24 heures – regroupement en fonction du tiers](#s8.4)
...
Tableau résumant le scénario : Réception de monnaie virtuelle – règle de 24 heures – regroupement   
en fonction de la personne qui effectue l’opération
...
![Infographie résumant le scénario et les exigences en matière de déclaration pour l’exemple C.1 : Réception de monnaie virtuelle – règle de 24 heures – Regroupement en fonction de la personne qui effectue l’opération](images/lvctr31-fra.png)![Infographie résumant le scénario et les exigences en matière de déclaration pour l’exemple C.1 : Réception de monnaie virtuelle – règle de 24 heures – Regroupement en fonction de la personne qui effectue l’opération](images/lvctr31-2-fra.png)

Infographie résumant le scénario et les exigences en matière de déclaration pour l’exemple C.1 : Réception de monnaie virtuelle – règle de 24 heures – Regroupement en fonction de la personne qui effectue l’opération
...
![Infographie résumant le scénario et l’exigence en matière de déclaration pour l’exemple C.2 : Réception de monnaie virtuelle – règle de 24 heures – Regroupement en fonction du bénéficiaire](images/lvctr32-fra.png)![Infographie résumant le scénario et l’exigence en matière de déclaration pour l’exemple C.2 : Réception de monnaie virtuelle – règle de 24 heures – Regroupement en fonction du bénéficiaire](images/lvctr32-2-fra.png)

Infographie résumant le scénario et l’exigence en matière de déclaration pour l’exemple C.2 : Réception de monnaie virtuelle – règle de 24 heures – Regroupement en fonction du bénéficiaire
...
![Infographie résumant le scénario et les exigences en matière de déclaration pour l’exemple C.3 : Réception de monnaie virtuelle – règle de 24 heures – regroupement en fonction du tiers  ](images/lvctr33-fra.png)![Infographie résumant le scénario et les exigences en matière de déclaration pour l’exemple C.3 : Réception de monnaie virtuelle – règle de 24 heures – regroupement en fonction du tiers  ](images/lvctr33-2-fra.png)

Infographie résumant le scénario et les exigences en matière de déclaration pour l’exemple C.3 : Réception de monnaie virtuelle – règle de 24 heures – regroupement en fonction du tiers
...
Liste des modifications et mises à jour

| Date [AAAA-MM-JJ] | Sommaire des modifications |
| 2023-10-23 | * Nouveau tire (ancien titre : « Directive sur la déclaration d’opérations : la règle de 24 heures ») * Réorganisation et reformatage des sections existantes afin que les informations pertinentes puissent être trouvées plus rapidement * Ajout de nouvelles sections expliquant les exceptions courantes et les subtilités de la règle de 24 heures, telles que :   + les types de déclarations identiques ou qui se chevauchent   + les opérations uniques d’un montant égal ou supérieur à 10 000 $   + les situations où il ne faut pas regrouper les opérations * Ajout de 9 nouveaux scénarios de déclaration d’opérations importantes en espèces et de déclaration d’opérations importantes en monnaie virtuelle (avec les infographies correspondantes) dans les annexes * L’utilisation d’un langage simple, dans la mesure du possible, afin d’améliorer la lisibilité * Ajustements mineurs pour se conformer au Guide de rédaction du contenu du site Canada.ca |
