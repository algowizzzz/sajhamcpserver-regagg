---
title: "Money laundering and terrorist financing indicators—Life insurance companies, brokers and agents"
regulator: "fintrac"
doc_type: "guidance"
status: "final"
source_kind: "web"
source_url: "https://fintrac-canafe.canada.ca/guidance-directives/transaction-operation/indicators-indicateurs/li_mltf-eng.php"
version: "1"
---
...
* [ML/TF indicators specific to life insurance or annuity providers](#s11)
* [ML/TF indicators specific to businesses who provide loans](#s12)
...
* Opening life insurance policies when the client's address or employment address is outside the local service area without a reasonable explanation.
...
In addition to the general ML/TF indicators that have been highlighted in this guidance, there may be more specific ML/TF indicators related to your business if you are involved in the business of providing loans (including mortgages) or extending credit to persons or entities. Below are some examples of possible sector specific ML/TF indicators that you should consider as part of your STR process.

* Client suddenly repays a problem loan unexpectedly.
* Client makes a large, unexpected loan payment with funds from an unknown source, or the source of funds that does not match what you know about the client.
* Client repays a long-term loan within a relatively short period.
* Source of down payment is inconsistent with the borrower's background and income.
* Down payment appears to be from an unrelated party.
...
* Client offers you large dollar deposits or some other form of incentive in return for favourable treatment of loan request.
