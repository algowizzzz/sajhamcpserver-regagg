---
title: "Exigences en matière de tenue de documents s'appliquant aux casinos"
regulator: "fintrac"
doc_type: "guidance"
status: "final"
source_kind: "web"
source_url: "https://fintrac-canafe.canada.ca/guidance-directives/recordkeeping-document/record/cas-fra.php"
version: "1"
---
...
Des exigences en matière de tenue de documents s'appliquent aux [casinos](/re-ed/casinos-fra) assujettis à la Loi sur le recyclage des produits de la criminalité et le financement des activités terroristes (la Loi) et aux règlements connexes.
...
Lorsque vous soumettez une [déclaration de déboursements de casino (DDC)](/guidance-directives/transaction-operation/cdr/casino-fra)  à CANAFE, vous devez en conserver une copie.[Note de bas de page 9](#fn20219)

**Conservation** : Au moins cinq ans à compter de la date à laquelle la DDC a été créée.[Note de bas de page 10](#fn202110)

#### Déclarations de télévirements

Lorsque vous soumettez une [déclaration de télévirement (DT)](/guidance-directives/transaction-operation/eft-dt/eft-dt-fra) à CANAFE, vous devez en conserver une copie.[Note de bas de page 11](#fn202111)

**Conservation** : Au moins cinq ans à compter de la date à laquelle la DT a été créée.[Note de bas de page 12](#fn202112)

### b. Relevés d'opération importante en espèces

Vous devez conserver un relevé d'opération importante en espèces lors de la réception de 10 000 $ ou plus en espèces.[Note de bas de page 13](#fn202113)

Les opérations importantes en espèces incluent la réception de 10 000 $ ou plus en espèces pour les opérations suivantes :[Note de bas de page 14](#fn202114)
...
* la prise de paris en [monnaie fiduciaire](/guidance-directives/glossary-glossaire/1-fra#monnaiefiduciaire);
* la vente de chèques du casino.

Si vous autorisez une personne ou une entité à recevoir des [fonds](/guidance-directives/glossary-glossaire/1-fra#fonds) en votre nom, et que cette personne ou entité reçoit 10 000 $ ou plus en espèces conformément à l'autorisation, vous êtes réputé avoir reçu le montant lorsqu'il est reçu par la personne ou l'entité, et vous devez tenir un relevé d'opération importante en espèces. [Note de bas de page 15](#fn202115)

**\*\*Remarque** : La [règle de 24 heures](/guidance-directives/transaction-operation/24hour/1-fra) s'applique à la présente exigence.[Note de bas de page 16](#fn202116)

Un relevé d'opération importante en espèces doit inclure les renseignements suivants :[Note de bas de page 17](#fn202117)
...
**Conservation** : Au moins cinq ans à compter de la date à laquelle le relevé d'opération importante en espèces a été créé.[Note de bas de page 18](#fn202118)

### c. Relevés d'opération importante en monnaie virtuelle

Vous devez conserver un relevé des opérations importantes en monnaie virtuelle (MV) lors de la réception d'une somme en MV équivalent à 10 000 $ ou plus.[Note de bas de page 19](#fn202119)

Si vous autorisez une personne ou une entité à recevoir de la MV en votre nom, et que cette personne ou entité reçoit une somme en MV équivalent à 10 000 $ ou plus conformément à l'autorisation, vous êtes réputé avoir reçu la MV lorsque la personne ou l'entité la reçoit, et vous devez conserver un relevé d'opération importante en MV.[Note de bas de page 20](#fn202120)

\*\***Remarque** : La règle de 24 heures s'applique à la présente exigence.[Note de bas de page 21](#fn202121)

Un relevé d'opération importante en MV doit inclure les renseignements suivants :[Note de bas de page 22](#fn202122)
...
**Conservation** : Au moins cinq ans à compter de la date à laquelle le relevé d'opération importante en monnaie virtuelle a été créé.[Note de bas de page 23](#fn202123)

### d. Relevés de télévirement de 1 000 $ ou plus

#### Amorcer un télévirement de 1 000 $ ou plus

Lorsque vous [amorcez](/guidance-directives/glossary-glossaire/1-fra#amorcer), à la demande d'une personne ou d'une entité, un [télévirement](/guidance-directives/glossary-glossaire/1-fra#tel) de 1 000 $ ou plus, vous devez consigner les renseignements suivants :[Note de bas de page 24](#fn202124)
...
Lorsque vous transmettez, à titre d'intermédiaire, un [télévirement international](/guidance-directives/glossary-glossaire/1-fra#telinter) de 1 000 $ ou plus qui est amorcé par une autre entité déclarante, vous devez consigner les renseignements suivants :[Note de bas de page 25](#fn202125)
...
* le nom et l'adresse de chaque bénéficiaire, sauf si, après avoir pris des [mesures raisonnables](/guidance-directives/glossary-glossaire/1-fra#raisonnable), cette information n'a pas été incluse dans le télévirement et qu'elle n'est par ailleurs pas connue.
...
* le nom, l'adresse, le numéro de téléphone, la date de naissance et la nature de l'entreprise principale, dans le cas d'un propriétaire unique, ou la profession de chaque personne bénéficiaire;
...
**\*\*Remarque** : Les télévirements internationaux et autres télévirements transmis à l'intérieur du Canada au moyen d'un message SWIFT MT 103 ou leur équivalent sont assujettis à la règle d'acheminement. [Note de bas de page 27](#fn202127) Veuillez consulter la directive de CANAFE sur la règle d'acheminement pour en savoir plus.

**Conservation** : Au moins cinq ans à compter de la date à laquelle le relevé de télévirement a été créé.[Note de bas de page 28](#fn202128)

### e. Relevés d'opération de 3 000 $ ou plus

Si vous recevez 3 000 $ ou plus en fonds au cours d'une seule opération, vous devez consigner les renseignements suivants :[Note de bas de page 29](#fn202129)
...
**Conservation** : Au moins cinq ans à compter de la date à laquelle le relevé d'opération de 3 000 $ ou plus a été créé.[Note de bas de page 30](#fn202130)
...
Si vous octroyez un crédit à un client de 3 000 $ ou plus, vous devez conserver un relevé de crédit comportant les renseignements suivants :[Note de bas de page 34](#fn202134)
...
**Conservation** : Au moins cinq ans à compter de la date à laquelle le relevé de crédit a été créé. [Note de bas de page 35](#fn202135)
...
Pour chaque **personne,** vous devez conserver un document où sont consignés, leurs nom, adresse, numéro de téléphone, date de naissance et profession, ou dans le cas d'un propriétaire unique, la nature de leur activité principale.[Note de bas de page 36](#fn202136)

Pour chaque titulaire de compte qui est **une personne morale ou une entité autre qu'une personne morale**, vous devez conserver un document où sont consignés, leurs nom, adresse, numéro de téléphone et la nature de leur activité principale.[Note de bas de page 37](#fn202137)

Pour chaque titulaire de compte qui est une **personne morale**, vous devez également conserver une copie de l'extrait des registres officiels de la personne morale où figure toute disposition portant sur le pouvoir de la lier quant au compte ou transaction.[Note de bas de page 38](#fn202138) Il peut s'agir :
...
**Conservation** : Vous devez conserver les documents sur les titulaires de comptes et les personnes habilitées à donner des instructions pendant au moins cinq ans à compter de la date à laquelle ils ont été créés. Cependant, si les renseignements sont conservés dans d'autres documents, alors les mesures de conservation de ces documents s'appliquent – soit au moins cinq ans à compter de la date à laquelle le compte a été fermé.[Note de bas de page 39](#fn202139)

#### Fiches-signatures

Vous devez conserver une [fiche-signature](/guidance-directives/glossary-glossaire/1-fra#fichesignature) pour chaque personne habilitée à donner des instructions sur un compte au moment de l'ouverture du compte.[Note de bas de page 40](#fn202140) Une fiche-signature peut comprendre la signature manuscrite d'une personne ou une [signature](/guidance-directives/glossary-glossaire/1-fra#signature) électronique créée ou adoptée par la personne.[Note de bas de page 41](#fn202141)
...
**Conservation** : Au moins cinq ans à compter de la date à laquelle le compte a été fermé.[Note de bas de page 42](#fn202142)

#### Utilisation prévue d'un compte

Vous devez conserver un document indiquant l'utilisation prévue d'un compte.[Note de bas de page 43](#fn202143)

**Conservation** : Au moins cinq ans à compter de la date à laquelle le compte a été fermé.[Note de bas de page 44](#fn202144)

#### Demandes faites à l'égard du compte

Vous devez aussi conserver un document où sont consignées toutes les demandes faites à l'égard du compte.[Note de bas de page 45](#fn202145)

**Conservation** : Au moins cinq ans à compter de la date à laquelle le compte a été fermé.[Note de bas de page 46](#fn202146)

#### Conventions de tenue de compte

Vous devez conserver toutes les conventions de tenue de compte que vous créez ou recevez.[Note de bas de page 47](#fn202147) Une convention de tenue de compte est un document qui souligne l'entente conclue entre vous et votre client concernant les activités dans le compte.

**Conservation** : Au moins cinq ans à compter de la date à laquelle le compte a été fermé.[Note de bas de page 48](#fn202148)

#### Relevés de dépôt

Vous devez conserver un relevé de dépôt pour chaque dépôt porté au crédit d'un compte.[Note de bas de page 49](#fn202149) Un relevé de dépôt s'entend d'un document qui contient les renseignements suivants : [Note de bas de page 50](#fn202150)
...
**Conservation** : Au moins cinq ans à compter de la date à laquelle les relevés de dépôt ont été créés.[Note de bas de page 51](#fn202151)

#### Notes de débit et de crédit

Vous devez conserver toutes les notes de débit et de crédit que vous établissez ou recevez à l'égard d'un compte.[Note de bas de page 52](#fn202152)

**Conservation** : Au moins cinq ans à compter de la date à laquelle les notes de débit ou de crédit ont été établies.[Note de bas de page 53](#fn202153)

## 2. Quelles sont mes responsabilités en matière de tenue de documents?

Afin de vous conformer aux exigences en matière de tenue de documents, vous devez conserver les documents de manière à ce qu'ils puissent être fournis à CANAFE dans les 30 jours suivant la date à laquelle ils sont demandés.[Note de bas de page 54](#fn202154) Les documents peuvent également être demandés par le biais d'une ordonnance judiciaire par les organismes d'application de la loi afin d'appuyer une enquête sur le blanchiment d'argent ou le financement des activités terroristes. Un document (ou une copie) peut être tenu sous forme lisible par machine ou sous forme électronique, pourvu qu'un imprimé puisse facilement être produit.[Note de bas de page 55](#fn202155)

Les employés qui tiennent des documents pour vous ne sont pas tenus de les conserver après la fin de leur emploi. Il en va de même pour les personnes avec lesquelles vous êtes liées par contrat, une fois le lien d'emploi ou contractuel est rompu, ces personnes ne sont plus obligées de tenir des documents à votre place.[Note de bas de page 56](#fn202156) Vous devez obtenir et conserver les documents qui ont été tenus pour vous par un employé ou un entrepreneur avant la fin de l'emploi ou du contrat de cette personne.
...
Si vous devez conserver un document contenant des renseignements auxquels vous pouvez facilement avoir accès dans d'autres documents que vous avez déjà à votre disposition, vous n'êtes pas tenu de consigner les mêmes renseignements une seconde fois.[Note de bas de page 57](#fn202157)
...
#### Télévirements au moyen d’une carte de crédit ou de débit

Si vous amorcez un télévirement international de 1 000 $ ou plus, transmettez un télévirement international de 1 000 $ ou plus amorcé par une autre personne ou entité, ou êtes le destinataire d’un télévirement international de 1 000 $ ou plus au moyen d’une carte de crédit ou de débit, vous n’avez pas à conserver les relevés d’opération qui y sont associés, si le bénéficiaire a conclu avec le fournisseur de services de paiement un accord permettant le paiement de biens et services à l’aide d’un tel moyen. [Note de bas de page 58](#fn202158)

#### Entités financières, organismes publics, et personnes morales ou fiducie dont l'actif est très important

Vous n'êtes pas tenu de conserver un relevé de réception de fonds, un relevé d'opération importante en espèces ou un relevé d'opération importante en MV si les espèces ou la MV ont été reçus d'un client qui est une [entité financière (EF)](/guidance-directives/glossary-glossaire/1-fra#ef) ou un [organisme public](/guidance-directives/glossary-glossaire/1-fra#op), ou d'une personne qui agit au nom d'un client qui est une EF ou un organisme public. [Note de bas de page 59](#fn202159)

Vous n'êtes pas tenu de conserver les documents indiqués dans la présente directive pour les télévirements, les opérations de change en devise étrangère, l'octroi de crédit, la réception de fonds, et les documents concernant un compte, lorsque vous ouvrez un compte pour, ou lorsqu'une opération est effectué par : [Note de bas de page 60](#fn202160)

* un organisme public;
* une [personne morale ou fiducie dont l'actif est très important](/guidance-directives/glossary-glossaire/1-fra#pmd);
* une filiale de ces entités, si les états financiers sont consolidés avec ceux de l'organisme public, de la personne morale dont l'actif est très important ou de la fiducie.

#### Monnaie virtuelle

Lorsque vous recevez de la MV à titre de compensation pour la validation d'une opération inscrite dans un [registre distribué](/guidance-directives/glossary-glossaire/1-fra#registredistribue), **ou** recevez une somme symbolique en MV visant uniquement à valider une autre opération ou un transfert de renseignements, vous n'est pas tenu de conserver un relevé d'opération importante en MV.[Note de bas de page 61](#fn202161)
...
:   Règlement sur la déclaration des opérations douteuses — recyclage des produits de la criminalité et financement des activités terroristes (le Règlement sur les DOD), DORS/2001-317, par. 12,1(1).
...
:   Le Règlement, DORS/2002-184, par. 72(1).

    [Retour à la référence de la note de bas de page 13](#fn202113-rf)

Note de bas de page 14
:   Le Règlement, DORS/2002-184, par. 72(2).
...
:   Le Règlement, DORS/2002-184, art. 73.
...
:   Le Règlement, DORS/2002-184, al. 74(2)c).

    [Retour à la référence de la note de bas de page 24](#fn202124-rf)

Note de bas de page 25
:   Le Règlement, DORS/2002-184, al. 74(2)d).

    [Retour à la référence de la note de bas de page 25](#fn202125-rf)

Note de bas de page 26
:   Le Règlement, DORS/2002-184, al. 74(2)e).

    [Retour à la référence de la note de bas de page 26](#fn202126-rf)

Note de bas de page 27
:   Loi sur le recyclage des produits de la criminalité et le financement des activités terroristes (la Loi), L.C. 2000, ch. 17, art. 9.5, et le Règlement, DORS/2002-184, art. 124.
...
:   Le Règlement, DORS/2002-184, al. 1(2) et 74(2)f).
...
:   Le Règlement, DORS/2002-184, al. 74(2)b).
...
:   Le Règlement, DORS/2002-184, al. 74(2)a).
...
:   Le Règlement, DORS/2002-184, al. 74(1)b).
...
:   Le Règlement, DORS/2002-184, al. 74(1)c).
...
:   Le Règlement, DORS/2002-184, par. 74(1)a).
...
:   Le Règlement, DORS/2002-184, al. 74(1)d).
...
:   Le Règlement, DORS/2002-184, al. 74(1)e).
...
:   Le Règlement, DORS/2002-184, al. 74(1)f).
...
:   Le Règlement, DORS/2002-184, al. 74(1)g).
...
:   Le Règlement, DORS/2002-184, al. 74(1)h).
...
:   Le Règlement sur les DOD, DORS/2001-317, 0, par. 12.1(2) et le Règlement, DORS/2002-184, art.147.

    [Retour à la référence de la note de bas de page 55](#fn202155-rf)

Note de bas de page 56
:   Le Règlement sur les DOD, DORS/2001-317, par. 12.1(3) et le Règlement, DORS/2002-184, par. 148(2).
