---
title: "À quel moment vérifier l'identité des personnes  et des entités – Entités financières"
regulator: "fintrac"
doc_type: "guidance"
status: "final"
source_kind: "web"
source_url: "https://fintrac-canafe.canada.ca/guidance-directives/client-clientele/client/fin-fra.php"
version: "1"
---
...
La présente directive sur la vérification de l'identité des clients décrit **à quel moment** les [entités financières (EF)](/guidance-directives/glossary-glossaire/1-fra#ef) doivent vérifier l'identité des [personnes](/guidance-directives/glossary-glossaire/1-fra#personne) et des [entités](/guidance-directives/glossary-glossaire/1-fra#entite) assujetties à la Loi sur le recyclage des produits de la criminalité et le financement des activités terroristes (la Loi) et aux règlements connexes. Vous pouvez obtenir d'autres informations sur la **façon** de vérifier l'identité des personnes et des entités dans la directive de CANAFE intitulée [Méthodes pour vérifier l'identité de personnes et d'entités](/guidance-directives/client-clientele/Guide11/11-fra).
...
1. [À quel moment dois-je vérifier l'identité des personnes et des entités?](#s1)
2. [Quelle est la différence entre vérifier l'identité et tenir les renseignements d'identification des clients à jour?](#s2)
3. [Quelles sont les exceptions aux exigences en matière de vérification de l'identité?](#s3)
...
Vous devez vérifier l'identité de toute personne ou entité qui reçoit une somme de 10 000 $ ou plus en espèces au moment de l'opération. [Note de bas de page 1](#fn20211) Cela inclut une situation où vous êtes réputé avoir reçu la somme, parce que vous avez autorisé une personne ou entité à recevoir des fonds en votre nom. [Note de bas de page 2](#fn20212)

**\*\*Remarque** : La présente obligation est assujettie à la [règle de 24 heures](/guidance-directives/transaction-operation/24hour/1-fra).[Note de bas de page 3](#fn20213)

### b. Opérations importantes en monnaie virtuelle (MV)

Vous devez vérifier l'identité de toute personne ou entité qui reçoit une somme de 10 000 $ ou plus en MV au moment de l'opération. [Note de bas de page 4](#fn20214) Cela inclut une situation où vous êtes réputé avoir reçu la somme en MV, parce que vous avez autorisé une personne ou entité à recevoir des fonds en votre nom. [Note de bas de page 5](#fn20215)

**\*\*Remarque** : La présente obligation est assujettie à la règle de 24 heures. [Note de bas de page 6](#fn20216)

### c. Opérations douteuses

Vous devez prendre des [mesures raisonnables](/guidance-directives/glossary-glossaire/1-fra#raisonnable) pour vérifier l'identité de toute personne ou entité qui effectue ou tente d'effectuer une opération douteuse, peu importe le montant de l'opération, y compris les opérations pour lesquelles une exception aux exigences de vérification de l'identité des clients s'applique habituellement, avant de transmettre une [déclaration d'opération douteuse (DOD)](/guidance-directives/transaction-operation/str-dod/str-dod-fra). [Note de bas de page 7](#fn20217)

### d. Émission ou rachat de mandats, de chèques de voyage ou d'autres titres négociables semblables de 3 000 $ ou plus

Vous devez vérifier l'identité de toute personne qui demande d'émettre ou de racheter des mandats-poste, des chèques de voyage ou des titres négociables semblables d'un montant de 3 000 $ ou plus, et ce, au moment de l'opération. [Note de bas de page 8](#fn20218)
...
Vous devez vérifier l'identité de toute personne qui demande d'[amorcer](/guidance-directives/glossary-glossaire/1-fra#amorcer) un [télévirement international](/guidance-directives/glossary-glossaire/1-fra#telinter) — ou un autre [télévirement](/guidance-directives/glossary-glossaire/1-fra#tel) qui est un message SWIFT MT-103 ou son équivalent — y compris les messages SWIFT MT-103 nationaux, de 1 000 $ ou plus au moment de l'opération. [Note de bas de page 9](#fn20219)

### f. Remettre des fonds au bénéficiaire d'un télévirement international de 1 000 $

Vous devez vérifier l'identité de toute personne qui est bénéficiaire d'un télévirement international de 1 000 $ ou plus au moment de la remise de fonds. [Note de bas de page 10](#fn202110)

### g. Transférer une somme en MV équivalent à 1 000 $ ou plus

Vous devez vérifier l'identité de toute personne qui demande de transférer une somme en MV équivalent à 1 000 $ ou plus au moment de l'opération. [Note de bas de page 11](#fn202111)

### h. Remettre une somme en MV au bénéficiaire équivalent à 1 000 $ ou plus

Vous devez vérifier l'identité de toute personne qui est bénéficiaire d'un transfert d'une somme en monnaie virtuelle équivalent à 1 000 $ ou plus, au moment de la remise de fonds. [Note de bas de page 12](#fn202112)

### i. Opération de change en devise de 3 000 $ ou plus

Vous devez vérifier l'identité de toute personne qui demande d'effectuer une opération de change en devise de 3 000 $ ou plus au moment de l'opération. [Note de bas de page 13](#fn202113)

### j. Opération de change en MV d'une somme équivalent à 1 000 $ ou plus

Vous devez vérifier l'identité de toute personne qui demande d'effectuer une opération de change en MV (l'échange de MV en fonds, de fonds en MV, ou d'une MV pour une autre) d'une somme équivalent à 1 000 $ ou plus, au moment de l'opération. [Note de bas de page 14](#fn202114)

### k. Comptes — Titulaires de comptes et personnes habilitées à donner des instructions

#### Titulaires de compte

Vous devez vérifier l'identité de toute personne, personne morale, et entité autre qu'une personne morale pour laquelle vous ouvrez un compte. [Note de bas de page 15](#fn202115) Vous devez procéder à cette vérification **avant** que soit effectuée la première opération dans le compte, à l'exception du dépôt initial. [Note de bas de page 16](#fn202116)

#### Personnes habilitées à donner des instructions

Vous devez vérifier l'identité de toute personne habilitée à donner des instructions sur un compte avant que soit effectuée la première opération dans le compte, à l'exception du dépôt initial. [Note de bas de page 17](#fn202117)

Vous êtes également tenu de vérifier l'identité d'un membre d'un **compte de régime collectif** qui est habilité à donner des instructions, au moment où une contribution est faite au régime à l'égard d'un membre du régime collectif. [Note de bas de page 18](#fn202118)

Vous ne pouvez pas ouvrir un compte pour une personne, personne morale, ou entité autre qu'une personne morale, si vous n'êtes pas en mesure de vérifier son identité conformément à la réglementation. [Note de bas de page 19](#fn202119)

### l. Comptes de carte de crédit — Titulaires de comptes

Vous devez vérifier l'identité de toute personne, personne morale, et entité autre qu'une personne morale pour laquelle vous ouvrez un compte de carte de crédit [Note de bas de page 20](#fn202120) avant que la carte de crédit ne soit activée. [Note de bas de page 21](#fn202121) Si la carte de crédit est émise à l'intention d'une personne qui n'est pas le titulaire du compte, vous devez consigner les renseignements relatifs à cette personne si elle est habilitée à donner des instructions sur le compte, mais vous n'avez pas besoin de vérifier son identité.
...
Vous devez vérifier l'identité de toute personne, personne morale, et entité autre qu'une personne morale pour laquelle vous ouvrez un compte de PPP [Note de bas de page 22](#fn202122) avant que le compte de PPP ne soit activé. [Note de bas de page 23](#fn202123)

#### Utilisateurs autorisés

Vous devez également vérifier l'identité de tout [utilisateur autorisé](/guidance-directives/glossary-glossaire/1-fra#utilisateur) du compte de PPP [Note de bas de page 24](#fn202124) avant que la première opération ne soit effectuée. [Note de bas de page 25](#fn202125)

#### Paiements de 1 000 $ ou plus à des comptes de PPP

Vous devez vérifier l'identité de toute personne, personne morale, et entité autre qu'une personne morale qui effectue un paiement de 1 000 $ ou plus au crédit d'un compte de produit de paiement prépayé [Note de bas de page 26](#fn202126) au moment de l'opération. [Note de bas de page 27](#fn202127)

### n. Fiducies — constituants d'une fiducie ou les cofiduciaires

Si vous êtes une société de fiducie, vous devez vérifier l'identité de toute personne qui est un [**constituant**](/guidance-directives/glossary-glossaire/1-fra#constituant) de la [fiducie entre vifs](/guidance-directives/glossary-glossaire/1-fra#fidvifs) pour laquelle vous êtes un [fiduciaire](/guidance-directives/glossary-glossaire/1-fra#fiduciaire). [Note de bas de page 28](#fn202128)

Si une personne morale ou une entité autre qu'une personne morale est le **constituant** d'une [fiducie institutionnelle](/guidance-directives/glossary-glossaire/1-fra#fidinstit) pour laquelle vous êtes un fiduciaire, vous devez aussi vérifier son identité. [Note de bas de page 29](#fn202129)

Vous devez vérifier l'identité de toute personne qui est habilitée à agir à titre de **cofiduciaire** d'une fiducie. [Note de bas de page 30](#fn202130) Si une entité est habilitée à agir à titre de **cofiduciaire** d'une fiducie, vous devez vérifier l'identité des personnes habilitées à donner des instructions relativement aux activités de cette entité en sa qualité de cofiduciaire, jusqu'à concurrence de trois. [Note de bas de page 31](#fn202131)

Vous devez vérifier l'identité d'une personne ou d'une entité dans les 15 jours suivant la date où la société de fiducie devient fiduciaire. [Note de bas de page 32](#fn202132)

## 2. Quelle est la différence entre vérifier l'identité et tenir les renseignements d'identification des clients à jour?

Dans le cadre de vos exigences en matière de [contrôle continu](/guidance-directives/client-clientele/omr-fra) pour les [relations d'affaires](/guidance-directives/client-clientele/brr-fra), vous devez tenir à jour tous les [renseignements relatifs à l'identité de vos clients](/guidance-directives/glossary-glossaire/1-fra#renseignements), à une fréquence qui variera en fonction de votre évaluation des risques, et selon ce qui est indiqué dans vos politiques et procédures. [Note de bas de page 33](#fn202133) Cela ne vous oblige pas à identifier à nouveau les clients conformément aux méthodes de vérification de l'identité. Comme l'explique la directive sur le contrôle continu, il vous suffit de tenir à jour les renseignements d'identification des clients. Il s'agit des informations dont vous disposez sur votre client, comme son nom et son adresse. Dans le cas d'une personne, cela comprend également, mais sans s'y limiter, la nature de son activité principale ou de sa profession; et dans le cas d'une entité, la nature de son entreprise principale.

## 3. Quelles sont les exceptions aux exigences en matière de vérification de l'identité?

Si vous avez déjà vérifié l'identité d'une personne ou d'une entité au moyen des méthodes énoncées dans le Règlement qui étaient en vigueur au moment où vous l'avez fait et que vous avez conservé les documents pertinents, vous n'êtes pas tenu de le faire de nouveau si vous n'avez aucun doute quant aux renseignements utilisés.[Note de bas de page 34](#fn202134)
...
* vous recevez les espèces d'une autre entité financière ou d'un organisme public, ou d'une personne qui agit pour le compte d'un client qui est une entité financière ou un organisme public;[Note de bas de page 35](#fn202135)
* il s'agit d'un dépôt porté au crédit d'un compte d'affaires ou fait par guichet automatique (y compris un dépôt rapide ou un dépôt de nuit).[Note de bas de page 36](#fn202136)

### Opérations importantes en MV

Vous n'êtes pas tenu de vérifier l'identité d'une personne ou d'une entité qui effectue une opération importante en MV, si vous recevez la MV d'une autre entité financière ou d'un organisme public, ou d'une personne qui agit pour le compte d'un client qui est une entité financière ou un organisme public.[Note de bas de page 37](#fn202137)

Au moment du transfert ou de la réception de monnaie virtuelle à titre de compensation pour la validation d'une opération inscrite dans un [registre distribué](/guidance-directives/glossary-glossaire/1-fra#registredistribue); **ou** de l'échange, du transfert ou de la réception d'une somme symbolique en monnaie virtuelle visant uniquement à valider une autre opération ou un transfert de renseignements – vous n'êtes pas tenu de conserver un relevé d'opération importante en MV et n'avez pas à vérifier l'identité.[Note de bas de page 38](#fn202138)
...
* vous avez déjà vérifié l'identité de la personne ou de l'entité et n'avez aucun doute quant aux renseignements relatifs à son identité;[Note de bas de page 39](#fn202139)
* vous croyez que la vérification de l'identité de la personne ou de l'entité l'informerait que vous soumettez une déclaration d'opération douteuse.[Note de bas de page 40](#fn202140)

### Télévirement au moyen d’une carte de crédit ou de débit ou d’un PPP

Les exigences de vérification de l’identité du client ne s’appliquent pas lorsque vous effectuez les opérations qui suivent pour une personne au moyen d’une carte de crédit ou de débit ou d’un PPP, si le bénéficiaire a conclu avec le fournisseur de services de paiement un accord permettant le paiement de biens et services à l’aide d’un tel moyen, lorsque vous :[Note de bas de page 41](#fn202141)

* amorcez un télévirement international de 1 000 $ ou plus;
* recevez à titre de destinataire un télévirement international ou un transfert d'une somme en MV équivalent à 1 000 $ ou plus et remettez les fonds au bénéficiaire.

### Activités de traitement de cartes de paiement

Les exigences de vérification de l'identité du client ne s'appliquent pas à l'égard des activités d'une entité financière quant au traitement, pour un commerçant, de paiements par cartes de crédit ou par produits de paiement prépayé.[Note de bas de page 42](#fn202142)

### Organismes publics, personnes morales ou fiducies dont l’actif est très important

Au moment de l'ouverture d'un compte, y compris d'un compte de carte de crédit, d'un compte de PPP ou d'un compte de fiducie, vous n'avez pas à vérifier l'identité d'une personne ou d'une entité, si le compte est destiné à :[Note de bas de page 43](#fn202143)

* un organisme public;
* une [personne morale ou fiducie dont l'actif est très important](/guidance-directives/glossary-glossaire/1-fra#pmd), ou
...
Vous n'avez pas à vérifier l'identité de la personne qui ouvre un compte, est habilitée à donner des instructions relativement à un compte, ouvre un compte de carte de crédit, ou est le fiduciaire ou le cofiduciaire d'une fiducie dans les circonstances suivantes :[Note de bas de page 44](#fn202144)
...
Vous n'avez pas à vérifier l'identité des personnes et des entités mentionnées dans la présente directive dans les cas suivants:[Note de bas de page 45](#fn202145)

* à la vente d'une police exonérée au sens du paragraphe 306 (1) du [Règlement de l'impôt sur le revenue](https://laws-lois.justice.gc.ca/fra/reglements/C.R.C.%2C_ch._945/index.html);
* à la vente d'une police d'assurance-vie collective n'ayant ni valeur de rachat ni composante épargne;
* à la vente d'une rente immédiate ou différée qui est réglée entièrement au moyen de fonds transférés directement d'un régime de pension agréé ou d'un régime de pension devant être agréé en vertu de la [Loi de 1985 sur les normes de prestation de pension](https://laws-lois.justice.gc.ca/fra/lois/P-7.01/index.html) ou de la législation provinciale semblable;
...
* les contributions du membre sont faites par le promoteur du régime ou au moyen de retenues salariales. [Note de bas de page 46](#fn202146)
...
Si vous avez des questions au sujet des exigences relatives au besoin de bien connaître son client, veuillez communiquer avec CANAFE par courriel à [guidelines-lignesdirectrices@fintrac-canafe.gc.ca](mailto:guidelines-lignesdirectrices@fintrac-canafe.gc.ca).

Note de bas de page 1
:   Le Règlement sur le recyclage des produits de la criminalité et le financement des activités terroristes (le Règlement), DORS/2002-184, al. 84a), 105(7)a), 109(4)a) et 112(3)a).

    [Retour à la référence de la note de bas de page1](#fn20211-rf)

Note de bas de page 2
:   Le Règlement, DORS/2002-184, par. 142(1).

    [Retour à la référence de la note de bas de page2](#fn20212-rf)

Note de bas de page 3
:   Le Règlement, DORS/2002-184, par.126.

    [Retour à la référence de la note de bas de page3](#fn20213-rf)

Note de bas de page 4
:   Le Règlement, DORS/2002-184, al. 84b), 105(7)a), 109(4)a) et 112(3)a).

    [Retour à la référence de la note de bas de page4](#fn20214-rf)

Note de bas de page 5
:   Le Règlement, DORS/2002-184, par. 143(1).

    [Retour à la référence de la note de bas de page5](#fn20215-rf)

Note de bas de page 6
:   Le Règlement, DORS/2002-184, art. 129.

    [Retour à la référence de la note de bas de page6](#fn20216-rf)

Note de bas de page 7
:   Le Règlement, DORS/2002-184, al. 85(1), 105(7)c), 109(4)(b) et 112(3)b).

    [Retour à la référence de la note de bas de page7](#fn20217-rf)

Note de bas de page 8
:   Le Règlement, DORS/2002-184, al. 86a)(iii)(A) et 105(7)a).

    [Retour à la référence de la note de bas de page8](#fn20218-rf)

Note de bas de page 9
:   Le Règlement, DORS/2002-184, al. 86a)(iii)(B) et 105(7)a).

    [Retour à la référence de la note de bas de page9](#fn20219-rf)

Note de bas de page 10
:   Le Règlement, DORS/2002-184, al. 86a)(iii)(F) et 105(7)a).

    [Retour à la référence de la note de bas de page10](#fn202110-rf)

Note de bas de page 11
:   Le Règlement, DORS/2002-184, al. 86a)(iii)(D) et 105(7)a).

    [Retour à la référence de la note de bas de page11](#fn202111-rf)

Note de bas de page 12
:   Le Règlement, DORS/2002-184, al. 86a)(iii)(F) et 105(7)a).

    [Retour à la référence de la note de bas de page12](#fn202112-rf)

Note de bas de page 13
:   Le Règlement, DORS/2002-184, al. 86a)(iii)(C) et 105(7)a).

    [Retour à la référence de la note de bas de page13](#fn202113-rf)

Note de bas de page 14
:   Le Règlement, DORS/2002-184, al. 86a)(iii)(E) et 105(7)a).

    [Retour à la référence de la note de bas de page14](#fn202114-rf)

Note de bas de page 15
:   Le Règlement, DORS/2002-184, al. 86a)(i), 86b) et 86c).

    [Retour à la référence de la note de bas de page15](#fn202115-rf)

Note de bas de page 16
:   Le Règlement, DORS/2002-184, al. 105(7)b), 109(4)c) et 112(3(c).

    [Retour à la référence de la note de bas de page16](#fn202116-rf)

Note de bas de page 17
:   Le Règlement, DORS/2002-184, al. 86a)(ii) et 105(7)b).

    [Retour à la référence de la note de bas de page17](#fn202117-rf)

Note de bas de page 18
:   Le Règlement, DORS/2002-184, al. 105(7)j).

    [Retour à la référence de la note de bas de page18](#fn202118-rf)

Note de bas de page 19
:   Loi sur le recyclage des produits de la criminalité et le financement des activités terroristes (la Loi), S.C 2000, c. 17, art. 9.2.

    [Retour à la référence de la note de bas de page19](#fn202119-rf)

Note de bas de page 20
:   Le Règlement, DORS/2002-184, art. 87.

    [Retour à la référence de la note de bas de page20](#fn202120-rf)

Note de bas de page 21
:   Le Règlement, DORS/2002-184, al. 105(7)d), 109(4)d), 112(3)d), 86a)(i), 86b) et 86c).

    [Retour à la référence de la note de bas de page21](#fn202121-rf)

Note de bas de page 22
:   Le Règlement, DORS/2002-184, al. 88a)(i), 88b)(i) et 88c)(i).

    [Retour à la référence de la note de bas de page22](#fn202122-rf)

Note de bas de page 23
:   Le Règlement, DORS/2002-184, al. 105(7)e), 109(4)e) et 112(3)e).

    [Retour à la référence de la note de bas de page23](#fn202123-rf)

Note de bas de page 24
:   Le Règlement, DORS/2002-184, al. 88a)(ii).

    [Retour à la référence de la note de bas de page24](#fn202124-rf)

Note de bas de page 25
:   Le Règlement, DORS/2002-184, al. 105(7)f).

    [Retour à la référence de la note de bas de page25](#fn202125-rf)

Note de bas de page 26
:   Le Règlement, DORS/2002-184, al. 88a)(iii), 88b)(ii) et 88c)(ii).

    [Retour à la référence de la note de bas de page26](#fn202126-rf)

Note de bas de page 27
:   Le Règlement, DORS/2002-184, al. 105(7)a), 109(4)a) et 112(3)a).

    [Retour à la référence de la note de bas de page27](#fn202127-rf)

Note de bas de page 28
:   Le Règlement, DORS/2002-184, par. 89a).

    [Retour à la référence de la note de bas de page28](#fn202128-rf)

Note de bas de page 29
:   Le Règlement, DORS/2002-184, par. 89b) et c).

    [Retour à la référence de la note de bas de page29](#fn202129-rf)

Note de bas de page 30
:   Le Règlement, DORS/2002-184, par. 89d).

    [Retour à la référence de la note de bas de page30](#fn202130-rf)

Note de bas de page 31
:   Le Règlement, DORS/2002-184, al. 89e)(i) et (ii).

    [Retour à la référence de la note de bas de page31](#fn202131-rf)

Note de bas de page 32
:   Le Règlement, DORS/2002-184, al. 105(7)g), 109(4)f) et 112(3)f).

    [Retour à la référence de la note de bas de page32](#fn202132-rf)

Note de bas de page 33
:   Le Règlement, DORS/2002-184, par. 123.1b).

    [Retour à la référence de la note de bas de page33](#fn202133-rf)

Note de bas de page 34
:   Le Règlement, DORS/2002-184, art. 155.

    [Retour à la référence de la note de bas de page34](#fn202134-rf)

Note de bas de page 35
:   Le Règlement, DORS/2002-184, al. 10 et 84a).

    [Retour à la référence de la note de bas de page35](#fn202135-rf)

Note de bas de page 36
:   Le Règlement, DORS/2002-184, par. 84a).

    [Retour à la référence de la note de bas de page36](#fn202136-rf)

Note de bas de page 37
:   Le Règlement, DORS/2002-184, al. 11 et 84b).

    [Retour à la référence de la note de bas de page37](#fn202137-rf)

Note de bas de page 38
:   Le Règlement, DORS/2002-184, art. 151.

    [Retour à la référence de la note de bas de page38](#fn202138-rf)

Note de bas de page 39
:   Le Règlement, DORS/2002-184, par. 155(1).

    [Retour à la référence de la note de bas de page39](#fn202139-rf)

Note de bas de page 40
:   Le Règlement, DORS/2002-184, par. 85(2).

    [Retour à la référence de la note de bas de page40](#fn202140-rf)

Note de bas de page 41
:   Le Règlement, DORS/2002-184, art. 150.1.

    [Retour à la référence de la note de bas de page41](#fn202141-rf)

Note de bas de page 42
:   Le Règlement, DORS/2002-184, art. 150.

    [Retour à la référence de la note de bas de page42](#fn202142-rf)

Note de bas de page 43
:   Le Règlement, DORS/2002-184, al. 154(2)m), n) et o).

    [Retour à la référence de la note de bas de page43](#fn202143-rf)

Note de bas de page 44
:   Le Règlement, DORS/2002-184, par. 154(1).

    [Retour à la référence de la note de bas de page44](#fn202144-rf)

Note de bas de page 45
:   Le Règlement, DORS/2002-184, par. 154(2).

    [Retour à la référence de la note de bas de page45](#fn202145-rf)

Note de bas de page 46
:   Le Règlement, DORS/2002-184, par. 154(3).

    [Retour à la référence de la note de bas de page46](#fn202146-rf)
