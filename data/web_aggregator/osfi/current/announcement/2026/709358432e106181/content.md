...
Les instructions détaillées aideront l’assureur à comprendre les exigences en matière de déclaration; elles **ne sont pas fournies** pour chacune des pages ou sections des relevés trimestriels et annuels P&C (Relevé des états financiers de base [PC1], Relevé de surveillance trimestriel [PC2], Relevé de surveillance annuel [PC3] et Relevé provincial [PCPROV]).

Sauf indications contraires à la présente section ou à la [section V, Normes administratives](/fr/donnees-formulaires/rapports-releves/produire-releve-financier/guides-production-releves-financiers/releves-dassurance-multirisque-section-v-normes-administratives "Relevés d’assurance multirisque – Section V – Normes administratives"), ces instructions s’appliquent à toutes les sociétés, sans égard à leur instance de constitution.

Les numéros de page figurant dans la colonne gauche de certaines pages des relevés trimestriels et annuels P&C renvoient au tableau à l’appui de l’élément en question. L’assureur doit alors consulter les instructions de la présente section relativement à ce tableau.

Toute mentionde « page » renvoie aux pages des relevés trimestriels et annuels P&C.

L’assureur doit inscrire les numéros de renvoi aux notes afférentes aux états financiers dans la deuxième colonne de gauche de certaines pages du relevé des états financiers de base P&C.

Sauf indication contraire, toute mention de« section » renvoie à une section des présentes instructions. Les renvois aux dispositions législatives seront indiqués par art., alinéa, etc., selon le cas.

La [marche à suivre pour imbriquer des objets dans le fichier Excel spécial se trouve à la section II - Normes de production](/fr/donnees-formulaires/rapports-releves/produire-releve-financier/guides-production-releves-financiers/releves-dassurance-multirisque-section-ii-normes-production "Relevés d’assurance multirisque – Section II – Normes de production").

## Exercice courant (colonnes 01 et 02) et exercice précédent (colonnes 02 et 03) dans PC1, PC2, PC3 et PCPROV
...
Lignes 03 à 70 – Catégories d'assurance
:   Pour plus de renseignements sur les branches d'assurance, se reporter à la [section III - Définitions](/fr/donnees-formulaires/rapports-releves/produire-releve-financier/guides-production-releves-financiers/releves-dassurance-multirisque-section-iii-definitions "Relevés d’assurance multirisque – Section III – Définitions").
...
:   Cette colonne doit comprendre les valeurs totales assurées (VTA) pour tous les risques en vigueur à la date du relevé. Les montants doivent être inscrits en milliers de dollars.
    ...
    Pour la branche assurance automobile, la VAT doit correspondre à une mesure de la valeur totale assurée de tous les véhicules visés par une couverture multirisques, y compris les endossements applicables, s’il y a lieu.
...
Ligne 01 – Actif / Actif placé en fiducie
...
:   Cette ligne s'adresse uniquement aux sociétés d'assurance canadiennes.
    ...
    Participations sans contrôle (ligne 48 de la page 20.20)
...
:   Matérialisation des sinistres en pourcentage des capitaux propres ajustés
    ...
    Montant : excédent ou (insuffisance) (ligne 599 de la colonne 29 de la page 60.35)
...
:   Inscrire la durée, en années, du portefeuille d’obligations déclaré aux lignes 04 et 05 de la page 20.10. Cette durée doit être arrondie à une décimale près. Elle doit être identique à celle qui a servi au calcul du test du capital minimal pour le risque de taux d’intérêt.

## Pages 20.10 à 20.60 – États financiers « consolidés »

Les états financiers des sociétés d'assurance canadiennes doivent être présentés sur une base consolidée.

Les états financiers des sociétés d'assurance étrangères doivent être présentés sur une base non consolidée.
...
:   Ces colonnes s'adressent uniquement aux sociétés d'assurance étrangères et doivent exclure les dépôts des réassureurs détenus dans des comptes en fiducie spéciaux.
...
:   Cette ligne s'adresse uniquement aux sociétés d'assurance canadiennes.
    ...
    Se reporter à la [section III - Définitions](/fr/donnees-formulaires/rapports-releves/produire-releve-financier/guides-production-releves-financiers/releves-dassurance-multirisque-section-iii-definitions "Relevés d’assurance multirisque – Section III – Définitions"), pour de plus amples directives.
...
Ligne 195 – Passifs au titre des contrats d'investissement – Passifs nets au titre des fonds distincts
:   Cette ligne s'adresse uniquement aux sociétés d'assurance vie.
...
:   Réservé à l'usage exclusif des sociétés d'assurance étrangères. Déclarer le solde de fin d'exercice tel que rapproché à la page 20.45.
...
:   Les assureurs doivent inscrire leur quote-part du revenu (de la perte) net(te) des filiales, des entreprises associées et des coentreprises en utilisant la méthode de la mise en équivalence. Ils doivent aussi déclarer la quote-part dans le bénéfice (perte) net(te) des accords de mise en commun de participations entre sociétés affiliées qui est comptabilisée selon la méthode de mise en équivalence.
...
:   Consulter la ligne directrice Test du capital minimal (TCM) pour ce qui est du calcul de la réserve pour risque nucléaire.
...
Les notations sont décrites dans la [ligne directrice TCM](/fr/consignes/repertoire-consignes/test-du-capital-minimal-ligne-directrice-2024 "Test du capital minimal - Ligne directrice (2024)").
...
:   Cette colonne s'adresse uniquement aux sociétés d'assurance étrangères.
...
:   Déclarer les accords de mise en commun de participations entre sociétés affiliées comptabilisés selon la méthode de comptabilisation de mise en équivalence.
...
Les sections I à IV s'adressent uniquement aux sociétés d'assurance canadiennes.

Les instructions qui suivent sont pertinentes pour les sections I à IV de cette page.

Si le pourcentage de propriété dans une coentreprise est supérieur à 10 %, tous les montants doivent être déclarés en détail. Il faut aussi indiquer les courtiers associés tels que définis dans la [ligne directrice TCM](/fr/consignes/repertoire-consignes/test-du-capital-minimal-ligne-directrice-2024 "Test du capital minimal - Ligne directrice (2024)").
...
Les participations dans les actions ordinaires et privilégiées ou les prêts / avances à des coentreprises (participations supérieures à 10 %), à des filiales non admissibles et à toutes les entreprises associées doivent être déclarés séparément. La méthode de comptabilisation de mise en équivalence sera utilisée pour évaluer les participations inscrites à la colonne 16. La colonne 18 représente l’écart entre la colonne 12 et la colonne 16.
...
Page 50.32 - Section V – Colonnes 40 à 69 – Transactions de réassurance intragroupes
...
Page 50.32 - Section VI – Colonne 35 – Impartition intragroupes
...
Page 50.32 - Section VII – Colonnes 40 et 42 – Transactions intragroupes donnant lieu à des actifs grevés
:   Inscrire le total de la ligne 19 de la colonne 05 de la page 10.42 du Supplément annuel. En cas de changement de plus de 10 % pendant la période, il faut tenir compte de ce changement dans le total du relevé trimestriel.
    ...
    En outre, les prêts de titres aux apparentés pris en compte dans les montants aux lignes 40 à 45 de la page 10.42 doivent être inclus à la section VII.

## Page 50.40 – Comptes à recevoir des (à payer aux)

Se reporter à la définition de l'expression « entreprise associée », à la [section III - Définitions](/fr/donnees-formulaires/rapports-releves/produire-releve-financier/guides-production-releves-financiers/releves-dassurance-multirisque-section-iii-definitions "Relevés d’assurance multirisque – Section III – Définitions").
...
## Page 60.25 – Résultat des activités d'assurance et Page 60.35 – Sinistres et frais de règlement payés, Exercice courant, Passifs au titre des sinistres survenus, Exercices courant et évolution des provisions nettes pour sinistres, Exercices précédents

Toutes les sociétés sont tenues de respecter les consignes relatives au genre d'utilisation figurant au chapitre 5 des exigences relatives à la déclaration des données statistiques sur les automobiles du [Plan statistique automobile](https://www.gisa.ca/StatisticalInformation), y compris celles pour la production du fichier de suivi des données sur la souscription.
...
Pour plus de précisions au sujet des branches d'assurance, voir la [section III - Définitions](/fr/donnees-formulaires/rapports-releves/produire-releve-financier/guides-production-releves-financiers/releves-dassurance-multirisque-section-iii-definitions "Relevés d’assurance multirisque – Section III – Définitions").
...
* Ligne 599 de la colonne 19 Les produits des activités d’assurance doivent correspondre au montant déclaré à la ligne 099 de la colonne 010 de la page 20.22.
* Ligne 599 de la colonne 29 Les frais des activités d’assurance doivent correspondre au montant déclaré à la ligne 110 de la colonne 01 de la page 20.22.
* Ligne 599 de la colonne 39 Les charges nettes afférentes aux contrats de réassurance détenus doivent correspondre au montant déclaré à la ligne 120 de la colonne 01 de la page 20.22.
* Ligne 599 de la colonne 45 Le résultat des activités d’assurance doit correspondre au montant déclaré à la ligne 199 de la colonne 01 de la page 20.22.
...
:   Pour chaque branche (et branche connexe), déclarer le nombre de polices en vigueur à la fin de l'exercice. Le nombre de polices en vigueur s'entend des polices directes émises par l'assureur.
    ...
    |  | Secteur | Nombre de polices en vigueur |
    | --- | --- | --- |
    | 1 police d'assurance automobile | | |
    | --- | --- | --- |
    | Automobile - responsabilité | 219 | 1 |
    | Automobile - accidents corporels | 229 | 1 |
    | Automobile - autre | 239 | 1 |
    | Automobile - total | **259** | **1** |
    | 1 police d'assurance entreprise | | |
    | Biens d'entreprise | 050 | 1 |
    | Chaudières | 270 | 1 |
    | Responsabilité | 429 | 1 |
    | Total | **599** | **2** |
...
## Page 60.35 – Sinistres et frais de règlement payés, Exercice courant, Passifs au titre des sinistres survenus, Exercices courant et évolution des provisions nettes pour sinistres, Exercices précédents

Ligne 599, colonne 19
:   Le montant des passifs au titre des sinistres survenus – exercice courant, qui est déclaré à la ligne 599 de la colonne 19 doit être égal à la différence entre la somme des montants déclarés à la ligne 799 des colonnes 10, 12 et 16 de la page 20.14, et la somme des montants déclarés à la ligne 599 des colonnes 10, 12 et 16 de la page 20.18.
...
:   Le total de la valeur actualisée des sinistres non payés des « pools » pour l'assurance automobile, y compris une provision pour l'ajustement pour risque (par exemple, Facility Association, Ontario Risk Sharing Plan et Plan de répartition des risques) est indiquée à la ligne 320.
...
Les pertes et les contrepassations de pertes sur contrats déficitaires (colonne 05) indiquées à la ligne 230 de la colonne 19 de la page 20.14 et la récupération des pertes et la récupération des contrepassations des pertes (colonne 10), tel qu’il est indiqué à la ligne 140 de la colonne 19 de la page 20.18 doivent être réparties, selon le principe de la répartition par branche d’assurance, dans la mesure du possible.
...
:   L'assureur détenant un permis délivré par la province de Québec ne doit inscrire aucun montant à ces lignes.
    ...
    17. La catégorie « assurance de biens » est celle en vertu de laquelle l'assureur s'engage à indemniser l'assuré de la perte de biens ou des dommages causés à ceux-ci, dans la mesure où cette assurance ne vise pas des biens qui sont plus spécifiquement couverts par une autre catégorie d'assurance.
    18. La catégorie « assurance des chaudières et des machines » est celle qui comprend une ou plusieurs des protections suivantes :
        1. une protection en vertu de laquelle l'assureur s'engage à indemniser l'assuré des pertes ou des dommages matériels qu'il subit en raison de l'explosion ou de la rupture d'une chaudière ou de tout autre appareil sous pression, y compris tout mécanisme, composante ou accessoire utile à son fonctionnement ou ceux découlant d'un accident survenant à l'occasion de son fonctionnement;
...
**Réassureurs agréés et réassureurs non agréés :** Voir la [section III - Définitions](/fr/donnees-formulaires/rapports-releves/produire-releve-financier/guides-production-releves-financiers/releves-dassurance-multirisque-section-iii-definitions "Relevés d’assurance multirisque – Section III – Définitions").
...
:   N'inclure, dans la colonne 32, que les dépôts n'appartenant pas à l'assureur détenus dans un CSR. Les autres dépôts n'appartenant pas à l'assureur et détenus dans un CSR doivent être déclarés dans la colonne 34.
    ...
    **Pour les sociétés d'assurance fédérales :**
    ...
    Voir la [Directive sur les contrats de sûreté en réassurance](/fr/donnees-formulaires/demandes-approbations/directive-sur-contrats-surete-en-reassurance "Directive sur les contrats de sûreté en réassurance") du BSIF et à la [ligne directrice TCM](/fr/consignes/repertoire-consignes/test-du-capital-minimal-ligne-directrice-2024 "Test du capital minimal - Ligne directrice (2024)") pour obtenir de plus amples détails sur les dépôts n'appartenant pas à l'assureur donnés en garantie par des assureurs prenants non agréés.
...
:   L'estimation brute des risques de catastrophe, moins toute protection contre des événements non catastrophiques, s'entend de la valeur la plus élevée entre un événement catastrophique unique se trouvant à l'intérieur de la fourchette comprise entre le 95e et le 99e centile ou les sinistres maximums probables (SMP) de réserve dont il est question dans la ligne directrice du BSIF B‑9, [Saines pratiques de gestion de l'exposition au risque de tremblement de terre](/fr/consignes/repertoire-consignes/saines-pratiques-gestion-lexposition-au-risque-tremblement-terre-ligne-directrice-2013 "Saines pratiques de gestion de l’exposition au risque de tremblement de terre - Ligne directrice (2013)"), ainsi que dans la ligne directrice de l'Autorité sur [la gestion de l'exposition au risque de tremblement de terre](https://lautorite.qc.ca/professionnels/assureurs/lignes-directrices/capital-et-liquidites/ligne-directrice-sur-la-gestion-de-lexposition-au-risque-de-tremblement-de-terre).
...
## Page 70.90 – Résumé des méthodes non traditionnelles d’atténuation des risques émis ou achetés par la société mère ou le siège social au titre de risques situés au Canada
...
:   Déclarer les commissions conditionnelles au sens de la [section III - Définitions](/fr/donnees-formulaires/rapports-releves/produire-releve-financier/guides-production-releves-financiers/releves-dassurance-multirisque-section-iii-definitions "Relevés d’assurance multirisque – Section III – Définitions").
...
:   Se reporter à la définition de l'expression « ristourne » à la [section III, Définitions](/fr/donnees-formulaires/rapports-releves/produire-releve-financier/guides-production-releves-financiers/releves-dassurance-multirisque-section-iii-definitions "Relevés d’assurance multirisque – Section III – Définitions").
...
Ces pages s’adressent uniquement aux sociétés d’assurance étrangères détenant un permis dans la province du Québec.
...
L'Autorité précise que l'encadrement de vos activités au Québec repose sur la définition d'« assureur », de l'article 1a) de la Loi sur les assureurs, RLRQ c. A-32[Note de bas de page 1](#fn1) (la « LA »), laquelle définition n'a pas été modifiée. Ainsi, les modifications apportées à la LSA ne changent en rien l'obligation des entités étrangères de se conformer aux exigences provinciales.
...
:   Le montant des dividendes doit être déclaré en fonction des primes souscrites directes.

## Page 85.45 – Produits des activités d’assurance (polices d'une durée supérieure à douze mois) par province et territoire

Remplir la page 85.45 si l’assureur a souscrit, au cours de l’exercice courant ou d’un exercice antérieur, des polices dont la durée excède 12 mois. Les données inscrites à la page 85.45 doivent inclure :

* pour les polices dont la durée n’excède pas 12 mois : la totalité des produits des activités d’assurance pour les polices qui ont été souscrites au cours de l’exercice courant;
* pour les polices dont la durée excède 12 mois : uniquement la portion des produits des activités d’assurance se rapportant aux 12 mois de l’exercice courant;
...
Ces pages (à l’exception de la page 93.30) s’adressent uniquement aux sociétés d’assurance canadiennes.
...
:   L'assureur détenant un permis délivré par la province de Québec ne doit inscrire aucun montant aux lignes 04, 05 et 33.
    ...
    L« assurance de biens » et l’ « assurance des chaudières et des machines » se définissent comme suit :
...
Ligne 99 – Dividendes – Directes
:   Le montant des dividendes doit être constaté en fonction des primes souscrites directes.
...
L'assureur doit consulter la [section V - Normes administratives](/fr/donnees-formulaires/rapports-releves/produire-releve-financier/guides-production-releves-financiers/releves-dassurance-multirisque-section-v-normes-administratives "Relevés d’assurance multirisque – Section V – Normes administratives").
...
:   La LA se trouve sur le [site Web de l'Autorité](https://www.lautorite.qc.ca/fr/loi-assurances-institutions-depots-pro.html).
