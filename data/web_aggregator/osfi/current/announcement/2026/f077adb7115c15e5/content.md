...
* subsections 468(5) and 930(5) of the [Bank Act](https://laws-lois.justice.gc.ca/eng/acts/b-1.01/)(BA)
* subsection 453(5) of the [Trust and Loan Companies Act](https://laws-lois.justice.gc.ca/eng/acts/t-19.8/)(TLCA)
* subsections 495(7), 554(5) and 971(5) of the [Insurance Companies Act](https://laws-lois.justice.gc.ca/eng/acts/i-11.8/) (ICA)
* subsection 390(5) of the [Cooperative Credit Associations Act](https://laws-lois.justice.gc.ca/eng/acts/c-41.01/) (CCAA)
...
9. if the transaction is material to the applicant or will present a material change in the business strategy of the applicant:
   ...
   3. three years of financial projections with respect to the applicant, including income statement, balance sheet, capital ratios and key assumptions[Footnote 5](#fnb5),
...
3. Where an applicant acquires control of a permitted entity, the applicant must generally obtain from the entity an undertaking to provide the Superintendent with reasonable access to the records of the entity.[Footnote 7](#fnb7)
4. The Minister may consider whether the proposed transaction would hinder the effective implementation of corrective measures in the future, and may request information to that effect.
5. Applicants are reminded about the protocol for the initial submission of documents in support of requests for approval.
6. Requests for approval(s) addressed in this document are not subject to a service charge.[Footnote 8](#fnb8)
