...
This guideline applies to all federally regulated financial institutions, including foreign bank branches and foreign insurance company branches, to the extent it is consistent with applicable requirements and legal obligations related to their business in Canada as set out in [Guideline E-4 on Foreign Entities Operating in Canada on a Branch Basis](/en/guidance/guidance-library/foreign-entities-operating-canada-branch-basis-guideline-2021 "Foreign Entities Operating in Canada on a Branch Basis – Guideline (2021)").
...
Consistent with our [Corporate Governance Guideline](/en/guidance/guidance-library/corporate-governance-guideline-2018 "Corporate Governance – Guideline (2018)"), senior management is responsible for:
...
* fits into an institution’s broader risk and governance framework as outlined in our [Corporate Governance Guideline](/en/guidance/guidance-library/corporate-governance-guideline-2018 "Corporate Governance – Guideline (2018)"),
...
* covers models or data sourced from external sources like foreign offices or third-party vendors (pursuant to our [Guideline B-10 Third-Party Risk Management Guideline](/en/guidance/guidance-library/third-party-risk-management-guideline "Third-Party Risk Management Guideline")).
...
Model deployment requires careful coordination to ensure the model is properly configured, tested, and moved into production[Footnote 4](#fn4). Integrating models into operational settings should preserve their integrity and reliability. This is particularly important for AI/ML models that may depend on multiple components, diverse and dynamic data sources, and third-party elements.
...
Footnote 1
:   While there are currently no universally agreed-upon definitions of AI, for the purposes of this guideline, consider the OECD definition of AI (where an AI system can be based on one or multiple models): “An AI system is a machine-based system that, for explicit or implicit objectives, infers, from the input it receives, how to generate outputs such as predictions, content, recommendations, or decisions that can influence physical or virtual environments. Different AI systems vary in their levels of autonomy and adaptiveness after deployment.”

    [Return to footnote 1  referrer](#fn1-rf)

Footnote 2
:   [Supervisory Framework - Office of the Superintendent of Financial Institutions](/en/supervision/supervisory-practices/supervisory-framework-0 "Supervisory Framework")

    [Return to footnote 2  referrer](#fn2-rf)

Footnote 3
:   When permitted under the institution’s risk appetite.

    [Return to footnote 3  referrer](#fn3-rf)

Footnote 4
:   The term production environment should be understood as a generic term for the way in which a model or its outputs are accessible once it has been approved.
