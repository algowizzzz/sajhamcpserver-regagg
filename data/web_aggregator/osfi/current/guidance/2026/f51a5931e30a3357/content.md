...
September 2026 Chapter 5 – Page 1 
...
Banks/BHC/T&L Credit Risk – Internal Ratings-Based Approach 
September 2026 Chapter 5 – Page 2 
Unclassified / Non classifié 
Table of Contents 
 
5.1. Overview ..................................................................................................................... 4 
5.2. Mechanics of the IRB approach ............................................................................... 4 
5.2.1 Categorization of exposures .................................................................................. 5 
5.2.2 Foundation and advanced approaches ................................................................. 13 
5.2.3 Adoption of the IRB approach across asset classes ............................................. 17 
5.3. IRB approach risk weight functions ...................................................................... 18 
Explanation of the risk-weight functions ............................................................. 18 
Risk-weighted assets for all exposures that are in default .................................. 19 
5.3.1 RWA for corporate, sovereign, PSE, and bank exposures not in default ............ 19 
5.3.2 RWA for retail exposures that are not in default ................................................. 22 
5.4. IRB risk components ............................................................................................... 23 
5.4.1 Risk components for corporate, sovereign, PSE, and bank exposures ................ 24 
5.4.2 Risk Components for retail exposures ................................................................. 36 
5.5. Supervisory slotting approach for specialized lending ......................................... 39 
5.5.1 Risk weights for specialized lending (PF, OF, CF and IPRE) ............................ 39 
5.5.2 Risk weights for specialized lending (HVCRE) .................................................. 40 
5.5.3 Expected loss (EL) for SL exposures subject to the supervisory slotting criteria40 
5.6. Rules for Purchased Receivables ............................................................................ 41 
5.6.1 Risk-weighted assets for default risk ................................................................... 41 
5.6.2 Risk-weighted assets for dilution risk ................................................................. 43 
5.6.3 Treatment of purchase price discounts for receivables ....................................... 44 
5.6.4 Recognition of credit risk mitigants .................................................................... 45 
5.7. Treatment of expected losses and recognition of allowances ............................... 45 
5.7.1 Calculation of expected losses ............................................................................. 45 
5.7.2 Calculation of provisions ..................................................................................... 46 
5.7.3 Treatment of EL and provisions .......................................................................... 46 
5.8. Minimum requirements for IRB approach ........................................................... 47 
5.8.1 Composition of minimum requirements .............................................................. 47 
5.8.2 Compliance with minimum requirements ........................................................... 48 
5.8.3 Rating system design ........................................................................................... 48

Banks/BHC/T&L Credit Risk – Internal Ratings-Based Approach 
September 2026 Chapter 5 – Page 3 
Unclassified / Non classifié 
5.8.4 Risk rating system operations .............................................................................. 55 
5.8.5 Corporate governance and oversight ................................................................... 58 
Use of internal ratings ......................................................................................... 59 
5.8.6 Risk quantification ............................................................................................... 59 
5.8.7 Validation of internal estimates ........................................................................... 78 
5.8.8 Supervisory LGD and EAD estimates ................................................................. 78 
5.8.9 Requirements for recognition of leasing ............................................................. 83 
5.8.10 Disclosure requirements................................................................................ 83 
Appendix 5-1 - Illustrative IRB Risk Weights .......................................................... 84 
Appendix 5-2 - Supervisory Slotting Criteria for Specialized Lending ................. 85 
Appendix 5-3 – Teranet metropolitan area house price indices to be used in the 
calculation of the DLGD floor .............................................................................. 103

Banks/BHC/T&L Credit Risk – Internal Ratings-Based Approach 
September 2026 Chapter 5 – Page 4 
Unclassified / Non classifié 
Chapter 5 - Credit Risk – Internal Ratings-Based Approach 
1. This chapter is drawn from the Basel Committee on Banking Supervision (BCBS) Basel 
Framework published on the Bank for International Settlements (BIS) website1. For reference, the 
Basel paragraph numbers that are associated with the text appearing in this chapter are indicated 
in square brackets at the end of each paragraph.2  
5.1.  Overview  
...
UL portion. Expected losses are treated separately, as outlined in s ection 5.7 and section 2.1.3.7 
of Chapter 2. [Basel Framework, CRE 30.2] 
 
4. In this chapter, the asset classes eligible for the IRB approach are defined in s ection 5.2. 
...
Banks/BHC/T&L Credit Risk – Internal Ratings-Based Approach 
September 2026 Chapter 5 – Page 5 
Unclassified / Non classifié 
weighted assets are assumed to represent UL only. Moreover, institutions must apply the risk 
...
identified. Within the cor porate and retail asset classes, a distinct treatment for purchased 
receivables may also apply provided certain conditions are met. For the equity asset class the IRB 
approach is not permitted, as outlined further in paragraph 48. For a discussion of the IRB 
...
entities (SME), as defined in paragraph 68. Corporate exposures also include U.S. Government 
...
Banks/BHC/T&L Credit Risk – Internal Ratings-Based Approach 
September 2026 Chapter 5 – Page 6 
Unclassified / Non classifié 
...
d. As a result of the preceding factors, the primary source of repayment of the obligation is 
...
Banks/BHC/T&L Credit Risk – Internal Ratings-Based Approach 
September 2026 Chapter 5 – Page 7 
Unclassified / Non classifié 
Commodities finance 
...
repaid from the proceeds of the sale of the commodity and the borrower  has no independent 
...
compensate for the weak credit quality o f the borrower. The exposure’s rating reflects its self -
...
hotels) where the prospects for repayment and recovery on the exposur e depend primarily on the 
...
a. Commercial real estate exposures in foreign jurisdictions secured by properties of types 
that are categorized by the relevant foreign national supervisor as sharing higher volatilities 
in portfolio default rates (referred to as HVCRE loans in foreign jurisdictions);  
b. Loans financing land acquisition, development and construction (ADC), as defined in 
Chapter 4, section 4.1.13, for HVCRE loans in foreign jurisdictions; and  
c. Loans financing land ADC of any  Canadian properties where the source of repayment at 
...
leased to the occupancy rate prevailing in that geographic m arket for that type of 
commercial real estate), unless the borrower has substantial equity at risk . “Substantial

Banks/BHC/T&L Credit Risk – Internal Ratings-Based Approach 
September 2026 Chapter 5 – Page 8 
Unclassified / Non classifié 
equity at risk ” means that at least 25% of the real estate’s appraised as -completed value 
has been contributed by the borrower, as defined in Chapter 4, section 4.1.10 and 4.1.13.   
...
20. This asset class covers all exposures to counterparties treated as sovereigns under the 
...
21. This asset class covers all exposures to counterparties treated as public sector entities 
(PSEs) under the standardized approach as defined in section 4.1.2. 
 (iv) Definition of bank exposures 
22. This asset class covers exposures to banks outlined in s ection 4.1.4, securities firms and 
...
23. This asset class also includes exposures to the entities listed in paragraph 22 that are in the 
...
a. do not fall within the scope of equity exposures as defined in paragraph 29;  
b. are not deducted from regulatory capital or risk- weighted at 250% according to Chapter 
2
3; and  
c. are not risk weighted at 1250% according to Chapter 4.  
[Basel Framework, CRE 30.18] 
 
 
3  For investments in the capital and/or Other TLAC Instruments of banking, financial, or insurance entities, 
institutions should also refer to section 2.3 of Chapter 2 of this guideline and apply the applicable regulatory 
adjustment.

Banks/BHC/T&L Credit Risk – Internal Ratings-Based Approach 
September 2026 Chapter 5 – Page 9 
Unclassified / Non classifié 
(v) Definition of regulatory retail exposures 
24. A retail exposure is categori zed as a regulatory retail exposure if it meets all of the six 
following criteria related to the nature of the borrowers and the size of the pool of exposures, 
otherwise the exposure is categorized as a non-regulatory r etail exposure, and is subject to the 
Corporate SME risk-weight function: 
Nature of borrower or low value of individual exposures 
a. Exposures to individuals – such as revolving credits and lines of credit (e.g. credit cards, 
...
4 (including first and subsequent liens, term loans and revolving 
home equity lines of credit) are eligible for retail treatment regardless of exposure size so 
long as: 
i. the credit is secured by a one-to-four unit residence as set out in Chapter 4, 
section 4.1.10; 
ii. the residence is or will be occupied by the borrower, or is rented, and 
iii. is extended to: 
• an individual, or  
• a condominium association, cooperative, or similar body with the purpose of 
granting its members the use of a primary residence in the property securing 
the loan. 
c. Loans extended to small businesses and managed as retail exposures are eligible for retail 
treatment provided the total exposure of the banking group to a small business borrower (on 
a consolidated basis where applicable) is less than $1.5 million.
5 Small business loans 
extended through or guaranteed by an individual are subject to the same exposure threshold.   
d. The maximum aggregated retail exposure to one counterpart y cannot exceed an absolute 
threshold of $1.5 million. Aggregated exposures means the gross amount of all forms of 
retail exposures, excluding residential real estate exposures. The gross amount (before any 
credit risk mitigation) would include the credit e quivalent amount (after applying the 
...
e. The exposure must be one of a large pool of exposures, which are managed by the institution 
on a pooled basis.  
 
4      Loans that meet the conditions set out in section 4.1.10 (footnote 39) of Chapter 4 are also eligible to be 
included in the IRB retail residential mortgage subclass. 
5      As stated in footnote 6 in Chapter 1 of this guideline, all dollar values in this guideline are in Canadian dollars, 
unless otherwise noted.

Banks/BHC/T&L Credit Risk – Internal Ratings-Based Approach 
September 2026 Chapter 5 – Page 10 
Unclassified / Non classifié 
f. Small business exposures below $1.5 million may be treated as retail exposures if the 
...
exposure be originated in a similar manner to regulatory retail exposures. Furthermore, it 
must not be managed individually in a way comparable to corporate exposures, but rather 
as part of a portfolio segment or pool of exposures with similar risk characteristics for 
purposes of risk assessment and quantification. However, this does not preclude regulatory 
retail exposures from being treated individually at some stages of the risk management 
process. The fact that an exposure is rated individually does not by itself deny the 
eligibility as a regulatory retail exposure. 
[Basel Framework, CRE 30.19 to 30.22] 
25. Within the regulatory retail asset class category, institutions are required to identify 
separately three sub-classes of exposures:  
a. residential mortgage loans as defined above,  
b. qualifying revolving retail exposures, as defined in paragraph 26, and 
c. all other regulatory retail exposures.    
[Basel Framework, CRE 30.23] 
(vi) Definition of qualifying revolving retail exposures 
26. All of the following criteria must be satisfied for a sub-portfolio to be treated as a 
...
c. The maximum exposure to a single individual in the sub-portfolio is $150,000 or less. 
d. Because the asset correlation assumptions for the QRRE risk -weight function are 
markedly below those for all other regulatory retail risk-weight function at low PD values, 
...
Banks/BHC/T&L Credit Risk – Internal Ratings-Based Approach 
September 2026 Chapter 5 – Page 11 
Unclassified / Non classifié 
f. OSFI must concur that treatment as a qualifying revolving retail exposure is consistent 
with the underlying risk characteristics of the sub-portfolio. 
[Basel Framework, CRE 30.24]  
27. The QRRE sub-class is split into exposures to transactors and revolvers. A QRRE 
...
months. All QRRE exposures that are not transactors are revolvers.
6 
[Basel Framework, CRE 30.25] 
28. In cases where an institution is unable to ensure compliance with the retail thresholds (for 
both QRR in paragraph 26 and total aggregate exposures in paragraph 24), they must be able to, 
...
29. This asset class covers exposures to equities as defined in section 4.1.8.   
[Basel Framework, CRE 30.26] 
 
(viii) Definition of eligible purchased receivables  
30. Eligible purchased receivables are divided into retail and corporate receivables as defined 
below.  [Basel Framework, CRE 30.27] 
Retail receivables 
31. Purchased retail receivables, provided the purchasing institution complies with the IRB 
...
32. In general, for purchased corporate receivables, institutions are expected to assess the 
default risk of individual obligors as specified in s ections 5.3.1 and 5.3.2 consistent with the 
...
6  New accounts will be deemed revolvers until the account has been open for at least 12 months and the 
definition of a transactor is satisfied.

Banks/BHC/T&L Credit Risk – Internal Ratings-Based Approach 
September 2026 Chapter 5 – Page 12 
Unclassified / Non classifié 
use of the top-down purchased receivables treatment is limited to situations where it would be an 
...
33. OSFI may deny the use of the top- down approach for purchased corporate receivables 
...
conditions: 
a. The receivables are purchased from unrelated, third party sellers, and as such the institution 
has not originated the receivables either directly or indirectly.  
b. The receivables must be generated on an arm’s -length basis between the seller and the 
obligor. (As such, intercompany accounts receivable and receivables subject to contra -
accounts between firms that buy and sell to each other are ineligible.)
7  
c. The purchasing institution has a claim on all proceeds from the pool of receivables or a 
pro-rata interest in the proceeds.
8 
d. If any single receivable or group of receivables guaranteed by the same seller or made to 
...
34. The existence of full or partial recourse to the seller does not automatically disqualify an 
...
35. Commitments are defined as arrangements  offered by the institution  and accepted by the 
client that obligate an institution, at a client's request, to:  
a. Extend credit in the form of loans or participations in loans, lease financing receivables, 
mortgages (including the undrawn portion of HELOCs), overdrafts;  
b. Purchase loans, securities, or other assets; or 
c. Issue credit substitutes such as letters of credit and guarantees. 
...
Banks/BHC/T&L Credit Risk – Internal Ratings-Based Approach 
September 2026 Chapter 5 – Page 13 
Unclassified / Non classifié 
This includes arrangements that can be: 
a. unconditionally cancelled by the institution at any time without prior notice to the 
obligor  
b. cancelled by the institution if the obligor fails to meet conditions set out in the facility 
documentation, including conditions that must be met by the obligor or third party 
(conditions precedent) prior to any initial or subsequent drawdown under the 
arrangement. 
...
36. For each of the asset classes covered under the IRB framework, there are three key 
elements: 
a. Risk components ─ estimates of risk parameters provided by institutions some of which 
are supervisory estimates. 
b. Risk-weight functions ─ the means by which risk components are transformed into risk-
weighted assets and therefore capital requirements. 
c. Minimum requirements ─ the minimum standards that must be met in order for an 
institution to use the IRB approach for a given asset class.  
[Basel Framework, CRE 30.32] 
37. For certain asset classes, two broad approaches are available: a foundation and an advanced 
...
38. For exposures to equities, as defined in paragraph 29, the IRB approaches are not permitted 
(see paragraph 48). In addition, the AIRB approach cannot be used for the following: 
a. Exposures to general corporates (i.e. exposures to corporates that are not classified as 
specialized lending) belonging to a group with total consolidated annual revenues greater 
than $750 million.

Banks/BHC/T&L Credit Risk – Internal Ratings-Based Approach 
September 2026 Chapter 5 – Page 14 
Unclassified / Non classifié 
b. Exposures in the bank asset class as defined in paragraph 23, and other securities firms and 
...
correlation parameter multiplier applies as referenced in paragraph 67.
9 
[Basel Framework, CRE 30.34] 
39. In making the assessment for the revenue threshold in paragraph a, the amounts must be as 
reported in the audited financial statements of the corporates or, for corporates that are part of 
consolidated groups, their consolidated groups (according to the accounting standard applicable to 
the ultimate parent of the consolidated group). The figures must be based either (i) on the average 
amounts calculated over the prior three years, or (ii) on the latest amounts available to the 
...
data of corporate borrowers on an ongoing basis, even if only the latest amount is used for purposes 
of comparing against the threshold amount. 
[Basel Framework, CRE 30.35] 
 
40. Apart from the asset classes listed in paragraph 38, the FIRB approach may only be applied 
...
41. Under the foundation approach, institutions must provide their own estimates of PD 
...
42. Under the advanced approach, institutions must calculate the effective maturity (M)
10 and 
provide their own estimates of PD, LGD and EAD.   
[Basel Framework, CRE 30.37] 
 
43. There is an exception to this general rule (specified in paragraphs 41 and 42) for the five 
sub-classes of assets identified as SL.  
[Basel Framework, CRE 30.38] 
 
9    Exposures to sovereigns and public sector entities are not excluded from the advanced IRB approach 
(seeparagraphs 20 and 21). 
10  At the discretion of the host regulator, certain domestic exposures in a foreign jurisdiction may be exempt from 
the calculation of M (see paragraph 131).

Banks/BHC/T&L Credit Risk – Internal Ratings-Based Approach 
September 2026 Chapter 5 – Page 15 
Unclassified / Non classifié 
The SL categories: PF, OF, CF, IPRE, and HVCRE 
44. Institutions that do not meet the requirements for the estimation of PD under the corporate 
foundation approach for their SL exposures are required to map their internal risk grades to five 
supervisory categories, each of which is associated with a specifi c risk weight. This approach is 
termed the ‘supervisory slotting criteria approach’. [Basel Framework, CRE 30.39] 
 
45. Institutions that meet the requirements for the estimation of PD are able to use the 
foundation approach to corporate exposures to derive risk weights for all classes of SL exposures 
except HVCRE. With the exception of exposures in specified in paragraph 1, there are no HVCRE 
exposures in Canada. However at the discretion of host regulators, institutions meeting the 
requirements for HVCRE exposures in foreign jurisdictions may be able to use a foundation 
approach that is similar in all respects to the corpo rate approach, with the exception of a separate 
risk-weight function as described in paragraph 75.  
[Basel Framework, CRE 30.40] 
 
46. Institutions that meet the requirements for the estimation of PD, LGD and EAD are 
permitted to use the advanced approach to corporate exposures to derive risk weights for all classes 
of SL exposures except HVCRE. With the exception of exposures in specifie d in paragraph 1, 
...
with the exception of a separate risk -weight function as described in paragraph 75.  [Basel 
Framework, CRE 30.41] 
 
(ii) Retail exposures 
47. For retail exposures, institutions must provide their own estimates of PD, LGD and EAD. 
There is no foundation approach for this asset class.  
[Basel Framework, CRE 30.42] 
 
(iii) Equity exposures 
48. The treatment of equity exposures is set out in Chapter 2 and section 4.1.8 of this guideline, 
...
a. Institutions using an IRB approach must calculate the IRB risk components (i.e. PD of the 
...
respect of which the standardized approach must be used as required by paragraph 38). 
b. Institutions using an IRB approach may use the standardized approach for credit risk when 
applying risk weights to the underlying components of funds if they are permitted to do so

Banks/BHC/T&L Credit Risk – Internal Ratings-Based Approach 
September 2026 Chapter 5 – Page 16 
Unclassified / Non classifié 
...
in paragraph 49 must be used. 
c. Institutions may rely on third-party calculations for determining the risk weights associated 
...
themselves. In this case, the third party must use the methods set out in paragraph 49, with 
...
49. In cases when the IRB calculation is not feasible (paragraph 48 b above), a third party is 
performing the calculation of risk weights (paragraph 48 above) or when the institution is using 
...
a. for securitization exposures, the Securitization External Ratings -Based Approach (SEC -
ERBA) set out in section 6.6.2 of this guideline or the Securitization Standardized 
Approach (SEC-SA) set out in section 6.6.4 of this guideline if the institution is not able to 
use the SEC -ERBA; or a 1250% risk weight where the specified requirements for using 
the SEC-ERBA or SEC-SA are not met; and 
b. the Standardized Approach as described in chapter 4 of this guideline for all other 
exposures. 
[Basel Framework, CRE 60.20] 
 
(iv) Eligible purchased receivables
 
50. The treatment of eligible purchased receivables potentially straddles two asset classes. For 
eligible corporate receivables, both a foundation and advanced approach are available subject to 
certain operational requirements being met. As noted in paragraph 32, for corporate purchased 
...
according to paragraphs 38 and 39. Otherwise, the FIRB treatment for purchased corporate 
...
51. Exposures to asset -backed securities that are tranched are treated as securitization 
...
Banks/BHC/T&L Credit Risk – Internal Ratings-Based Approach 
September 2026 Chapter 5 – Page 17 
Unclassified / Non classifié 
...
52. Once an institution adopts an IRB approach for part of its holdings within an asset class, it 
is expected to extend it across all holdings within that asset class. In this context, the relevant asset 
classes are as follows: 
a. Sovereigns 
b. Public Sector Entities 
c. Banks 
d. Corporates (excluding specialized lending and purchased receivables) 
e. Specialized lending 
f. Corporate purchased receivables 
g. QRRE 
h. Retail residential mortgages 
i. All other regulatory retail (excluding purchased receivables) 
j. Retail purchased receivables 
[Basel Framework, CRE 30.45]
 
53. OSFI recognizes that for many institutions it may not be practicable for various reasons to 
...
54. As such, OSFI may allow institutions to adopt a phased rollout of the IRB approach across 
...
approach for an asset class within a part icular business unit (or in the case of retail exposures for 
...
55. If an institution intends to adopt an IRB approach for an asset class, it  must produce an 
...
approaches, and not motivated by a desire to adopt an approach that minimizes its capital charge.

Banks/BHC/T&L Credit Risk – Internal Ratings-Based Approach 
September 2026 Chapter 5 – Page 18 
Unclassified / Non classifié 
...
56. Some exposures that are immaterial in terms of size and perceived risk profile may be 
exempt from the requirements paragraphs 54 and 55, subject to supervisory approval. Capital 
...
57. Institutions adopting an IRB approach for an asset class are expected to continue to employ 
an IRB approach for that asset class. A voluntary return to the standardized or foundation approach 
is permitted only in extraordinary circumstances, such as divest iture of a large fraction of the 
institution’s credit-related business, and must be approved by OSFI.   
[Basel Framework, CRE 30.50] 
 
58. Given the data limitations associated with SL exposures, an institution may remain on the 
...
59. Irrespective of the materiality, exposures to central counterparties arising from over -the-
...
60. Institutions adopting the IRB approaches are required to calculate their capital 
...
61. Section 5.3 presents the calculation of risk-weighted assets under the IRB approach for i) 
...
62. Regarding the risk-weight functions for deriving risk weighted assets set out in section 5.3:

Banks/BHC/T&L Credit Risk – Internal Ratings-Based Approach 
September 2026 Chapter 5 – Page 19 
Unclassified / Non classifié 
a. Probability of default (PD) and loss-given-default (LGD) are measured as decimals. 
b. Exposure at default (EAD) is measured as currency (e.g. CAD), except where explicitly 
noted otherwise. 
c. ln denotes the natural logarithm and e the base of the natural logarithm. 
d. N(x) denotes the cumulative distribution function for a standard normal random variable 
(i.e. the probability that a normal random variable with mean zero and variance of one is 
less than or equal to x). The normal cumulative distribution function is, for example, 
available in Excel as the function NORMSDIST. 
e. G(z) denotes the inverse cumulative distribution function for a standard normal random 
variable (i.e. the value of x such that N(x) = z). The inverse of the normal cumulative 
distribution function is, for example, available in Excel as the function NORMSINV. 
[Basel Framework, CRE 31.2]
 
Risk-weighted assets for all exposures that are in default 
63. The capital requirement (K) for a defaulted exposure under the AIRB approach is equal to 
the greater of zero and the difference between its LGD (described in paragraph 282) and the 
institution’s best estimate of expected loss (described in paragraph 285). For exposures under the 
FIRB approach, the capital requirement for a defaulted exposure is equal to 0. The risk -weighted 
asset amount for the defaulted exposure is the product of K, 12.5, and the EAD.  [Basel Framework, 
CRE 31.3] 
...
64. The derivation of risk- weighted assets is dependent on estimates of the PD, LGD, EAD 
and, in some cases, effective maturity (M), for a given exposure.  [Basel Framework, CRE 31.4] 
 
65. For exposures not in default, the formula for calculating risk-weighted assets is: 
Correlation (R) = 0.12 ∙
1−𝑒𝑒−50∙𝑃𝑃𝑃𝑃
1−𝑒𝑒−50 + 0.24 ∙ �1 −
1−𝑒𝑒−50∙𝑃𝑃𝑃𝑃
1−𝑒𝑒−50 � 
Maturity adjustment (b) = [0.11852 − 0.05478 ∙ ln(𝑃𝑃𝑃𝑃)]2 
Capital requirement11 (K) = �𝐿𝐿𝐿𝐿𝑃𝑃 ∙ 𝑁𝑁 �
𝐺𝐺(𝑃𝑃𝑃𝑃)
�(1−𝑅𝑅)  + � 𝑅𝑅
1−𝑅𝑅 ∙  𝐿𝐿 (0 . 999)� −  𝑃𝑃𝑃𝑃 ∙ 𝐿𝐿𝐿𝐿𝑃𝑃� ×
(1 + (𝑀𝑀 − 2.5)∙ 𝑏𝑏)
1−1.5∙ 𝑏𝑏   
Risk-weighted assets (RWA) = 𝐾𝐾 ∙ 12.5 ∙ 𝐸𝐸𝐸𝐸𝑃𝑃 
I
llustrative risk weights are shown in Appendix 5-1. 
 
11  If this calculation results in a negative capital charge for any individual sovereign exposure, institutions should 
apply a zero capital charge for that exposure.

Banks/BHC/T&L Credit Risk – Internal Ratings-Based Approach 
September 2026 Chapter 5 – Page 20 
Unclassified / Non classifié 
[Basel Framework, CRE 31.5] 
66. The M used in the calculation of K in paragraph 65 is the effective maturity, calculated 
...
Full maturity adjustment = (1 + (𝑀𝑀 − 2.5) ∙ 𝑏𝑏)
(1 − 1.5 ∙ 𝑏𝑏)�  
[Basel Framework, CRE 31.6] 
67. A multiplier of 1.25 is applied to the correlation parameter of all exposures to financial  
institutions meeting the following criteria: 
a. Regulated financial institutions whose total assets are greater than or equal to $150 billion. 
The most recent audited financial statement of the parent company and consolidated 
...
substantial legal entity in the consolidated group
12 is supervised by a regulator that imposes 
prudential requirements consistent with international norms. These include, but are not 
limited to, prudentially regulated Insurance Companies, Broker/Dealers, Banks, Thrifts 
and Futures Commission Merchants; 
b. Unregulated financial institutions, regardless of size. Unregulated financial institutions are, 
for the purposes of this paragraph, legal entities whose main business includes: the 
management of financial assets, lending, factoring, leasing, provision of c redit 
...
68. Under the IRB approach for corporate credits, institutions will be permitted to separately 
distinguish exposures to SME borrowers (defined as corporate exposures where the reported sales 
for the consolidated group of which the firm is a part is less than $75 million) from those to large 
firms. A firm-size adjustment (i.e. 0.04 x (1- (S - 7.5)/67.5)) is made to the corporate risk weight 
formula for exposures to SME borrowers. S is expressed as total annual sales in millions of dollars 
with values of S falling in the range of equal to or less than $75 million or greater than or equal to 
$7.5 million. Reported sales of less than $7.5 million will be treated as if they were equivalent to 
$7.5 million for the purposes of the firm-size adjustment for SME borrowers.  
 
12 The term “consolidated group” is defined in paragraph 39 above.

Banks/BHC/T&L Credit Risk – Internal Ratings-Based Approach 
September 2026 Chapter 5 – Page 21 
Unclassified / Non classifié 
Correlation (R) = 0.12 ∙
�1 − 𝑒𝑒(−50 ∙ 𝑃𝑃𝑃𝑃)�
�1 − 𝑒𝑒(−50)� +   0.24 ∙ �1 −
...
69. Annual sales, rather than total assets, are to be used to measure borrower size, unless in 
limited circumstances an institution can demonstrate that it would be more appropriate to use the 
total assets of the borrower. OSFI is willing to consider limited r ecognition for classes of entities 
...
in the risk weight for SMEs  is achieved when borrower size is $ 7.5 million. For borrower sizes 
below $7.5 million, borrower size is set equal to $7.5 million. The adjustment shrinks to zero as 
borrower size approaches $75 million. Additionally, the Corporate SME RWA formula must be 
used with $7.5 million for the annual sales amount for exposures to individuals for non-regulatory 
retail exposures.   [Basel Framework, CRE 31.9] 
(iii) Risk weights for specialized lending  
Risk weights for PF, OF, CF, and IPRE 
70. Institutions that meet the requirements for the estimation of PD will be able to use the FIRB 
approach for the corporate asset class to derive risk weights for SL sub-classes.  
[Basel Framework, CRE 31.10] 
 
71. Institutions that meet the requirements for the estimation of PD and LGD and EAD (where 
relevant) will be able to use the AIRB approach for the corporate asset class to derive risk weights 
for SL sub-classes.   
[Basel Framework, CRE 31.10] 
72. Institutions that do not meet the requirements for the estimation of PD under the IRB 
approach for corporate exposures must follow the supervisory slotting approach outlined in section 
5.5.1.  
[Basel Framework, CRE 31.10] 
Risk weights for HVCRE 
73. For Canadian exposures, the HVCRE category only applies to loans financing ADC 
...
74. However, the HVCRE risk weights may apply more broadly to loans made by Canadian 
...
Banks/BHC/T&L Credit Risk – Internal Ratings-Based Approach 
September 2026 Chapter 5 – Page 22 
Unclassified / Non classifié 
75. Institutions will use the same formula for the derivation of HVCRE risk weights that is 
...
76. Institutions that do not meet the requirements for estimation of LGD and EAD for HVCRE 
...
77. There are four separate risk-weight functions for retail exposures, as defined in paragraphs 
78 to 82. Risk weights for retail exposures are based on separate assessments of PD and LGD as 
inputs to the risk-weight functions. None of the three non-regulatory retail risk-weight functions 
contain the explicit maturity adjustment component that is present in the risk weight function for 
exposures to banks, sovereigns, PSEs and corporates. Illustrative risk weights are shown in 
Appendix 5-1.  [Basel Framework, CRE 31.13] 
(i) Residential mortgage exposures 
78. For exposures defined in paragraph 24 that are not in default and are secured or partly 
secured
13 by residential mortgages, risk weights will be assigned based on the following formula: 
Correlation (R)  = 0. 15 where repayment is not materially dependent on cash flows 
generated by the property;14 or 
  = 0.22 where one or more of the following applies and with the 
exception noted below: 
a. repayment is materially dependent on cash flows generated by the property15;  
b. OSFI’s expectations related to Guideline B-2016 are not met;  
c. the mortgage is a variable rate fixed-payment residential mortgage with an LTV above 
65% for which the payments are insufficient to cover the interest component of the 
mortgage for three or more consecutive months due to increases in interest rates.  
...
13 This means that risk weights for residential mortgages also apply to the unsecured portion of such residential 
mortgages. 
14  As defined in Section 4.1.11 of Chapter 4 of this guideline. 
15  As defined in Section 4.1.11 of Chapter 4 of this guideline 
16  Guideline B-20: Residential Mortgage Underwriting Practices and Procedures

Banks/BHC/T&L Credit Risk – Internal Ratings-Based Approach 
September 2026 Chapter 5 – Page 23 
Unclassified / Non classifié 
...
Capital requirement (K)  = �𝐿𝐿𝐿𝐿𝑃𝑃 ∙  𝑁𝑁 �
𝐺𝐺(𝑃𝑃𝑃𝑃)
�(1 − 𝑅𝑅) + ��
𝑅𝑅
1 − 𝑅𝑅� ∙ 𝐿𝐿(0.999)� − 𝑃𝑃𝑃𝑃 ∙ 𝐿𝐿𝐿𝐿𝑃𝑃� 
...
79. For qualifying revolving retail exposures as defined in paragraph 26 that are not in default, 
...
80. For all other regulatory retail exposures that are not in default, risk weights are assigned 
...
1 − 𝑅𝑅� ∙ 𝐿𝐿(0.999 )� − 𝑃𝑃𝑃𝑃 ∙ 𝐿𝐿𝐿𝐿𝑃𝑃�  
Risk-weighted assets = K x 12.5 x EAD 
(i) [Basel Framework, CRE 31.16]Non-regulatory retail 
81. Retail exposures which fail to meet any of the six criteria related to the nature of the 
borrowers and the size of the pool of exposures in paragraph 25 are categorized as non-regulatory 
retail. They are subject to the Corporate SME risk-weight function. 
5.4. IRB risk components 
82. Section 5.4 presents the calculation of the risk components (PD, LGD, EAD, M) that are 
used in the formulas set out in s ection 5.3. In calculating these components, the legal certainty

Banks/BHC/T&L Credit Risk – Internal Ratings-Based Approach 
September 2026 Chapter 5 – Page 24 
Unclassified / Non classifié 
...
to a default grade(s), consistent with the reference definition of defa ult, is 100%. The minimum 
requirements for the derivation of the PD estimates associated with each internal borrower grade 
are outlined in paragraphs 275 to 277.  [Basel Framework, CRE 32.3] 
 
85. The PD floor for exposures to U.S. GSEs in conservatorship or receivership is 0.03%. For 
all other exposures except those in the sovereign asset class (including PSEs treated as sovereigns 
as defined in paragraph 20), the PD for each exposure that is used as input into the risk weight 
formula and the calculation of expected loss must not be less than 0.05%.  
...
and an advanced approach. As noted in paragraph 38, the advanced approach is not permitted for 
exposures to certain entities.  [Basel Framework, CRE 32.5] 
LGD under the foundation approach: treatment of unsecured claims and non-recognized 
collateral 
...
corporate asset class) that are not secured by recognized collat eral will be assigned a 45% LGD. 
...
Banks/BHC/T&L Credit Risk – Internal Ratings-Based Approach 
September 2026 Chapter 5 – Page 25 
Unclassified / Non classifié 
...
collateral, are also recognized. These include receivables, specified commerci al and residential 
...
91. The simple approach to collateral presented in s ection 4.3.3 (ii)  is not available to 
...
the exposure weighted average of the LGD applicable to the unsecured part of an exposure (LGD
U) 
...
otherwise specified; 
LGD
U is that applicable for an unsecured exposure, as set out in paragraphs 87 and 88; 
LGDS is the LGD applicable to exposures secured by the type of collateral used in the 
transaction, as specified in paragraph 93; 
𝐿𝐿𝐿𝐿𝑃𝑃′  =  𝐿𝐿𝐿𝐿𝑃𝑃𝑈𝑈 x 𝐸𝐸𝑈𝑈
𝐸𝐸 ∙ (1 + 𝐻𝐻𝐸𝐸) + 𝐿𝐿𝐿𝐿𝑃𝑃𝑆𝑆 x 𝐸𝐸𝑆𝑆
𝐸𝐸 ∙ (1 + 𝐻𝐻𝐸𝐸) 
...
Banks/BHC/T&L Credit Risk – Internal Ratings-Based Approach 
September 2026 Chapter 5 – Page 26 
Unclassified / Non classifié 
Eligible financial 
collateral 
...
institution; and (ii) the counterparty credit risk arising fr om the risk that the borrower of the 
...
after each step of recogni zing one individual type of collateral, the remaining value of the 
unsecured exposure (E
U) will be reduced by the adjusted value of the collateral (ES) recognized in 
...
a. LGDSi is the LGD applicable to that form of collateral (as specified in paragraph 93). 
b. ESi is the current value of the collateral received after the application of the haircut applicable 
for the type of collateral (Hc) (as specified in paragraph 93). 
 
17  This includes exposures to covered bonds as defined in section 4.1.5 of chapter 4.

Banks/BHC/T&L Credit Risk – Internal Ratings-Based Approach 
September 2026 Chapter 5 – Page 27 
Unclassified / Non classifié 
𝐿𝐿𝐿𝐿𝑃𝑃∗ = 𝐿𝐿𝐿𝐿𝑃𝑃𝑈𝑈 ∙ 𝐸𝐸𝑈𝑈
𝐸𝐸 ∙ (1 + 𝐻𝐻𝐸𝐸) + � 𝐿𝐿𝐿𝐿𝑃𝑃𝑆𝑆𝑆𝑆 ∙ 𝐸𝐸𝑆𝑆𝑆𝑆
𝐸𝐸 ∗ (1 + 𝐻𝐻𝐸𝐸)
𝑆𝑆
...
set out in paragraph 32 ), institutions may use their own internal estimates of LGD for corporate, 
PSE and sovereign exposures. LGD must be measured as the loss given default as a percentage of 
the EAD. Institutions eligible for the IRB approach that are unable to meet these addi tional 
...
Corporate and 
PSE 
0% for U.S. GSEs in conservatorship or 
receivership and 25% otherwise 
...
99. The LGD floors for secured exposures in the table above apply when the exposure is fully 
...
a. LGD
U floor  and LGD S floor  are the floor values for fully unsecured and fully secured 
exposures respectively, as specified in the table in paragraph 98. 
b. The other terms are defined as set out in paragraphs 92 and 93. 
𝐹𝐹𝐹𝐹𝐹𝐹𝐹𝐹𝐹𝐹 = 𝐿𝐿𝐿𝐿𝑃𝑃𝑈𝑈𝑈𝑈𝑈𝑈𝑈𝑈𝑈𝑈𝑈𝑈 ∙ 𝐸𝐸𝑈𝑈
𝐸𝐸 ∙ (1 + 𝐻𝐻𝐸𝐸) + 𝐿𝐿𝐿𝐿𝑃𝑃𝑆𝑆𝑈𝑈 𝑈𝑈𝑈𝑈𝑈𝑈𝑈𝑈 ∙ 𝐸𝐸𝑆𝑆
𝐸𝐸 ∙ (1 + 𝐻𝐻𝐸𝐸)

Banks/BHC/T&L Credit Risk – Internal Ratings-Based Approach 
September 2026 Chapter 5 – Page 28 
Unclassified / Non classifié 
...
not be able to model the effects of the collateral (i.e. it may n ot have enough data to model the 
effect of the collateral on recoveries). In such cases, the institution is permitted to apply the formula 
set out in paragraph 92 or 96, with the exception that the LGD
U term would be the institution’s 
own internal estimate of the unsecured LGD. To adopt this treatment the collateral must be eligible 
under the F -IRB and the institution’s estimate of LGD
U must not take account of any effects of 
collateral recoveries. [Basel Framework, CRE 32.18] 
 
101. The minimum requirements for the derivation of LGD estimates are outlined in s ection 
...
amount (E`) used to calculate counterparty credit risk. I n both cases, in addition to counterparty 
...
supervisory values of LGD, and an advanced approach for those instit utions using their own 
...
Consistent with the standardized approach, institutions may choose not to recogni ze credit 
...
Banks/BHC/T&L Credit Risk – Internal Ratings-Based Approach 
September 2026 Chapter 5 – Page 29 
Unclassified / Non classifié 
except that companies that are internally rated may also be recogni zed under the foundation 
approach. To receive recognition, the requirements outlined in s ection 4.3.5 must be met. [Basel 
Framework, CRE 32.23] 
...
i. the risk-weight function appropriate to the type of guarantor, and  
ii. the PD appropriate to the guarantor’s borrower grade.  
b. The institution may replace the LGD of the underlying transaction with the LGD applicable 
to the guarantee taking into account seniority and any collateralization of a guaranteed 
commitment. For example, when an institution has a subordinated claim on the borrower 
but the guarantee represents a senior claim on the guarantor this may be reflected by using 
an LGD applicable for senior exposures (see paragraph 87) instead of an LGD applicable 
for subordinated exposures. 
c. In case the institution applies the standardized approach to direct exposures to the guarantor 
it may only recognize the guarantee by applying the standardized approach to the covered 
portion of the exposure. [Basel Framework, CRE 32.24]
...
107. The uncovered portion of the exposure is assigned the risk weight associated with the 
...
Banks/BHC/T&L Credit Risk – Internal Ratings-Based Approach 
September 2026 Chapter 5 – Page 30 
Unclassified / Non classifié 
...
applies the standardized approach to direct exposures to the guarantor it may only recogni ze the 
...
it may only recogni ze the guarantee by determining the risk weight for the comparable direct 
...
satisfied.
18 For exposures for which an institution has permission to use its own estimates of LGD, 
the institution may recogni ze the risk mitigating effects of first- to-default credit derivatives, but 
...
a. All exposures are measured gross of specific allowances19 
b. The EAD on drawn amounts should not be less than the sum of: 
 
18  When credit derivatives do not cover the restructuring of the underlying obligation, the partial recognition set 
out in paragraph 277 of Chapter 4 applies. 
19  Under IFRS 9, Stage 3 allowances and partial write-offs are considered to be specific allowances, while Stage 1 
and Stage 2 allowances are considered to be general allowances.

Banks/BHC/T&L Credit Risk – Internal Ratings-Based Approach 
September 2026 Chapter 5 – Page 31 
Unclassified / Non classifié 
i. the amount by which an institution’s regulatory capital would be reduced if the 
exposure were written-off fully, and  
ii. any specific allowances.  
c. When the difference between the instrument’s EAD and the sum of (i) and (ii) is positive, 
this amount is termed a discount. The calculation of risk-weighted assets is independent of 
any discounts. 
d. Under the limited circumstances described in section 5.7.2, discounts may be included in 
the measurement of total eligible allowances for purposes of the EL -provision calculation 
set out in section 5.7. 
[Basel Framework, CRE 32.29] 
Exposure measurement for on-balance sheet items 
115. On-balance sheet netting of loans and deposits will be recogni zed subject to the same 
conditions as under the standardized approach (see s ection 4.3.4). Where currency or maturity 
...
approaches, commitments are defined in paragraph 35. [Basel Framework, CRE 32.32] 
...
Banks/BHC/T&L Credit Risk – Internal Ratings-Based Approach 
September 2026 Chapter 5 – Page 32 
Unclassified / Non classifié 
...
paragraph 37) to use their own internal estimates of EAD for undrawn revolving commitments 20 
...
CRE 32.37] 
124. For securities financing transactions (SFTs), institutions may recognize a reduction in the 
counterparty credit risk requirement arising from the effect of a master netting agreement 
providing that it satisfies the criteria set out in s ection 4.3.3 iii (e). The institution must calculate 
E`, which is the exposure to be used for the counterparty credit risk requirement taking account of 
the risk mitigation of collateral received, using the formula set out in s ection 4.3.3 iii (e). In 
...
holds for the underlying securities being different and unrelated to securit izations. The master 
netting agreement must satisfy the criteria set out in section 4.3.3 iii (e). The VaR models approach 
 
20  A revolving loan facility is one that lets a borrower obtain a loan where the borrower has the flexibility to 
decide how often to withdraw from the loan and at what time intervals. A revolving facility allows the borrower 
to drawdown, repay and re-draw loans advanced to it. Facilities that allow prepayments and subsequent redraws 
of those prepayments are considered as revolving.

Banks/BHC/T&L Credit Risk – Internal Ratings-Based Approach 
September 2026 Chapter 5 – Page 33 
Unclassified / Non classifié 
...
can separately apply for supervisory recognition to use the ir internal value-at-risk (VaR) models 
...
day’s VaR number: 
E`  = 
 𝑚𝑚𝑚𝑚𝑚𝑚 {0, [(∑𝐸𝐸 −  ∑𝐶𝐶) +  𝑉𝑉𝑚𝑚𝑉𝑉 𝐹𝐹𝑜𝑜𝑜𝑜𝑜𝑜𝑜𝑜𝑜𝑜 𝑓𝑓𝐹𝐹𝐹𝐹𝑚𝑚 𝑖𝑖𝑖𝑖𝑜𝑜𝑖𝑖𝐹𝐹𝑖𝑖𝑚𝑚𝐹𝐹 𝑚𝑚𝐹𝐹𝑚𝑚𝑖𝑖𝐹𝐹]} 
...
accordance with the Internal Models Method set out in the counterparty cre dit risk standards in 
Chapter 7. [Basel Framework, CRE 32.42] 
129. As in the standardized approach, for transactions where the conditions in section 4.3.3 ii 
...
any transaction that does not meet the requireme nts in s ection 4.3.3 ii (c) of the standardized 
...
group of which the firm is a part of are less than $750 million. The consolidated group must be a 
domestic company based in the foreign country where the exemption is applied to qualify for this

Banks/BHC/T&L Credit Risk – Internal Ratings-Based Approach 
September 2026 Chapter 5 – Page 34 
Unclassified / Non classifié 
exemption. If adopted by a foreign supervisor, all exposures to qualifying smaller domestic firms 
in that jurisdiction will be assumed to have an average maturity of 2.5 years. [Basel Framework, 
CRE 32.45] 
...
equals the maximum remaining time (in years) that the borrower is pe rmitted to take to fully 
...
137. The one-year floor does not apply to certain short -term exposures, comprising fully or 
nearly-fully collateralized
21 capital market-driven transactions (i.e. OTC derivatives transactions 
...
21 The intention is to include both parties of a transaction meeting these conditions where neither of the parties is 
systematically under-collateralized.

Banks/BHC/T&L Credit Risk – Internal Ratings-Based Approach 
September 2026 Chapter 5 – Page 35 
Unclassified / Non classifié 
138. The one -year floor, set out in paragraph 132, also does not apply to the following 
exposures: 
a. Short-term self -liquidating trade transactions. Import and export letters of credit and 
similar transactions should be accounted for at their actual remaining maturity. 
b. Issued as well as confirmed letters of credit that are: 
...
a. Repo-style transactions, interbank loans and deposits and other economically equivalent 
products with a maturity of under one-year that might not fall within the scope of paragraph 
137.  
b. Some short -term self -liquidating trade transactions that do not fall within the scope of 
...
c. Some exposures arising from settling securities purchases and sales. This also includes 
...
d. Some exposures arising from cash settlements by wire transfer, including overdrafts arising 
...
is set at 2.5 years unless otherwise specified in paragraph 130.  In addition, all non-regulatory retail 
exposures will be assigned a maturity of 2.5 years. [Basel Framework, CRE 32.55]

Banks/BHC/T&L Credit Risk – Internal Ratings-Based Approach 
September 2026 Chapter 5 – Page 36 
Unclassified / Non classifié 
...
a. the one-year PD associated with the internal borrower grade to which the pool of retail 
exposures is assigned; and 
b. 0.10% for revolver QRRE exposures (see paragraph 27 for the definition of revolvers) and 
0.05% for all other exposures.  
...
Banks/BHC/T&L Credit Risk – Internal Ratings-Based Approach 
September 2026 Chapter 5 – Page 37 
Unclassified / Non classifié 
...
a. the deductible portion is calculated as 10% of the original loan amount (i.e. the deductible 
portion grows as a percentage of the full amount of the total exposure as the mortgage 
amortizes), and is to be risk weighted according to paragraph 1.a; 
...
a. A loan to the private mortgage insurer with a Government of Canada backstop. In this case, 
the deductible exposure defined in paragraph 146 is treated as a guaranteed exposure. It 
can be risk weighted using either i) the PD of the private mortgage insurer (using the risk 
weight function described in paragraphs 65 to 67) or ii) the PD of the original mortgage 
borrower (and the risk weight function for residential mortgages in paragraph 78). In both 
cases, a LGD of 100% must be used. The backstop exposure is treated as an exposure to 
the Government of Canada. 
b. An uninsured residential mortgage using the original borrower’s PD and LGD. 
c. A loan to the private mortgage insurer (without a Government of Canada backstop) using 
either i) the PD of the original borrower and an LGD adjusted to incorporate the effect of 
the guarantee or ii) the PD of the private mortgage insurer and the LGD of the  original 
borrower. In both cases, the resulting RWA cannot be less than that of a comparable direct 
exposure to the private mortgage insurer (which is the risk weight determined using the 
private mortgage insurer’s PD and the LGD used for an unsecured fac ility to the private 
mortgage insurer). 
...
PD or LGD estimate, subject to the minimum requirements in pa ragraphs 300 to 315. Whether 
...
Banks/BHC/T&L Credit Risk – Internal Ratings-Based Approach 
September 2026 Chapter 5 – Page 38 
Unclassified / Non classifié 
...
provider. Consistent with the standardized approach, institutions may choose not to re cognize 
credit protection if doing so would result in a higher capital requirement.  [Basel Framework, CRE 
32.61] 
(iii) Exposure at default (EAD) 
151. Both on and off-balance sheet retail exposures are measured gross of specific allowances.22 
...
will be permitted subject to the same conditions outlined in s ection 4.3.4. Institutions must use 
their own estimates of CCFs for undrawn revolving commitments not subject to a CCF of 100% 
in the standardized approach (see s ection 4.1.18) and the minimum requirements in paragraphs 
...
b. 50% of the off balance sheet exposure using the applicable CCF in the standardized 
approach. 
...
22  Under IFRS 9, Stage 3 allowances and partial write-offs are considered to be specific allowances, while Stage 1 
and Stage 2 allowances are considered to be general allowances.

Banks/BHC/T&L Credit Risk – Internal Ratings-Based Approach 
September 2026 Chapter 5 – Page 39 
Unclassified / Non classifié 
...
estimation of PD under the corporate IRB approach will be required to map thei r internal grades 
...
2.5 years or OSFI determines that institutions’ underwriting and other risk char acteristics are

Banks/BHC/T&L Credit Risk – Internal Ratings-Based Approach 
September 2026 Chapter 5 – Page 40 
Unclassified / Non classifié 
...
161. The HVCRE risk weights in paragraphs 162 and 75 apply to Canadian institution foreign 
...
Banks/BHC/T&L Credit Risk – Internal Ratings-Based Approach 
September 2026 Chapter 5 – Page 41 
Unclassified / Non classifié 
...
risk-weighted assets for dilution risk is provided in s ection 5.6.2. The method of calculating 
...
(defined in paragraph 26 ), they should use the risk- weight function for all other regulatory retail 
...
for retail exposures but can utili ze external and internal reference data to estimate the PDs and 
...
Banks/BHC/T&L Credit Risk – Internal Ratings-Based Approach 
September 2026 Chapter 5 – Page 42 
Unclassified / Non classifié 
...
a. The purchasing institution will estimate the pool’s one-year EL for default risk, expressed 
...
b. Given the EL estimate for the pool’s default losses, the risk weight for default risk is 
determined by the risk-weight function for corporate exposures.
23 As described below, the 
precise calculation of risk weights for default risk depends on the institution’s ability to 
decompose EL into its PD and LGD components in a reliable manner. Institutions can 
...
corporate exposures (this excludes large corporate exposures, which are ineligible under 
...
a. If the purchasing institution is unable to decompose EL into its PD and LGD 
components in a reliable manner, the risk weight is determined from the corporate risk-
weight function using the following specifications: 
i.  If the institution can demonstrate that the exposures are exclusively senior claims 
to corporate borrowers: 
• An LGD of 40% can be used. 
• PD will be calculated by dividing the EL using this LGD. 
• EAD will be calculated as the outstanding amount minus the capital charge 
for dilution prior to credit risk mitigation (K
Dilution). 
...
minus K
Dilution.  
ii. If the institution cannot demonstrate that the exposures are exclusively senior 
claims to corporate borrowers: 
• PD is the institution’s estimate of EL 
 
23 The firm-size adjustment for SME, as defined in paragraph 68, will be the weighted average by individual 
...
Banks/BHC/T&L Credit Risk – Internal Ratings-Based Approach 
September 2026 Chapter 5 – Page 43 
Unclassified / Non classifié 
• LGD will be 100%. 
...
receivables purchased plus 40% of any undrawn purchase commitments 
minus KDilution.  
b. If the purchasing institution is able to estimate PD in a reliable manner, the risk weight 
is determined from the corporate risk-weight functions according to the specifications 
for LGD, M and the treatment of guarantees under the foundation approach as given in 
paragraphs 87 to 96, 102 to 108, and 130.  [Basel Framework, CRE 34.5] 
Advanced IRB treatment 
175. Under the AIRB approach, if the purchasing institution can estimate either the pool’s 
default-weighted average loss rates given default (as defined in paragraph 282) or average PD in 
...
average loss rate given default and must be consistent with the concepts defined in paragraph 282. 
...
treatment, EAD will be the amount outstanding minus K
Dilution. EAD for a revolving purchase 
facility will be the sum of the current amount of receivables purchased plus 40% of any undrawn 
purchase commitments minus K Dilution (thus, institutions using the AIRB approach will not be 
...
cash credits to the receivable’s obligor.
24 For both corporate and retail receivables, unless the 
 
24 Examples include offsets or allowances arising from returns of goods sold, disputes regarding product quality, 
...
Banks/BHC/T&L Credit Risk – Internal Ratings-Based Approach 
September 2026 Chapter 5 – Page 44 
Unclassified / Non classifié 
...
a. At the level of either the pool as a whole (top-down approach) or the individual receivables 
making up the pool (bottom-up approach), the purchasing institution will estimate the one-
year EL for dilution risk, also expressed in percentage of the receivable s amount. 
Institutions can utilize external and internal data to estimate EL. As with the treatments of 
default risk, this estimate must be computed on a stand -alone basis; that is, under the 
assumption of no recourse or other support from the seller or third-party guarantors.  
b. For the purpose of calculating risk weights for dilution risk, the corporate risk- weight 
function must be used with the following settings:  
i. The PD must be set equal to the estimated EL. 
ii. The LGD must be set at 100%. 
iii. An appropriate maturity treatment applies when determining the capital requirement 
for dilution risk. If an institution can demonstrate that the dilution risk is 
appropriately monitored and managed to be resolved within one year, the supervisor 
may allow the institution to apply a one-year maturity. 
...
recognize this refund able amount as first loss protection under the securitiz ation framework 
...
discounts for receivables do not affect eit her the EL -provision calculation in s ection 5.7 or the 
...
Banks/BHC/T&L Credit Risk – Internal Ratings-Based Approach 
September 2026 Chapter 5 – Page 45 
Unclassified / Non classifié 
...
a. If the guarantee covers both the pool’s default risk and dilution risk, the institution will 
...
b. If the guarantee covers only default risk or dilution risk, but not both, the institution will 
...
c. If a guarantee covers only a portion of the default and/or dilution risk, the uncovered 
...
allowances
25) and EL may be included in or must be deducted from regulatory capital, as outlined 
...
exposures) to obtain a total EL amount. The treatment of EL for securitiz ation exposures is 
...
in default, institutions must use their best estimate of expected los s as defined in paragraph 285 
...
25 Under IFRS 9, Stage 3 allowances and partial write-offs are considered to be specific allowances, while Stage 1 
and Stage 2 allowances are considered to be general allowances.

Banks/BHC/T&L Credit Risk – Internal Ratings-Based Approach 
September 2026 Chapter 5 – Page 46 
Unclassified / Non classifié 
...
the standardized approach should be attributed to the standardized trea tment. Similarly, general 
...
Banks/BHC/T&L Credit Risk – Internal Ratings-Based Approach 
September 2026 Chapter 5 – Page 47 
Unclassified / Non classifié 
...
j. Requirements for recognition of leasing, and 
...
195. The overarching principle behind these requirements is that rating and risk estimation 
...
Banks/BHC/T&L Credit Risk – Internal Ratings-Based Approach 
September 2026 Chapter 5 – Page 48 
Unclassified / Non classifié 
...
estimates of PD
26 and must adhere to the overall requirements for rating system design, operations, 
...
also meet the incremental minimum requirements for these risk factors included in paragraphs 282 
...
credit risk management practices must also be consistent with the e volving sound practices 
...
return to compliance, and seek approval from OSFI, or the institution m ust demonstrate that the 
...
201. Within each asset class, an institution may utiliz e multiple rating methodologies/systems. 
...
in a manner t hat best reflects the level of risk of the borrower. Institutions must not allocate 
...
26  Institutions are not required to produce their own estimates of PD for exposures subject to the supervisory 
slotting approach.

Banks/BHC/T&L Credit Risk – Internal Ratings-Based Approach 
September 2026 Chapter 5 – Page 49 
Unclassified / Non classifié 
(i) Rating dimensions 
...
of the probability of default risk typical for bor rowers assigned the grade and the criteria used to 
...
206. Institutions using the supervisory slotting criteria for the SL sub-class are exempt from this 
two-dimensional requirement for these exposures. Given the interdependence between 
borrower/transaction characteristics in exposures subject to the supervisory s lotting approaches, 
...
This exemption does not apply to instit utions using either the general corporate foundation or 
advanced approach for the SL sub-class. [Basel Framework, CRE 36.15]

Banks/BHC/T&L Credit Risk – Internal Ratings-Based Approach 
September 2026 Chapter 5 – Page 50 
Unclassified / Non classifié 
...
b. Transaction risk characteristics, including product and/or collateral types (e.g. loan to value 
measures, seasoning,
27 guarantees; and seniority (e.g. first vs. second lien)). Institutions 
must explicitly address cross-collateral provisions where present.  
c. Delinquency of exposure: Institutions are expected to separately identify exposures that are 
...
must include both a description of the degree of default risk typica l for borrowers assigned the 
...
27  For each pool where the institutions estimate PD and LGD, they should analyse the representativeness of the 
...
Banks/BHC/T&L Credit Risk – Internal Ratings-Based Approach 
September 2026 Chapter 5 – Page 51 
Unclassified / Non classifié 
...
purposes must ensure that the number of exposures in a given pool is suff icient so as to allow for 
...
a. The grade descriptions and criteria must be sufficiently detailed to allow those charged 
...
b. Written rating definitions must be clear and detailed enough to allow third parties, such as 
internal audit or an equally independent function and OSFI, to understand the assignment 
of ratings, to replicate rating assignments and evaluate the appropriatene ss of the 
grade/pool assignments.

Banks/BHC/T&L Credit Risk – Internal Ratings-Based Approach 
September 2026 Chapter 5 – Page 52 
Unclassified / Non classifié 
c. The criteria must also be consistent with the institution’s internal lending standards and its 
...
exposures that fall under each o f the supervisory categories. Each lending activity has a unique 
...
unexpected events. The range of economic conditions that are considere d when making 
...
Banks/BHC/T&L Credit Risk – Internal Ratings-Based Approach 
September 2026 Chapter 5 – Page 53 
Unclassified / Non classifié 
...
to perform that arises from periods of stressed volatilities when assigning a rati ng and 
...
information. Furthermore, where limited data are available, an in stitution must adopt a 
...
scoring models and other mechanical rating procedures generally use onl y a subset of available 
...
human oversight is neces sary to ensure that all relevant and material information, including that 
...
227. The institution must demonstrate that the data used to build the model are representative of 
...
Banks/BHC/T&L Credit Risk – Internal Ratings-Based Approach 
September 2026 Chapter 5 – Page 54 
Unclassified / Non classifié 
...
address topics such as portfolio differentiation, rating criteria, res ponsibilities of parties that rate 
...
to result in ratings that meaningfully differentiate risk. Rating criteria and procedure s must be 
...
the risk rating process, and such documentation m ust support identification of changes made to 
the risk rating process subsequent to the last supervisory review. The organi zation of rating 
...
demonstrate consistency with the reference definitions set out in paragraphs 265 to 274.   
...
internal rating systems. The burden is on the model’s vendor and the instit ution to satisfy OSFI. 
[Basel Framework, CRE 36.37]

Banks/BHC/T&L Credit Risk – Internal Ratings-Based Approach 
September 2026 Chapter 5 – Page 55 
Unclassified / Non classifié 
...
a connected group including circumstances under which the same r ating may or may not be 
...
assignment process can be achieved through a range of practices that wi ll be carefully reviewed 
...
pool as a means of ensuring that exposures continue to be ass igned to the correct pool. This 
requirement may be satisfied by review of a representative sample of exposures in the pool.

Banks/BHC/T&L Credit Risk – Internal Ratings-Based Approach 
September 2026 Chapter 5 – Page 56 
Unclassified / Non classifié 
...
LGD of the facility bef ore and after evaluation of the effects of the guarantee/credit derivative. 
Information about the components of loss or recovery for each defaulted exposure must be 
retained, such as amounts recovered, source of recovery (e.g. collateral, liquidation proce eds and 
guarantees), time period required for recovery, and administrative costs.   
[Basel Framework, CRE 36.47]

Banks/BHC/T&L Credit Risk – Internal Ratings-Based Approach 
September 2026 Chapter 5 – Page 57 
Unclassified / Non classifié 
245. Institutions under the foundation approach which utili ze supervisory estimates are 
...
evaluate evidence of ratings migr ation in external ratings. This would include the institution 
broadly matching its buckets to rating categories. [Basel Framework, CRE 36.52]  
 
250. Where an institution operates in several markets, it does not need to test for such conditions 
...
Banks/BHC/T&L Credit Risk – Internal Ratings-Based Approach 
September 2026 Chapter 5 – Page 58 
Unclassified / Non classifié 
...
must be functionally independent from the personnel and management f unctions responsible for 
originating exposures. Areas of responsibility must include: 
a. Testing and monitoring internal grades; 
b. Production and analysis of summary reports from the institution’s rating system, to include 
...
c. Implementing procedures to verify that rating definitions are consistently applied across 
departments and geographic areas;  
d. Reviewing and documenting any changes to the rating process, including the reasons for 
the changes; and 
e. Reviewing the rating criteria to evaluate if they remain predictive of risk. Changes to the 
...
Banks/BHC/T&L Credit Risk – Internal Ratings-Based Approach 
September 2026 Chapter 5 – Page 59 
Unclassified / Non classifié 
...
institutions using the IRB approach. Ratings systems and estimates desi gned and implemented 
...
Generally, all institutions using the IRB approaches must estimate a PD
28 for each internal 
...
28  Institutions are not required to produce their own estimates of PD for exposures subject to the supervisory 
slotting approach.

Banks/BHC/T&L Credit Risk – Internal Ratings-Based Approach 
September 2026 Chapter 5 – Page 60 
Unclassified / Non classifié 
...
in paragraphs 275 to 280. Institutions on the advanced approach must estimate an appropriate LGD 
(as defined in paragraphs 282 to 287) for each of its facilities (or retail pools). For exposures 
...
available data, information and methods. An institution may utili ze internal data and data from 
...
matched to or at least comparable with those of the institution’s expos ures and standards. The 
...
take into account paragraphs 282 to 299. The number of exposures in the sample and the data 
...
that is related to the likely range of errors. Where methods and dat a are less satisfactory and the 
...
Banks/BHC/T&L Credit Risk – Internal Ratings-Based Approach 
September 2026 Chapter 5 – Page 61 
Unclassified / Non classifié 
...
security (if held). 
b. The obligor is past due more than 90 days on any material credit obligation to the banking 
...
b. The institution makes a charge -off or specific allowance resulting from a significant 
...
e. The institution has filed for the obligor’s bankruptcy or a similar order in respect of the 
...
267. Additional guidance on indications of unlikeliness to pay can be found in 
OSFI 
...
facility, rather than at the level of the borrower,  with the exception of combined loan products 
(CLP) discussed below in paragraph 269. As such, default by a borrower on one facility does not 
require an institution to treat all other facilities  from that borr ower to the banking group as 
defaulted. In addition, for QRRE exposures, institutions may wait until a  borrower is more than 
180 days past due on any material facility to the banking group (instead of the 90 days mentioned 
in paragraph 265) prior to determining that a default has occurred.  
269. All products secured by the same property issued as part of the same CLP are to be 
considered a single facility. That is, 1) if a retail borrower is deemed to have defaulted on any 
product within a CLP facility, it is deemed to have defaulted on all products in the CLP facility  
and 2) as of fiscal Q3 2027, all products within a single CLP facility shall be assigned the same 
PD and LGD estimates for purposes of calculating minimum capital requirements . [Basel 
Framework, CRE 36.71]  
 
270. An institution must record actual defaults on IRB exposure classes using this reference 
definition. An institution must also use the reference definition for its estimation of PDs, and

Banks/BHC/T&L Credit Risk – Internal Ratings-Based Approach 
September 2026 Chapter 5 – Page 62 
Unclassified / Non classifié 
...
out in paragraph 276. However, in such cases, institutions must demonstrate to OSFI that 
...
271. If the institution considers that a previously defaulted exposure’s status is such that no 
...
(iii) Re-ageing 
272. The institution must have clearly articulated and documented policies in respect of the 
...
273. Authorized overdrafts must be subject to a credit limit set by the institution and brought to 
the knowledge of the client. Any break of this limit must be monitored; if the account were not 
brought under the limit after 90 to 180 days (subject to the applicable pa st-due trigger), it would 
...
274. The definition of loss used in estimating LGD is economic loss. When measuring economic 
...
Banks/BHC/T&L Credit Risk – Internal Ratings-Based Approach 
September 2026 Chapter 5 – Page 63 
Unclassified / Non classifié 
 
(vi) Requirements specific to PD estimation 
Corporate, sovereign, PSE, and bank exposures 
275. Institutions must use information and techniques that take appropriate account of the long-
...
276. Institutions may have a primary technique and use others as a point of comparison and 
potential adjustment. OSFI will not be satisfied by mechanical application of a technique without 
supporting analysis. Institutions must recogni ze the importance of judgmental considerations in 
...
based on the obser ved historical average on e-year default rate that is a simple average based on 
number of obligors (count weighted). Weighting approaches, such as EAD weighting, are not 
permitted. 
a. An institution may use data on internal default experience for the estimation of PD. An 
...
current rating system. Where only limited data are available, or where underwriting 
standards or rating systems have changed, the institution must add a greater margin of 
conservatism in its estimate of PD. The use of pooled data across institutions may also be 
recognized. An institution must demonstrate that the internal rating systems and criteria 
of other institutions in the pool are comparable with its own. 
b. Institutions may associate or map their internal grades to the scale used by an external 
credit assessment institution or similar institution and then attribute the default rate 
observed for the external institution’s grades to the institution’s grades. Ma ppings must 
be based on a comparison of internal rating criteria to the criteria used by the external 
institution and on a comparison of the internal and external ratings of any common 
borrowers. Biases or inconsistencies in the mapping approach or underlying data must be 
avoided. The external institution’s criteria underlying the data used for quantification must 
be oriented to the risk of the borrower and not reflect transaction characteristics. The 
institution’s analysis must include a comparison of the default definitions used, subject to 
the requirements in paragraph 265 to 271. The institution must document the basis for the 
mapping. 
c. An institution is allowed to use a simple average of default -probability estimates for 
...
277. Irrespective of whether an institution is using external, internal, or pooled data sources, or 
a combination of the three, for its PD estimation, the length of the underlying historical observation

Banks/BHC/T&L Credit Risk – Internal Ratings-Based Approach 
September 2026 Chapter 5 – Page 64 
Unclassified / Non classifié 
...
must be used. The data should include a representative mi x of good and bad years and must at a 
...
used to adjust their est imates where datasets do not include at least 10% of data from downturn 
years. [Basel Framework, CRE 36.79]  
Retail exposures 
278. Given the institution-specific basis of assigning exposures to pools, institutions must regard 
...
279. One method for deriving long- run average estimates of PD and default -weighted average 
loss rates given default (as defined in paragraph 282) for retail would be based on an estimate of 
the expected long-run loss rate. An institution may (i) use an appropriate PD estimate to infer the 
long-run default-weighted average loss rate given default, or (ii) use a long- run default-weighted 
average los s rate given default to infer the appropriate PD. In either case, it is important to 
...
in paragraph 282. [Basel Framework, CRE 36.81] 
 
280. Irrespective of whether institutions are using external, internal, pooled data sources, or a 
...
Banks/BHC/T&L Credit Risk – Internal Ratings-Based Approach 
September 2026 Chapter 5 – Page 65 
Unclassified / Non classifié 
...
less than 10% of data coming from downturn years, there are m ultiple ways institutions could 
...
281. Institutions have the option of using either the standardized approach without credit risk 
mitigation or the retail IRB approach using the method outlined in paragraph 279 that treats all 
margin loans as a single risk segment. Prime brokerage business may not be classified as a retail 
exposure.  
 
a. Standardized approach without credit risk mitigation  
Notwithstanding that institutions are required to use the IRB approach for retail, 
appropriately margined retail loans are not considered a significant credit risk. Therefore 
retail margin loans are eligible for a permanent waiver to use the standardized approach 
without credit risk mitigation.  
b. IRB approach 
This approach is permitted for institutions that wish to extend IRB retail methods to retail 
margin loans as a single risk segment. In such a case the institution would be eligible to 
derive either a PD or LGD for the segment from the segment’s expected long-run loss rate 
(see paragraph 279).  
(vii) Requirements specific to own-LGD estimates 
Standards for all asset classes 
282. An institution must estimate an LGD for each facility that aims to reflect economic 
...
economic loss
29 of all observed defaults within the data source for that type of facility. In addition, 
...
loss severities observed during periods of high credit losses, forecasts based on appr opriately 
 
29  Post-default advances and corresponding accrued interest can be captured in LGD or EAD estimates, provided 
it is done consistently across the institution.

Banks/BHC/T&L Credit Risk – Internal Ratings-Based Approach 
September 2026 Chapter 5 – Page 66 
Unclassified / Non classifié 
...
283. In its analysis, the institution must consider the extent of any dependence between the risk 
of the borrower and that of the collateral or collateral provider. Cases where there is a significant 
degree of dependence must be addressed in a conservative mann er. Any currency mismatch 
...
284. LGD estimates must be grounded in historical recovery rates and, when applicable, must 
not solely be based on the collateral’s estimated market value. This requirement recognizes the 
potential inability of institutions to gain both control of their collate ral and liquidate it 
...
procedures, legal certainty and risk management pr ocess that are generally consistent with those 
required for the foundation IRB approach. [Basel Framework, CRE 36.85]  
 
285. Recognizing the principle that realized losses can at times systematically exceed expected 
levels, the LGD assigned to a defaulted asset should reflect the possibility that the institution would 
have to recognize additional, unexpected losses during the re covery period. For each defaulted 
...
is less than the sum of specific
30 allowances on that asset will attract supervisory scrutiny and must 
...
286. Estimates of LGD must be based on a minimum data observation period that should ideally 
...
287. The minimum data observation period for LGD estimates for retail exposures is five years. 
The less data an institution has, the more conservative it must be in its estimation.   
[Basel Framework, CRE 36.88]  
 
30  Under IFRS 9, Stage 3 allowances and partial write-offs are considered to be specific allowances, while Stage 1 
and Stage 2 allowances are considered to be general allowances.

Banks/BHC/T&L Credit Risk – Internal Ratings-Based Approach 
September 2026 Chapter 5 – Page 67 
Unclassified / Non classifié 
Downturn LGD Floor 
288. Effective November 1, 2016, new exposures secured by residential real estate 31 located 
...
The DLGD floor is applied at the loan level to the pre-mitigation
32 DLGD. 
T
he add-on formula is as follows: 
𝐸𝐸𝑚𝑚
𝑚𝑚 − 𝐹𝐹𝑖𝑖 =  Max(CLTV − 80% × (100% − ΔP), 0)
CLTV  
Where: 
• CLTV (Current Loan-To-Value) is defined as the ratio of the exposure at default 33 over 
the updated property value. 
• ∆𝑃𝑃 (Price Correction) is defined as the decrease in house prices necessary to reach a 
...
Formulaically, ∆P is defined as follows: 
∆𝑃𝑃 = max ��1 −  𝐻𝐻𝐹𝐹
𝑜𝑜
𝐻𝐻𝑖𝑖 
𝑃𝑃
...
the corresponding metropolitan areas34 and the composite-11 for loans outside of those 32 cities. 
Quarterly recalculation of the floor is required. A list of the 32 public metropolitan area indicies 
has been provided in Appendix 5-3. 
...
Banks/BHC/T&L Credit Risk – Internal Ratings-Based Approach 
September 2026 Chapter 5 – Page 68 
Unclassified / Non classifié 
𝐸𝐸𝑚𝑚𝑚𝑚 − 𝐹𝐹𝑖𝑖 =  𝑀𝑀𝑚𝑚𝑚𝑚 �𝑀𝑀𝑖𝑖𝑖𝑖(𝐶𝐶𝐿𝐿𝐶𝐶𝑉𝑉, 𝑀𝑀𝑚𝑚𝑚𝑚(𝐶𝐶𝐶𝐶𝐿𝐿𝐶𝐶𝑉𝑉 − 80% × (100% − ∆𝑃𝑃), 0))
𝐶𝐶𝐿𝐿𝐶𝐶𝑉𝑉 , 0� 
...
exposure of the facility upon default of the obligor.35 For on-balance sheet items, institutions must 
...
recognition of ne tting are the same as those under the foundation approach. The additional 
minimum requirements for internal estimation of EAD under the advanced approach, therefore, 
focus on the estimation of EAD for off -balance sheet items (excluding transactions that ex pose 
...
290. Under the advanced approach, institutions must assign an estimate of EAD for each facility. 
...
the impact of previous recession(s). However, some inst itutions may only have the option of 
making conservative use of external data. Moreover, where an institution bases its estimates on 
 
31  Exposures secured by residential real estate refer to all retail lending products for which the collateral is 
residential real estate. New exposures include newly originated mortgages, refinances, and renewals.  
32  The DLGD floor applies to new insured mortgages effective November 1, 2017.  
33  The estimation of the exposure at default must be performed according to the requirements specified in this 
chapter. 
34    The metropolitan areas’ geographical limits are determined using Statistics Canada’s definition of Census 
Metropolitan Areas.  
35   Post-default advances and corresponding accrued interest can be captured in LGD or EAD estimates, provided 
it is done consistently across the institution.

Banks/BHC/T&L Credit Risk – Internal Ratings-Based Approach 
September 2026 Chapter 5 – Page 69 
Unclassified / Non classifié 
...
the institution from using in formation from facilities that defaulted within twelve months of the 
...
estimates should be based on appropriately homogenous segments. Alternatively, the estimates 
...
a. SME/mid-market data being applied to large corporate obligors. 
b. Data from commitments with ‘small’ unused limit availability being applied to facilities 
with ‘large’ unused limit availability. 
c. Data from obligors already identified as problematic at reference date being applied to 
current obligors with no known issues (e.g. customers at reference date who were already 
delinquent, watchlisted by the institution, subject to recent institution-initiated limit

Banks/BHC/T&L Credit Risk – Internal Ratings-Based Approach 
September 2026 Chapter 5 – Page 70 
Unclassified / Non classifié 
reductions, blocked from further drawdowns or subject to other types of collections 
activity). 
d. Data that has been affected by changes in obligors’ mix of borrowing and other credit-
related products over the observation period unless that data has been effectively 
mitigated for such changes, e.g. by adjusting the data to remove the effects of the changes 
in the product mix. OSFI expects institutions to demonstrate a detailed understanding of 
the impact of changes in customer product mix on EAD reference data sets (and 
associated EAD estimates) and that the impact is immaterial or has been effectively 
mitigated within each institution’s estimation process. Institutions’ analyses in this regard 
will be actively challenged by OSFI. Effective mitigation would not include: setting 
floors to credit conversion factor (CCF)/EAD observations; use of obligor-level estimates 
that do not fully cover the relevant product transformation options or inappropriately 
combine products with very different characteristics (e.g. revolving and non-revolving 
products); adjusting only ‘material’ observations affected by product transformation; 
generally excluding observations affected by product profile transformation (thereby 
potentially distorting the representativeness of the remaining data).  [Basel Framework, 
CRE 36.94] 
 
295. A well-known feature of the commonly used undrawn limit factor (ULF) approach
36 to 
...
a. An acceptable approach could include using an estimation method other than the ULF 
...
factor or additional utilization factor approach.
37 Note that, consistent with paragraph 
294, including limit utilization as a driver in EAD models could quarantine much of the 
relevant portfolio from this issue but, in the absence of other actions, leaves open how to 
develop appropriate EAD estimates to be applied to exposures within the region of 
instability.  
 
36    A specific type of CCF, where predicted additional drawings in the lead-up to default are expressed as a    
percentage of the undrawn limit that remains available to the obligor under the terms and conditions of a 
facility, i.e. EAD=B0=Bt+ULF[Lt –Bt], where B0 = facility balance at date of default; Bt = current balance (for 
predicted EAD) or balance at reference date (for observed EAD); Lt = current limit (for predicted EAD) or limit 
at reference date (for realized/observed EAD).  
37  A limit factor (LF) is a specific type of CCF, where the predicted balance at default is expressed as a percentage 
...
EAD=B0=BF[Bt]. An additional utilization factor (AUF) is a specific type of CCF, where predicted ad ditional 
...
Banks/BHC/T&L Credit Risk – Internal Ratings-Based Approach 
September 2026 Chapter 5 – Page 71 
Unclassified / Non classifié 
b. Common but ineffective approaches to mitigating this issue include capping and flooring 
reference data (e.g. observed CCFs at 100 per cent and zero respectively) or omitting 
...
observation period spans a longer period for any source, and the data are re levant, this longer 
...
LGD. For retail exposures, where guarantees exist, either in support of an individual obligation or 
...
Banks/BHC/T&L Credit Risk – Internal Ratings-Based Approach 
September 2026 Chapter 5 – Page 72 
Unclassified / Non classifié 
...
to a cap on the total claims that can be made on defaulted loans covered by th e guarantee 
arrangement.  
...
a. No recognition of double default: Paragraph 109 of the Framework permits institutions to 
...
b. No recognition of double recovery: Since collateral is reflected through an adjustment to 
...
c. Requirement to track guarantor PDs : Any institution that measures credit risk 
...
d. Requirement to recognize the possibility of guarantor default in the adjustment: Any LGD 
...
e. Requirement for credible data : Any estimates used in an LGD adjustment must be based 
...
f. Use of consistent methodology for similar types of guarantees: Under paragraph 109, an 
...
Banks/BHC/T&L Credit Risk – Internal Ratings-Based Approach 
September 2026 Chapter 5 – Page 73 
Unclassified / Non classifié 
...
have clearly specified criteria for the types of guarantors it will recogni ze for regulatory capital 
purposes. [Basel Framework, CRE 36.104]  
 
308. An institution may not reduce the risk weight of an exposure to a third party on account of 
...
Banks/BHC/T&L Credit Risk – Internal Ratings-Based Approach 
September 2026 Chapter 5 – Page 74 
Unclassified / Non classifié 
...
exposures to pools) to reflect the impact of guarantees for regulator y capital purposes. These 
...
derivatives.
 Additional considerations arise in respect of asset mismatches. The criteria used for 
...
Banks/BHC/T&L Credit Risk – Internal Ratings-Based Approach 
September 2026 Chapter 5 – Page 75 
Unclassified / Non classifié 
...
a. The institution is not able to use an ‘LGD-adjustment’ option; and 
b. The range of eligible guarantees and guarantors is limited to those outlined in paragraph 
105.  
...
or by extern al sources. The purchasing institution must determine whether the data provided by 
the seller are consistent with expectations agreed upon by both parties concerning, for example, 
the type, volume and on -going quality of receivables purchased. Where this i s not the case, the 
...
down treatment of default risk, the receivable pool and overal l lending relationship should be 
closely monitored and controlled. Specifically, an institution will have to demonstrate the 
following:   
a. Legal certainty; 
b. Effectiveness of monitoring systems; 
c. Effectiveness of work-out systems; 
d. Effectiveness of systems for controlling collateral, credit availability, and cash; and 
e. Compliance with the institution’s internal policies and procedures. 
[Basel Framework, CRE 36.1115]

Banks/BHC/T&L Credit Risk – Internal Ratings-Based Approach 
September 2026 Chapter 5 – Page 76 
Unclassified / Non classifié 
Legal certainty 
...
a. The institution must (a) assess the correlation among the quality of the receivables and the 
financial condition of both the seller and servicer, and (b) have in place internal policies 
and procedures that provide adequate safeguards to protect against suc h contingencies, 
including the assignment of an internal risk rating for each seller and servicer.  
b. The institution must have clear and effective policies and procedures for determining seller 
...
documented. 
c. The institution must have the ability to assess the characteristics of the receivables pool, 
...
d. The institution must have effective policies and procedures for monitoring on an aggregate 
basis single-obligor concentrations both within and across receivables pools.  
e. The institution must receive timely and sufficiently detailed reports of receivables ageings 
and dilutions to: (a) ensure compliance with the institution’s eligibility criteria and 
advancing policies governing purchased receivables, and (b) provide an effe ctive means 
...
a. The institution should have clear and effective policies, procedures, and information 
systems to monitor compliance with (a) all contractual terms of the facility (including

Banks/BHC/T&L Credit Risk – Internal Ratings-Based Approach 
September 2026 Chapter 5 – Page 77 
Unclassified / Non classifié 
...
eligibility. The institution’s systems should track covenant violations and w aivers as well 
as exceptions to established policies and procedures. 
b. To limit inappropriate draws, the institution should have effective policies and procedures 
for detecting, approving, monitoring, and correcting over-advances. 
c. The institution should have effective policies and procedures for dealing with financially 
...
b. Internal systems must ensure that funds are advanced only against specified supporting 
...
a. Regular internal and/or external audits of all critical phases of the institution’s receivables 
purchase programme. 
b. Verification of the separation of duties (i) between the assessment of the seller/servicer and 
...
Banks/BHC/T&L Credit Risk – Internal Ratings-Based Approach 
September 2026 Chapter 5 – Page 78 
Unclassified / Non classifié 
...
information on realized LGDs and EADs should form part of the institution’s asse ssment of 
...
Banks/BHC/T&L Credit Risk – Internal Ratings-Based Approach 
September 2026 Chapter 5 – Page 79 
Unclassified / Non classifié 
...
defined as: 
a. Collateral where the risk of the borrower is not materially dependent upon the performance 
...
and  
b. Additionally, the value of the collateral pledged must not be materially dependent on the 
...
a. Legal enforceability: any claim on a collateral taken must be legally enforceable in all 
...
underpinning it must be such that they provide for the institution to realize the value of the 
collateral within a reasonable timeframe. 
b. Objective market value of collateral: the collateral must be valued at or less than the current 
...
c. Frequent revaluation: the institution is expected to monitor the value of the collateral on a 
...
d. Junior liens: Residential and commercial real estate may be recognized as collateral for 
FIRB only when the institution’s collateral interest is the first lien on the property, and 
there is no more senior or intervening claim.
38 Junior liens are recognized as collateral only 
 
38  In some jurisdictions, first liens are subject to the prior right of preferential creditors, such as outstanding tax 
claims and employees’ wages.

Banks/BHC/T&L Credit Risk – Internal Ratings-Based Approach 
September 2026 Chapter 5 – Page 80 
Unclassified / Non classifié 
where the institution holds the senior lien and where no other party holds an intervening 
lien on the property. Where junior liens are recogni zed the institution must first take the 
haircut value of the collateral, then reduce it by the sum of all loans with liens that rank 
higher than the junior lien, the remaining value is the collateral that supports the loan with 
the junior lien. In cases whe re liens are held by third parties that rank pari passu with the 
lien of the institution, only the proportion of the collateral (after the application of haircuts 
and reductions due to the value of loans with liens that rank higher than the lien of the 
institution) that is attributable to the institution may be recognized. 
[Basel Framework, CRE 36.131]  
336. Additional collateral management requirements are as follows: 
a. The types of CRE and RRE collateral accepted by the institution and lending policies 
(advance rates) when this type of collateral is taken must be clearly documented. 
b. The institution must take steps to ensure that the property taken as collateral is adequately 
insured against damage or deterioration. 
c. The institution must monitor on an ongoing basis the extent of any permissible prior claims 
(e.g. tax) on the property.  
d. The institution must appropriately monitor the risk of environmental liability arising in 
...
Banks/BHC/T&L Credit Risk – Internal Ratings-Based Approach 
September 2026 Chapter 5 – Page 81 
Unclassified / Non classifié 
...
industry (e.g. effects of the business cycle) and the types of customer s with whom the borrower 
...
343. The margin between the amount of the exposure and the value of the receivables must 
...
accounts, control of the proceeds of accounts paid, analys es of dilution (credits given by the 
...
reliant on the borrower for their viability or the borrower and the is suers belong to a common 
...
Banks/BHC/T&L Credit Risk – Internal Ratings-Based Approach 
September 2026 Chapter 5 – Page 82 
Unclassified / Non classifié 
...
a. The institution demonstrates to the satisfaction of OSFI that there are liquid markets for 
disposal of collateral in an expeditious and economically efficient manner. Institutions 
must carry out a reassessment of this condition both periodically and when i nformation 
indicates material changes in the market. 
b. The institution demonstrates to the satisfaction of OSFI that there are well established, 
...
a. With the sole exception of permissible prior claims specified in footnote 38 in paragraph 
335 , only first liens on, or charges over, collateral are permissible. As such, the institution 
must have priority over all other lenders to the realized proceeds of the collateral.  
b. The loan agreement must include detailed descriptions of the collateral and the right to 
examine and revalue the collateral whenever this is deemed necessary by the lending 
institution.  
c. The types of physical collateral accepted by the institution and policies and practices in 
...
d. Institutions’ credit policies with regard to the transaction structure must address appropriate 
...
e. In cases of inventories (e.g. raw materials, work- in-process, finished goods, dealers’ 
inventories of autos) and equipment, the periodic revaluation process must include physical 
inspection of the collateral.  
[Basel Framework, CRE 36.144]

Banks/BHC/T&L Credit Risk – Internal Ratings-Based Approach 
September 2026 Chapter 5 – Page 83 
Unclassified / Non classifié 
...
b. A robust legal framework establishing the lessor’s legal ownership of the asset and its 
ability to exercise its rights as owner in a timely fashion; and 
c. The difference between the rate of depreciation of the physical asset and the rate of 
...
351. Leases that expose the institution to residual value risk will be treated in the following 
...
a. The discounted lease payment stream will receive a risk weight appropriate for the lessee’s 
financial strength (PD) and supervisory or own- estimate of LGD, whichever is 
appropriate.  
...
requirements set out in OSFI’s Pillar 3 Disclosure Expectations
.These are minimum requirements 
for use of IRB: failure to meet these will render institutions ineligible to use the relevant IRB 
approach.  [Basel Framework, CRE 36.148]

Banks/BHC/T&L Credit Risk – Internal Ratings-Based Approach 
September 2026 Chapter 5 – Page 84 
Unclassified / Non classifié 
...
group of which the firm is a part is less than $75 million). Accordingly, the firm size adjustment 
was made in determining the second set of risk weights provided in column two given that the 
turnover of the firm receiving the exposure is assumed to be $7.5 million. [Basel Framework, 
CRE 99.3] 
...
Banks/BHC/T&L Credit Risk – Internal Ratings-Based Approach 
September 2026 Chapter 5 – Page 85 
Unclassified / Non classifié 
...
Banks/BHC/T&L Credit Risk – Internal Ratings-Based Approach 
September 2026 Chapter 5 – Page 86 
Unclassified / Non classifié 
...
Banks/BHC/T&L Credit Risk – Internal Ratings-Based Approach 
September 2026 Chapter 5 – Page 87 
Unclassified / Non classifié 
...
Banks/BHC/T&L Credit Risk – Internal Ratings-Based Approach 
September 2026 Chapter 5 – Page 88 
Unclassified / Non classifié 
...
Banks/BHC/T&L Credit Risk – Internal Ratings-Based Approach 
September 2026 Chapter 5 – Page 89 
Unclassified / Non classifié 
...
Banks/BHC/T&L Credit Risk – Internal Ratings-Based Approach 
September 2026 Chapter 5 – Page 90 
Unclassified / Non classifié 
...
Banks/BHC/T&L Credit Risk – Internal Ratings-Based Approach 
September 2026 Chapter 5 – Page 91 
Unclassified / Non classifié 
Table 2a ─ Financial strength ─ Supervisory Rating Grades for Income-Producing Real Estate Exposures and High-Volatility 
...
Banks/BHC/T&L Credit Risk – Internal Ratings-Based Approach 
September 2026 Chapter 5 – Page 92 
Unclassified / Non classifié 
Table 2b ─ Cash-flow predictability ─ Supervisory Rating Grades for Income-Producing Real Estate Exposures and High-Volatility Commercial 
...
Banks/BHC/T&L Credit Risk – Internal Ratings-Based Approach 
September 2026 Chapter 5 – Page 93 
Unclassified / Non classifié 
Table 2c ─ Asset characteristics ─ Supervisory Rating Grades for Income-Producing Real Estate Exposures and High-Volatility Commercial Real 
Estate Exposures 
 Strong Good Satisfactory Weak 
...
Banks/BHC/T&L Credit Risk – Internal Ratings-Based Approach 
September 2026 Chapter 5 – Page 94 
Unclassified / Non classifié 
Table 2d ─ Strength of Sponsor/ Developer ─ Supervisory Rating Grades for Income-Producing Real Estate Exposures and High-Volatility 
Commercial Real Estate Exposures 
...
Banks/BHC/T&L Credit Risk – Internal Ratings-Based Approach 
September 2026 Chapter 5 – Page 95 
Unclassified / Non classifié 
Table 2e ─ Security Package ─ Supervisory Rating Grades for Income-Producing Real Estate Exposures and High-Volatility Commercial Real 
Estate Exposures 
Nature of lien  Perfected first lien39 Perfected first lien Perfected first lien Ability of lender to 
...
39  Lenders in some markets extensively use loan structures that include junior liens. Junior liens may be indicative of this level of risk if the total LTV inclusive 
of all senior positions does not exceed a typical first loan LTV. 
 Strong Good Satisfactory Weak

Banks/BHC/T&L Credit Risk – Internal Ratings-Based Approach 
September 2026 Chapter 5 – Page 96 
Unclassified / Non classifié 
...
Banks/BHC/T&L Credit Risk – Internal Ratings-Based Approach 
September 2026 Chapter 5 – Page 97 
Unclassified / Non classifié 
...
Banks/BHC/T&L Credit Risk – Internal Ratings-Based Approach 
September 2026 Chapter 5 – Page 98 
Unclassified / Non classifié 
...
Banks/BHC/T&L Credit Risk – Internal Ratings-Based Approach 
September 2026 Chapter 5 – Page 99 
Unclassified / Non classifié 
...
Banks/BHC/T&L Credit Risk – Internal Ratings-Based Approach 
September 2026 Chapter 5 – Page 100 
Unclassified / Non classifié 
...
Banks/BHC/T&L Credit Risk – Internal Ratings-Based Approach 
September 2026 Chapter 5 – Page 101 
Unclassified / Non classifié 
...
Banks/BHC/T&L Credit Risk – Internal Ratings-Based Approach 
September 2026 Chapter 5 – Page 102 
Unclassified / Non classifié 
...
Banks/BHC/T&L Credit Risk – Internal Ratings Based Approach 
January 2022  Chapter 5 - Page 103 
Unclassified / Non classifié 
Appendix 5-3 – Teranet metropolitan area house price indices to be used in 
the calculation of the DLGD floor  
 
 
1. The Teranet index values are available on a monthly basis for the following 32 census 
...
Banks/BHC/T&L Credit Risk – Internal Ratings Based Approach 
January 2022  Chapter 5 - Page 104 
Unclassified / Non classifié 
• Montreal* 
• Quebec City* 
• Sherbrooke 
