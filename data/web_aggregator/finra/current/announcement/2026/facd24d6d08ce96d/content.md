...
Function Description Percentage of 
Exam Items Number of Items 
1 Seeks Business for the Broker-Dealer from 
Customers and Potential Customers 7% 9 
2 
...
candidate’s exam includes 5 additional, unidentified pretest items that do not contribute toward the candidate's score. 
The pretest items are randomly distributed throughout the exam. Therefore, each candidate’s exam consists of a total 
of 130 items (125 scored and 5 unscored). There is no penalty for guessing. Therefore, candidates should attempt to 
answer all items. Candidates will be allowed 3 hours and 45 minutes to complete the Series 7 exam.  
...
1.2 Describes investment products and services to current and potential customers with the 
...
3.1 Provides customers with information about investment strategies, risks and rewards, and 
...
3.2 Reviews and analyzes customers' investment profiles and product options to determine that 
...
• Electronic exchanges or auction markets (e.g., electronic communications networks (ECNs), over-the-
counter (OTC), dark pools of liquidity) 
...
• Characteristics: types, maturities, denominations, primary dealers, distribution, issue form, quotations, pass-
through, calculating a spread, pricing, payment of interest and principal 
...
3.3 Provides required disclosures regarding investment products and their characteristics, 
...
• Technical analysis of basic chart patterns and key terms (e.g., trend lines, saucer/inverted saucer, head-
and-shoulders/inverted head-and-shoulders, breakouts, resistance/support levels, moving averages, 
...
• Types of orders (e.g., all-or-none (AON), fill-or-kill (FOK), immediate-or-cancel (IOC), not-held, market-on-
close (MOC), spread, straddle) 
...
(DRS)) 
• Settlement of transactions (e.g., security-specific requirements, when-, as- and if-issued, ex-rights, ex-
dividends, due bill checks, negotiated settlements, option exercise/assignment, don’t know (DK), 
extensions)
