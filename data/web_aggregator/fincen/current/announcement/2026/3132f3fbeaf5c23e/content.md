...
The following frequently asked questions (FAQs) have been provided to assist financial institutions in their use of the FinCEN SAR. FinCEN issued [four additional FAQs on October 9, 2025](/system/files/2025-10/SAR-FAQs-October-2025.pdf). FinCEN will issue additional FAQs and guidance as needed.
...
The following explains how to apply the guidance provided in FinCEN advisory [FIN-2011-A016](/system/files/shared/FIN-2011-A016.pdf) when using the FinCEN SAR:
