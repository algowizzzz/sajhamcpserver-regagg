# Components of the method for charging reporting entities : Charging reporting entities for FINTRAC’s compliance program
...
* [Components of the method](#s1)
* [Summary of the components for each type of reporting entity](#s2)
* [Estimating charges](#s3)
* [Related links](#s4)
...
**Note:** For information regarding how FINTRAC determines the annual cost of its compliance program, refer to [Determining the cost of FINTRAC’s compliance program](/guidance-directives/cost-cout/development-elaboration-eng#s2).
...
1. [Type of reporting entity](#c1)
2. [Base amount (based on annual value of Canadian assets)](#c2)
3. [Portion of the annual cost of FINTRAC’s compliance program](#c3)
4. [Annual volume of threshold transaction reports](#c4)

### Component 1: Type of reporting entity

The method applies to [prescribed](/guidance-directives/glossary-glossaire/1-eng#prescribed) reporting entities, and the determination of charges differs depending on the type of reporting entity.

Further reading:

* [Reporting entities subject to charges](/guidance-directives/cost-cout/entities-entites-eng)
* [Determination of charges by type of reporting entity](/guidance-directives/cost-cout/determination-determiner-eng)

### Component 2: Base amount (based on annual value of Canadian assets)

The determining factor of the **base amount** is the **value of Canadian assets** held by the [entity](/guidance-directives/glossary-glossaire/1-eng#entity) at the end of its financial year.

**Base amounts[Footnote \*](#fn1) in relation to the value of entity’s Canadian assets at the end of its financial year**
...
|  |  |
| --- | --- |
| Note  These base amounts are effective April 1, 2024 for the 2024-2025 fiscal year.  [Return to footnote \* referrer](#fn1-rf) Annual adjustments to base amounts On April 1 of every year (subsequent to fiscal year 2024-2025), all base amounts are adjusted by the percentage change over 12 months in the April All-items [Consumer Price Index](https://www23.statcan.gc.ca/imdb/p2SV.pl?Function=getSurvey&SDDS=2301) for Canada, as published by Statistics Canada under the Statistics Act, for the previous fiscal year. All adjusted base assessment amounts are rounded to the nearest dollar.  The annual indexed increases to the base amounts are implemented to keep pace with inflation. This is consistent with other agencies that have a similar funding model (such as the Office of the Superintendent of Financial Institutions). | |
...
These considerations led to the option of charging larger, federally regulated reporting entities (that is, banks, trust and loan companies, and [life insurance companies](/guidance-directives/glossary-glossaire/1-eng#lic)) a base amount.
...
* the [guiding principles established by the Department of Finance Canada and FINTRAC](/guidance-directives/cost-cout/development-elaboration-eng#x1)
* the approaches of the Department of Finance Canada’s other portfolio agencies
...
* the **sum of all base amounts** of federally regulated banks, trust and loan companies, and life insurance companies for that fiscal year   
  **subtracted from**
* the **cost of FINTRAC’s compliance program** for the fiscal year
...
| Calculation of “remaining compliance cost” | $45,000,000  - $11,890,000  = $33,110,000 |
...
* relative exposure to money laundering and terrorist activity financing risks
* market share
...
* [electronic funds transfers](/guidance-directives/glossary-glossaire/1-eng#eft)
...
FINTRAC developed its method for charging reporting entities in a manner that reflects the [guiding principles established by the Department of Finance Canada and FINTRAC](/guidance-directives/cost-cout/development-elaboration-eng#x1) and accounts for the following 2 factors:
...
* size
* business volumes
* exposure to money laundering and terrorist activity financing risks
* supervisory obligations

## Summary of the components for each type of reporting entity

**Note**: For details and examples of how charges are determined for each type of reporting entity, refer to [Determination of charges by type of reporting entity](/guidance-directives/cost-cout/determination-determiner-eng).
...
* the explanation provided on this page (Components of the method for charging reporting entities) and on the page [Determination of charges by type of reporting entity](/guidance-directives/cost-cout/determination-determiner-eng)
* the amount that they were charged the previous year, if applicable
...
* the annual volumes of threshold transaction reports submitted by reporting entities

For information regarding an additional factor that may result in fluctuations in charges, refer to [Determining the cost of FINTRAC’s compliance program](/guidance-directives/cost-cout/development-elaboration-eng#s2).
...
* [Consumer Price Index](https://www23.statcan.gc.ca/imdb/p2SV.pl?Function=getSurvey&SDDS=2301) (Statistic Canada)
* [Reporting entities subject to charges](/guidance-directives/cost-cout/entities-entites-eng)
* [Determination of charges by type of reporting entity](/guidance-directives/cost-cout/determination-determiner-eng)
...
* [FINTRAC – Guidance for businesses glossary](/guidance-directives/glossary-glossaire/1-eng)
