# Record keeping requirements for money services businesses and foreign money services businesses : FINTRAC’s compliance guidance

**From:** [Financial Transactions and Reports Analysis Centre of Canada](/intro-eng) (FINTRAC)

This guidance outlines certain record keeping requirements for [money services businesses](/guidance-directives/glossary-glossaire/1-eng#msb) and [foreign money services businesses](/guidance-directives/glossary-glossaire/1-eng#fmsb).
...
* [Ministerial directives](/obligations/directives-eng)
...
* [Third party determination records](/guidance-directives/client-clientele/tpdr-eng)
...
* a [copy of every report sent to FINTRAC](#x1):
  + Suspicious Transaction Reports
  + Listed Person or Entity Property Reports
  + Large Cash Transaction Reports
  + Large Virtual Currency Transaction Reports
  + Electronic Funds Transfer Reports
* [large cash transaction records](#x2)
  + when you receive cash in amount equivalent to $10,000 or more in a single transaction
* [large virtual currency transaction records](#x3)
  + when you receive virtual currency in an amount equivalent to $10,000 or more in a single transaction
* [records of transactions of $3,000 or more](#x4) 
  + when you receive $3,000 or more in funds or an equivalent amount in virtual currency for the issuance of negotiable instruments
  + when you redeem one or more money orders for a total value of $3,000 or more in funds or in virtual currency
* [records of remitting and transmitting $1,000 or more in funds by means other than an electronic funds transfer](#x5)
  + when you transmit $1,000 or more in funds by means other than an electronic funds transfer
  + when you remit $1,000 or more in funds to a beneficiary by means other than an electronic funds transfer
* [records of electronic funds transfers of $1,000 or more](#x6)
  + when you [initiate](/guidance-directives/glossary-glossaire/1-eng#initiation) an international electronic funds transfer of $1,000 or more
  + when you send an international electronic funds transfer of $1,000 or more that was initiated by another reporting entity
  + when you are the final recipient of an international electronic funds transfer of $1,000 or more
* [records of virtual currency transfers equivalent to $1,000 or more](#x7)
  + when you transfer virtual currency in an amount equivalent to $1,000 or more
  + when you receive virtual currency in an amount equivalent to $1,000 or more for remittance to a beneficiary
* [foreign currency exchange transaction tickets](#x8)
  + when you conduct a foreign currency exchange transaction
* [virtual currency exchange transaction tickets](#x9)
  + when you conduct a virtual currency exchange transaction
* [crowdfunding platform services records](#x10)
  + when you provide crowdfunding platform services
* [internal memorandum records](#x11)
  + when you create or receive internal memorandums about services
* [service agreement records](#x12)
  + when you enter into an agreement to provide a money services business service
* [transport records](#x13)
  + when you transport $1,000 or more in cash or virtual currency
  + when you transport $3,000 or more in negotiable instruments
  + when you transport an undeclared amount of cash, virtual currency or negotiable instruments that cannot be readily determined
  + when you transport cash, virtual currency or negotiable instruments at the request of a bank, credit union or caisse populaire
* [cheque cashers records](#x14)
  + when you cash one or more cheques that total $3,000 or more
* [acquirer services records](#x15)
  + when you provide acquirer services in relation to a private automated banking machine
...
* when the client’s occupation is “manager”, the record should reflect the area of management, such as “hotel reservations manager” or “retail clothing store manager”
* when an entity’s principal business area is “sales”, the record should specify the type of sales, such as “pharmaceutical sales” or “retail sales”
...
* [Suspicious Transaction Report](/guidance-directives/transaction-operation/str-dod/str-dod-eng)
* [Listed Person or Entity Property Report](/guidance-directives/transaction-operation/Guide5/5-eng)

**Retention:** You must keep a copy of the report for at least 5 years after the day it was submitted.

When you submit a:

* [Large Cash Transaction Report](/guidance-directives/transaction-operation/lctr-doie/lctr-doie-eng)
* [Large Virtual Currency Transaction Report](/guidance-directives/transaction-operation/lvctr/lvctr-eng)
* [Electronic Funds Transfer Report](/guidance-directives/transaction-operation/eft-dt/eft-dt-eng)
...
Foreign money services businesses must keep a large cash transaction record when they receive $10,000 or more in cash from a [person](/guidance-directives/glossary-glossaire/1-eng#person) or an [entity](/guidance-directives/glossary-glossaire/1-eng#entity) in Canada.
...
**Note**: This requirement is subject to the [24-hour rule](/guidance-directives/transaction-operation/24hour/1-eng).

A large cash transaction record must include:

* the date you received the cash
* for any **person** involved in the transaction, including the person from whom you received the cash, their:
  + name
  + address
  + date of birth
  + occupation
  + in the case of a sole proprietor, the nature of their principal business
* for any **entity** involved in the transaction, including the entity from which you received the cash, their:
  + name
  + address
  + nature of their principal business
* the type and amount of each fiat currency received
* the method by which you received the cash (for example, in person, by mail, by armoured car)
* the exchange rates used and the source (if applicable)
* if an account was affected by the transaction, include:
  + the account number
  + type of account (for example, business, personal)
...
* the purpose of the transaction (for example, the cash was used to purchase a money order)
* the following details about the remittance (i.e. the disposition) of, or exchange for, the cash received:
  + the method of remittance (for example, wire transfer, money order)
  + if the remittance is in funds, the amount and type of funds involved
  + if the remittance is not in funds, the type of remittance (for example, virtual currency) and value if different from the amount received in cash
...
* for any **person** involved in the transaction, including the person from whom you received the virtual currency, their:
  + name
  + address
  + date of birth
  + occupation
  + in the case of a sole proprietor, the nature of their principal business
* for any **entity** involved in the transaction, including the entity from which you received the virtual currency, their:
  + name
  + address
  + nature of their principal business
* the type and amount of each virtual currency involved in the receipt
* the exchange rates used and the source
* if an account was affected by the transaction, include:
  + the account number
  + type of account
  + name of each account holder
* every reference number related to the transaction that is meant to be equivalent to an account number
* every transaction identifier (this may include a transaction hash or similar identifier, if applicable)
* every sending and receiving address
...
* the date you received the funds or virtual currency
* if you received the amount from a **person**, their:
  + name
  + address
  + date of birth
  + occupation
  + in the case of a sole proprietor, the nature of their principal business
* if you receive the amount from an **entity**, their:
  + name
  + address
  + nature of their principal business
* the amount received for the issuance
* the amount and type of funds received
* the amount and type of virtual currency involved
* if an account is involved in the transaction:
  + the account number
  + type of account
  + name of each account holder
* every reference number related to the transaction that is meant to be similar to an account number
* if virtual currency is involved:
  + every transaction identifier including transaction hashes or similar identifiers (if applicable)
  + every sending and receiving address
...
* if the client is a **person**, their:
  + name
  + address
  + date of birth
  + occupation
  + in the case of a sole proprietor, the nature of their principal business
* if the client is an **entity**, their:
  + name
  + address
  + nature of their principal business
...
* if an account is involved in the redemption:
  ...
  + type of account
  + name of each account holder
* every reference number related to the redemption that is meant to be similar to an account number
* if the redemption involves virtual currency:
  + every transaction identifier, including transaction hashes or similar identifiers (as applicable)
  + every sending and receiving address
...
* the number of every account involved in the transaction
* every reference number related to the transaction that is meant to be similar to an account number
...
* for each beneficiary that is a **person**, their:
  + name
  + address
  + telephone number
  + date of birth
  + occupation
  + in the case of a sole proprietor, the nature of the principal business
* for each beneficiary that is an **entity**, their:
  + name
  + address
  + telephone number
  + nature of the principal business
* the exchange rates used for the remittance and the source
* the number of every account involved in the transaction
* every reference number related to the transaction that is meant to be similar to an account number
...
When you [initiate](/guidance-directives/glossary-glossaire/1-eng#initiation), at the request of a person or an entity, an electronic funds transfer of $1,000 or more, you must record:

* the date the electronic funds transfer was initiated
...
* if an account is involved in the initiation:
  ...
  + type of account
  + name of each account holder
* every reference number related to the electronic funds transfer that is meant to be similar to an account number
* the number of every account that is involved in the electronic funds transfer, other than those involved in the initiation
...
* the date the electronic funds transfer was sent
* if fiat currencies were exchanged in the course of sending the electronic funds transfer, the amount and type of each fiat currency involved in the exchange
* the exchange rates used and the source
* for every account involved in sending the electronic funds transfer:
  + the account number
  + type of account
  + name of each account holder
* every reference number related to sending the electronic funds transfer that is meant to be similar to an account number
* the name and address of the person or entity that requested the initiation of the electronic funds transfer, unless the information was not included with the transfer and cannot be obtained by taking [reasonable measures](/guidance-directives/glossary-glossaire/1-eng#reasonable)
...
* the date the electronic funds transfer was [finally received](/guidance-directives/glossary-glossaire/1-eng#final)
...
* if the remittance is not in funds, the type of remittance (for example, virtual currency, precious stones) and its value, if different from the amount of funds finally received
* for every account involved in the final receipt or remittance:
  + the account number
  + type of account
  + name of each account holder
* every reference number related to the electronic funds transfer that is meant to be similar to an account number
* the name and address of the person or entity that requested the initiation of the electronic funds transfer, unless that information was not included with the transfer and cannot be obtained by taking reasonable measures
* the number of every account that is involved in the electronic funds transfer, other than those involved in the final receipt or remittance

**Note:**

When you initiate, send as an intermediary, or finally receive an electronic funds transfer, you **must** include with the transfer the prescribed information in accordance with the travel rule. For more information, consult: [Travel rule for electronic funds and virtual currency transfers](/guidance-directives/transaction-operation/travel-acheminement/1-eng).
...
* the amount and type of virtual currencies that are involved in the transfer
* if the client is a **person**, their:
  + name
  + address
  + date of birth
...
* for every account involved in the transfer:
  ...
  + name of each account holder
* every reference number related to the transaction that is meant to be similar to an account number
* every transaction identifier transaction hashes or similar identifiers (if applicable)
* every sending and receiving address
* exchange rates used and the source
...
* the amount and type of virtual currencies that are involved
* for each beneficiary that is a **person**, their:
  + name
  + address
  + date of birth
...
* the date of the remittance
* the exchange rates used for the remittance and the source
* if the remittance is in virtual currency, the amount and type of each virtual currency involved
* if the remittance is not in virtual currency, the type and value of the remittance, if different from the value of the virtual currency received
...
* every reference number related to the transaction that is meant to be similar to an account number
* every transaction identifier, including transaction hashes or similar identifiers (if applicable)
* every sending and receiving addresses
...
For more information, consult: [Travel rule for electronic funds and virtual currency transfers](/guidance-directives/transaction-operation/travel-acheminement/1-eng).
...
* if the **transaction was of $3,000 or more** and **requested by a** **person**, their:
  + name
  + address
  + date of birth
  + occupation
  + in the case of a sole proprietor, the nature of their principal business
* if the **transaction was of $3,000 or more** and **requested by an entity**, their:
  + name
  + address
  + nature of their principal business
* the type and amount of each fiat currency received from the client
* the type and amount of each fiat currency given to the client
...
* if the **virtual currency transaction was equivalent to $1,000 or more** and **requested by a person**, their:
  + name
  + address
  + date of birth
  + occupation
  + in the case of a sole proprietor, the nature of their principal business
* if the **virtual currency transaction was equivalent to $1,000 or more** and **requested by an entity**, their:
  + name
  + address
  + nature of their principal business
* the amount and type of funds and the amount and type of virtual currencies involved in the payment made and received by the person or entity that requested the exchange
* the method (for example, a virtual currency, currency exchange business) by which the payment was made and received
* the exchange rates used and the source
* for every account involved in the transaction:
  + the account number
  + type of account
  + name of each account holder
* every reference number related the transaction that is meant to be similar to that of an account number
* every transaction identifier (this may include a transaction hash or a similar identifier, if applicable)
* every sending and receiving address
...
If you are a money services business or foreign money services business that provides [crowdfunding platform services](/guidance-directives/glossary-glossaire/1-eng#cfps) to persons or entities in Canada, you must:

* keep an [information record](/guidance-directives/glossary-glossaire/1-eng#info) about the person or entity that you are providing those services for (person or entity setting up the fundraiser)
* keep a record of the purpose for which the funds or virtual currency are being raised
* if the funds or virtual currency are being raised for a person or entity other than the person or entity setting up the fundraiser:
  + keep a record of their name
  + take reasonable measures to obtain their address, nature of their principal business or occupation, their date of birth (in the case of a person) and keep a record of the information you obtain
...
* every person who signs the agreement for the entity, their:
  + name
  + address
  + date of birth
  + occupation
  + in the case of a sole proprietor, the nature of their principal business
* an information record about the entity, which must include:
  + name of the entity
  + address of the entity
  + the nature of the entity’s principal business
* if the **entity is a corporation**, you must also keep a copy of the part of its official corporate records that contains provisions relating to the power to bind the corporation in respect of transactions with the money services business or foreign money services business. This could be found in for example:
  + the certificate of incumbency
  + the articles of incorporation
  + the bylaws of the corporation that set out the officers duly authorized to sign on behalf of the corporation, such as the president, treasurer, vice-president, comptroller
...
* every employee who is authorized to order a transaction under the agreement, their:
  + name
  + address
  + date of birth
...
If you are a money services business or foreign money services business that transports [cash](/guidance-directives/glossary-glossaire/1-eng#cash), [virtual currency](/guidance-directives/glossary-glossaire/1-eng#vc) (such as the storage of virtual currency) or negotiable instruments (such as money orders or traveller’s cheques) in Canada, you must keep the following records listed below.
...
* date of collection
* date of delivery
* location that the cash or virtual currency was collected from
* location that that cash or virtual currency was delivered to
* type and amount of cash or virtual currency transported
* information on the person or entity who made the transport request:
  + name
  + address
  + nature of their principal business or occupation
  + in the case of a person, record also their date of birth
* information on each beneficiary (if known):
  + name
  + address
* information on each account affected by the transport:
  + account number
  + type of account
  + name of each account holder
* every reference number that is connected to the transport (that has an equivalent function to an account number)
...
* date of collection
* date of delivery
* location that the negotiable instruments were collected from
* location that that the negotiable instruments were delivered to
* type and amount of negotiable instruments transported
* information on the person or entity who made the transport request:
  + name
  + address
  + nature of their principal business or occupation
...
* date of collection
* date of delivery
* location that the cash, virtual currency, or negotiable instruments was collected from
* location that that cash, virtual currency, or negotiable instruments was delivered to
* the type of cash, virtual currency or negotiable instruments transported (if known)
* information on the person or entity who made the transport request:
  + name
  + address
  + telephone number
...
* information on each account affected by the transport:
  ...
  + name of each account holder
* every reference number that is connected to the transport (that has an equivalent function to an account number)
* reason why the amount was not declared
* method of remittance
...
* location that the cash, virtual currency, or negotiable instruments was collected from
* location that that cash, virtual currency, or negotiable instruments was delivered to
* the type and amount of cash, virtual currency or negotiable instruments transported (if known)
* information on the entity who made the transport request:
  + name
  + address
  + telephone number
...
* date when each cheque was cashed
* information on the person or entity who provided the cheque to be cashed:
  + name
  + address
  + nature or their principal business or occupation
  + if the client is a person, their date of birth
* total amount of the cheque or cheques
* name of the issuer of each cheque
* information on every account affected by the cashing of the cheque or cheques:
  + account number
  + type of account
  + name of each account holder
* every reference number (equivalent to an account number) that is connected to the cashing of the cheque or cheques
...
When you provide acquirer services in relation to a private automated banking machine, you must record:

* information on the owner, the lessor and the operator of the private automated banking machine:
  + name(s)
  + address(es)
  + email address(es)
  + telephone number(s)
  + nature of their principal business or their occupation
  + for a **person**, their date of birth
* information on the owner of the cash that is loaded into the private automated banking machine:
  + name
  + address
  + email address
  + telephone number
  + for a **person**, their date of birth and the nature of their principal business or their occupation
  + for an **entity**, its registration or incorporation number, the jurisdiction and country of issue of that number, and the nature of its principal business
* settlement account number for the private automated banking machine
* information on each settlement account holder:
  + name
  + address
  + if the account holder is a **person**, their date of birth and the nature of their principal business or their occupation
  + if the account holder is an **entity**, its registration or incorporation number, the jurisdiction and country of issue of that number, and the nature of its principal business
* information on the private automated banking machine:
  + terminal identification number
  + brand
  + model
  + serial number
  + the number of bills that the private automated banking machine can contain
  + name of the place of business at which the private automated banking machine is located
  + address of the place of business at which the private automated banking machine is located
  + type of business where the private automated banking machine is located
* an indication of the business relationship, detailing the roles and responsibilities among the private automated banking machine’s owner, lessor, and/or operator, the owner of the cash loaded into the machine, and the owner of the business premises where the machine is located
* source of cash that is loaded into the automated banking machine
* method used to transport the cash

**Retention:** At least five years from the date the acquirer services record was created.

Legal references

* Proceeds of Crime (Money Laundering) and Terrorist Financing Suspicious Transaction Reporting Regulations, subsection 12.1(1)
* Proceeds of Crime (Money Laundering) and Terrorist Financing Regulations (SOR/2002-184)
  ...
  + section 126
  + subsection 129(1)
  + subsections 142(1) and 142(2)
  + subsections 143(1) and 143(2)
  + section 144
  + paragraphs 148(1)(b), 148(1)(c)
...
* from a [financial entity](/guidance-directives/glossary-glossaire/1-eng)
* from a [public body](/guidance-directives/glossary-glossaire/1-eng)
* from a person who is acting on behalf of a client that is a financial entity or public body
* for the purpose of transport:
* to or from another reporting entity (referred to in section 5 of the Act), if the transport is at their request and in an undeclared amount that cannot readily be determined
* between the Bank of Canada and a person or entity in Canada
* between 2 places of business of the same reporting entity (referred to in section 5 of the Act), and the transport is at their request

When you transfer or receive virtual currency as compensation for the validation of a transaction that is recorded in a [distributed ledger](/guidance-directives/glossary-glossaire/1-eng) **or** when you exchange, transfer or receive a nominal amount of virtual currency for the sole purpose of validating different transaction or a transfer of information, you **do not** need to keep a record of:

* large virtual currency transactions
* transfers of $1,000 or more in virtual currency at the request of a person or entity
* receipt of $1,000 or more in virtual currency for remittance to a beneficiary
* virtual currency exchange transaction tickets
...
* Proceeds of Crime (Money Laundering) and Terrorist Financing Regulations (SOR/2002-184)
  ...
  + section 35
  + section 35.1
  + paragraphs 151(1)(a) and 151(1)(b)
  + subsections 151.1(1), 151.1(2)
  + section 153

## For assistance

If you have questions on your requirements, please contact FINTRAC by email at [guidelines-lignesdirectrices@fintrac-canafe.gc.ca](mailto:guidelines-lignesdirectrices@fintrac-canafe.gc.ca).
