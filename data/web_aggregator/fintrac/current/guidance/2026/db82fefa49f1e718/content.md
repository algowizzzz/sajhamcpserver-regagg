# Facture et paiement : Facturer les entités déclarantes pour le programme de conformité de CANAFE

**Du :** [Centre d'analyse des opérations et déclarations financières du Canada](/intro-fra) (CANAFE)

Apprenez-en plus sur la facture que CANAFE envoie aux entités déclarantes (entreprises et personnes) dans le cadre de son modèle de financement par cotisations relatives aux frais et sur les méthodes de paiement recommandées.

## Sur cette page

* [Facture](#s1)
* [Paiement](#s2)
* [Pour obtenir de l’aide](#s3)
* [Liens connexes](#s4)

## Facture

La facture est envoyée aux entités déclarantes par courriel et comprend les éléments suivants :

* la cotisation provisoire pour l’exercice financier en cours (c’est-à-dire le montant prévu)
* le rajustement de la cotisation finale (c’est-à-dire l’écart entre le montant de la cotisation provisoire et le montant de la cotisation finale pour l’exercice financier précédent)
* le montant total dû par l’entité déclarante (c’est-à-dire la somme des 2 montants susmentionnés)
* les renseignements concernant les méthodes de paiement recommandées (consulter la section [Paiement](#s2) ci-dessous) et les modalités connexes

Le courriel et la facture comprendront des références aux pouvoirs accordés à CANAFE de facturer les montants aux entités déclarantes et de recevoir leurs paiements, comme indiqué dans la Loi sur le recyclage des produits de la criminalité et le financement des activités terroristes et les règlements connexes.

### Cotisation provisoire

Voici les éléments qui sont utilisés pour déterminer la cotisation provisoire :

* une prévision du coût total du programme de conformité pour l’exercice financier visé
* le cas échéant, le volume de déclarations d’opérations visées par un seuil de l’entité déclarante pendant l’exercice financier précédent
* le cas échéant, la valeur des actifs canadiens de l’entité déclarante à la fin de l’exercice financier précédent

Le calcul de ce montant a pour but :

* d’estimer le coût total pour l’exercice visé
* de déterminer la partie du coût total qui sera facturée à chaque entité déclarante concernée

### Rajustement de la cotisation finale

Pour déterminer le rajustement de la cotisation finale, on utilise les valeurs réelles de fin d’exercice indiquées dans les états financiers vérifié.

Le rajustement de la cotisation finale sera ensuite déterminé en calculant l’écart entre le montant de la cotisation provisoire (déjà facturé) et le montant de la cotisation finale pour un exercice financier donné.

### Montant total dû

Il s’agit du montant total dû par l’entité déclarante.

**Remarque :** Le montant total dû par l'entité déclarante est **définitif, sans appel, obligatoire et exigible** **en totalité** dès la réception de la facture.

Tous les montants constituent une créance de Sa Majesté le Roi du chef du Canada, sont exigibles immédiatement et peuvent être recouvrés à titre de dettes devant tout tribunal compétent.

## Paiement

La méthode de paiement recommandée est le télévirement, lequel doit être payé en dollars canadiens.

## Pour obtenir de l’aide

Pour toute question concernant le modèle de financement par cotisations relatives aux frais, ou pour utiliser une autre méthode de paiement : [expenses\_assessment-evaluation\_depenses@fintrac-canafe.gc.ca](mailto:expenses_assessment-evaluation_depenses@fintrac-canafe.gc.ca).
...
* [Déterminer le coût du programme de conformité de CANAFE](/guidance-directives/cost-cout/development-elaboration-fra#s2)
