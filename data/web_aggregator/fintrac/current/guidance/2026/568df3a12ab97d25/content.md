...
[British Columbia (BC) notary publics and BC notary corporations](/re-ed/BCnot-eng) have record keeping requirements under the Proceeds of Crime (Money Laundering) and Terrorist Financing Act (PCMLTFA) and associated Regulations.

BC notaries public and BC notary corporations have record keeping obligations when they engage in any of the following activities on behalf of any person or entity (other than their employers), or give instructions for the following activities on behalf of any person or entity (other than their employers):[Footnote 1](#fn20211)
...
* British Columbia (BC) notary publics and BC notary corporations
...
When you submit a [Suspicious Transaction Report (STR)](/guidance-directives/transaction-operation/str-dod/str-dod-eng) to FINTRAC, you must keep a copy of it.[Footnote 2](#fn20212)

**Retention**: At least five years after the day the STR was submitted.[Footnote 3](#fn20213)

#### Listed Person or Entity Property Reports

When you submit a [Listed Person or Entity Property Report](/guidance-directives/transaction-operation/Guide5/5-eng) to FINTRAC, you must keep a copy of it.[Footnote 4](#fn20214)

**Retention**: At least five years after the day the TPR was submitted.[Footnote 5](#fn20215)

#### Large Cash Transaction Reports

When you submit a [Large Cash Transaction Report (LCTR)](/guidance-directives/transaction-operation/lctr-doie/lctr-doie-eng) to FINTRAC, you must keep a copy of it.[Footnote 6](#fn20216)

**Retention**: At least five years from the date LCTR was created.[Footnote 7](#fn20217)

#### Large Virtual Currency Transaction Reports

When you submit a [Large Virtual Currency Transaction Report (LVCTR)](/guidance-directives/transaction-operation/lvctr/lvctr-eng) to FINTRAC, you must keep a copy of it.[Footnote 8](#fn20218)

**Retention**: At least five years from the date the LVCTR was created.[Footnote 9](#fn20219)

### b. Large cash transaction records

You must keep a large cash transaction record when you receive $10,000 or more in cash.[Footnote 10](#fn202110)

If you authorize a person or an entity to receive funds on your behalf, and that person or entity receives $10,000 or more in cash in accordance with the authorization, you are deemed to have received the amount when it is received by the person or entity, and you must keep a large cash transaction record.[Footnote 11](#fn202111)

**\*\*Note**: This requirement is subject to the [24-hour rule](/guidance-directives/transaction-operation/24hour/1-eng).[Footnote 12](#fn202112)

A large cash transaction record must include:[Footnote 13](#fn202113)
...
**Retention**: At least five years from the date the large cash transaction record was created.[Footnote 14](#fn202114)

### c. Large virtual currency transaction records

You must keep a large virtual currency (VC) transaction record when you receive VC in an amount equivalent to $10,000 or more.[Footnote 15](#fn202115)

If you authorize a person or an entity to receive VC on your behalf, and that person or entity receives VC in an amount equivalent to $10,000 or more in accordance with the authorization, you are deemed to have received the VC when it is received by the person or entity, and you must keep a large VC transaction record.[Footnote 16](#fn202116)

**\*\*Note**: This requirement is subject to the 24-hour rule.[Footnote 17](#fn202117)

A large VC transaction record must include:[Footnote 18](#fn202118)
...
**Retention**: At least five years from the date the large VC transaction record was created.[Footnote 19](#fn202119)

### d. Receipt of funds records

When you receive funds (in cash or in another form) of $3,000 or more, you must record:[Footnote 20](#fn202120)
...
If the receipt of funds record is in respect of an entity that is a corporation, you must also keep a copy of the part of the official corporate records that contains any provision relating to the power to bind the corporation regarding the transaction.[Footnote 21](#fn202121) This could be found in:
...
**Retention**: At least five years from the date the receipt of funds record was created.[Footnote 22](#fn202122)

## 2. What are my responsibilities when maintaining records?

In order to comply with your record keeping requirements, you must keep records in such a manner that they can be provided to FINTRAC within 30 days of a request.[Footnote 23](#fn202123) The records may also be requested through a judicial order by law enforcement to support an investigation of money laundering or terrorist activity financing. A record (or a copy) may be kept in a machine-readable or electronic form, so long as a paper copy can easily be produced.[Footnote 24](#fn202124)

Employees who keep records for you are not required to keep them after their employment ends. The same is true for persons in a contractual relationship with you, when the contractual relationship ends, they no longer have to keep records for you.[Footnote 25](#fn202125) You have to obtain and keep the records that were kept for you by an employee or a contractor before the end of the person's employment or contract.
...
If you are required to keep a record with information that is readily available in other records, you do not have to record the information again.[Footnote 26](#fn202126)
...
You do not have to keep a large cash transaction record or a large VC transaction record if the cash or VC was received from a client that is a [financial entity (FE)](/guidance-directives/glossary-glossaire/1-eng#fin) or a [public body](/guidance-directives/glossary-glossaire/1-eng#pb), or a person who is acting on behalf of a client that is an FE or public body.[Footnote 27](#fn202127)

You do not have to keep a receipt of funds record for:[Footnote 28](#fn202128)
...
When you receive VC as compensation for the validation of a transaction that is recorded in a [distributed ledger](/guidance-directives/glossary-glossaire/1-eng#distributed)**or** when you receive a nominal amount of VC for the sole purpose of validating a different transaction or a transfer of information, you do not need to keep a large VC transaction record.[Footnote 29](#fn202129)
...
Footnote 1
:   Proceeds of Crime (Money Laundering) and Terrorist Financing Regulations (PCMLTFR), SOR/2002-184, s. 38.

    [Return to footnote1](#fn20211-rf)

Footnote 2
:   Proceeds of Crime (Money Laundering) and Terrorist Financing Suspicious Transactions Reporting Regulations (PCMLTFSTRR), SOR/2001-317, s. 12.1(1).
...
Footnote 20
:   PCMLTFR, SOR/2002-184, ss. 1(2) and 43.

    [Return to footnote20](#fn202120-rf)

Footnote 21
:   PCMLTFR, SOR/2002-184, s. 43(b).
...
Footnote 27
:   PCMLTFR, SOR/2002-184, ss. 41 and 42.

    [Return to footnote27](#fn202127-rf)

Footnote 28
:   PCMLTFR, SOR/2002-184, s. 154(2)(f), (m),(n), and (o).
