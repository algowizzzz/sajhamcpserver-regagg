...
This guidance explains the methods that can be used by reporting entities to verify the identity of a [person](/guidance-directives/glossary-glossaire/1-eng#person) or an [entity](/guidance-directives/glossary-glossaire/1-eng#entity).

**Note**: For specific information on when to verify the identity of a person or an entity for your business sector, refer to the [related guidance by business sectors](#sectors).

The requirement to verify the identity of a person or an entity under the Proceeds of Crime (Money Laundering) and Terrorist Financing Act (the Act) and associated Regulations **applies to all reporting entities**.

**Note**: Throughout this guidance, references to reporting entities covered under paragraphs 5(a) to (g) of the Act include:

* banks
* [authorized foreign banks](https://laws-lois.justice.gc.ca/eng/acts/b-1.01/FullText.html)
...
* [1. Meaning of verifying the identity of a person or an entity](#s1)
* [2. How to verify the identity of a person](#s2)
  + [2.1 Government-issued photo identification method](#s21)
  + [2.2 Credit file method](#s22)
  + [2.3 Dual-process method](#s23)
  + [2.4 Affiliate or member method](#s24)
  + [2.5 Reliance method](#s25)
* [3. Verifying a person's identity if it has been previously verified](#s4)
* [4. How to identify a child](#s5)
* [5. How to verify the identity of a person who does not have any identity verification documentation or information for a retail deposit account](#s6)
* [6. How to verify the identity of an entity](#s7)
  + [6.1 Confirmation of existence method](#s71)
  + [6.2 Reliance method](#s72)
  + [6.3 Simplified identification method](#s73)
* [7. Verifying the identity of an entity if it has been previously verified](#s8)
* [8. Using an agent or mandatary to verify the identify of a person or an entity on your behalf](#s81) Effective October 1, 2025
* [9. Restrictions on the use of personal information](#s9)
* [Annex 1: Summary of the methods to identify persons and associated record keeping obligations](#a1)
* [Annex 2: Summary of who can identify a person on your behalf](#a2)
* [Annex 3: Summary of methods to identify an entity and associated record keeping obligations](#a3)
* [Annex 4: Examples of acceptable photo identification documents](#a4)
* [Annex 5: Examples of reliable sources of information for the dual-process method](#a5)
* [For assistance](#a6)
...
### Related guidance by business sector
...
* [When to verify the identity of persons and entities – Mortgage administrators, brokers and lenders](/guidance-directives/client-clientele/client/mort-eng)
...
* [Learning resources for businesses](/training-formation/training-formation-eng)
...
[Verifying identity](/guidance-directives/glossary-glossaire/1-eng#verify) is a foundational element of Canada's anti-money laundering and anti-terrorist financing regime and a key component of a reporting entity's relationship with [clients](/guidance-directives/glossary-glossaire/1-eng#client). It helps you to know your clients and to understand and assess any risk that may be associated to their transactions or activities.
...
* be [**authentic**](/guidance-directives/glossary-glossaire/1-eng#authentic), [**valid**](/guidance-directives/glossary-glossaire/1-eng#valid) **and** [**current**](/guidance-directives/glossary-glossaire/1-eng#current)
...
Photo identification documents issued by municipal governments, Canadian or foreign, are not acceptable. See [Annex 4](#a4) for examples of acceptable government-issued photo identification documents.
...
The tradelines cannot be your own, as the reporting entity verifying the person's identity, and each tradeline must originate from a different reliable source (for example, a federally regulated financial institution, a utility service provider, etc.).
...
* an [**affiliate**](/guidance-directives/glossary-glossaire/1-eng#aff) of yours that is a reporting entity referred to in any of paragraphs 5(a) to (g) of the Act
* a **foreign affiliate** of yours that carries out activities outside of Canada that are similar to the activities of a reporting entity referred to in any of paragraphs 5(a) to (g) of the Act, **or**
* a financial entity that is subject to the Act and is a **member** of your financial services cooperative or credit union central
...
* Proceeds of Crime (Money Laundering) and Terrorist Financing Regulations (SOR/2002-184)
  + paragraph 105(1)(e)
  + subparagraph 105(1)(e)(i)
  + subparagraph 105 (1)(e)(ii)
  + subparagraph 105 (1)(e)(iii)
  + paragraph 108(e)
  + paragraph 108(f)
  + subsection 155(1)
...
* **another reporting entity** (person or entity that is referred to in section 5 of the Act, **or**
...
* the **affiliated foreign entity** has policies in place similar to the record keeping, verifying identity, and compliance program requirements under the Act, including the requirement to develop and apply policies to assess, in the course of their activities, the risk of a money laundering offence or a terrorist activity financing offence, and the requirement to take enhanced measures where the risk has been identified as high, **and**
...
To rely on measures previously taken by **another reporting entity** or an **affiliated foreign entity** to verify the identity of a person, you must:

* as soon as feasible, obtain from the **other reporting entity** or **affiliated foreign entity** the information that was confirmed as being that of the person, and be satisfied that:
  + the information is valid and current, and
  + the **other reporting entity** or **affiliated foreign entity** verified the person's identity using the government-issued photo identification method, the credit file method or the dual-process method, or if the **other reporting entity** or **affiliated foreign entity** verified the person's identity prior to June 1, 2021, that they did so in accordance with the Proceeds of Crime (Money Laundering) and Terrorist Financing Regulations, by using the methods that were in place at the time, **and**
* have a written agreement or arrangement with the **other reporting entity** or **affiliated foreign entity** that upon request requires them to provide you, as soon as feasible, with all of the information that they referred to in order to verify the person's identity
...
If you rely on **another reporting entity** or an **affiliated foreign entity** to verify the identity of a person, you must keep a record of:

* the person's name
* the written agreement or arrangement with the **other reporting entity** or **affiliated foreign entity** for the purpose of verifying a person's identity, and
* the information that the **other reporting entity** or **affiliated foreign entity** referred to in order to verify the identity the person
...
## 3. Verifying a person's identity if it has been previously verified
...
* the methods specified in the Proceeds of Crime (Money Laundering) and Terrorist Financing Regulations prior to June 1, 2021 as it read at the time, and have kept the required record
...
**Note**: In the context of a business merger or acquisition, you are not required to re-identify the acquired [clients](/guidance-directives/glossary-glossaire/1-eng#client) if their identities were verified in accordance with the methods in the Proceeds of Crime (Money Laundering) and Terrorist Financing Regulations at the time the verification took place. As a best practice, you are encouraged to review and update client information (for example, name, address, occupation, etc.), in accordance with your [risk assessment](/guidance-directives/glossary-glossaire/1-eng#risk) process. The acquired clients become the responsibility of the acquiring entity which must ensure compliance with the Act and associated Regulations. This includes reviewing any money laundering or terrorist financing risks that may be associated with these clients.
...
## 5. How to verify the identity of a person who does not have any identity verification documentation or information for a retail deposit account

In the case of opening a retail deposit account, if a bank cannot verify a person's identity in accordance with one of the methods outlined above, they would still be in compliance with their anti-money laundering/anti-terrorist financing obligations if they opened the account in a way that meets the conditions set out in [subsections 627.17(1) and (3) of the Bank Act](https://laws-lois.justice.gc.ca/eng/acts/B-1.01/page-64.html#h-1369270).
...
## 6. How to verify the identity of an entity

You can use any of the 3 methods described below to verify the identity of an entity:

1. 6.1 [Confirmation of existing method](#s71)
2. 6.2 [Reliance method](#s72)
3. 6.3 [Simplified identification method](#s73)
...
### 6.1 Confirmation of existence method
...
* another **reporting entity** (a person or entity that is referred to in section 5 of the Act), **or**
* an entity that is affiliated with you **or** with another reporting entity **and** carries out activities outside of Canada that are similar to those of a person or entity referred to in any of paragraphs 5(a) to (g) of the Act (an **affiliated foreign entity**)
...
To rely on the measures previously taken by **another reporting entity** or an **affiliated foreign entity** to verify the identity of a corporation or other entity, you must:

* as soon as feasible, obtain from the **other reporting entity** or **affiliated foreign entity** the information that was used to confirm the identity of the corporation or other entity, as the case may be, and be satisfied that:
  + the information is valid and current
  + **for a corporation**, its identity was verified by the **other reporting entity** or **affiliated foreign entity** by referring to a record as described in the confirmation of existence method above, **or** if the measures to verify the corporation's identity were performed prior to June 1, 2021, that the **other reporting entity** or **affiliated foreign entity** confirmed the corporation's existence and ascertained its name, address, and the names of its directors in accordance with the methods in the Proceeds of Crime (Money Laundering) and Terrorist Financing Regulations as they read at that time
  + **for an entity other than a corporation**, its identity was verified by the **other reporting entity** or **affiliated foreign entity** by referring to a record as described in the confirmation of existence method above, **or** if the measures to verify the entity's identity were performed prior to June 1, 2021, the **other reporting entity** or **affiliated foreign entity** confirmed the entity's existence in accordance with the methods in the Proceeds of Crime (Money Laundering) and Terrorist Financing Regulations as they read at that time, **and**
* have a written agreement or arrangement in place with the **other reporting entity** or **affiliated foreign entity** that upon request requires them to provide you, as soon as feasible, with all of the information that they referred to in order to verify the identity of the **corporation** or other **entity,**as the case may be
...
If you subsequently consider, based on your risk assessment, that the risk of a money laundering offence or terrorist activity financing offence has increased and is no longer low then you **must**, as soon as feasible, verify the identity of the corporation or other entity, as the case may be, by referring to the appropriate records, as explained in [**section 7.1, Confirmation of existence method**](#s71).
...
## 7. Verifying the identity of an entity if it has been previously verified
...
* One of the methods explained in this guidance, or
* in the case of an **entity**, you confirmed the entity's existence in accordance with the Proceeds of Crime (Money Laundering) and Terrorist Financing Regulations, and you complied with the related record keeping provisions, as they read at the time prior to June 1, 2021, **or**
* in the case of a **corporation**, you confirmed the corporation's existence and ascertained its name and address and the names of its directors in accordance with Proceeds of Crime (Money Laundering) and Terrorist Financing Regulations, and you complied with the related record keeping provisions, as they read at the time prior to June 1, 2021
...
## 8. Using an agent or a mandatary to verify the identity of a person or an entity on your behalf

Effective October 1, 2025

You may verify the identity of a person or entity by using an agent or [mandatary](/guidance-directives/glossary-glossaire/1-eng#mandatary) to carry out the verification on your behalf.

For a **person**, the agent or mandatary must carry out the verification in accordance with:

* the government-issued photo identification method
* the credit file method, or
* the dual-process method

For a **corporation and an entity other than a corporation**, the agent or mandatary must carry out the verification in accordance with the confirmation of existence identification method.

You may also rely on the measures that were previously taken by an agent or mandatary to verify the person's, corporation’s or other entity’s identity, if the agent or mandatary was:

* acting in their own capacity at the time, whether or not they were required to use the methods in accordance with the Proceeds of Crime (Money Laundering) and Terrorist Financing Regulations, **or**
* acting as an agent or mandatary under a written agreement or arrangement that was entered into with another reporting entity, required to verify:
  + **a person's** **identity** using either the government-issued photo identification method, the credit file method or the dual-process method, or if the measures were taken prior to June 1, 2021, using the methods in accordance with the Proceeds of Crime (Money Laundering) and Terrorist Financing Regulations that were in place at the time
  + **a corporation’s and other entity’s identity** in accordance with the confirmation of existence method

To use an agent or mandatary to verify the identity of a person, corporation or other entity you must:

* have a written agreement or arrangement in place with the agent or mandatary for the purpose of verifying the person’s, corporation’s or other entity's identity **before**you use them
* obtain, as soon as feasible, all of the information that the agent or mandatary referred to in order to verify the person's, corporation’s or other entity’s identity, and the information that the agent or mandatory confirmed as being that of the person, the corporation or other entity, **and**
* be satisfied that:
  + the information that the agent or mandatary confirmed as being that of the person, corporation or other entity is valid and current
  + the **person's identity** was verified using the government-issued photo identification method, the credit file method or the dual-process method, or, if the person's identity was verified prior to June 1, 2021, using the methods in accordance with the Proceeds of Crime (Money Laundering) and Terrorist Financing Regulations in place at the time
  + the **corporation’s or other entity’s identity** was verified using the confirmation of existence method
...
When you verify the identity of a person or entity by using an agent or mandatary, you must keep a record of:

* the person's or entity’s name
* the written agreement or arrangement with the agent or mandatary for verifying a person's or entity’s identity
* all of the information the agent or mandatary referred to in order to verify the identity of the person or entity, and the information that the agent or mandatary confirmed as being that of the person or entity (this includes, as applicable, information that is required to be kept in the record for the method used)

**Note**: As a reporting entity it is your responsibility to meet your client identification requirements under the Act and associated Regulations, even when you use an agent or mandatary to verify the identity of a person or entity on your behalf, or when you rely on the measures previously taken by an agent or mandatary to verify a person's or entity’s identity.

For example, if your agent verifies the identity of a person using the government-issued photo identification method but they don't refer to an authentic, valid and current photo identification document issued by a federal, provincial or territorial government, or keep the required records after verifying the person's identity, you are still responsible.

Specifically, it is your responsibility to ensure that the agent is verifying client identity and to keep the required records in accordance with the Act and associated Regulations.

Your compliance program's policies and procedures must describe the processes you follow when you rely on an agent or mandatary to verify a person's or entity’s identity and how you will ensure that the information is valid and current.
...
The use of personal information in Canadian commercial activities is protected by the Personal Information Protection and Electronic Documents Act, or by similar provincial legislation. You have to inform clients about the collection of their personal information. However, you do not have to inform them when you include their personal information in the reports you are required to submit to FINTRAC.

The [Office of the Privacy Commissioner of Canada](https://www.priv.gc.ca/en/) can provide further guidance, and has created a Question and Answer document about [Protection and Electronic Documents Act and the Proceeds of Crime (Money Laundering) and Terrorist Financing Act](https://www.priv.gc.ca/en/privacy-topics/surveillance/police-and-public-safety/financial-transaction-reporting/faqs_pcmltfa_01/), to help clarify your responsibilities under the Personal Information Protection and Electronic Documents Act .
...
| --- | --- | --- | --- |
| Government-issued photo identification | Photo identification document issued by a government (not a municipal government) that is authentic, valid and current | Name and photograph | * Person's name * Date of verification * Type of document * Document number * Province or state and country that issued the document * Expiry date (if applicable) |
| Credit file | Valid and current information from a Canadian credit file that has been in existence for at least three years where information is derived from more than one source | Name, address and date of birth | * Person's name * Date you consulted/searched the credit file * Name of the credit bureau or third party vendor * Person's credit file number |
| **Dual-process** | Valid and current information from two different reliable sources where neither the reporting entity nor the person is a source | A combination of two of the following:   * name and address * name and date of birth, **or** * name and confirmation of a financial account | * Person's name * Date you verified the information * Name of the two different sources used to verify the identity of the person * Type of information referred to * Account number or number associated with the information if no account number exists |
| Affiliate or member | Information in the records of the affiliate or the member for the method used | Name, address and date of birth | * Person's name * Date you verified the identity of the person * Name of affiliate or member that previously verified the identity of the person * Method used by the affiliate or member to verify the person's identity * Information that the affiliate or member recorded based on the method used |
| Reliance | * Be satisfied that the information from the other reporting entity or affiliated foreign entity is valid and current and that the person's identity was verified by using the government-issued photo identification, credit file or dual-process methods or * Where the identity was verified prior to June 1, 2021, that the person's identity was verified using one of the methods in force in the Proceeds of Crime (Money Laundering) and Terrorist Financing Regulations at that time | The identification details listed under the identification method used | * Person's name * The written agreement or arrangement with the other reporting entity or affiliated foreign entity for the purpose of verifying a person's identity * The information provided by the other reporting entity or affiliated foreign entity that they referred to in order to verify the identity of the person |
...
| --- | --- | --- | --- |
| **Agent or mandatary that:**  * Acts for you * Previously acted in their own capacity, or acted as an agent or mandatary under a written agreement or arrangement with another person or entity for the purposes of verifying identity | * Be satisfied that the information is valid and current and that the person's identity was verified using one of the government-issued photo identification, credit file or dual-process methods **or** * Where the identity was verified prior to June 1, 2021, that the person's identity was verified using one of the methods in force in the Proceeds of Crime (Money Laundering) and Terrorist Financing Regulations at that time | The identification details listed under the identification method used | * Person's name * The written agreement or arrangement with the agent or mandatary for the purpose of verifying a person's identity * All of the information the agent or mandatary referred to when verifying the person's identity * The information obtained from the agent or mandatary that they confirmed as being that of the person |

## Annex 3: Summary of methods to identify an entity and associated record keeping obligations

| Identification Method | Documents or information to review | Identification details that must match | Information that must be recorded |
| --- | --- | --- | --- |
| Confirmation of existence | * Information that is authentic, valid and current   **For an entity (other than a corporation):**   * partnership agreement * articles of association * the most recent version of any other record that confirms its existence and contains its name and address   **For a corporation:**   * certificate of incorporation * record that has to be filed annually under provincial securities legislation * the most recent version of any other record that confirms the corporation's existence and contains its name and address and the names of its directors | * Name and address * Names of Directors (for corporation only) | If you consulted an electronic record from a publicly accessible database:   * registration number * type of document consulted * source of the electronic document   If you consulted a paper record or an electronic record:   * the paper record, or a copy of the record |
| Reliance | * Verify that information from the other reporting entity or affiliated foreign entity is valid and current and that the entity's identity was verified by using the confirmation of existence method * Where the identity was verified prior to June 1, 2021, that the entity's identity was verified using one of the methods in force in the Proceeds of Crime (Money Laundering) and Terrorist Financing Regulations at that time | * Name and address * Names of Directors (for corporation only) | * Entity's name * The written agreement or arrangement with the other reporting entity or affiliated foreign entity for the purpose of verifying an entity's identity * The information provided by the other reporting entity or affiliated foreign entity that they referred to in order to verify the identity of the entity |
| Simplified identification    (This method can only be used if you are a reporting entity that is referred to in any of paragraphs 5(a) to (g) of the Act.) | * Risk assessment to confirm that the risk of a money laundering offence or terrorist activity financing offence is low * Information to satisfy that the entity exists and that every person who deals with you on behalf of the entity is authorized to do so | Not applicable but this method can only be used to verify the identity of specific entities | * The grounds for considering that there is a low risk of a money laundering offence or terrorist activity financing offence * The information obtained about the entity and persons to satisfy that it exists and that the persons you deal with are authorized to act on behalf of the entity |
...
| [Permanent resident card](https://www.canada.ca/en/immigration-refugees-citizenship/corporate/partners-service-providers/status-documents.html#prcard) | Canada |
...
| [Secure Certificate of Indian Status](https://www.sac-isc.gc.ca/eng/1100100032380/1572461388012) | Canada |
| [Refugee Protection Claimant Document](https://www.canada.ca/en/immigration-refugees-citizenship/corporate/partners-service-providers/status-documents.html#rpcd) (issued prior to March 24, 2025) | Canada |
| [Refugee Protection Identity Document](https://www.canada.ca/en/immigration-refugees-citizenship/corporate/partners-service-providers/status-documents.html#rpid) (issued since March 25, 2025) | Canada |
| Driver's licences | |
...
| [Prince Edward Island Driver's Licence](https://www.princeedwardisland.ca/en/information/transportation-and-infrastructure/getting-a-pei-drivers-license) | Prince Edward Island, Canada |
...
| [Northwest Territories General Identification Card](https://www.inf.gov.nt.ca/en/newlicence) | Northwest Territories, Canada |
| [Nunavut General Identification Card](http://gov.nu.ca/edt/faq/where-can-i-get-general-identification-card) | Nunavut, Canada |
...
| --- | --- | --- |
| **Issued by a Canadian government body:**   * A fax, photocopy, scan or electronic image of a government-issued photo identification document * Any statement, form, certificate or other source issued by a Canadian government body (federal, provincial, territorial or municipal):   + Canada Pension Plan statement   + Property tax assessment issued by a municipality   + Provincially issued vehicle registration * Benefits statement:   + Federal, provincial, territorial, or municipal levels   **Issued by other Canadian sources:**   * Utility bill (for example, electricity, water, telecommunications) * Canada 411 * Record of Employment * Registered investment account statements (for example, Registered Retirement Savings Plan, Tax-Free Savings Account or Registered Retirement Income Fund) * Canadian credit file that has been in existence for at least six months * Product from a Canadian credit bureau or other third party (containing two trade lines in existence for at least six months) * Insurance documents (home, auto, life) * For a currently enrolled student, a transcript or documentation issued by a school that contains a unique reference number | **Issued by a Canadian government body:**   * A fax, photocopy, scan or electronic image of a government-issued photo identification document * Any statement, form, certificate or other source issued by a Canadian government body (federal, provincial, territorial or municipal):   + Birth certificate   + Marriage certificate or government-issued proof of marriage document (long form which includes date of birth)   + Divorce documentation   + Permanent resident card   + Citizenship certificate   + Temporary driver's licence (non-photo)   **Issued by other Canadian sources:**   * Canadian credit file that has been in existence for at least six months * Product from a Canadian credit bureau (containing two trade lines in existence for at least six months) * Investment account statements (for example, Registered Retirement Savings Plan, Guaranteed Investment Certificate) * Insurance documents (home, auto, life)   **Issued by a foreign government:**   * Travel visa * A fax, photocopy, scan or electronic image of a photo identification document issued by a foreign federal, provincial or territorial government (for example, foreign driver's licence or passport) | **Confirm that the person has a deposit account, prepaid payment product account, credit card or loan account by means of:**   * Credit card statement * Bank statement for deposit or chequing accounts * Loan account statement (for example, mortgage) * Cheque that has been processed in the last statement period (cleared, insufficient funds) by a financial institution * Telephone call, email, letter, or other traceable means of confirmation from the financial entity holding the deposit account, prepaid payment product account, credit card or loan account * Product from a Canadian credit bureau (containing two trade lines in existence for at least six months) * Use of micro-deposits |
