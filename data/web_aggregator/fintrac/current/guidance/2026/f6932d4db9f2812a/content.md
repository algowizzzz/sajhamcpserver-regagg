...
If you are an agent of the Crown that accepts deposit liabilities in the course of providing financial services to the public, such as a provincial savings office, you are considered a [financial entity](/guidance-directives/glossary-glossaire/1-eng#fin). Refer to the [sector-specific indicators for financial entities](/guidance-directives/transaction-operation/indicators-indicateurs/fin_mltf-eng) for relevant money laundering (ML) and terrorist financing (TF) ([ML/TF indicators](/guidance-directives/glossary-glossaire/1-eng#mltfi)).

If you are an agent of the Crown that sells precious metals to the public, you are considered a [dealer in precious metals and precious stones (DPMS)](/guidance-directives/glossary-glossaire/1-eng#dpms). Refer to the [sector-specific indicators for DPMS](/guidance-directives/transaction-operation/indicators-indicateurs/dpms_mltf-eng) for relevant ML/TF indicators.

## Related guidance

* [Reporting suspicious transactions to FINTRAC](/guidance-directives/transaction-operation/str-dod/str-dod-eng)
* [Indicators for financial entities](/guidance-directives/transaction-operation/indicators-indicateurs/fin_mltf-eng)
* [Indicators for DPMS](/guidance-directives/transaction-operation/indicators-indicateurs/dpms_mltf-eng)
