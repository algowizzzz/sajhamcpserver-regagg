...
* le virement de fonds ou le transfert de valeurs mobilières ou de MV par tout moyen.
...
Lorsque vous soumettez une [Déclaration d'opérations douteuses à CANAFE](/guidance-directives/transaction-operation/str-dod/str-dod-fra), vous devez en conserver une copie.[Note de bas de page 2](#fn20212)

**Conservation** : Au moins cinq ans à compter de la date à laquelle la DOD a été soumise.[Note de bas de page 3](#fn20213)

#### Déclarations de biens appartenant à une personne ou entité inscrite

Lorsque vous soumettez une [déclaration de biens appartenant à une personne ou entité inscrite](/guidance-directives/transaction-operation/Guide5/5-fra) à CANAFE, vous devez en conserver une copie.[Note de bas de page 4](#fn20214)

**Conservation** : Au moins cinq ans à compter de la date à laquelle la DBGT a été soumise.[Note de bas de page 5](#fn20215)

#### Déclarations d'opérations importantes en espèces

Lorsque vous soumettez une [déclaration d'opérations importantes en espèces](/guidance-directives/transaction-operation/lctr-doie/lctr-doie-fra) à CANAFE, vous devez en conserver une copie.[Note de bas de page 6](#fn20216)

**Conservation** : Au moins cinq ans à compter de la date à laquelle la DOIE a été créée.[Note de bas de page 7](#fn20217)

#### Déclarations d'opérations importantes en monnaie virtuelle

Lorsque vous soumettez une [déclaration d'opérations importantes en monnaie virtuelle (DOIMV)](/guidance-directives/transaction-operation/lvctr/lvctr-fra) à CANAFE, vous devez en conserver une copie.[Note de bas de page 8](#fn20218)

**Conservation** : Au moins cinq ans à compter de la date à laquelle la DOIMV a été créée.[Note de bas de page 9](#fn20219)

### b. Relevés d'opérations importantes en espèces

Vous devez conserver un relevé d'opérations importantes en espèces lors de la réception de 10 000 $ ou plus en espèces.[Note de bas de page 10](#fn202110)

Si vous autorisez une personne ou une entité à recevoir des fonds en votre nom, et que cette personne ou entité reçoit 10 000 $ ou plus en espèces conformément à l'autorisation, vous êtes réputé avoir reçu le montant lorsqu'il est reçu par la personne ou l'entité, et vous devez tenir un relevé d'opérations importantes en espèces. [Note de bas de page 11](#fn202111)

**\*\*Remarque** : La [règle de 24 heures](/guidance-directives/transaction-operation/24hour/1-fra) s'applique à la présente exigence.[Note de bas de page 12](#fn202112)

Un relevé d'opérations importantes en espèces doit inclure les renseignements suivants :[Note de bas de page 13](#fn202113)
...
**Conservation** : Au moins cinq ans à compter de la date à laquelle le relevé d'opérations importantes en espèces a été créé.[Note de bas de page 14](#fn202114)

### c. Relevés d'opérations importantes en monnaie virtuelle

Vous devez conserver un relevé des opérations importantes en monnaie virtuelle (MV) lors de la réception d'une somme en MV équivalent à 10 000 $ ou plus.[Note de bas de page 15](#fn202115)

Si vous autorisez une personne ou une entité à recevoir de la MV en votre nom, et que cette personne ou entité reçoit une somme en MV équivalent à 10 000 $ ou plus conformément à l'autorisation, vous êtes réputé avoir reçu la MV lorsque la personne ou l'entité la reçoit, et vous devez conserver un relevé d'opérations importantes en MV.[Note de bas de page 16](#fn202116)

\*\***Remarque** : La règle de 24 heures s'applique à la présente exigence.[Note de bas de page 17](#fn202117)

Un relevé d'opérations importantes en MV doit inclure les renseignements suivants :[Note de bas de page 18](#fn202118)
...
**Conservation** : Au moins cinq ans à compter de la date à laquelle le relevé d'opération importante en MV a été créé.[Note de bas de page 19](#fn202119)

### d. Relevés de réception de fonds

Lorsque vous recevez des fonds (en espèces ou sous une autre forme) de 3 000 $ ou plus, vous devez consigner les renseignements suivants :[Note de bas de page 20](#fn202120)
...
**Conservation** : Au moins cinq ans à compter de la date à laquelle le relevé de réception de fonds a été créé.[Note de bas de page 22](#fn202122)

## 2. Quelles sont mes responsabilités en matière de tenue de documents?

Afin de vous conformer aux exigences en matière de tenue de documents, vous devez conserver les documents de manière à ce qu'ils puissent être fournis à CANAFE dans les 30 jours suivant la date à laquelle ils sont demandés.[Note de bas de page 23](#fn202123)Les documents peuvent également être demandés par le biais d'une ordonnance judiciaire par les organismes d'application de la loi afin d'appuyer une enquête sur le blanchiment d'argent ou le financement des activités terroristes. Un document (ou une copie) peut être tenu sous forme lisible par machine ou sous forme électronique, pourvu qu'un imprimé puisse facilement être produit.[Note de bas de page 24](#fn202124)

Les employés qui tiennent des documents pour vous ne sont pas tenus de les conserver après la fin de leur emploi. Il en va de même pour les personnes avec lesquelles vous êtes liées par contrat, une fois le lien d'emploi ou contractuel est rompu, ces personnes ne sont plus obligées de tenir des documents à votre place.[Note de bas de page 25](#fn202125) Vous devez obtenir et conserver les documents qui ont été tenus pour vous par un employé ou un entrepreneur avant la fin de l'emploi ou du contrat de cette personne.
...
Si vous devez conserver un document contenant des renseignements auxquels vous pouvez facilement avoir accès dans d'autres documents que vous avez déjà à votre disposition, vous n'êtes pas tenu de consigner les mêmes renseignements une seconde fois.[Note de bas de page 26](#fn202126)
...
:   Le Règlement sur le recyclage des produits de la criminalité et le financement des activités terroristes (le Règlement), DORS/2002-184, art. 38.
...
:   Le Règlement, DORS/2002-184, art. 41 et 62.
...
:   Le Règlement, DORS/2002-184, art. 42 et 63.
...
:   Le Règlement, DORS/2002-184, al. 1(2) et 43.

    [Retour à la référence de la note de bas de page 20](#fn202120-rf)

Note de bas de page 21
:   Le Règlement, DORS/2002-184, al. 43(b).
...
:   Le Règlement, DORS/2002-184, art. 41 et 42.

    [Retour à la référence de la note de bas de page 27](#fn202127-rf)

Note de bas de page 28
:   Le Règlement, DORS/2002-184, al. 154(2))(f), (m),(n), et (o).
