...
La présente directive décrit certaines exigences en matière de tenue de documents s’appliquant aux [entreprises de services monétaires](/guidance-directives/glossary-glossaire/1-fra#esm) et aux [entreprises de services monétaires étrangères](/guidance-directives/glossary-glossaire/1-fra#esme).
...
* [Directive sur les personnes politiquement vulnérables et les dirigeants d’une organisation internationale à l’intention des secteurs d’entités déclarantes dont les activités ne sont pas liées à des comptes](/guidance-directives/client-clientele/pep/pep-non-acct-fra)
...
* [1. Les documents à conserver et ce qu’ils doivent contenir](#s1)
* [2. Mes responsabilités en matière de tenue de documents](#s2)
* [3. Les exceptions aux exigences en matière de tenue de documents](#s3)
* [Aide](#s4)
...
* [Une copie de toutes les déclarations transmises à CANAFE](#x1)
...
* [Relevés d’opération importante en espèces](#x2)
  + Lorsque vous recevez un montant en espèces équivalent à 10 000 $ ou plus en une seule opération.
* [Relevés d’opération importante en monnaie virtuelle](#x3)
  + Lorsque vous recevez un montant en monnaie virtuelle équivalent à 10 000 $ ou plus en une seule opération.
* [Relevés d’opération de 3 000 $ ou plus](#x4)
  + Lorsque vous recevez des fonds ou de la monnaie virtuelle d’un montant équivalent à 3 000 $ ou plus pour l’émission de titres négociables.
  + Lorsque vous rachetez un ou plusieurs mandats d’une valeur totale de 3 000 $ ou plus en fonds ou en monnaie virtuelle.
* [Relevés de remise et de transmission de fonds de 1 000 $ ou plus par un moyen autre qu’un télévirement](#x5)
  + Lorsque vous transmettez des fonds d’un montant de 1 000 $ ou plus par un moyen autre qu’un télévirement.
  + Lorsque vous remettez des fonds d’un montant de 1 000 $ ou plus à un bénéficiaire par un moyen autre qu’un télévirement.
* [Relevés de télévirement de 1 000 $ ou plus](#x6)
  + Lorsque vous **[amorcez](/guidance-directives/glossary-glossaire/1-fra#amorcer)** un télévirement international de 1 000 $ ou plus.
  + Lorsque vous envoyez un télévirement international de 1 000 $ ou plus qu’une autre entité déclarante a amorcé.
  + Lorsque vous êtes le destinataire d’un télévirement international de 1 000 $ ou plus.
* [Relevés de transfert d’un montant en monnaie virtuelle équivalent à 1 000 $ ou plus](#x7)
  + Lorsque vous transférez de la monnaie virtuelle d’un montant équivalent à 1 000 $ ou plus.
  + Lorsque vous recevez de la monnaie virtuelle d’un montant équivalent à 1 000 $ ou plus à remettre à un bénéficiaire.
* [Fiches d’opération de change en devise](#x8)
  + Lorsque vous effectuez une opération de change en devise.
* [Fiches d’opérations de change en monnaie virtuelle](#x9)
  + Lorsque vous effectuez une opération de change en monnaie virtuelle.
* [Relevés de services de plateforme de sociofinancement](#x10)
  + Lorsque vous offrez des services de plateforme de sociofinancement.
* [Notes de service internes](#x11)
  + Lorsque vous créez ou recevez des notes de service internes au sujet de services.
* [Relevés d’accord de service](#x12)
  + Lorsque vous concluez un accord pour fournir un service d’entreprise de services monétaires.
* [Relevés de transport](#x13)
  + Lorsque vous transportez 1 000 $ ou plus en espèces ou en monnaie virtuelle.
  + Lorsque vous transportez 3 000 $ ou plus en titres négociables.
  + Lorsque vous transportez un montant non déclaré en espèces, en monnaie virtuelle ou en titres négociables qui ne peut pas être facilement déterminé.
  + Lorsque vous transportez des espèces, de la monnaie virtuelle ou des titres négociables à la demande d’une banque, d’une caisse de crédit ou d’une caisse populaire.
* [Relevés d’encaissement de chèques](#x14)
  + Lorsque vous encaissez un ou plusieurs chèques totalisant 3 000 $ ou plus.
* [Documents à l’égard de services d’acquéreur](#x15)
  + Lorsque vous fournissez des service d’acquéreur à l’égard d’un guichet automatique privé.
...
* Si la profession d’un client est « gérant » ou « directeur », il faut indiquer son domaine de gestion, comme « directeur des réservations d’hôtel » ou « gérant d’une boutique de vente au détail de vêtements ».
* Si la nature de l’activité principale d’une entité est la « vente », il faut préciser le type de ventes, comme « ventes pharmaceutiques » ou « ventes au détail ».
...
* [Déclaration d’opérations douteuses](/guidance-directives/transaction-operation/str-dod/str-dod-fra)
...
* [Déclarations d’opérations importantes en espèces](/guidance-directives/transaction-operation/lctr-doie/lctr-doie-fra)
* [Déclaration d’opérations importantes en monnaie virtuelle](/guidance-directives/transaction-operation/lvctr/lvctr-fra)
* [Déclaration de télévirements](/guidance-directives/transaction-operation/eft-dt/eft-dt-fra)
...
Les entreprises de services monétaires étrangères doivent conserver un relevé d’opération importante en espèces lors de la réception de 10 000 $ ou plus en espèces d’une [personne](/guidance-directives/glossary-glossaire/1-fra#personne) ou d’une [entité](/guidance-directives/glossary-glossaire/1-fra#entite) au Canada.
...
**Remarque :** La [règle de 24 heures](/guidance-directives/transaction-operation/24hour/1-fra) s’applique à la présente exigence.

Un relevé d’opération importante en espèces doit inclure les renseignements suivants :

* La date de réception des espèces
* Pour toute **personne** ayant participé à l’opération, y compris la personne de qui vous avez reçu les espèces :
  + Son nom
  + Son adresse
  + Sa date de naissance
  + Sa profession
  + Dans le cas d’un propriétaire unique, la nature de son activité principale
* Pour toute **entité** ayant participé à l’opération, y compris l’entité de qui vous avez reçu les espèces :
  + Son nom
  + Son adresse
  + La nature de son activité principale
* Le type et le montant de chaque monnaie fiduciaire liée à la réception
* La méthode au moyen de laquelle vous avez reçu les espèces (par exemple, en personne, par courrier ou par voiture blindée)
* Les taux de change utilisés et la source (s’il y a lieu)
* Si un compte est touché par l’opération :
  + Le numéro du compte
  + Le type de compte (par exemple, personnel ou d’entreprise)
...
* L’objet de l’opération (par exemple, des espèces ont été utilisées pour acheter un mandat)
* Les détails ci-après à l’égard de la remise du montant reçu (c’est-à-dire la répartition de fonds), ou de la remise faite en échange du montant :
  + La méthode de remise (par exemple, virement bancaire ou mandat)
  + Si la remise prend la forme de fonds, les types de fonds en cause et le montant en cause, pour chaque type
  + Si la remise prend une autre forme, la forme en cause (par exemple, monnaie virtuelle) et, si elle diffère du montant reçu en espèces, la valeur de la remise
...
* La date de réception de la monnaie virtuelle
* Pour toute **personne** ayant participé à l’opération, y compris la personne de qui vous avez reçu la monnaie virtuelle :
  + Son nom
  + Son adresse
  + Sa date de naissance
  + Sa profession
  + Dans le cas d’un propriétaire unique, la nature de son activité principale
* Pour toute **entité** ayant participé à l’opération, y compris l’entité de qui vous avez reçu la monnaie virtuelle :
  + Son nom
  + Son adresse
  + La nature de son activité principale
* Le type et le montant de chaque monnaie virtuelle liée à la réception
* Les taux de change utilisés et la source
* Si un compte est touché par l’opération :
  + Le numéro du compte
  + Le type de compte
  + Le nom de chaque titulaire du compte
* Tous les numéros de référence liés à l’opération dont la fonction est équivalente à celle d’un numéro de compte
* Tous les identifiants de l’opération, y compris les identifiants de bloc par hachage (transaction hash) ou autres identifiants similaires (s’il y a lieu)
* Toutes les adresses d’envoi et de réception
...
* La date de réception des fonds ou de la monnaie virtuelle
* Si vous recevez le montant d’une **personne** :
  + Son nom
  + Son adresse
  + Sa date de naissance
  + Sa profession
  + Dans le cas d’un propriétaire unique, la nature de son activité principale
* Si vous recevez le montant d’une **entité** :
  + Son nom
  + Son adresse
  + La nature de son activité principale
* Le montant reçu pour l’émission
* Le montant et le type de fonds reçu
* Le montant et le type de monnaie virtuelle liée à l’opération
* Si un compte est touché par l’opération :
  + Le numéro du compte
  + Le type de compte
  + Le nom de chaque titulaire du compte
* Tous les numéros de référence liés à l’opération dont la fonction est équivalente à celle d’un numéro de compte
* Si le montant reçu est en monnaie virtuelle :
  + Tous les identifiants de l’opération, y compris les identifiants de bloc par hachage (transaction hash) ou autres identifiants similaires (s’il y a lieu)
  + Toutes les adresses d’envoi et de réception
...
* La date du rachat du ou des mandats
...
* Si le rachat concerne de la monnaie virtuelle :
  + Tous les identifiants de l’opération y compris les identifiants de bloc par hachage (transaction hash) ou autres identifiants similaires (s’il y a lieu)
  + Toutes les adresses d’envoi et de réception
...
* Pour chaque bénéficiaire qui est une **personne** :
  + Son nom
  + Son adresse
  + Son numéro de téléphone
  + Sa date de naissance
  + Sa profession
  + Dans le cas d’un propriétaire unique, la nature de son activité principale
* Pour chaque bénéficiaire qui est une **entité** :
  + Son nom
  + Son adresse
  + Son numéro de téléphone
  + La nature de son activité principale
* Les taux de change utilisés pour la remise et la source
* Le numéro du compte de tout compte touché par l’opération
* Tous les numéros de référence liés à l’opération dont la fonction est équivalente à celle d’un numéro de compte
...
Lorsque vous [amorcez](/guidance-directives/glossary-glossaire/1-fra#amorcer) à la demande d’une personne ou d’une entité, un télévirement de 1 000 $ ou plus, vous devez consigner les renseignements suivants :

* La date à laquelle le télévirement est amorcé
* Le montant et le type de fonds lié à l’amorce
* Si le client est une **personne** :
  + Son nom
  + Son adresse
  + Son numéro de téléphone
...
* La date à laquelle le télévirement est envoyé
* Si des monnaies fiduciaires sont échangées dans le cadre de la transmission du télévirement, le montant et le type de monnaie fiduciaire liés à l’échange
* Les taux de change utilisés et la source
...
* Le nom et l’adresse de la personne ou de l’entité qui a demandé que soit amorcé le télévirement, sauf si, cette information n’accompagne pas le télévirement et qu’elle ne peut pas être obtenue malgré la prise de [mesures raisonnables](/guidance-directives/glossary-glossaire/1-fra#raisonnable)
...
* La date à laquelle le télévirement est [reçu à titre de destinataire](/guidance-directives/glossary-glossaire/1-fra#destinataire)
* Le montant et le type de fonds liés à la réception à titre de destinataire
* Pour chaque bénéficiaire qui est une **personne** :
  + Son nom
  + Son adresse
  + Son numéro de téléphone
...
* Si la remise n’est pas sous forme de fonds (par exemple, monnaie virtuelle ou pierres précieuses), la forme de la remise et, si elle diffère du montant des fonds reçus à titre de destinataire, la valeur de la remise
* Pour chaque compte touché par la réception à titre de destinataire ou la remise :
  + Le numéro du compte
  + Le type de compte
  + Le nom de chaque titulaire du compte
* Tous les numéros de référence liés au télévirement dont la fonction est équivalente à celle d’un numéro de compte
* Le nom et l’adresse de la personne ou entité qui a demandé que soit amorcé le télévirement, à moins que ces renseignements n’accompagnent pas le télévirement et ne puissent pas être obtenus malgré la prise de mesures raisonnables
...
Lorsque vous amorcez, transmettez à titre d’intermédiaire, ou recevez à titre de destinataire un télévirement, vous **devez** y inclure les renseignements réglementaires conformément à la règle d’acheminement. Pour obtenir d’autres renseignements, veuillez consulter la [Règle d’acheminement pour les télévirements et le transfert de monnaie virtuelle](/guidance-directives/transaction-operation/travel-acheminement/1-fra).
...
* Le montant et le type de monnaie virtuelle en cause
* Si le client est une **personne** :
  + Son nom
  + Son adresse
  + Sa date de naissance
...
* Pour tout compte touché par l’opération :
  ...
  + Le nom de chaque titulaire du compte
* Tous les numéros de référence liés à l’opération dont la fonction est équivalente à celle d’un numéro de compte
* Tous les identifiants de l’opération, identifiants de bloc par hachage [transaction hash] ou autres identifiants similaires (s’il y a lieu)
* Toutes les adresses d’envoi et de réception
* Les taux de change utilisés et la source
...
* Le montant et le type de chaque monnaie virtuelle en cause
* Pour chaque bénéficiaire qui est une **personne**
  + Son nom
  + Son adresse
  + Sa date de naissance
...
* La date de la remise
* Les taux de change utilisés pour la remise et la source
* Si la remise est sous forme de monnaie virtuelle, le montant et le type de chaque monnaie virtuelle liée à la remise
...
* Pour chaque compte touché par l’opération :
  + Le numéro du compte
  + Le type de compte
  + Le nom de chaque titulaire du compte
* Tous les numéros de référence liés à l’opération dont la fonction est équivalente à celle d’un numéro de compte
* Tous les identifiants de l’opération, y compris les identifiants de bloc par hachage (transaction hash) les autres identifiants similaires (s’il y a lieu)
* Toutes les adresses d’envoi et de réception
* Le nom et l’adresse de la personne ou entité qui a demandé le transfert, à moins que ces renseignements n’accompagnent pas le transfert, et qu’ils ne peuvent pas être obtenus malgré la prise de mesures raisonnables
...
Pour de l’information supplémentaire, veuillez consulter la [Règle d’acheminement pour les télévirements et le transfert de monnaie virtuelle](/guidance-directives/transaction-operation/travel-acheminement/1-fra).
...
* Dans le cas d’**une opération de 3 000 $ ou plus demandée par une personne** :
  + Son nom
  + Son adresse
  + Sa date de naissance
  + Sa profession
  + Dans le cas d’un propriétaire unique, la nature de son activité principale
* Dans le cas d’**une opération de 3 000 $ ou plus demandée par une entité**
  + Son nom
  + Son adresse
  + La nature de son activité principale
* Le type et le montant de chaque monnaie fiduciaire reçue du client
* Le type et le montant de chaque monnaie fiduciaire remise au client
* La méthode (comme le recours à un bureau de change) grâce à laquelle le paiement a été effectué et reçu
* Les taux de change utilisés et la source
* Pour tout compte touché par l’opération :
  + Le numéro du compte
  + Le type de compte
...
* La date de l’opération
* Dans le cas d’**une opération en monnaie virtuelle équivalente à 1 000 $ ou plus demandée par une personne** :
  + Son nom
  + Son adresse
  + Sa date de naissance
  + Sa profession
  + Dans le cas d’un propriétaire unique, la nature de son activité principale
* Dans le cas d’**une opération en monnaie virtuelle équivalente à 1 000 $ ou plus demandée par une entité** :
  + Son nom
  + Son adresse
  + La nature de son activité principale
* Le montant et le type des fonds et des monnaies virtuelles en cause dans le paiement fait et reçu par la personne ou l’entité qui a demandé l’opération de change
* La méthode (comme le recours à un bureau de change en monnaie virtuelle) grâce à laquelle le paiement a été effectué et reçu
* Les taux de change utilisés et la source
* Pour tout compte touché par l’opération :
  + Le numéro du compte
  + Le type de compte
  + Le nom de chaque titulaire du compte
* Tous les numéros de référence liés à l’opération dont la fonction est équivalente à celle d’un numéro de compte
* Tous les identifiants de l’opération (cela peut inclure un identifiant de bloc par hachage [transaction hash] ou un identifiant similaire, s’il y a lieu)
...
Si vous êtes une entreprise de services monétaires ou une entreprise de services monétaires étrangère qui fournit des [services de plateforme de sociofinancement](/guidance-directives/glossary-glossaire/1-fra#cfps) à des personnes ou à des entités au Canada, vous devez :

* conserver un [dossier de renseignements](/guidance-directives/glossary-glossaire/1-fra#dossier) sur toute personne ou entité à qui vous fournissez de tels services (personne ou entité qui organise la collecte de fonds);
* conserver un dossier sur l’objectif de la collecte de fonds ou de monnaies virtuelles;
* si la collecte de fonds ou de monnaies virtuelles est effectuée pour une autre personne ou entité que celle qui l’a organisée :
  + conserver le nom de celle-ci;
  + prendre des mesures raisonnables pour connaître l’adresse, la nature de l’activité principale ou la profession et la date de naissance (lorsqu’il s’agit d’une personne) de celle-ci, et conserver cette information.
...
* Pour chaque personne qui signe l’accord pour l’entité :
  + Son nom
  + Son adresse
  + Sa date de naissance
  + Sa profession
  + Dans le cas d’un propriétaire unique, la nature de son activité principale
* Un dossier de renseignements au sujet de l’entité, qui inclut :
  + Le nom de l’entité
  + L’adresse de l’entité
  + La nature de l’activité principale de l’entité
* Si l’**entité est une personne morale**, vous devez également conserver une copie de l’extrait des registres officiels de la personne morale où figure toute disposition portant sur le pouvoir de la lier quant aux opérations effectuées avec l’entreprise de services monétaires ou l’entreprise de services monétaires étrangère. Il pourrait s’agir, par exemple :
  + De l’attestation de fonction
  + Des statuts constitutifs
  + Des règlements administratifs de la personne morale qui précisent les cadres dûment autorisés à signer pour le compte de la personne morale, par exemple le président, le trésorier, le vice-président ou le contrôleur
...
* Pour chaque employé qui est autorisé à ordonner que des opérations soient effectuées aux termes de l’accord :
  + Son nom
  + Son adresse
  + Sa date de naissance
...
Si vous êtes une entreprise de services monétaires ou une entreprise de services monétaires étrangère qui transporte des [espèces](/guidance-directives/glossary-glossaire/1-fra#espèces), de la [monnaie virtuelle](/guidance-directives/glossary-glossaire/1-fra#monnaievirtuelle) (comme pour le stockage de monnaies virtuelles) ou des titres négociables (comme des mandats ou des chèques de voyage) au Canada, vous devez conserver les renseignements énumérés ci-dessous.
...
* Le lieu de collecte des espèces ou de la monnaie virtuelle
* Le lieu de livraison des espèces ou de la monnaie virtuelle
* Le type et le montant des espèces ou de la monnaie virtuelle dont vous avez fait le transport
* Les renseignements sur la personne ou l’entité qui a demandé le transport :
  + Son nom
  + Son adresse
  + La nature de son activité principale ou sa profession
  + Dans le cas d’une personne, sa date de naissance
* Les renseignements sur chaque bénéficiaire (s’ils sont connus) :
  + Son nom
  + Son adresse
* Les renseignements sur chaque compte touché par le transport :
  + Le numéro du compte
  + Le type de compte
  + Le nom de chaque titulaire du compte
* Tous les numéros de référence liés au transport (dont la fonction est équivalente à celle d’un numéro de compte)
...
* La date de collecte
* La date de livraison
* Le lieu de collecte des titres négociables
* Le lieu de livraison des titres négociables
* Le type et le montant des titres négociables dont vous avez fait le transport
* Les renseignements sur la personne ou l’entité qui a demandé le transport :
  + Son nom
  + Son adresse
  + La nature de son activité principale ou sa profession
...
* La date de collecte
* La date de livraison
* Le lieu de collecte des espèces, de la monnaie virtuelle ou des titres négociables
* Le lieu de livraison des espèces, de la monnaie virtuelle ou des titres négociables
* Le type des espèces, de la monnaie virtuelle ou des titres négociables dont vous avez fait le transport (s’il est connu)
* Les renseignements sur la personne ou l’entité qui a demandé le transport :
  + Son nom
  + Son adresse
  + Son numéro de téléphone
...
* Les renseignements sur chaque compte touché par le transport :
  ...
  + Le nom de chaque titulaire du compte
* Tous les numéros de référence liés au transport (dont la fonction est équivalente à celle d’un numéro de compte)
* La raison pour laquelle le montant n’a pas été déclaré
* La méthode de remise
...
* Le lieu de collecte des espèces, de la monnaie virtuelle ou des titres négociables
* Le lieu de livraison des espèces, de la monnaie virtuelle ou des titres négociables
* Le type et le montant des espèces, de la monnaie virtuelle ou des titres négociables dont vous avez fait le transport (s’ils sont connus)
* Les renseignements sur l’entité qui a demandé le transport :
  + Son nom
  + Son adresse
  + Son numéro de téléphone
...
* La date à laquelle chaque chèque a été encaissé
* Les renseignements sur la personne ou l’entité ayant présenté le chèque à encaisser :
  + Son nom
  + Son adresse
  + La nature de son activité principale ou sa profession
  + Si le client est une personne, sa date de naissance
* Le montant total du ou des chèques
* Le nom de l’émetteur de chaque chèque
* Les renseignements de tous les comptes touchés par l’encaissement du ou des chèques :
  + Le numéro du compte
  + Le type de compte
  + Le nom de chaque titulaire du compte
  + Tous les numéros de référence (dont la fonction est équivalente à celle d’un numéro de compte) liés à l’encaissement du ou des chèques
* Si l’encaissement du ou des chèques comprend de la monnaie virtuelle, tous les identifiants de l’opération, y compris les adresses d’envoi et de réception

**Conservation :** Au moins cinq ans à compter de la date à laquelle le relevé d’encaissement du ou des chèques a été créé.

### Documents à l’égard de services d’acquéreur

Lorsque vous fournissez des services d’acquéreur à l’égard d’un guichet automatique privé, vous devez consigner ce qui suit :

* Les renseignements sur le propriétaire, le locataire et l’exploitant du guichet automatique privé :
  + Son nom
  + Son adresse
  ...
  + Dans le cas d’une **personne**, sa date de naissance
* Les renseignements sur le propriétaire des espèces placées à l’intérieur du guichet automatique privé
  + Son nom
  + Son adresse
  + Son adresse de courriel
  + Son numéro de téléphone
  + Dans le cas d’une **personne**, sa date de naissance et la nature de son entreprise principale ou sa profession
  + Dans le cas d’une **entité**, son numéro de constitution ou d’enregistrement ainsi que le territoire et le pays de délivrance de ce numéro et la nature de son entreprise principale
* Le numéro du compte de règlement du guichet automatique privé
* Les renseignements de chaque titulaire du compte :
  + Son nom
  + Son adresse
  + Dans le cas d’une **personne**, sa date de naissance et la nature de son entreprise principale ou sa profession
  + Dans le cas d’une **entité**, son numéro de constitution ou d’enregistrement ainsi que le territoire et le pays de délivrance de ce numéro et la nature de son entreprise principale
* Les renseignements du guichet automatique privé
  + Le numéro d’identification de terminal
  + La marque
  + Le modèle
  + Le numéro de série
  + Le nombre de billets que peut contenir le guichet automatique privé,
  + Le nom de l’établissement où le guichet automatique privé est situé
  + L’adresse de l’établissement où le guichet automatique privé est situé
  + La nature de l’entreprise principale de l’établissement où le guichet automatique privé est situé
* Une mention précisant les relations d’affaires entre le propriétaire des espèces, le propriétaire, le locataire et l’exploitant du guichet automatique privé et le propriétaire de l’établissement où le guichet automatique privé est situé
* La provenance des espèces placées à l’intérieur du guichet automatique privé
* Le moyen utilisé pour transporter les espèces

**Conservation**: Au moins cinq ans à compter de la date où le document à l’égard d'un service d’acquéreur est créé.
...
* Règlement sur le recyclage des produits de la criminalité et le financement des activités terroristes (DORS/2002-184)
  ...
  + article 126
  + paragraphe 129(1)
  + paragraphes 142(1) et 142(2)
  + paragraphes 143(1) et 143(2)
  + article 144
  + alinéas 148(1)b) et 148(1)c)
...
* Une [entité financière](/guidance-directives/glossary-glossaire/1-fra#ef)
* Un [organisme public](/guidance-directives/glossary-glossaire/1-fra#op)
* Une personne qui agit au nom d’un client qui est une entité financière ou un organisme public
* Pour le transport ayant une des caractéristiques suivantes :
  + À destination ou en provenance d’une autre entité déclarante (mentionnée dans l’article 5 de la Loi), si le transport est à sa demande et d’un montant non déclaré qui ne peut pas être facilement déterminé
  + Entre la Banque du Canada et une personne ou entité au Canada
  + Entre deux lieux d’affaires d’une même entité déclarante (mentionnée dans l’article 5 de la Loi), si le transport est à sa demande

Lorsque vous procédez au transfert ou à la réception de monnaies virtuelles à titre de compensation pour la validation d’une opération inscrite dans un [registre distribué](/guidance-directives/glossary-glossaire/1-fra#registredistribue), **ou** à l’échange, au transfert ou à la réception d’un montant symbolique en monnaie virtuelle visant uniquement à valider une autre opération ou un transfert de renseignements, vous **n’êtes pas tenu** de conserver les documents dans lesquels est consigné ce qui suit :

* Les opérations importantes en monnaie virtuelle
* Les transferts de montants en monnaie virtuelle de 1 000 $ ou plus demandés par une personne ou entité
* La réception de montants en monnaie virtuelle de 1 000 $ ou plus à remettre à un bénéficiaire
* Les fiches d’opérations de change en monnaie virtuelle
...
* Entre la Banque du Canada et une personne ou entité au Canada
* Entre deux entités financières
* Entre deux lieux d’affaires d’une même entité déclarante, à sa demande
...
* Règlement sur le recyclage des produits de la criminalité et le financement des activités terroristes (DORS/2002-184)
  ...
  + article 35
  + article 35.1
  + alinéas 151(1)a) et 151(1)b)
  + paragraphes 151.1(1) et 151.1(2)
  + article 153

## Aide

Si vous avez des questions sur les exigences que vous devez respecter, veuillez communiquer avec CANAFE par courriel à l’adresse [guidelines-lignesdirectrices@fintrac-canafe.gc.ca](mailto:guidelines-lignesdirectrices@fintrac-canafe.gc.ca).
