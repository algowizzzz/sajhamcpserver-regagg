...
[Departments and agents of the Crown](/re-ed/agents-eng) have record keeping requirements under the Proceeds of Crime (Money Laundering) and Terrorist Financing Act (PCMLTFA) and associated Regulations.

This guidance will **only** describe the record keeping requirements of departments and agents of the Crown that issue, sell or redeem money orders in the course of providing financial services to the public.[Footnote 1](#fn20211)

If you are a department or an agent of the Crown that accepts deposit liabilities in the course of providing financial services to the public, your requirements can be found on the [financial entities sector page](/re-ed/fin-eng).[Footnote 2](#fn20212)

If you are a department or agent of the Crown that sells precious metals in the amount of $10,000 or more in a single transaction, your requirements can be found on the [dealers in precious metals and precious stones sector page](/re-ed/dpms-eng).[Footnote 3](#fn20213)
...
3. [What are the exceptions to my record keeping obligations?](#s3)
...
**\*\*Note**: This obligation is subject to the [24-hour rule](/guidance-directives/transaction-operation/24hour/1-eng).[Footnote 14](#fn202114)
...
You must keep a large virtual currency (VC) transaction record when you receive VC in an amount equivalent to $10,000 or more.[Footnote 17](#fn202117)

If you authorize a person or entity to receive VC on your behalf, and that person or entity receives VC in an amount equivalent to $10,000 or more in accordance with the authorization, you are deemed to have received VC when it is received by the person or entity, and you must keep a large VC transaction record.[Footnote 18](#fn202118)

**\*\*Note**: This obligation is subject to the 24-hour rule.[Footnote 19](#fn202119)
...
**Retention**: At least five years from the date the large virtual currency transaction record was created.[Footnote 21](#fn202121)

### d. Records for transactions of $3,000 or more

#### Issuing or selling money orders

When you receive $3,000 or more in relation to issuing or selling one or more money orders that total $3,000 or more, you must record:[Footnote 22](#fn202122)
...
* if your client is an entity, the information contained within an [information record](#se);
* the amount received;
...
When you redeem one or more money orders that total $3,000 or more at the request of a person or entity, you must record:[Footnote 23](#fn202123)
...
**Retention**: At least five years from the date the record for a transaction of $3000 or more was created.[Footnote 24](#fn202124)

### e. Information records

If the client is a corporation or other entity, you must keep an information record, which is a record of the entity's name and address, as well as the nature of its principal business.[Footnote 25](#fn202125)

If the information record is kept on a client that is a corporation, you also need to keep a copy of the part of the official corporate records that contains any provision relating to the power to bind the corporation regarding the transaction.[Footnote 26](#fn202126) This could be found in, for example:
...
**Retention**: At least five years from the day the last business transaction was conducted.[Footnote 27](#fn202127)

## 2. What are my responsibilities when maintaining records?

In order to comply with your record keeping requirements, you must keep records in such a manner that they can be provided to FINTRAC within 30 days of a request.[Footnote 28](#fn202128) The records may also be requested through a judicial order by law enforcement to support an investigation of money laundering or terrorist activity financing. A record (or a copy) may be kept in a machine-readable or electronic form, so long as a paper copy can easily be produced.[Footnote 29](#fn202129)

Employees who keep records for you are not required to keep them after their employment ends. The same is true for persons in a contractual relationship with you, when the contractual relationship ends, they no longer have to keep records for you.[Footnote 30](#fn202130) You have to obtain and keep the records that were kept for you by any employee or a contractor before the end of the person's employment or contract.
...
If you are required to keep a record with information thatis readily available in other records, you do not have to record the information again.[Footnote 31](#fn202131)
...
If you receive $3,000 or more from a client that is a [financial entity (FE)](/guidance-directives/glossary-glossaire/1-eng#fin) or a person who is acting on behalf of a client that is a financial entity for the issuance or sale of one or more money orders, you do not have to keep a record of the transaction.[Footnote 32](#fn202132)

You do not have to keep a large cash transaction record or a large VC transaction record if the cash or VC is received from a client that is a financial entity or a [public body](/guidance-directives/glossary-glossaire/1-eng#pb), or from a person who is acting on behalf of a client that is a financial entity or public body.[Footnote 33](#fn202133)

You do not have to keep records for transactions of $3,000 or more nor information records for:[Footnote 34](#fn202134)

* public bodies;
* [very large corporations or trusts](/guidance-directives/glossary-glossaire/1-eng#large); or
...
When you receive VC as compensation for the validation of a transaction that is recorded in a [distributed ledger](/guidance-directives/glossary-glossaire/1-eng#distributed)**or** when you receive a nominal amount of VC for the sole purpose of validating a different transaction or a transfer of information, you do not need to keep a large VC transaction record.[Footnote 35](#fn202135)
...
Footnote 1
:   Proceeds of Crime (Money Laundering) and Terrorist Financing Regulations (PCMLTFR), SOR/2002-184, s. 77.

    [Return to footnote1](#fn20211-rf)

Footnote 2
:   PCMLTFR, SOR/2002-184, ss. 1(2) and 76.

    [Return to footnote2](#fn20212-rf)

Footnote 3
:   PCMLTFR, SOR/2002-184, ss. 1(2) and 65(1).

    [Return to footnote3](#fn20213-rf)

Footnote 4
:   Proceeds of Crime (Money Laundering) and Terrorist Financing Suspicious Transaction Reporting Regulations, SOR/2001-317, s. 12.1(1).
...
Footnote 12
:   PCMLTFR, SOR/2002-184, s. 80.

    [Return to footnote12](#fn202112-rf)

Footnote 13
:   PCMLTFR, SOR/2002-184, s. 142(3).
...
Footnote 17
:   PCMLTFR, SOR/2002-184, s. 81.

    [Return to footnote17](#fn202117-rf)

Footnote 18
:   PCMLTFR, SOR/2002-184, s. 143(3).
...
Footnote 22
:   PCMLTFR, SOR/2002-184, s. 82(a).

    [Return to footnote22](#fn202122-rf)

Footnote 23
:   PCMLTFR, SOR/2002-184, s. 82(b).
...
Footnote 29
:   PCMLTFR, SOR/2002-184, s. 147.

    [Return to footnote29](#fn202129-rf)

Footnote 30
:   PCMLTFR, SOR/2002-184, s. 148(2).
...
Footnote 33
:   PCMLTFR, SOR/2002-184, ss. 80 and 81.

    [Return to footnote33](#fn202133-rf)

Footnote 34
:   PCMLTFR, SOR/2002-184, s. 154(2)(m),(n), and (o).
