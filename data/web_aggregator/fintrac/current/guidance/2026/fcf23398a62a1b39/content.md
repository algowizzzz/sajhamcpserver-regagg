# Exigences en matière de tenue de documents pour les administrateurs, courtiers et prêteurs hypothécaires : Directive de conformité de CANAFE

**Du :** [Centre d'analyse des opérations et déclarations financières du Canada](/intro-fra) (CANAFE)

Cette directive définit certaines exigences en matière de tenue de documents pour les [administrateurs, courtiers et prêteurs hypothécaires](/re-ed/mortgage-hypotheque-fra).

Vous avez d'autres obligations en matière de tenue de documents, lesquelles sont expliquées en détail dans les directives suivantes :
...
* [Directives ministérielles](/obligations/directives-fra)

**Remarque :** Dans la présente directive, toute référence à des montants en dollars (tel que 10 000 $) est faite en dollars canadiens, sauf indication contraire.
...
* [Règlement relatif aux produits de la criminalité (blanchiment d'argent) et au financement des activités terroristes](https://laws-lois.justice.gc.ca/fra/reglements/DORS-2002-184/)

Ressources connexes

* [Avis d'interprétation de CANAFE](/guidance-directives/overview-apercu/fins/1-fra)
* [Base de données des interprétations politiques](/guidance-directives/overview-apercu/pi/pi-fra)
* [Sanctions en cas de non-respect](/pen/1-fra)
* [Glossaire de la directive](/guidance-directives/glossary-glossaire/1-fra)

## 1. Quels documents dois-je tenir et que doivent-ils contenir

Vous devez tenir les documents suivants :

* [déclarations - une copie de toutes les déclarations transmises à CANAFE](#s11)
  + Déclarations d'opérations douteuses+ Déclarations de biens appartenant à une personne ou entité inscrite
    + Déclarations d'opérations importantes en espèces
    + Déclarations d'opérations importantes en monnaie virtuelle
* [relevés d'opérations importantes en espèces](#s12)
  + lorsque vous recevez une somme en espèces équivalent à 10 000 $ ou plus au cours d'une seule opération
* [relevés d'opérations importantes en monnaie virtuelle](#s13)
  + lorsque vous recevez une somme en monnaie virtuelle équivalent à 10 000 $ ou plus au cours d'une seule opération.
* [relevé de réception de fonds](#s14)
  + lorsque vous recevez des fonds, quel qu'en soit le montant, dans le cadre d'une hypothèque sur un bien immobilier ou d'une hypothèque sur un immeuble
* [dossiers de renseignements](#s15)
  + [administrateur hypothécaire](/guidance-directives/glossary-glossaire/1-fra#adminhypo) : lorsque vous effectuez la gestion administrative d'un contrat de prêt hypothécaire sur immeubles ou biens réels.
  + [courtier hypothécaire](/guidance-directives/glossary-glossaire/1-fra#courthypo) : lorsque vous négociez un prêt garanti par hypothèque sur immeuble ou bien réel.
  + [prêteur hypothécaire](/guidance-directives/glossary-glossaire/1-fra#prethypo) : lorsque vous accordez un prêt garanti par hypothèque sur un immeuble ou des biens réels, ou lorsque vous recueillez des fonds pour un tel prêt.
* [dossiers de prêt hypothécaire](#s16)
  + lorsque vous concluez un prêt avec un client qui est garanti par hypothèque sur immeuble ou biens réels.
...
* lorsque le client est un « gérant » ou un « directeur », le dossier doit refléter le domaine de gestion dans lequel il travaille, par exemple « directeur des réservations d'hôtel » ou « gérant d'une boutique de vente au détail de vêtements »
* lorsqu'une entité dans le domaine de la vente, vous devez préciser le type de ventes, par exemple « ventes pharmaceutiques » ou « ventes au détail », pour la nature de l'entreprise principale de l'entité
...
**Conservation**: Au moins 5 ans à compter de la date à laquelle la déclaration a été soumise.

Lorsque vous soumettez une :

* [Déclaration d'opérations importantes en espèces](/guidance-directives/transaction-operation/lctr-doie/lctr-doie-fra)
* [Déclaration d'opérations importantes en monnaie virtuelle](/guidance-directives/transaction-operation/lvctr/lvctr-fra)

**Conservation :** Au moins 5 ans à compter de la date à laquelle la déclaration a été créée.

### Relevés d'opérations importantes en espèces

Vous devez conserver un relevé d'opérations importantes en espèces lors de la réception de 10 000 $ ou plus en espèces.

Si vous autorisez une personne ou une entité à recevoir des fonds en votre nom, et que cette personne ou entité reçoit 10 000 $ ou plus en espèces conformément à l'autorisation, vous êtes réputé avoir reçu le montant lorsqu'il est reçu par la personne ou l'entité, et vous devez tenir un relevé d'opérations importantes en espèces.

**Remarque**: La [règle de 24 heures](/guidance-directives/transaction-operation/24hour/1-fra) s'applique à la présente exigence.

Un relevé d'opérations importantes en espèces doit inclure les renseignements suivants :

* la date de réception;
* pour toute **personne** ayant participé à l'opération (y compris la personne de qui vous avez reçu les espèces), leurs :
  + nom
  + adresse
  + date de naissance
  + profession
  + dans le cas d'un propriétaire unique, la nature de leur activité principale
* pour toute **entité** ayant participé à l'opération (y compris l'entité de qui vous avez reçu les espèces), leur :
  + nom
  + adresse
  + nature de leur activité principale
* les type et montant de chaque monnaie fiduciaire liée à la réception
* l'objet de l'opération
  + par exemple, des espèces ont été utilisées pour acheter un condominium, etc.
* la méthode au moyen de laquelle vous avez reçu les espèces
  + par exemple, en personne, par courrier
* les taux de change utilisés et leur source (s'il y a lieu)
* si un compte est touché par l'opération, indiquez :
  + le numéro du compte
  + le type de compte (par exemple, entreprise, personnel, etc.)
...
**Conservation**: Au moins 5 ans à compter de la date à laquelle le relevé d'opérations importantes en espèces a été créé.

### Relevés d'opérations importantes en monnaie virtuelle
...
Si vous autorisez une personne ou une entité à recevoir de la monnaie virtuelle en votre nom, et que cette personne ou entité reçoit une somme en monnaie virtuelle équivalent à 10 000 $ ou plus conformément à l'autorisation, vous êtes réputé avoir reçu la monnaie virtuelle lorsque la personne ou l'entité la reçoit, et vous devez conserver un relevé d'opérations importantes en monnaie virtuelle.

**Remarque**: La [règle de 24 heures](/guidance-directives/transaction-operation/24hour/1-fra) s'applique à la présente exigence.

Un relevé d'opérations importantes en monnaie virtuelle doit inclure les renseignements suivants :

* la date de réception
* pour toute **personne** ayant participé à l'opération (y compris la personne de qui vous avez reçu la monnaie virtuelle), leurs :
  + nom
  + adresse
  + date de naissance
  + profession
  + dans le cas d'un propriétaire unique, la nature de leur activité principale
* pour toute **entité** ayant participé à l'opération (y compris l'entité de qui vous avez reçu la monnaie virtuelle), leur :
  + nom
  + adresse
  + nature de leur activité principale
...
**Conservation**: Au moins 5 ans à compter de la date à laquelle le relevé d'opérations importantes en monnaie virtuelle a été créé.

### Relevés de réception de fonds

Vous devez conserver un relevé de réception de fonds à l'égard de toute somme reçue en lien avec une hypothèque sur immeuble ou bien réel, lequel doit inclure les renseignements suivants :

* la date de réception
* si vous avez reçu les fonds d'une **personne**, leurs :
  + nom
  + adresse
  + date de naissance
  + profession
  + dans le cas d'un propriétaire unique, la nature de leur activité principale
* si vous avez reçu les fonds **d'une** **entité** **ou pour le compte d'une entité**, leur :
  + nom
  + adresse
  + nature de leur activité principale
* le montant des fonds reçus et le montant de toute partie des fonds qui est reçue en espèces
  + la méthode au moyen de laquelle vous avez reçu les espèces (par exemple, en personne, par courrier)
* les type et montant de chaque monnaie fiduciaire liée à la réception
* les taux de change utilisés et leur source (s'il y a lieu)
* si un compte est touché par l'opération (par exemple, des fonds retirés ou déposés dans un compte), indiquez :
  + le numéro du compte
  + le type de compte
  + le nom de chaque titulaire du compte
* si **d'autres** **personnes** ont participé à l'opération, leurs :
  + nom
  + adresse
  + date de naissance
  + profession
  + dans le cas d'un propriétaire unique, la nature de leur activité principale
* si **d'autres** **entités** ont participé à l'opération, leurs :
  + nom
  + adresse
  + nature de leur activité principale
* tous les numéros de référence liés à l'opération dont la fonction est équivalente à celle d'un numéro de compte
...
Si la réception de fonds est liée à une entité qui est une personne morale, vous devez aussi conserver une copie de l'extrait des registres officiels de celle-ci où figure toute disposition portant sur le pouvoir de lier la personne morale quant à l'opération. Il peut s'agir, par exemple :
...
**Conservation**: Au moins 5 ans à compter de la date à laquelle le relevé de réception de fonds a été créé.

### Dossiers de renseignements

[Administrateurs hypothécaires](/guidance-directives/glossary-glossaire/1-fra#adminhypo) : Vous devez tenir un dossier de renseignements pour chaque personne ou entité pour laquelle vous assurez la gestion administrative de contrats de prêts hypothécaires sur immeubles ou biens réels.

[Courtiers hypothécaires](/guidance-directives/glossary-glossaire/1-fra#courthypo) : Vous devez tenir un dossier de renseignements pour chaque personne ou entité pour laquelle vous négociez un prêt garanti par hypothèque sur immeuble ou bien réel.

[Prêteurs hypothécaires](/guidance-directives/glossary-glossaire/1-fra#prethypo) : Vous devez tenir un dossier de renseignements pour chaque personne ou entité à laquelle vous accordez un prêt garanti par hypothèque sur un immeuble ou des biens réels, ou lorsque vous recueillez des fonds pour un tel prêt.

Si plusieurs clients participent à une opération, un dossier de renseignements doit être tenu pour chaque client.

Un dossier de renseignements doit inclure :

* si le client est une **personne**, leurs :
  + nom
  + adresse
  + date de naissance
  + profession
  + dans le cas d'un propriétaire unique, la nature de leur activité principale
* si le client est une**entité**, leurs :
  + nom
  + adresse
  + nature de leur activité principale

Si le dossier de renseignement est lié à une entité qui est une personne morale, vous devez aussi conserver une copie de l'extrait des registres officiels de celle-ci où figure toute disposition portant sur le pouvoir de lier la personne morale quant à l'opération. Il peut s'agir, par exemple :

* d'un certificat d'attestation de fonction
* des statuts constitutifs ou des règlements administratifs de la personne morale qui précisent les cadres dûment autorisés à signer pour le compte de la personne morale, par exemple le président, le trésorier, le vice-président ou le contrôleur, etc.

**Conservation**: Au moins 5

### Dossiers de prêt hypothécaire

Lorsque vous accordez un prêt garanti par hypothèque sur immeuble ou bien réel conclu avec un client, un document indiquant la capacité financière de ce dernier, vous devez tenir un document indiquant :

* la capacité financière du client
* les modalités du prêt
* la nature de l'activité principale du client ou sa profession
* si le client est une personne, les nom et adresse de son entreprise ou de son lieu de travail

**Conservation**: Au moins 5 ans à compter de la date à laquelle le dossier a été créé.
...
### Clients qui sont des entités financières, organismes publics, et personnes morales ou fiducie dont l'actif est très important

Vous n'êtes pas tenu de conserver un relevé d'opération importante en espèces ou un relevé d'opération importante en monnaie virtuelle si les espèces, la monnaie virtuelle ou les fonds ont été reçus d'un client qui est une [entité financière](/guidance-directives/glossary-glossaire/1-fra) ou un [organisme public](/guidance-directives/glossary-glossaire/1-fra#op), ou d'une personne qui agit pour le compte d'un client qui est une entité financière ou un organisme public.
