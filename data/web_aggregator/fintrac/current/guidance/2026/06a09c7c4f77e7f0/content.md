...
![The following chart depicts a cycle with the 6 steps of the risk-based approach. Each step is described in the following pages.](images/rba2020-eng.png)
...
![Likelihood and impact matrix](images/Likelihood-ImpactMatrix(EN).jpg)
...
| Your client is in possession or control of property that is owned or controlled by or on behalf of a listed person or entity | You are required to send a Listed Person or Entity Property Report to FINTRAC if you have property in your possession or control that is owned or controlled by or on behalf of a listed person or entity. This includes information about transactions or proposed transactions relating to that property. Once you file a Listed Person or Entity Property Report, the client automatically becomes high-risk. |
...
| The entity has a complex structure that conceals the identity of beneficial owners | When you cannot obtain or confirm the ownership and control information of a corporation or an entity, you are required to verify the identity of the most senior managing officer of the entity and treat the entity as high-risk, and apply the prescribed special measures as stated in the Proceeds of Crime Money Laundering and Terrorist Financing Regulations.  For more information, please consult FINTRAC's [Beneficial ownership requirements guidance](/guidance-directives/client-clientele/bor-eng).  It is important to note that when you do have the information on beneficial ownership, there may be other information or indicators that would make this relationship pose a higher risk. |
...
Footnote 1
:   Proceeds of Crime (Money Laundering) and Terrorist Financing Regulations (PCMLTFR), SOR/2002-184, s. 156(1)(c) and Proceeds of Crime (Money Laundering) and Terrorist Financing Act (PCMLTFA), S.C. 2000, c 17, s. 9.6(2).

    [Return to footnote1](#fn20201-rf)

Footnote 2
:   Updated Assessment of Inherent Risks of Money Laundering and Terrorist Financing in Canada: <https://www.canada.ca/en/department-finance/programs/financial-sector-policy/updated-assessment-inherent-risks-money-laundering-terrorist-financing-canada.html>

    [Return to footnote2](#fn20202-rf)

Footnote 3
:   PCMLTFR, SOR/2002-184, s. 156(1)(c)(ii).

    [Return to footnote3](#fn20203-rf)

Footnote 4
:   PCMLTFR, SOR/2002-184, s. 156(1)(c)(iii).

    [Return to footnote4](#fn20204-rf)

Footnote 5
:   PCMLTFR, SOR/2002-184, s. 156(2).

    [Return to footnote5](#fn20205-rf)

Footnote 6
:   PCMLTFR, SOR/2002-184, s. 156(1)(c)(i).

    [Return to footnote6](#fn20206-rf)

Footnote 7
:   PCMLTFR, SOR/2002-184, s. 156(1)(c)(iv).

    [Return to footnote7](#fn20207-rf)

Footnote 8
:   PCMLTFR, SOR/2002-184, s. 156(1)(c)(v).

    [Return to footnote8](#fn20208-rf)

Footnote 9
:   PCMLTFR, SOR/2002-184, s. 123.1(b).

    [Return to footnote9](#fn20209-rf)

Footnote 10
:   PCMLTFR, SOR/2002-184, s. 123.1(c).

    [Return to footnote10](#fn202010-rf)

Footnote 11
:   PCMLTFR, SOR/2002-184, s. 157 and PCMLTFA, S.C. 2000, c 17, s. 9.6(3).

    [Return to footnote11](#fn202011-rf)

Footnote 12
:   Ibid.

    [Return to footnote12](#fn202012-rf)

Footnote 13
:   Ibid.

    [Return to footnote13](#fn202013-rf)

Footnote 14
:   PCMLTFR, SOR/2002-184, s. 145.

    [Return to footnote14](#fn202014-rf)

Footnote 15
:   PCMLTFR, SOR/2002-184, s. 123.1.

    [Return to footnote15](#fn202015-rf)

Footnote 16
:   PCMLTFR, SOR/2002-184, s. 157 and PCMLTFA, S.C. 2000, c 17, s. 9.6(3).

    [Return to footnote16](#fn202016-rf)

Footnote 17
:   Ibid.

    [Return to footnote17](#fn202017-rf)

Footnote 18
:   PCMLTFR, SOR/2002-184, ss. 123.1 and 146(1).

    [Return to footnote18](#fn202018-rf)

Footnote 19
:   PCMLTFR, SOR/2002-184, s. 157 and PCMLTFA, S.C. 2000, c 17, s. 9.6(3).

    [Return to footnote19](#fn202019-rf)

Footnote 20
:   PCMLTFR, SOR/2002-184, ss. 156(1)(c) and 156(2) and PCMLTFA, S.C. 2000, c 17, s. 9.6(2).

    [Return to footnote20](#fn202020-rf)

Footnote 21
:   PCMLTFR, SOR/2002-184, ss. 156(3) and 156(1)(f).

    [Return to footnote21](#fn202021-rf)

Footnote 22
:   PCMLTFR, SOR/2002-184, s. 123.1(b).

    [Return to footnote22](#fn202022-rf)

Footnote 23
:   PCMLTFR, SOR/2002-184, ss. 123.1 and 157(b)(ii).

    [Return to footnote23](#fn202023-rf)

Footnote 24
:   PCMLTFR, SOR/2002-184, s. 123.1(b).

    [Return to footnote24](#fn202024-rf)

Footnote 25
:   PCMLTFR, SOR/2002-184, s. 123.1.

    [Return to footnote25](#fn202025-rf)

Footnote 26
:   PCMLTFR, SOR/2002-184, s. 157(b)(ii).

    [Return to footnote26](#fn202026-rf)

Footnote 27
:   PCMLTFR, SOR/2002-184, ss. 156(1)(f) and 156(3).

    [Return to footnote27](#fn202027-rf)

Footnote 28
:   PCMLTFR, SOR/2002-184, s. 156(3).

    [Return to footnote28](#fn202028-rf)

Footnote 29
:   PCMLTFR, SOR/2002-184, s. 156(4).

    [Return to footnote29](#fn202029-rf)

Footnote 30
:   Ibid.

    [Return to footnote30](#fn202030-rf)
