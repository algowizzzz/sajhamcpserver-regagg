# Record keeping requirements for factors : FINTRAC's compliance guidance

**From:** [Financial Transactions and Reports Analysis Centre of Canada](/intro-eng) (FINTRAC)

This guidance outlines certain record keeping requirements for [factors](/guidance-directives/glossary-glossaire/1-eng#factor).
...
* [information records and other factoring agreement records](#x4)
  + when you enter into a factoring agreement
* [receipt of funds records](#x5)
  + when you receive funds of $3,000 or more
...
* the following details about the remittance (i.e. the disposition) of, or exchange for, the cash received:
  ...
  + if the remittance is not in funds, the type of remittance (for example, real estate purchase, deposit) and its value if different from the amount received in cash
...
* an [**information record**](/guidance-directives/glossary-glossaire/1-eng#info) in respect of the person or entity with whom you enter into the agreement
  + if the information record is in respect of an **entity**, you **must** keep the following information on every person that enters into the agreement on behalf of the entity:
    - name
    - address
    - date of birth
    - the nature of their principal business or occupation
  + if the information record is in respect of an **entity that is a corporation,** you must also keep a copy of the part of its official corporate records that contains any provision relating to the power to bind the corporation regarding transactions with the factor. This could be found in for example:
...
* a record of **the financial capacity** of the person or entity with which you enter into the agreement
* a **record of the terms of the factoring agreement**
* **for any payment you make, a record that includes**:
  ...
  + the name of every person or entity involved in the payment
  + every account number or other equivalent reference number connected to the payment

**Retention**:

* Information record: 5 years from the day the last business transaction was conducted.
* Other records: at least 5 years from the date the record was created.
...
* the amount of funds received and the amount of any part of the funds received in cash
  + the method by which the amount is received (for example, in person, by mail, etc.)
* the type and amount of each [**fiat**](/guidance-directives/glossary-glossaire/1-eng#fiat) currency involved in the receipt
* the exchange rates used and the source (if applicable)
...
* if **other persons** are involved in the transaction, their:
  ...
  + date of birth
  + occupation
  + the nature of their principal business (in the case of a sole proprietor)
* if **other entities** are involved in the transaction, their:
  + name
  + address
  + the nature of principal business
* every reference number connected to the transaction that is meant to be similar to an account number
* the purpose of the transaction
...
* At least 5 years from the date the receipt of funds record was created.
...
* a subsidiary of a [public body](/guidance-directives/glossary-glossaire/1-eng#pb) or [very large corporation or trust](/guidance-directives/glossary-glossaire/1-eng#large), if the financial statements of the subsidiary are consolidated with those of the public body, very large corporation or trust
...
* a [very large corporation or trust](/guidance-directives/glossary-glossaire/1-eng#large)
* a subsidiary of a [public body](/guidance-directives/glossary-glossaire/1-eng#pb) or [very large corporation or trust](/guidance-directives/glossary-glossaire/1-eng#large), if the financial statements of the subsidiary are consolidated with those of the public body, very large corporation or trust
* a person who is acting on behalf of a client that is a [financial entity](/guidance-directives/glossary-glossaire/1-eng#fin)or [public body](/guidance-directives/glossary-glossaire/1-eng#pb)
