...
La présente directive s'applique aux entités financières (EF). Elle s'applique aussi aux sociétés d'assurance-vie, ainsi qu'aux entités qui sont des représentants d'assurance-vie qui offrent des produits de paiement prépayés (PPP) au public, ou qui tiennent des comptes de produits de paiement prépayés (comptes de PPP); lesquels sont considérés comme étant des EF aux fins de la prestation de ces activités[Note de bas de page 1](#fn1). La directive explique les exigences de la Loi sur le recyclage des produits de la criminalité et le financement des activités terroristes (la Loi) et des règlements connexes en ce qui concerne les PPP et les comptes de PPP.
...
1. [En quoi consistent les PPP et les comptes de PPP?](#s1)
2. [Quelles sont mes exigences et quelles sont les exceptions s'appliquant aux PPP et aux comptes de PPP?](#s2)

## 1. En quoi consistent les PPP et les comptes de PPP?

### PPP

Un [PPP](/guidance-directives/glossary-glossaire/1-fra#ppp) est un produit **émis par une EF** et permet à une personne ou entité de prendre part à une opération en lui donnant un accès électronique à des fonds ou à de la monnaie virtuelle versés, avant l'opération, dans un compte de PPP détenu avec l'EF.

La présente définition exclut un produit :

* permettant d'avoir accès à un compte de crédit ou de débit;
* ne pouvant être utilisé qu'auprès d'un commerçant spécifique;
* à usage unique émis dans le cadre d'un programme de rabais d'un détaillant.[Note de bas de page 2](#fn2)
...
Un [compte de PPP](/guidance-directives/glossary-glossaire/1-fra#cpp) est un compte **lié** **à un PPP**, qui permet :
...
* de maintenir un solde de 1 000 $ ou plus en fonds ou en monnaie virtuelle.[Note de bas de page 3](#fn3)

La présente définition exclut un compte auquel :

* seul un organisme public peut verser des fonds ou de la monnaie virtuelle;
* seul un organisme de bienfaisance enregistré, au sens du paragraphe 248(1) de la Loi de l'impôt sur le revenu, peut verser des fonds ou de la monnaie virtuelle, s'il le fait à des fins d'aide humanitaire.[Note de bas de page 4](#fn4)
...
* À quel moment [vérifier l'identité des personnes et des entités – Entités financières](/guidance-directives/client-clientele/client/fin-fra)
  + Comptes de produits de paiement prépayés (PPP)
    - Titulaires de compte
    - Utilisateurs autorisés
    - Paiements de 1 000 $ ou plus sur le compte de PPP
...
* [Exigences en matière de tenue de documents s'appliquant aux entités financières](/guidance-directives/recordkeeping-document/record/fin-fra)
  + Comptes de produits de paiement prépayés et relevés d'opérations
  + Documents concernant un compte de PPP
  + Relevés d'opérations dans un compte de PPP
* [Exigences en matière de déclaration d'opérations](/guidance-directives/guidance-directives-fra#s3)
...
:   Règlement sur le recyclage des produits de la criminalité et le financement des activités terroristes (le Règlement), DORS/2002-184, par. 1(2).
