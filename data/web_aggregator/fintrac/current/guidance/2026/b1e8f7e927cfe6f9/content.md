...
* [**Introduction**](#s0)
  + [Why is the manual important and what does it cover?](#s0.1)
* [**Part 1—Examination framework**](#s1)
  + [Risk-based examinations](#s1.1)
  + [Assessment methods](#s1.2)
  + [Assessment approach to evaluating findings](#s1.3)
* [**Part 2—Examination phases**](#s2)
  + [Roles and responsibilities](#s2.1)
  + [Phase 1—Planning and scoping](#s2.2)
  + [Phase 2—Examination and assessment](#s2.3)
  + [Phase 3—Developing conclusions and finalizing the examination](#s2.4)
* [**Part 3—Assessment methods**](#s3)
  + [3.1. Compliance program requirements](#s3.1)
  + [3.2. Client identification and other know your client requirements](#s3.2)
  + [3.3. Financial transactions reporting requirements](#s3.3)
  + [3.4. Record keeping requirements](#s3.4)
  + [3.5. Correspondent banking relationship requirements](#s3.5)
  + [3.6. Foreign branches, foreign subsidiaries and affiliates requirements](#s3.6)
  + [3.7. Money services business (MSB), and Foreign money services business (FMSB) registration requirements](#s3.7)
  + [3.8. Ministerial directives' requirements](#s3.8)

## Introduction

### Why is the manual important and what does it cover?

The Financial Transactions and Reports Analysis Centre of Canada, known as FINTRAC, is committed to helping you meet the legal requirements set out in the [Proceeds of Crime (Money Laundering) and Terrorist Financing Act (PCMLTFA)](/act-loi/1-eng) and associated Regulations.
...
We use the methods to assess how you comply with the legal requirements set out in the PCMLTFA and associated Regulations. We also consider [FINTRAC guidance](/guidance-directives/guidance-directives-eng), which sets out how we interpret the legal requirements.
...
* [Voluntary self-declarations of non-compliance (VSDONC)](/guidance-directives/exam-examen/vsdonc/1-eng) in which you informed us that you have not met certain requirements;
...
If you identify non-compliance after a FINTRAC examination has started, you should inform the FINTRAC officer immediately and send us a [voluntary self-declaration of non-compliance](/guidance-directives/exam-examen/vsdonc/1-eng). We consider the date on which we notify you of the examination to be the start of the examination (that is, the date of the notification call).

When we receive a voluntary self-declaration of non-compliance on an issue that was not previously voluntarily disclosed before a FINTRAC examination has started, we will work with the entity to resolve the issue, However, if we receive a self-declaration during an examination, we will assess the non-compliance as part of the examination, work with the business to correct it, and determine if the non-compliance warrants an enforcement action.
...
As part of our evaluation, we consider the [harm done](/pen/1-eng#s1) by not meeting a requirement. In doing so, we assess the nature, relative importance, extent, the root cause of the non-compliance, and any mitigating or aggravating factors.
...
We consider the relative importance of the requirement with which you were not compliant. While all requirements are important, and we expect businesses to fulfill them, certain requirements have a greater impact on FINTRAC's ability to carry out its [mandate](/act-loi/1-eng) and on Canada's anti-money laundering and anti-terrorist financing regime. For example, the requirement to submit financial transaction reports could have a greater impact on FINTRAC's intelligence mandate and the regime as a whole than the requirement to submit reports that are free of minor data-quality issues.
...
We may send our examination findings letter to your compliance officer. This letter describes the findings that we discussed during the exit interview.
...
* The process you have in place to establish reasonable grounds to suspect that transactions or attempted transactions may be related to money laundering or terrorist activity financing, and your process for submitting Suspicious Transaction Reports "[as soon as practicable](/guidance-directives/glossary-glossaire/1-eng#asap)" and as a priority over other tasks.
...
We use the methods described in this section to assess your compliance with [client identification and other know your client requirements](/guidance-directives/guidance-directives-eng#s2).
...
In addition, we verify that you document the required information when you verify the identity of a person or an entity. Refer to our [record keeping guidance](/guidance-directives/guidance-directives-eng#s4) for more information on the requirement to keep records and to the section of this manual that describes the methods we use to assess record keeping.

When you have verified the identity of a client as required by the PCMLTFA and associated Regulations, you may have additional responsibilities related to know your client requirements. Refer to our [know your client guidance](/guidance-directives/guidance-directives-eng#s2) and to the section of this manual that describes the methods we use to assess these requirements for more information.
...
We use the methods described in this section to assess your compliance with [financial transaction reporting requirements](/guidance-directives/guidance-directives-eng#s3).
...
Most of the assessment methods described in this section are based on [money laundering and terrorist activity financing indicators](/guidance-directives/transaction-operation/str-dod/str-dod-eng) published in FINTRAC guidance and other well-known reliable sources, such as the Financial Action Task Force (FATF).
...
We use the methods described in this section to assess your compliance with [record keeping requirements](/guidance-directives/guidance-directives-eng#s4).
...
We use the methods described in this section to assess your compliance with [correspondent banking relationships requirements](/guidance-directives/relationship-relation/1-eng).
...
We use the methods described in this section to assess your compliance with requirements relating to [foreign branches, foreign subsidiaries and affiliates](/guidance-directives/branches-succursales/1-eng).
...
We use the methods described in this section to assess your compliance with [money services business and foreign money services business registration requirements](/msb-esm/register-inscrire/reg-ins-eng).
...
We use the methods described in this section to assess your compliance with requirements relating to [ministerial directives](/obligations/directives-eng).
