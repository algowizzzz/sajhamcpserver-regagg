# Invoice and payment : Charging reporting entities for FINTRAC’s compliance program
...
* the interim assessment amount for the current fiscal year (that is, the forecasted amount)
* the final assessment adjustment amount (that is, the difference between the interim assessment and the final assessment for the previous fiscal year)
* the total amount that the reporting entity owes (that is, the sum of the 2 amounts above)
* information about the recommended payment method (refer to [Payment](#s2) section below) and associated instructions

Both the email and invoice include references to the authorities granted to FINTRAC to charge and collect payments from reporting entities, as [prescribed](/guidance-directives/glossary-glossaire/1-eng#prescribed) in the Proceeds of Crime (Money Laundering) and Terrorist Financing Act and associated Regulations.

### Interim assessment amount

The basis of the determination of the interim assessment amount is:

* a forecast of the total cost of the compliance program for that fiscal year
* if applicable, the reporting entity’s threshold transaction reporting volume during the previous fiscal year
* if applicable, the value of the reporting entity’s Canadian assets at the end of its previous financial year

The purpose of determining this amount is to:

* estimate the total cost for that fiscal year
* determine the portion of the total cost that is charged to each applicable reporting entity
...
Questions about the assessment of expenses funding model, or to use an alternate payment method: [expenses\_assessment-evaluation\_depenses@fintrac-canafe.gc.ca](mailto:expenses_assessment-evaluation_depenses@fintrac-canafe.gc.ca)
...
* [Determining the cost of FINTRAC’s compliance program](/guidance-directives/cost-cout/development-elaboration-eng#s2)
* [Components of the method for charging reporting entities](/guidance-directives/cost-cout/charging-facturation-eng)
