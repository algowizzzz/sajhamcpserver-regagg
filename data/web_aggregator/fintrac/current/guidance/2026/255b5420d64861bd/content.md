...
Si vous êtes un mandataire de Sa Majesté et que vous vous livrez à l'acceptation de dépôts dans le cadre des services financiers que vous fournissez au public, comme une caisse d'épargne provinciale, vous êtes considéré une [entité financière](/guidance-directives/glossary-glossaire/1-fra#ef). Veuillez consulter les [indicateurs de blanchiment d'argent (BA) et de financement du terrorisme (FT) propres aux entités financières](/guidance-directives/transaction-operation/indicators-indicateurs/fin_mltf-fra) pour obtenir les [indicateurs](/guidance-directives/glossary-glossaire/1-fra#ibaft) pertinents.

Si vous êtes un mandataire de Sa Majesté qui vend au public des métaux précieux, vous êtes considéré un [négociant en métaux précieux et pierres précieuses (NMPPP)](/guidance-directives/glossary-glossaire/1-fra#nmpp). Veuillez consulter [les indicateurs de BA et de FT propres aux NMPPP](/guidance-directives/transaction-operation/indicators-indicateurs/dpms_mltf-fra) pour obtenir les indicateurs pertinents.

## Directives connexes

* [Déclaration d'opérations douteuses à CANAFE](/guidance-directives/transaction-operation/str-dod/str-dod-fra)
* [Indicateurs pour les entités financières](fin_mltf-fra)
* [Indicateurs pour les NMPPP](dpms_mltf-fra)
