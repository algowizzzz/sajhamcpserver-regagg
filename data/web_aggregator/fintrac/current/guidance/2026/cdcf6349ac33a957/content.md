...
In addition to the ML/TF indicators in this guidance, you are expected to use the [National Risk Assessment](/businesses-entreprises/assessment-evaluation-eng) and [risk assessment guidance](/guidance-directives/compliance-conformite/rba/rba-eng) to inform your risk-based approach (see Related guidance). You are also expected to use FINTRAC’s [strategic intelligence](/intel/sintel-eng) which includes additional indicators, and [guidance](/guidance-directives/guidance-directives-eng#s0) to identify trends and typologies associated with specific threats and vulnerabilities.
...
* [ML/TF indicators related to customer behaviour](#s2)
...
* [ML/TF indicators based on atypical transactional activity](#s5)
* [ML/TF indicators related to transactions structured below the reporting or identification requirements](#s6)
* [ML/TF indicators related to transactions that involve non-Canadian jurisdictions](#s7)
* [ML/TF indicators related to the use of other parties](#s8)
* [ML indicators related to bribery and corruption](#s11-1)
* [Indicators specifically related to TF](#s9)
* [ML/TF indicators specific to DPMS](#s10)
* [ML/TF indicators specific to wholesalers and suppliers](#s11)
...
* [Assessment of money laundering and terrorist financing risks in Canada](/businesses-entreprises/assessment-evaluation-eng)
...
As a dealer in precious metals and precious stones, you may observe these ML/TF indicators over the course of your business activities with a customer. It is important to note that depending on your business activities, some of these ML/TF indicators may not apply.
...
* The customer refuses or tries to avoid providing required information, or provides information that is misleading, vague, or difficult to verify.
* The customer refuses to provide information regarding the beneficial owners of an entity, or provides information that is false, conflicting, misleading or substantially incorrect.
* The identification document presented by the customer cannot be authenticated
* There are inconsistencies in the identification documents or different identifiers provided by the customer, such as name, address, date of birth or phone number.
...
* The customer provides only a non-civic address or disguises a post office box as a civic address for the purpose of concealing their physical residence.
* Common identifiers (e.g. addresses, phone numbers, etc.) are used by multiple customers that do not appear to be related.
* Common identifiers (e.g. addresses, phone numbers, etc.) are used by multiple customers conducting similar transactions.
...
* Customer avoids contact with employees.
...
* Customer makes enquiries/statements indicating a desire to avoid reporting or tries to persuade the reporting entity not to file/maintain required reports.
...
* There is a sudden change in the customer's financial profile, pattern of activity or transactions.
...
Your process to evaluate risk for products and services you provide should be documented as part of your KYC and [risk assessment](/guidance-directives/compliance-conformite/rba/rba-eng) requirements. The following ML/TF indicators will focus on products or services that may be applicable within your business.

* Customer appears to have recently established a series of new relationships with different financial entities.
* A product and/or service opened on behalf of a person or entity that is inconsistent based on what you know about that customer.
* Credit card transactions are exceptionally high for what is expected of the customer including transactions involving luxury items.
* Multiple entities either headquartered at the same location or having the same directors/signing authorities for [no apparent reason.](/guidance-directives/glossary-glossaire/1-eng#nar)
...
* You become aware of the structuring of transactions at multiple locations.
...
* Customer makes enquiries that would indicate a desire to avoid reporting.
...
* A customer conducts a transaction while accompanied, overseen or directed by an unrelated party, atypical of what would be expected.
* Payments from unrelated parties (foreign or domestic).
* Customer appears to be or states they are acting on behalf of another party, atypical of what would be expected.

#### Use of gatekeeper

A gatekeeper is a person or entity that controls access to the financial system and can act on behalf of a customer. Such services can be abused so that criminals have access to the financial system without being identified. Gatekeepers may include lawyers, accountants and other professions which can access the financial system on behalf of a customer. While there are many transactions where it is "normal" to have a gatekeeper represent the interests of a customer, such an appearance of normalcy can also be utilized to the advantage of criminals to provide the veneer of legitimacy to their transactions. The use of gatekeepers themselves is not an indicator of an ML/TF offence. However, entities should consider the following examples which can indicate misuse of the financial system access provided to gatekeepers.
...
* Gatekeeper is utilizing their account for transactions not typical of their business.
...
* Consider whether the environment and/or industry in which the client operates is at higher risk of exposure to bribery and corruption.
* Determine if the client is a [politically exposed domestic person](/guidance-directives/glossary-glossaire/1-eng#pedp), [politically exposed foreign person](/guidance-directives/glossary-glossaire/1-eng#pefp) or [head of an international organization](/guidance-directives/glossary-glossaire/1-eng#hio).
...
* Score low on the [Transparency International Corruption Perceptions Index.](https://www.transparency.org/en/cpi/2024)
* Exhibit known deficiencies in anti-money laundering or anti-terrorist activity financing regimes, including countries identified by the Financial Action Task Force
* Are known for banking secrecy, which can obscure financial transactions and ownership structures.
...
Transactions involving long-term government contracts that may have been awarded through an opaque selection process to a legal entity or multiple legal entities with similar [beneficial owners.](/guidance-directives/glossary-glossaire/1-eng#bo)

#### Services provided to state-owned entities in high-risk jurisdictions for corruption

Transactions involving services provided to state-owned companies or public institutions by companies registered in [high-risk jurisdictions for corruption](#z1).
...
* Did not take part in the related project.
* Would not typically be involved in the client’s industry or line of business.

#### High-value payments in high-risk jurisdictions

A client makes high-value payments for services, such as consulting fees, in [jurisdictions identified as high-risk for corruption](#z1).
...
* Vague or incomplete payment details.
* Fraudulent documentation used to justify the transfer of funds.
...
* Inconsistent with the client’s reported source of wealth.
* Outside the individual’s normal pattern of activity or lifestyle.
...
* Multiple cash deposits into their account.
* Multiple electronic funds transfers from different senders within a short time frame.
* Situations where the politically exposed person is both the ordering and beneficiary client for electronic funds transfers.
...
* Customer provides multiple variations on their name, address, phone number or additional identifiers.

## ML/TF indicators specific to DPMS

In addition to the general ML/TF indicators that have been highlighted in this guidance, there may be more specific ML/TF indicators related to your business, if you purchase or sell precious metals, precious stones or jewellery, or if you are an agent of the Crown that sells precious metals to the public. Below are some examples of sector-specific ML/TF indicators that you should consider as part of your STR process.
...
* Unusual payment methods, such as large amounts of cash, multiple or sequentially numbered money orders, traveller's cheques, or cashier's cheques, or payment from other parties.
...
* A customer asking about the possibility of returning goods and obtaining a cheque (especially if the customer requests that cheque be written to another party).
...
* Counterpart presence, such as an affiliated store or branch or associate, in non-cooperative countries and territories or country that is the subject of advisories issued by FINTRAC or the FATF.
