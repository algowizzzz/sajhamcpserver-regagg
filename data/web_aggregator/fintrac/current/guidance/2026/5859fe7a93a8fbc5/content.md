...
Footnote 1
:   For the purposes of these indicators, we define a Privacy Coin as a cryptocurrency that has built-in features to hide data about its users and/or transactions. Although the method to obscure transactions can vary, the focus is on creating anonymity in the transaction.
