...
Les [entités financières](/re-ed/fin-fra) (EF), les [courtiers en valeurs mobilières](/re-ed/sec-fra) et les [casinos](/re-ed/casinos-fra) (entités déclarantes dont les activités sont liées à des comptes) doivent satisfaire à certaines exigences applicables aux personnes politiquement vulnérables (PPV) et aux [dirigeants d'une organisation internationale](/guidance-directives/glossary-glossaire/1-fra#doi) (DOI) en vertu de la Loi sur le recyclage des produits de la criminalité et le financement des activités terroristes (la Loi) et des règlements connexes. Toutefois, certaines exigences et les exemples donnés dans la présente directive ne s'appliquent qu'à certaines entités déclarantes (ED).

Dans la présente directive, les PPV comprennent les [étrangers politiquement vulnérables (EPV)](/guidance-directives/glossary-glossaire/1-fra#epv) et les [nationaux politiquement vulnérables (NPV)](/guidance-directives/glossary-glossaire/1-fra#npv), sauf indication contraire.
...
1. [Quand dois-je déterminer si une personne est une PPV, un DOI, un membre de la famille d'une PPV ou d'un DOI ou une personne étroitement associée à une PPV ou à un DOI, et qui est visé par une telle détermination?](#s1)
2. [Quelles sont les exceptions à la détermination des PPV, des DOI, des membres de la famille d'une PPV ou d'un DOI ou une personne étroitement associée à une PPV ou à un DOI?](#s2)
3. [Quelles mesures dois-je prendre après avoir déterminé qu'une personne est une PPV, un DOI, un membre de la famille d'une PPV ou d'un DOI ou une personne étroitement associée à une PPV ou à un DOI?](#s3)
4. [Quels documents sur la PPV, le DOI, le membre de la famille de la PPV ou du DOI ou la personne étroitement associée à la PPV ou au DOI dois-je conserver?](#s4)

Pour en savoir plus sur vos obligations en ce qui concerne la détermination des PPV, des DOI et des [personnes](/guidance-directives/glossary-glossaire/1-fra#personne) qui leur sont étroitement liées ou associées, et pour obtenir des précisions sur la terminologie et les considérations connexes, par exemple qui est considéré comme un membre de la haute direction, se reporter à la directive de [CANAFE sur les personnes politiquement vulnérables et les dirigeants d'une organisation internationale.](/guidance-directives/client-clientele/pep/pep-fra)

La présente directive comprend les annexes suivantes, qui résument les circonstances dans lesquelles les ED dont les activités sont liées à des comptes doivent déterminer si une personne est une PPV ou un DOI, établir l'[origine des fonds](/guidance-directives/glossary-glossaire/1-fra#originemv), [l'origine de la monnaie virtuelle (MV)](/guidance-directives/glossary-glossaire/1-fra#originemv) et [l'origine de la richesse](/guidance-directives/glossary-glossaire/1-fra#origineriche), et conserver des documents :

* [Annexe 1](#annexe1) — Quand déterminer si une personne est une PPV ou un DOI – ED dont les activités sont liées à des comptes
* [Annexe 2](#annexe2) — Détermination de l'origine des fonds, de la MV ou de la richesse – ED dont les activités sont liées à des comptes
* [Annexe 3](#annexe3) — Conservation des documents concernant la PPV et le DOI – ED dont les activités sont liées à des comptes
...
Vous devez prendre des [mesures raisonnables](/guidance-directives/glossary-glossaire/1-fra#raisonnable) pour déterminer si une personne dont les activités sont liées à un compte est une PPV, un DOI, un [membre de la famille](/guidance-directives/glossary-glossaire/1-fra#famille) d'une PPV ou d'un DOI ou une personne étroitement associée à une PPV ou à un DOI (ou à un EPV seulement, dans certaines circonstances) :

* à l'ouverture d'un compte;
* pour les [utilisateurs autorisés](/guidance-directives/glossary-glossaire/1-fra#utilisateur) de compte de produit de paiement prépayé (CPPP) (EF seulement);
* lors de la vérification périodique des titulaires de compte existants;
* lors de la vérification périodique des utilisateurs autorisés de CPPP (EF seulement);
* lorsque vous détectez un fait au sujet des titulaires de compte existants qui indique un lien avec une PPV ou un DOI;
* lorsque vous détectez un fait au sujet des utilisateurs autorisés de CPPP qui indique un lien avec une PPV ou un DOI (EF uniquement).
...
* [l'amorce](/guidance-directives/glossary-glossaire/1-fra#amorcer) d'un [télévirement international](/guidance-directives/glossary-glossaire/1-fra#telinter) de 100 000 $ ou plus;
* la réception à titre de destinataire d'un télévirement international de 100 000 $ ou plus;
* la réception de 100 000 $ ou plus en espèces ou d'une somme en MV équivalant à 100 000 $ ou plus (casinos seulement);
* les transferts d'une somme en MV équivalant à 100 000 $ ou plus (EF seulement);
* la réception d'une somme en MV équivalant à 100 000 $ ou plus pour remise à un bénéficiaire (EF seulement);
* les paiements au crédit d'un CPPP de 100 000 $ ou plus (EF seulement).
...
À titre d'EF, de courtier en valeurs mobilières ou de casino, vous devez prendre des mesures raisonnables pour déterminer si une personne pour laquelle vous ouvrez un compte est une PPV, un DOI, un membre de la famille d'une de ces personnes ou une personne étroitement associée à un EPV.[Note de bas de page 1](#fn1)

#### Utilisateur autorisé de CPPP (EF uniquement)

À titre d'EF, vous devez prendre des mesures raisonnables pour déterminer si la personne identifiée comme étant un utilisateur autorisé d'un CPPP est une PPV, un DOI, un membre de la famille d'une de ces personnes, ou une personne étroitement associée à un EPV.[Note de bas de page 2](#fn2)

#### Surveillance périodique des titulaires de compte existants et des utilisateurs autorisés de CPPP

À titre d'EF, de courtier en valeurs mobilières ou de casino, vous devez prendre périodiquement des mesures raisonnables pour déterminer si le titulaire d'un compte est une PPV, un DOI, un membre de la famille d'une de ces personnes ou une personne étroitement associée à un EPV.[Note de bas de page 3](#fn3)

À titre d'EF, vous devez également prendre périodiquement des mesures raisonnables pour déterminer si l'utilisateur autorisé d'un CPPP est une PPV, un DOI, un membre de la famille d'une de ces personnes ou une personne étroitement associée à un EPV.[Note de bas de page 4](#fn4)

#### Détection d'un fait au sujet de titulaires de compte existants et d'utilisateurs autorisés de CPPP

À titre d'EF, de courtier en valeurs mobilières ou de casino, si vous ou un de vos employés ou dirigeants constatez un fait qui donne naissance à un motif raisonnable de soupçonner que le titulaire d'un compte est une PPV, un DOI, un membre de la famille d'une de ces personnes ou une personne qui leur est étroitement associée, vous devez prendre des mesures raisonnables pour établir s'il s'agit d'une telle personne.[Note de bas de page 5](#fn5)
...
1. Vous avez déjà établi qu'une personne est un EPV ou un membre de la famille d'un EPV.[Note de bas de page 13](#fn13)
2. Si vous êtes une **EF** ou un **courtier en valeurs** mobilières, vous n'êtes pas tenu de déterminer si une personne membre d'un régime collectif est une PPV, un DOI, un membre de la famille d'une de ces personnes ou une personne qui leur est étroitement associée, si :[Note de bas de page 14](#fn14)
...
À titre d'EF, de courtier en valeurs mobilières ou de casino, lorsque vous **ouvrez un compte, effectuez une vérification périodique ou détectez un fait** et que vous déterminez que le titulaire d'un compte ou l'utilisateur autorisé d'un CPPP (EF seulement) est un EPV, un membre de la famille d'un EPV ou une personne qui étroitement associée à un EPV, vous devez :[Note de bas de page 17](#fn17)

* prendre des mesures raisonnables pour établir l'origine des fonds ou de la MV qui ont été versés ou dont le versement au compte est prévu et l'origine de la richesse de la personne;
* obtenir l'autorisation d'un membre de la haute direction pour maintenir le compte ouvert;
* prendre des [mesures accrues](/guidance-directives/client-clientele/omr-fra), y compris prendre des mesures supplémentaires pour vérifier son identité, assurer un contrôle accru et continu et prendre toute autre mesure accrue pour atténuer les risques posés par la personne.

#### NPV ou DOI

À titre d'EF, de courtier en valeurs mobilières ou de casino, lorsque vous **ouvrez un compte, effectuez une vérification périodique ou détectez un fait** et déterminez que le titulaire d'un compte ou l'utilisateur autorisé (EF) est un NPV, un DOI, un membre de la famille d'une de ces personnes ou une personne qui leur est étroitement associée, **et**, selon votre [évaluation des risques](/guidance-directives/compliance-conformite/rba/rba-fra), vous considérez qu’il y a un **risque élevé** qu’une infraction de blanchiment d’argent ou de financement des activités terroristes soit commise, vous devez :[Note de bas de page 18](#fn18)

* prendre des mesures raisonnables pour établir l'origine des fonds ou de la MV qui ont été versés ou dont le versement au compte est prévu et l'origine de la richesse de la personne;
* obtenir l'autorisation d'un membre de la haute direction pour maintenir le compte ouvert;
* prendre des mesures accrues, y compris prendre des mesures supplémentaires pour vérifier son identité, assurer un contrôle accru et continu et prendre toute autre mesure accrue pour atténuer les risques posés par la personne.

Lorsque vous **détectez un fait relatif à un compte existant** et déterminez qu'une personne est étroitement associée à un NPV ou à un DOI, **et** selon votre évaluation des risques, vous considérez qu’il y a un **risque élevé** qu’une infraction de blanchiment d’argent ou de financement des activités terroristes soit commise, vous devez :[Note de bas de page 19](#fn19)
...
Lorsque vous **ouvrez un compte** pour une PPV, un DOI, un membre de la famille d'une de ces personnes ou une personne qui leur est étroitement associée, ou que vous **détectez un fait** concernant ces personnes, vous disposez de **30 jours** après la date d'ouverture du compte ou de la date à laquelle vous détectez un fait pour :[Note de bas de page 20](#fn20)
...
À titre d'EF ou de casino, pour les opérations mentionnées ci-dessus, vous disposez d'un délai de **30 jours** suivant la date à laquelle l'opération est effectuée, selon le cas, pour :[Note de bas de page 29](#fn29)

* prendre des mesures raisonnables pour déterminer si la personne est une PPV, un DOI, un membre de la famille d'une de ces personnes ou une personne qui leur est étroitement associée et, s'il y a lieu, établir l'origine des fonds ou de la MV ayant servi à l'opération et l'origine de la richesse de la personne et veiller à ce qu'un membre de la haute direction examine l'opération;
* prendre des mesures raisonnables pour déterminer si la personne est une PPV, un DOI, un membre de la famille d'une de ces personnes ou une personne qui leur est étroitement associée et, s'il y a lieu, veiller à ce qu'un membre de la haute direction examine l'opération.
...
**Conservation** : Vous devez conserver les documents concernant le compte de la PPV et du DOI pendant au moins cinq ans à compter de la date de fermeture du compte auquel ils se rapportent.[Note de bas de page 31](#fn31)

### Documents concernant l'opération d'une PPV et d'un DOI

Si, à titre d'EF ou de casino, vous **examinez** une des opérations susmentionnées (voir la section sur la détermination des PPV ou des DOI dans le cadre des opérations) pour laquelle vous avez déterminé qu'une personne est une PPV ou un DOI, vous devez conserver un document contenant les renseignements suivants : [Note de bas de page 32](#fn32)

* le poste ou la charge et le nom de l'organisation ou de l'institution de la PPV ou du DOI;
* la date de la détermination;
* l'origine des fonds ou de la MV ayant servi à l'opération, si elle est connue;
* l'origine de la richesse de la personne, si elle est connue;
...
**Conservation** : Vous devez conserver les documents concernant l'opération pendant au moins cinq ans à compter de la date de la dernière opération commerciale.[Note de bas de page 33](#fn33)
...
:   Le Règlement, DORS/2002-184, art. 150.1.
    ...
    [Retour à la référence de la note de bas de page 16](#fn16-rf)

Note de bas de page 17
:   Le Règlement, DORS/2002-184, par. 121(1) et art. 157, et la Loi sur le recyclage des produits de la criminalité et le financement des activités terroristes (la Loi), L.C. 2000, ch. 17, par. 9.6(3).

    [Retour à la référence de la note de bas de page 17](#fn17-rf)

Note de bas de page 18
:   Le Règlement, DORS/2002-184, par. 121(1) et (2) et art. 157, et la Loi, L.C. 2000, ch. 17, par. 9.6(3).

    [Retour à la référence de la note de bas de page 18](#fn18-rf)

Note de bas de page 19
:   Le Règlement, DORS/2002-184, par. 121(2) et art. 157 et la Loi, L.C. 2000, ch. 17, art. 9.6(2).

    [Retour à la référence de la note de bas de page 19](#fn19-rf)

Note de bas de page 20
:   Le Règlement, DORS/2002-184, par. 121(3) .

    [Retour à la référence de la note de bas de page 20](#fn20-rf)

Note de bas de page 21
:   Le Règlement, DORS/2002-184, par. 121(3) et 122(1).

    [Retour à la référence de la note de bas de page 21](#fn21-rf)

Note de bas de page 22
:   Le Règlement, DORS/2002-184, par. 122(2).

    [Retour à la référence de la note de bas de page 22](#fn22-rf)

Note de bas de page 23
:   Le Règlement, DORS/2002-184, par. 122(3).

    [Retour à la référence de la note de bas de page 23](#fn23-rf)

Note de bas de page 24
:   Le Règlement, DORS/2002-184, par. 122(1).

    [Retour à la référence de la note de bas de page 24](#fn24-rf)

Note de bas de page 25
:   Le Règlement, DORS/2002-184, par. 122(1) et 122(5).

    [Retour à la référence de la note de bas de page 25](#fn25-rf)

Note de bas de page 26
:   Le Règlement, DORS/2002-184, par. 122(6) et la Loi, L.C. 2000, ch. 17, par. 9.6(2).

    [Retour à la référence de la note de bas de page 26](#fn25-rf)

Note de bas de page 27
:   Le Règlement, DORS/2002-184, par. 122(7) et la Loi, L.C. 2000, ch. 17, par. 9.6(2).

    [Retour à la référence de la note de bas de page 27](#fn26-rf)

Note de bas de page 28
:   Le Règlement, DORS/2002-184, par. 122(5) et la Loi, L.C. 2000, ch. 17, par. 9.6(2).

    [Retour à la référence de la note de bas de page 28](#fn28-rf)

Note de bas de page 29
:   Le Règlement, DORS/2002-184, par. 122(9).

    [Retour à la référence de la note de bas de page 29](#fn29-rf)

Note de bas de page 30
:   Le Règlement, DORS/2002-184, par. 123(1).

    [Retour à la référence de la note de bas de page 30](#fn30-rf)

Note de bas de page 31
:   Le Règlement, DORS/2002-184, al. 148(1)a).

    [Retour à la référence de la note de bas de page 31](#fn31-rf)

Note de bas de page 32
:   Le Règlement, DORS/2002-184, par. 123(2).

    [Retour à la référence de la note de bas de page 32](#fn32-rf)

Note de bas de page 33
:   Le Règlement, DORS/2002-184, al. 148(1)b).

    [Retour à la référence de la note de bas de page 33](#fn33-rf)
