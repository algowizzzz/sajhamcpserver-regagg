...
* [ML/TF indicators involving wire transfers (including electronic funds transfers)](#s7)
* [ML/TF indicators related to transactions that involve non-Canadian jurisdictions](#s8)
* [ML/TF indicators related to the use of other parties](#s9)
* [ML indicators related to bribery and corruption](#s11-1)
* [Indicators specifically related to TF](#s10)
* [ML/TF indicators specific to MSBs](#s11)
...
* Client refuses to identify a source for funds or provides information that is false, misleading, or substantially incorrect.
...
* A product and/or service initiated on behalf of a person or entity that is inconsistent based on what you know about that client.
* Frequent and/or atypical transfers between the client's products for [no apparent reason](/guidance-directives/glossary-glossaire/1-eng#nar).
...
* Atypical transfers by client on an in-and-out basis, or other methods of moving funds quickly, such as a currency exchange followed immediately by a wire transfer of the funds out.
...
* The structuring of wire transfers through multiple locations of the same MSB or by groups of persons who enter a single location at the same time.
...
* A client conducts transaction(s) while accompanied, overseen or directed by another party.
...
* Gatekeeper is processing transactions not typical of their business (e.g. excessive amount of cash, payment to non-clients or parties of transactions).
...
* Client conducted travel-related purchases (e.g. purchase of airline tickets, travel visa, passport, etc.) linked to high-risk jurisdictions (including cities or districts of concern), specifically countries (and adjacent countries) under conflict and/or political instability or known to support terrorist activities and organizations. Person or entity's online presence supports violent extremism or radicalization.
...
* Client purchases a large volume of money orders and changes payment type to avoid reporting requirements.
