...
* Négociants de métaux précieux et de pierres précieuses (NMPPP)
...
* [Indicateurs de BA/FT liés à des opérations concernant des territoires étrangers](#s7)
* [Indicateurs de BA/FT liés à l'utilisation d'autres parties](#s8)
* [Indicateurs de BA liés à la corruption](#s11-1)
* [Indicateurs spécifiquement liés au FT](#s9)
* [Indicateurs de BA/FT propres aux NMPPP](#s10)
* [Indicateurs de BA/FT propres aux grossistes et fournisseurs](#s11)
...
* Le client refuse de fournir des renseignements concernant les bénéficiaires effectifs d'une entité, ou fournit des renseignements faux, contradictoires, trompeurs ou substantiellement incorrects.
...
* Les opérations par carte de crédit sont d'un montant exceptionnellement élevé par rapport à ce à quoi on s'attendrait de la part de ce client, y compris des opérations liées à des articles de luxe.
* Plusieurs entités ayant leur siège social au même endroit ou ayant les mêmes directeurs ou signataires autorisés [sans raison apparente](/guidance-directives/glossary-glossaire/1-fra#sra).
...
* Vous constatez le fractionnement d'opérations dans plusieurs emplacements.
...
* Le client effectue une opération alors qu'il est accompagné, supervisé ou dirigé par une autre partie non liée, ce qui n'est pas ce à quoi l'on s'attendrait habituellement.
* Des paiements à destination ou en provenance de parties non apparentées (étrangères ou nationales).
* Le client semble ou affirme agir au nom d'une autre partie, ce qui n'est pas ce à quoi l'on s'attendrait habituellement.
...
* Le contrôleur d'accès utilise son compte pour des opérations qui ne sont pas conformes à son activité.
...
* La présence en ligne d'une personne ou d'une entité démontrant leur appui d'un l'extrémiste violent ou de la radicalisation.
...
* Le client achète sans discernement de la marchandise sans s'attarder à sa valeur, sa taille ou sa couleur.
* Le client ou le fournisseur effectue des achats ou des ventes inhabituels.
* Les méthodes de paiement sont inhabituelles, comme des montants importants en espèces, des mandats multiples ou numérotés séquentiellement, des chèques de voyage, des chèques de voyage ou des paiements provenant d'autres parties.
...
* Le client commande un article, en règle le prix en espèces, annule la commande et reçoit un remboursement important.
* Le client demande s'il est possible de retourner les biens et d'obtenir le remboursement par chèque (surtout si le client demande que le chèque soit libellé à une autre partie).
* Le client règle le prix d'un bijou de grande valeur ou de métaux précieux en espèces.
* Le client ne demande pas de rabais et ne tente pas de négocier le prix.
* Le prix de l'achat semble être au-delà des moyens du client, d'après la profession ou le revenu qu'il a indiqué.
* Le client tente d'utiliser le chèque ou la carte de crédit d'un tiers.
* Les fonds proviennent d'un centre financier à l'étranger plutôt que d'une banque locale.
* Les paiements sont importants ou sont effectués fréquemment dans une devise autre que des dollars canadiens.
* Les opérations sont antiéconomiques.
* Des achats ou des ventes qui ne sont pas conformes aux normes de l'industrie.

### Indicateurs de BA et de FT propres aux grossistes et fournisseurs

* Surfacturation ou sous-facturation.
* Demandes très structurées ou complexes.
* Plusieurs demandes de factures.
* Envois de grande valeur qui sont trop assurés ou pas assez assurés.
* Le fournisseur ne veut pas fournir de coordonnées ou de références financières complètes ou précises ou ne veut pas préciser ses affiliations commerciales.
* Présence d'un homologue, tel qu'un associé ou un représentant d'une succursale ou d'un magasin affilié qui se trouve dans un pays faisant partie de la liste des pays et territoires non coopératifs ou qui est situé dans un pays faisant l'objet d'un avis de CANAFE ou du GAFI.
