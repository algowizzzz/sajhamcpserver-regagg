...
**Retention**: At least five years from the date the VC transfer or VC receipt record was created.[Footnote 30](#fn202130)
...
**Retention**: At least five years from the date the VC exchange transaction record was created.[Footnote 36](#fn202136)
...
* every credit card application related to the account;[Footnote 66](#fn202166) and
...
Footnote 21
:   PCMLTFR, SOR/2002-184, s. 12(m).

    [Return to footnote21](#fn202121-rf)

Footnote 22
:   PCMLTFR, SOR/2002-184, s. 12(n).
...
Footnote 24
:   PCMLTFR, SOR/2002-184, s. 12(o).

    [Return to footnote24](#fn202124-rf)

Footnote 25
:   PCMLTFR, SOR/2002-184, s. 12(p).

    [Return to footnote25](#fn202125-rf)

Footnote 26
:   PCMLTFR, SOR/2002-184, s. 12(q).
...
Footnote 28
:   PCMLTFR, SOR/2002-184, s. 12(r).

    [Return to footnote28](#fn202128-rf)

Footnote 29
:   PCMLTFR, SOR/2002-184, s. 12(s).
...
Footnote 57
:   PCMLTFR, SOR/2002-184, s. 12(j).

    [Return to footnote57](#fn202157-rf)

Footnote 58
:   PCMLTFR, SOR/2002-184, s. 148(1)(c) and 12(j)(ii)(D).

    [Return to footnote58](#fn202158-rf)

Footnote 59
:   PCMLTFR, SOR/2002-184, s. 12(k).
...
:   Ibid
    ...
    [Return to footnote62](#fn202162-rf)

Footnote 63
:   Ibid

    [Return to footnote63](#fn202163-rf)

Footnote 64
:   PCMLTFR, SOR/2002-184, s. 13(b).

    [Return to footnote64](#fn202164-rf)

Footnote 65
:   PCMLTFR, SOR/2002-184, ss. 148(1)(a) and 148(1)(c).

    [Return to footnote65](#fn202165-rf)

Footnote 66
:   PCMLTFR, SOR/2002-184, s. 13(c).

    [Return to footnote66](#fn202166-rf)

Footnote 67
:   PCMLTFR, SOR/2002-184, s. 13(d).

    [Return to footnote67](#fn202167-rf)

Footnote 68
:   PCMLTFR, SOR/2002-184, ss. 148(1)(a) and (c).

    [Return to footnote68](#fn202168-rf)

Footnote 69
:   PCMLTFR, SOR/2002-184, s. 13(e).

    [Return to footnote69](#fn202169-rf)

Footnote 70
:   PCMLTFR, SOR/2002-184, s. 13(h).

    [Return to footnote70](#fn202170-rf)

Footnote 71
:   PCMLTFR, SOR/2002-184, s. 13(f).

    [Return to footnote71](#fn202171-rf)

Footnote 72
:   PCMLTFR, SOR/2002-184, s. 13(g).

    [Return to footnote72](#fn202172-rf)

Footnote 73
:   PCMLTFR, SOR/2002-184, s. 148(1)(c).

    [Return to footnote73](#fn202173-rf)

Footnote 74
:   PCMLTFR, SOR/2002-184, s. 14(1)(a).

    [Return to footnote74](#fn202174-rf)

Footnote 75
:   Ibid

    [Return to footnote75](#fn202175-rf)

Footnote 76
:   Ibid

    [Return to footnote76](#fn202176-rf)

Footnote 77
:   PCMLTFR, SOR/2002-184, s. 14(1)(b).

    [Return to footnote77](#fn202177-rf)

Footnote 78
:   PCMLTFR, SOR/2002-184, ss. 148(1)(a) and 148(1)(c).

    [Return to footnote78](#fn202178-rf)

Footnote 79
:   PCMLTFR, SOR/2002-184, s. 14(1)(c).

    [Return to footnote79](#fn202179-rf)

Footnote 80
:   PCMLTFR, SOR/2002-184, s. 14(1)(e).

    [Return to footnote80](#fn202180-rf)

Footnote 81
:   PCMLTFR, SOR/2002-184, s. 14(1)(f).

    [Return to footnote81](#fn202181-rf)

Footnote 82
:   PCMLTFR, SOR/2002-184, s. 14(1)(d).

    [Return to footnote82](#fn202182-rf)

Footnote 83
:   PCMLTFR, SOR/2002-184, s. 14(2).

    [Return to footnote83](#fn202183-rf)

Footnote 84
:   PCMLTFR, SOR/2002-184, ss. 148(1)(a) and (c).

    [Return to footnote84](#fn202184-rf)

Footnote 85
:   PCMLTFR, SOR/2002-184, s. 14(g).

    [Return to footnote85](#fn202185-rf)

Footnote 86
:   PCMLTFR, SOR/2002-184, s. 14(l).

    [Return to footnote86](#fn202186-rf)

Footnote 87
:   PCMLTFR, SOR/2002-184, s. 14(h).

    [Return to footnote87](#fn202187-rf)

Footnote 88
:   PCMLTFR, SOR/2002-184, s. 14(i).

    [Return to footnote88](#fn202188-rf)

Footnote 89
:   PCMLTFR, SOR/2002-184, s. 14(j).

    [Return to footnote89](#fn202189-rf)

Footnote 90
:   PCMLTFR, SOR/2002-184, s. 14(k).

    [Return to footnote90](#fn202190-rf)

Footnote 91
:   PCMLTFR, SOR/2002-184, s. 148(1)(c).

    [Return to footnote91](#fn202191-rf)

Footnote 92
:   PCMLTFR, SOR/2002-184, s. 15(1).

    [Return to footnote92](#fn202192-rf)

Footnote 93
:   PCMLTFR, SOR/2002-184, s. 139.

    [Return to footnote93](#fn202193-rf)

Footnote 94
:   PCMLTFR, SOR/2002-184, s. 149.

    [Return to footnote94](#fn202194-rf)

Footnote 95
:   PCMLTFR, SOR/2002-184, s. 147.

    [Return to footnote95](#fn202195-rf)

Footnote 96
:   PCMLTFR, SOR/2002-184, s. 148(2).

    [Return to footnote96](#fn202196-rf)

Footnote 97
:   PCMLTFR, SOR/2002-184, s. 153.

    [Return to footnote97](#fn202197-rf)
:   PCMLTFR, SOR/2002-184, s. 150.1

    [Return to footnote98](#fn202198-rf)

Footnote 99
:   PCMLTFR, SOR/2002-184, s. 150.

    [Return to footnote99](#fn202199-rf)

Footnote 100
:   PCMLTFR, SOR/2002-184, ss. 10 and 11.

    [Return to footnote100](#fn2021100-rf)

Footnote 101
:   PCMLTFR, SOR/2002-184, s. 12(m).

    [Return to footnote101](#fn2021101-rf)

Footnote 102
:   PCMLTFR, SOR/2002-184, ss. 154(2) (m), (n) and (o).

    [Return to footnote102](#fn2021102-rf)

Footnote 103
:   PCMLTFR, SOR/2002-184, s. 151(1)(a)(b).

    [Return to footnote103](#fn2021103-rf)

Footnote 104
:   PCMLTFR, SOR/2002-184, s. 154(2).

    [Return to footnote104](#fn2021104-rf)

Footnote 105
:   PCMLTFR SOR/2002-184, s. 154(3).

    [Return to footnote105](#fn2021105-rf)
