# Déterminer les frais selon le type d’entité déclarante : Facturer les entités déclarantes pour le programme de conformité de CANAFE

**Du :** [Centre d'analyse des opérations et déclarations financières du Canada](/intro-fra) (CANAFE)

Apprenez-en plus sur les différentes approches que CANAFE utilise pour déterminer les montants qu'il facture aux différents types d'entités déclarantes pour les coûts annuels de son programme de conformité.

## Sur cette page

* [Banques sous réglementation fédérale](#s1)
* [Sociétés de fiducie et de prêt et sociétés d’assurance-vie sous réglementation fédérale](#s2)
* [Autres entités déclarantes qui transmettent 500 déclarations d’opérations visées par un seuil ou plus pendant un exercice financier donné](#s3)
* [Liens connexes](#s4)

## Banques sous réglementation fédérale

CANAFE calcule les frais facturés aux banques en utilisant la formule suivante :
...
**A :** Montant de base  
(pour déterminer le montant de base, consultez le tableau [Montants de base selon la valeur des actifs canadiens de l’entité à la fin de l’exercice financier](/guidance-directives/cost-cout/charging-facturation-fra#c2-table))

**B :** Coûts de conformité restants   
(coût annuel du programme de conformité de CANAFE auquel on soustrait la somme de tous les montants de base)

**C :** Somme des déclarations d’opérations visées par un seuil transmises **par les banques** pendant l’exercice financier

**D :** Somme des déclarations d’opérations visées par un seuil transmises à CANAFE pendant l’exercice financier

**E :** Valeur des actifs canadiens détenus **par la banque** à la fin de son exercice financier

**F :** Valeur totale des actifs canadiens détenus **par toutes les banques**  à la fin de l’exercice financier

**G :** Frais finaux facturés à la banque

Exemple : Frais facturés à la banque 123

Pour cet exemple :

* les coûts de conformité restants à facturer aux entités déclarantes pour l’exercice financier sont de 33 110 000 $ **(B)**
* la somme des déclarations d’opérations visées par un seuil transmises par les banques pendant l’exercice financier est de 31 500 000 **(C)**
* la somme des déclarations d’opérations visées par un seuil transmises à CANAFE pendant l’exercice financier est de 35 000 000 **(D)**
* la valeur totale des actifs canadiens détenus par toutes les banques à la fin de l’exercice financier est de 10 000 000 000 000 $ **(F)**

**Calcul du montant facturé à la banque 123 pour l’exercice financier**

| Valeur des actifs canadiens à la fin de son exercice financier (E) | 650 000 000 000 $ |
| Montant de base (A) | 200 000 $ |
| Formule et calcul | **A + [B × (C ÷ D) × (E ÷ F)] = G**  200 000 $   **+  [**33 110 000 $  **x  (**31 500 000 ÷ 35 000 000**)  x  (**650 000 000 000 $ ÷ 10 000 000 000 000 $**)]  =**  2 136 935 $ |
| Montant facturé pour cet exercice financier (G) | 2 136 935 $ |
|  |  |
| --- | --- |
| **Remarque** : Cet exemple est hypothétique et il est utilisé à titre d’illustration seulement. | |

## Sociétés de fiducie et de prêt et sociétés d’assurance-vie sous réglementation fédérale

Le calcul des frais facturés aux sociétés de fiducie et de prêt et aux [sociétés d’assurance-vie](/guidance-directives/glossary-glossaire/1-fra#sav) sous réglementation fédérale dépend de la transmission ou non de 500 déclarations d’opérations visées par un seuil ou plus à CANAFE pendant l’exercice financier.

### Transmission de moins de 500 déclarations d’opérations visées par un seuil

CANAFE facture **uniquement le montant de base**  aux sociétés de fiducie et de prêt et aux sociétés d’assurance-vie sous réglementation fédérale qui ont transmis moins de 500 déclarations d’opérations visées par un seuil à CANAFE pendant l'exercice financier.

Exemple : Frais facturés à la société de fiducie et de prêt 123

Pour déterminer le montant de base, consultez le tableau [Montants de base selon la valeur des actifs canadiens de l’entité à la fin de l’exercice financier](/guidance-directives/cost-cout/charging-facturation-fra#c2-table).

**Calcul du montant facturé à la société de fiducie et de prêt 123 pour l’exercice financier**

| Valeur des actifs canadiens à la fin de son exercice financier | 3 000 000 $ |
| Montant de base | 5 000 $ |
| Nombre de déclarations d’opérations visées par un seuil transmises pendant l’exercice financier | 0 |
| Formule et calcul | Sans objet |
| Montant facturé pour cet exercice financier | 5 000 $ |
|  |  |
| --- | --- |
| **Remarque** : Cet exemple est hypothétique et il est utilisé à titre d’illustration seulement. | |

### Transmission de 500 déclarations d’opérations visées par un seuil ou plus

CANAFE calcule les frais facturés aux sociétés de fiducie et de prêt et aux sociétés d’assurance-vie sous réglementation fédérale qui transmettent 500 déclarations d’opérations visées par un seuil ou plus pendant l’exercice financier en utilisant la formule suivante :
...
**H :** Somme des déclarations d’opérations visées par un seuil transmises par les entités déclarantes **autres que les banques** pendant l’exercice financier

**D :** Somme des déclarations d’opérations visées par un seuil transmises à CANAFE pendant l’exercice financier

**I :** Nombre de déclarations d’opérations visées par un seuil transmises **par l’entité déclarante**  pendant l’exercice financier

**J :** Somme des déclarations d’opérations visées par un seuil transmises par les entités déclarantes **autres que les banques** et dont le volume de déclaration est de 500 déclarations ou plus pendant l’exercice financier

**K :** Frais finaux facturés à la société de fiducie et de prêt ou à la société d’assurance-vie

Exemple : Frais facturés à la société de fiducie et de prêt 456

Pour cet exemple :

* les coûts de conformité restants à facturer aux entités déclarantes pour l’exercice financier sont de 33 110 000 $ **(B)**
* la somme des déclarations d’opérations visées par un seuil transmises par les entités déclarantes **autres que les banques** pendant l’exercice financier est de 3 500 000 **(H)**
* la somme des déclarations d’opérations visées par un seuil transmises à CANAFE pendant l’exercice financier est de 35 000 000 **(D)**
* la somme des déclarations d’opérations visées par un seuil transmises par les entités déclarantes **autres que les banques** et dont le volume de déclaration est de 500 déclarations ou plus pendant l’exercice financier est de 3 425 000 **(J)**

**Calcul du montant facturé à la société de fiducie et de prêt 456 pour l’exercice financier**

| Valeur des actifs canadiens à la fin de son exercice financier | 100 000 000 $ |
| Montant de base (A) | 25 000 $ |
| Nombre de déclarations d’opérations visées par un seuil transmises pendant l’exercice financier (I) | 15 000 |
| Formule et calcul | **A + [B × (H ÷ D) × (I ÷ J)] = K**  25 000 $   **+  [**33 110 000 $  **x  (**3 500 000 ÷ 35 000 000**)  x  (**15 000 ÷ 3 425 000**)]  =**  39 500 $ |
| Montant facturé pour cet exercice financier (K) | 39 500 $ |
|  |  |
| --- | --- |
| **Remarque** : Cet exemple est hypothétique et il est utilisé à titre d’illustration seulement. | |

## Autres entités déclarantes qui transmettent 500 déclarations d’opérations visées par un seuil ou plus pendant un exercice financier donné

CANAFE calcule les frais facturés aux entités déclarantes **autres que** les banques, les sociétés de fiducie et de prêt et les sociétés d’assurance-vie sous réglementation fédérale qui transmettent 500 déclarations d’opérations visées par un seuil à CANAFE ou plus pendant l’exercice financier en utilisant la formule suivante :
...
(Somme de tous les montants de base soustraite du coût annuel du programme de conformité de CANAFE)
...
**L :** Frais finaux facturés à l’entité déclarante autre

Exemple : Frais facturés à l’entité déclarante 123
...
**Calcul du montant facturé à l’entité déclarante 123 pour l’exercice financier**

| Valeur des actifs canadiens à la fin de son exercice financier | Sans objet |
| Montant de base | Sans objet |
| Nombre de déclarations d’opérations visées par un seuil transmises pendant l’exercice financier (I) | 300 000 |
| Formule et calcul | **B × (H ÷ D) × (I ÷ J) = L**  33 110 000 $   **x  (**3 500 000 ÷ 35 000 000**)  x  (**300 000 ÷ 3 425 000**)  =**  290 015 $ |
| Montant facturé pour cet exercice financier (L) | 290 015 $ |
|  |  |
| --- | --- |
| **Remarque** : Cet exemple est hypothétique et il est utilisé à titre d’illustration seulement. | |
...
* [Composantes de la méthode de facturation aux entités déclarantes](/guidance-directives/cost-cout/charging-facturation-fra)
