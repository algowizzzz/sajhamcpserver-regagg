# Record keeping requirements for real estate brokers or sales representatives, and real estate developers : FINTRAC's compliance guidance

This guidance outlines certain record keeping requirements for [real estate brokers or sales representatives, and real estate developers](/re-ed/real-eng).

If you are a [real estate broker or sales representative](/guidance-directives/glossary-glossaire/1-eng#rebsr), you must keep the records listed in this guidance when you act as an agent or mandatary in the purchase or sale of real estate.

If you are a [real estate developer](/guidance-directives/glossary-glossaire/1-eng#red), you must keep the records listed in this guidance when you sell to the public a new house, condominium unit, commercial or industrial building, or multi-unit residential building. In addition, if you are a real estate developer that is incorporated, you must keep the records listed in this guidance when you are acting on your own behalf, or on behalf of a subsidiary or affiliate.
...
* [large cash transaction records](#x2)
  + when you receive cash in an amount equivalent to $10,000 or more in a single transaction
...
* [receipt of funds records](#x4)
  + when you receive funds in any amount
* [information records](#x5)
  + **real estate brokers and sales representatives**: when you act as an agent or mandatary for the purchase or sale of real estate, and when there is any party to the transaction that is not represented by a real estate broker or sales representative
  + **real estate developers:** sell a new house, new condominium unit, new commercial or industrial building or new multi-unit residential building
...
* the purpose of the transaction
  + for example, the cash was used to purchase a condominium unit
* the method by which you received the cash
  + for example, in person, by mail
* the exchange rates used and the source (if applicable)
* if an account was affected by the transaction, include:
  + the account number
  + type of account (for example, business, persona
...
* the following details about the remittance (i.e. the disposition) of, or exchange for, the cash received:
  + the method of remittance (for example, real estate purchase, deposit)
  + if the remittance is not in funds, the type of remittance (for example, real estate purchase, deposit) and its value if different from the amount received in cash the name of every person or entity involved in the remittance, their account number or policy number. If there is no account or policy number, their identifying number
...
* if the amount is received from a **person**, their:
  + name
  + address
  + date of birth
  + occupation
  + in the case of a sole proprietor, the nature of their principal business
* if the amount is received from or on behalf of an **entity**, their:
  + name
  + address
  + the nature of its principal business
* the amount of funds received and the amount of any part of the funds that is received in cash
* the method by which the amount is received (for example, in person, by mail)
* the type and amount of each fiat currency involved in the receipt
* the exchange rates used and the source (if applicable)
* if an account was affected by the transaction (for example, funds withdrawn from or deposited to an account), include:
  ...
  + type of account
  + the name of each account holder
* if **other persons** are involved in the transaction, their:
  + name
  + address
  + date of birth
  + occupation
  + in the case of a sole proprietor, the nature of their principal business
* if **other entities** are involved in the transaction, their:
  + name
  + address
  + the nature of their principal business
* every reference number connected to the transaction that is meant to be similar to an account number
...
**Real estate brokers and sales representatives** must keep an [information record](/guidance-directives/glossary-glossaire/1-eng#info) on every person or entity for which they act as an agent or mandatary for the purchase or sale of real estate, and on any party to the transaction that is not represented by a real estate broker or sales representatives.
...
* the articles of incorporation, or
* the bylaws of the corporation that set out the officers duly authorized to sign on the behalf of the corporation, such as the president, treasurer, vice-president, or comptroller.
...
* Proceeds of Crime (Money Laundering) and Terrorist Financing Regulations (SOR/2002-184)
  ...
  + section 56
  + section 57
  + subsections 58(1), 58(2), 58(3) and 58(4)
  + section 59
  + section 62
  + section 63
  + section 64
  ...
  + subsection 143(3)
  + section 144
  + paragraphs 148(1)(b) and 148(1)(c)
...
You are not required to keep a large cash transaction record, a large virtual currency transaction record, or a receipt of funds record if the cash, virtual currency or funds is received from a client that is a [financial entity](/guidance-directives/glossary-glossaire/1-eng#fin) or a [public body](/guidance-directives/glossary-glossaire/1-eng#pb), or a person who is acting on behalf of a client that is an financial entity or public body.
...
When you receive virtual currency as compensation for the validation of a transaction that is recorded in a [distributed ledger](/guidance-directives/glossary-glossaire/1-eng#distributed) **or** you receive a nominal amount of virtual currency for the sole purpose of validating a different transaction or a transfer of information, you do not need to keep a large virtual currency transaction record.
