...
**Note:** As of October 1, 2025, you must consult [Corporations Canada's database](https://ised-isde.canada.ca/cc/lgcy/fdrlCrpSrch.html?locale=en_CA) to check whether any corporations that you have assessed and which are incorporated under the Canada Business Corporations Act pose a high risk of being involved in money laundering or financing terrorist activity. If there is a material discrepancy between the beneficial ownership information and the individuals with significant control listed in the database, you must:
...
* [2. Who beneficial owners are](#s2)
* [3. When to obtain beneficial ownership information and confirm its accuracy](#s3)
* [4. When and how to consult Corporations Canada’s database](#s4)
* [5. What beneficial ownership information you need to obtain](#s5)
* [6. How to obtain beneficial ownership information](#s6)
* [7. How to confirm the accuracy of beneficial ownership information](#s7)
* [8. What a material discrepancy is and what to do if you identify one with Corporations Canada’s database](#s8)
* [9. How to submit a Beneficial Ownership Discrepancy Report](#s9)
* [10. What to do if you cannot obtain beneficial ownership information or confirm its accuracy](#s10)
* [11. Circumstances where you do not need to obtain beneficial ownership information](#s11)
* [12. What to do if there are no beneficial owners](#s12)
* [13. What beneficial ownership records you need to keep](#s13)
* [Annex 1: Example of a record of beneficial ownership information for a corporation](#s14)
* [Annex 2: Example of a material discrepancy requiring a Beneficial Ownership Discrepancy Report](#s15)
* [Annex 3: Example of a record of beneficial ownership information for an entity other than a corporation or a trust](#s16)
* [Annex 4: Example of a record of beneficial ownership information for a trust (other than a widely held or publicly traded trust)](#s17)
* [Annex 5: List of available federal and provincial resources on beneficial ownership](#s18)
* [For assistance](#s19)
...
* [When to identify persons and entities](/guidance-directives/guidance-directives-eng#s2)
...
**Note:** [Canada’s assessment of money laundering and terrorist financing risks](https://www.canada.ca/en/department-finance/programs/financial-sector-policy/nira-neri/2025/report.html), also referred to as the “National Risk Assessment”, details the vulnerabilities posed by Corporations and other legal persons and arrangements. The concealment of beneficial ownership information is a technique used in money laundering and terrorist activity financing schemes. Identifying beneficial ownership removes the anonymity of the individuals (i.e. natural persons) behind the transactions and account activities, which is a key component of Canada's anti-money laundering and anti-terrorist financing regime.

[Beneficial owners](/guidance-directives/glossary-glossaire/1-eng#bo) are the individuals who directly or indirectly own or control at least 25% of a corporation or an entity other than a corporation (such as a partnership).

In the case of a [trust](/guidance-directives/glossary-glossaire/1-eng#trust), the relevant parties are the [trustees](/guidance-directives/glossary-glossaire/1-eng#trustee), the known [beneficiaries](/guidance-directives/glossary-glossaire/1-eng#beneficiary) and the [settlors](/guidance-directives/glossary-glossaire/1-eng#settlor).

The trustees of a widely held or a publicly traded trust are all persons who own or control, directly or indirectly, at least 25% of its units.
...
For example, the beneficial owners of a corporation that is owned by a trust would include all **persons** who own or control, directly or indirectly, at least 25% of its units.

It is important to consider and review the names found on official documentation to confirm the accuracy of the beneficial ownership information. It may be necessary to search through many layers of information to confirm who the beneficial owners are, as the names found on official documentation may not always reflect the actual beneficial owners.
...
If you have assessed a corporation incorporated under the Canada Business Corporations Act as posing a **high risk** of a money laundering or financing terrorist activities, you must consult [Corporations Canada’s database](https://ised-isde.canada.ca/cc/lgcy/fdrlCrpSrch.html?lang=eng) when initially identifying high-risk business relationships **and** during ongoing monitoring.

When consulting Corporations Canada’s database, you must compare the information you obtained on the corporation to the individuals with significant control of the corporation listed in [Corporations Canada’s database](https://ised-isde.canada.ca/cc/lgcy/fdrlCrpSrch.html) and determine if there is a **material discrepancy**. Section 8 provides more information on what constitutes material discrepancy [8. What a material discrepancy is and what to do if you identify one with Corporations Canada’s database](#s8).

For more information on your requirements to assess your money laundering, terrorist activity financing and sanctions evasion risks during your activities, refer to FINTRAC’s [Risk assessment guidance](/guidance-directives/compliance-conformite/rba/rba-eng).

### Consult the following resources by Corporations Canada:

* [Federal Corporations database](https://ised-isde.canada.ca/cc/lgcy/fdrlCrpSrch.html)
* Who are [Individuals with Significant Control](https://ised-isde.canada.ca/site/corporations-canada/en/individuals-significant-control)
...
* the names of all directors of the corporation and the names and addresses of all persons who directly or indirectly own or control at least 25% of the shares or units of the corporation
...
* the names of all trustees and the names and addresses of all persons who directly or indirectly own or control at least 25% of its units

**Entities other than corporations or trusts:**

* the names and addresses of all persons who directly or indirectly own or control at least 25% of the entity
...
* an organization, other than one referred to above, that solicits financial donations from the public.
...
* publicly available information, including information from federal or provincial registries (see Annex 5: Resources)
* official documentation provided by the entity
* beneficial ownership information provided verbally or in writing by the entity and recorded for record-keeping purposes
* a completed document provided by the entity

Collaboration between federal, provincial and territorial governments within Canada has led to harmonized amendments within most Canadian jurisdictions to require corporations to maintain accurate and up-to-date records of information on all beneficial owners, and to make them accessible upon request to law enforcement, tax authorities, and other relevant bodies. Such amendments have been made in all jurisdictions within Canada, except for Alberta, the Northwest Territories and Nunavut. For more details, consult [Annex 5: List of available federal and provincial resources on beneficial ownership](#s18).
...
Reasonable measures may include referring to official documentation or records, or consulting provincial or federal registries.
...
* board of directors' records of decisions
...
A material discrepancy is a significant inconsistency between a corporation’s beneficial ownership information under the Canada Business Corporations Act and the individuals with significant control listed in Corporations Canada’s database. This could affect the identification of the individuals who own or control a corporation, or even conceal it.
...
* the fact that information is not available to the public due to an exception or exemption is clearly indicated in Corporations Canada’s database
...
**Note:** A material discrepancy that is resolved within 30 days of its identification does not have to be reported.

For further clarity, a material discrepancy may be reported upon identification without waiting for the 30 days to elapse. Additionally, re-consulting Corporations Canada’s database within that timeframe to determine whether the discrepancy has been resolved is not a requirement.
...
For an example, consult [Annex 2 - Example of a material discrepancy requiring a Beneficial Ownership Discrepancy Report](#s15)

If you have assessed a corporation incorporated under the Canada Business Corporations Act as posing a low risk of money laundering or terrorist financing offences, but have identified a material discrepancy, you have the option to **voluntarily** submit a Beneficial Ownership Discrepancy Report to Corporations Canada.

If you consulted the Corporation Canada database to confirm the accuracy of the beneficial ownership information you obtained and could not do so due to the identification of a material discrepancy, you may take other reasonable measures to confirm its accuracy. If you cannot confirm the accuracy of the beneficial ownership information you obtained, you must apply the prescribed measures as detailed in Section [10. What to do if you cannot obtain beneficial ownership information or confirm its accuracy](#s10).
...
You must submit a Beneficial Ownership Discrepancy Report using the Beneficial Ownership Discrepancy Reporting application from your [My ISED account](https://ised-isde.canada.ca/site/corporations-canada/en/about-us/my-ised-account).

For instructions on how to submit a Beneficial Ownership Discrepancy Report, consult Corporations Canada's reporting guidance [Beneficial ownership discrepancy reporting](https://can01.safelinks.protection.outlook.com/?url=https%3A%2F%2Fised-isde.canada.ca%2Fsite%2Fcorporations-canada%2Fen%2Fbeneficial-ownership-discrepancy-reporting&data=05%7C02%7CBrooke.Sanche%40fintrac-canafe.gc.ca%7Cba6e3e7b034d42f5cbd908ddeaf1ef9f%7C7030e590392c41bda5738fa48f815afd%7C0%7C0%7C638925047010184697%7CUnknown%7CTWFpbGZsb3d8eyJFbXB0eU1hcGkiOnRydWUsIlYiOiIwLjAuMDAwMCIsIlAiOiJXaW4zMiIsIkFOIjoiTWFpbCIsIldUIjoyfQ%3D%3D%7C0%7C%7C%7C&sdata=6Ke25a0JCgqZtkcG2oOYTMee5eEkwjn5t08udwSlsoI%3D&reserved=0).
...
If you do not have a reporting entity number assigned by FINTRAC, you must register with the [FINTRAC Web Reporting System](https://fintrac-canafe.canada.ca/reporting-declaration/Info/f2r-eng). To enroll, email your request to FINTRAC at [F2R@fintrac-canafe.gc.ca](mailto:F2R@fintrac-canafe.gc.ca).
...
If you are unable to obtain the beneficial ownership information, keep it up to date during ongoing monitoring of business relationships, or confirm its accuracy when it is first obtained, or during ongoing monitoring you must:

* take reasonable measures to verify the identity of the entity's chief executive officer or of the person performing that function
* apply the special measures for high-risk clients, including enhanced ongoing monitoring

If you are unable to obtain beneficial ownership information, keep it up to date, or confirm its accuracy, such as when the ownership structure is too complex or opaque, it should be considered as part of your risk assessment of the client.
...
The Regulations do not require you to verify the identity of the chief executive officer or of the person performing that function, using the prescribed methods. However, you could use one of the methods outlined in the [Methods to verify the identity of persons and entities guidance](/guidance-directives/client-clientele/Guide11/11-eng) to meet this obligation as your reasonable measure.

Additionally, there is no record keeping obligation if you have identified the chief executive officer or a person who performs that function using the prescribed methods to verify identity. However, during a FINTRAC examination, you could be asked to demonstrate the reasonable measures you took to identify the chief executive officer or of the person performing that function.
...
You do not have to obtain or confirm the accuracy of beneficial ownership information in the following situations, including by consulting Corporations Canada’s database:

1. For a group plan account held within a dividend or a distribution reinvestment plan, including a plan that allows purchases of additional shares or units by the member with contributions other than the dividends or distributions paid by the plan sponsor, if the sponsor is an entity:
...
2. If you are a **financial entity**, in respect of the processing of payments by credit card or prepaid payment product for a merchant
3. If you are a **life insurance company, broker or agent** and you deal in reinsurance, in respect of those dealings

**In all cases**, the beneficial ownership requirements do not apply if you are not required to verify the identity of an entity under the Regulations due to a related exception. This is because your obligation to verify the identity of a client, transaction or activity does not apply in that circumstance. For more information, please refer to your sector-specific guidance on [When to identify persons and entities](/guidance-directives/guidance-directives-eng#s2).
...
You can **obtain confirmation that no individual** either directly or indirectly owns or controls at least 25% of a corporation, a widely held or publicly traded trust, or another entity. This is not the same thing as being **unable to obtain** the beneficial ownership information.

If **you conclude that no individual** either directly or indirectly owns or controls at least 25% of a corporation, a widely held or publicly traded trust, or another entity, you **must retain records** of the steps you took and the information you obtained in order to reach that conclusion. However, you are still required to obtain and take reasonable measures to confirm information about the ownership, control and structure of the entity.
...
The measures that you take to confirm beneficial ownership information may form part of your overall policies and procedures, therefore, a separate record may not be necessary. You only need to keep a record of the specific measures you take to confirm the accuracy of beneficial ownership information if these differ from the documented measures in your policies and procedures.

For a **corporation**, you must record:

* the names of all directors of the corporation
* the names and addresses of all persons who directly or indirectly own or control at least 25% of the shares of the corporation; and
* information establishing the ownership, control and structure of the corporation

For an example, consult [Annex 1: Example of a record of beneficial ownership information for a corporation](/guidance-directives/client-clientele/bor-eng#s14)
...
For an example, consult [Annex 4: Example of a record of beneficial ownership information for a trust (other than a widely held or publicly traded trust)](/guidance-directives/client-clientele/bor-eng#s17)

For a **widely held or publicly traded trust**, you must record:

* the names of all trustees of the trust
* the names and addresses of all persons who directly or indirectly own or control at least 25% of the units of the trust; and
* information establishing the ownership, control and structure of the trust

For an **entity other than a corporation or trust**, you must record:

* the names and addresses of all persons who directly or indirectly own or control at least 25% of the entity; and
* information establishing the ownership, control and structure of the entity

For an example, consult [Annex 3: Example of a record of beneficial ownership information for an entity other than a corporation or a trust](/guidance-directives/client-clientele/bor-eng#s16)
...
* a charity registered with the Canada Revenue Agency under the Income Tax Act; or
* an organization, other than a registered charity, that solicits financial donations from the public

In situations where no individual directly or indirectly owns or controls at least 25% of a corporation, a widely held or publicly traded trust, or another entity, you must retain records of the steps you took and the information you obtained in order to reach that conclusion. The date you took the measures should also be included as a best practice.
...
ABC Canada Inc., a privately held corporation incorporated under the Canada Business Corporations Act, carries out a transaction or activity for which you have to verify its identity, triggering your beneficial ownership obligations. You learn that ABC Canada Inc. is owned by John Brown and Green Company Ltd. You discover that John owns 15% of the shares in the company (15 of the 100 total) and that Green Company Ltd. owns 85% of the shares (85 of 100 total). Since Green Company Ltd. owns and controls at least 25% of ABC Canada Inc., you need to find the beneficial owners, who cannot be a corporation or an entity. You inquire further and discover that Tina Grey owns 70% of Green Company Inc.'s shares and her two children, Alex and Lucy Grey, each own 15% respectively. Next, you learn that ABC Canada Inc.'s Board of Directors is made up of:
...
![Flowchart of ABC Canada Inc. ownership and board of directors.](images/bor-1-eng.png)
...
1. the names of all directors of ABC Canada Inc.:
   ...
   * Tammy Maki
   * Lisa Bailey
2. the names and addresses of all persons who directly or indirectly own or control at least 25% of the shares of ABC Canada Inc.:
   * the name and address of Tina Grey, who indirectly owns more than 25% of the shares of ABC Canada Inc.'s through her ownership of Green Company Ltd.
3. the information establishing the ownership, control and structure of ABC Canada Inc., including:
   * the ownership of ABC Canada Inc. shared between John Brown (15%) and Green Company Ltd. (85%)
   * the ownership of Green Company Ltd. shared between Tina Grey (70%), Alex Grey (15%), and Lucy Grey (15%)
   * the control of ABC Canada Inc., significantly being held by Green Company Ltd. and specifically Tina Grey
   * the structure of ABC Canada Inc., including that it is a privately held corporation
   * other structural details about ABC Canada Inc., including the positions held by each director and any organization chart
4. the reasonable measures you took to confirm the accuracy of the information:
   * the steps you took to confirm the accuracy of this information
   * any official documents obtained to support those measures
...
Corporation Canada’s database indicates 2 individuals with significant control of ABC Canada Inc., who both indirectly and jointly hold at least 25% of shares:

* Tina Grey Johnson
* Mathew Grey

You had previously obtained the information that Tina Grey owns or controls at least 25% of ABC Canada Inc. The additional name “Johnson” is reasonably a minor variation in the name and is not considered a material discrepancy as it refers to the same individual.
...
If the material discrepancy is not resolved within 30 days, you must submit a Beneficial Ownership Discrepancy Report to Corporations Canada within 30 days of identifying the discrepancy.
...
As a partnership, Rainbow Services carries out transactions or activities for which you must verify its identity, thus triggering your beneficial ownership obligations. You learn that Howard White and Betty Green are the two partners. Betty is the general partner and is responsible for operating the day-to-day operations and Howard is the limited partner who has invested funds into the partnership. All decisions related to the partnership must be unanimous, and either partner can decide to end the partnership.

### Diagram 2—Beneficial ownership information for an entity other than a corporation or a trust

![Flowchart showing Rainbow Services partners and ownership](images/bor-2-eng.png)
...
1. the names and addresses of all persons who directly or indirectly own or control at least 25% of Rainbow Services:
   * Howard and Betty's names and addresses, as the partners who equally own and control the partnership
2. the information establishing the ownership, control and structure of Rainbow Services, including:
   * that ownership and control of Rainbow Services are held equally between Howard (50%) and Betty (50%)
   * that Rainbow Services is a partnership between Howard and Betty
   * any other structural details about Rainbow Services, including any organizational chart
3. the reasonable measures you took to confirm the accuracy of the information:
   * the steps you took to confirm the accuracy of this information
   * any official documents obtained to support those measures, such as a copy of the partnership agreement
...
![Flowchart of spousal trust showing settlor, trustee, and beneficiary.](images/bor-3-eng.png)
...
1. the names and addresses of all trustees, known beneficiaries and known settlors of the trust:
   ...
   * Joe's name and address, as the trustee
   * Sue's name and address, as the beneficiary
2. the information establishing the ownership, control and structure of the trust, including:
   * The beneficial ownership information is reflected in the information required to be obtained for the trust:
     + that Robert, as the settlor, can modify or revoke the terms of the trust
     + that Joe, as the trustee, controls the assets in the trust
     + that Sue, as the beneficiary, is the only person entitled to receive the assets or income from the trust
     + the structure of the trust, including that it is a spousal trust
3. The reasonable measures you took to confirm the accuracy of the information:
   * the steps you took to confirm the accuracy of this information
   * any official documents obtained to support those measures, such as the trust agreement

## Annex 5: List of available federal and provincial resources on beneficial ownership

### Federal resources

* [Individuals with significant control](https://ised-isde.canada.ca/site/corporations-canada/en/individuals-significant-control)
* [Corporations Canada’s database](https://ised-isde.canada.ca/cc/lgcy/fdrlCrpSrch.html?lang=eng)

### Provincial and territorial resources

* [British Columbia](https://www2.gov.bc.ca/gov/content/employment-business/business/bc-companies/transparency-register)
* [Manitoba](https://companiesoffice.gov.mb.ca/beneficialownership.html)
* [New Brunswick](https://www2.snb.ca/content/snb/en/sites/corporate-registry/beneficial-ownership-register.html)
* [Newfoundland and Labrador](https://www.gov.nl.ca/dgsnl/registries/companies/isc)
* [Nova Scotia](https://news.novascotia.ca/en/2023/02/15/new-rules-help-prevent-use-companies-criminal-activities)
* [Ontario](https://www.ontario.ca/page/beneficial-ownership-information-requirements)
* [Prince Edward Island](https://www.princeedwardisland.ca/en/information/justice-and-public-safety/corporate-transparency-requirements)
* [Quebec](https://www.quebec.ca/en/businesses-and-self-employed-workers/start-entreprise/register-constitute-enterprise/new-obligations-transparency/about)

+ [Quebec enterprise register](https://www.quebec.ca/en/businesses-and-self-employed-workers/find-information-about-enterprise/search-enterprise-register/find-an-enterprise)

* [Yukon](https://publications.saskatchewan.ca/#/products/113407)
