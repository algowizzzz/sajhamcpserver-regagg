...
2. [Violations related to other compliance measures](#s2)
3. [Violations related to complying with a Minister's directive](#s3)
   * 3.1 [Harm done in the case violations related to complying with a Minister's directive](#s3.1)
   * 3.2 [Penalty determination for violations related to complying with a Minister's directive](#s3.2)
4. [Violations related to correspondent banking](#s4)
   * 4.1 [Violation for having a correspondent banking relationship with a shell bank](#s4.1)
   * 4.2 [Violation related to obtaining approval of senior management for correspondent banking relationship](#s4.2)
   * 4.3 [Violation related to ascertaining the name and address of a foreign financial institution](#s4.3)
   * 4.4 [Violations related to ascertaining prescribed information in respect of a foreign financial institution](#s4.4)
   * 4.5 [Violations related to ascertaining that a foreign financial institution meets client identification requirements](#s4.5)
   * 4.6 [Violations related to correspondent banking relationships records](#s4.6)
5. [Violations related to requirements for foreign branches and subsidiaries](#s5)
   * 5.1 [Violations related to compliance policies for foreign branches and subsidiaries](#s5.1)
   * 5.2 [Violation related to policies and procedures for the exchange of information between affiliated entities](#s5.2)
   * 5.3 [Violations related to record keeping and notification for foreign branches and subsidiaries](#s5.3)
6. [Violations related to including prescribed information in prescribed electronic funds transfers (travel rule)](#s6)
   * 6.1 [Harm done in the case of violations related to including prescribed information in prescribed EFTs (travel rule)](#s6.1)
   * 6.2 [Penalty determination for violations related to including prescribed information in prescribed EFTs (travel rule)](#s6.2)
7. [Violations related to the requirement to assist FINTRAC](#s7)
   * 7.1 [Violations related to the requirement to provide an authorized person with reasonable assistance and information reasonably required, or provide information in accordance with a notice](#s7.1)
   * 7.2 [Harm done in the case of violations related to the requirement to provide an authorized person with reasonable assistance and information reasonably required, or provide information in accordance with a notice](#s7.2)
   * 7.3 [Penalty determination for violations related to the requirement to provide an authorized person with reasonable assistance and information reasonably required, or provide information in accordance with a notice](#s7.3)
...
| Provision of the Act | Provision of the PCMLTFR[Footnote 3](#fn3) | Description | Classification of violation |
...
We use the penalty calculation for compliance program violations to address the failure to develop and apply compliance policies for foreign branches and subsidiaries. Refer to the [guide on harm done assessment for compliance program violations](cp-eng) for harm standards and penalty determinations.
...
If the prescribed information is missing from a transfer, the harm is the same as the harm posed by not keeping a record. See the [guide on harm done assessment for record keeping violations](rk-eng) for the harm rationale.

### 6.2 Penalty determination for violations related to including prescribed information in prescribed EFTs (travel rule)

The harm of not including prescribed information in a prescribed EFT is the same as the harm posed by not keeping a record, therefore the same penalty applies. See the [guide on harm done assessment for record keeping violations](rk-eng) for the penalty determination.
