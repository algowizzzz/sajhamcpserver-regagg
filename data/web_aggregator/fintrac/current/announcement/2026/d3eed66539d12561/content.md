# Questions fréquemment posées sur les nationaux politiquement vulnérables et les dirigeants d'une organisation internationale

**Mai 2021**

Cette page répond aux questions sur les [nationaux politiquement vulnérables](/guidance-directives/glossary-glossaire/1-fra#npv) (NPV), les [dirigeants d'une organisation internationale](/guidance-directives/glossary-glossaire/1-fra#doi) (DOI) et les exigences connexes. Pour de plus amples renseignements sur les [**étrangers** politiquement vulnérables](/guidance-directives/glossary-glossaire/1-fra#epv) (EPV) et les exigences connexes, veuillez consulter les [directives de CANAFE sur les personnes politiquement vulnérables (PPV) et les DOI](/guidance-directives/guidance-directives-fra#s2).
...
* un NPV, **cinq ans** après avoir quitté ses fonctions (y compris après son décès);
* un DOI, **cinq ans** après qu'elle cesse de diriger l'organisation ou l'institution (y compris après son décès).
...
* un **membre de la famille** d'un NPV ou d'un DOI, **cinq ans** après que le NPV ou le DOI a quitté son poste (y compris après son décès);
* une **personne est étroitement associée** à un NPV ou à un DOI jusqu'à la fin de cette relation.
...
Les membres du public qui ont des questions sur les exigences en matière de PPV et de DOI peuvent consulter les directives de CANAFE sur les PPV et les DOI ou communiquer avec CANAFE au 1-866-346-8722 ([information@fintrac-canafe.gc.ca](mailto:information@fintrac-canafe.gc.ca)). Les demandes de renseignements des médias peuvent être adressées à Finances Canada au 1-613-369-4000 ([fin.media-media.fin@canada.ca](mailto:fin.media-media.fin@canada.ca)).
