...
Operational brief: Risks and indicators for dealers in precious metals and stones (version PDF, 608 KB)](dpms-eng.pdf)
...
When DPMS carry out purchases or sales, and the value of a single transaction is $10,000 or more, they become what are known as “designated reporting entities” under the Act. This means they [have to file a report with FINTRAC](/re-ed/dpms-eng) in the following circumstances:
...
FINTRAC's website contains [detailed guidance](/re-ed/dpms-eng) on the legal obligations of DPMS under the Act.
...
* **Trends, typologies and potential threats of money laundering and terrorist financing:** When DPMS are dealing with clients for whom there are observable trends and/or typologies of money laundering and terrorist financing, they should review FINTRAC's [Suspicious Transaction Guidance](/guidance-directives/guidance-directives-eng#s3) and [Strategic Intelligence](/intel/sintel-eng) to determine whether these clients present a higher risk for money laundering or terrorist financing.
...
In addition to taking a risk-based approach, DPMS must put a [comprehensive and effective compliance program in place](/guidance-directives/compliance-conformite/Guide4/4-eng) to meet all their reporting and other obligations under the Proceeds of Crime (Money Laundering) and Terrorist Financing Act (e.g. client identification and record-keeping).
...
The indicators that follow are intended to help DPMS assess whether there may be reasonable grounds to suspect that a transaction, or attempted transaction, is related to the commission of a money laundering or terrorist financing offence. DPMS should use these indicators in conjunction with other published indicators, such as those contained in [FINTRAC's Money Laundering and Terrorist Financing Indicators Guidance for DPMS](/guidance-directives/transaction-operation/indicators-indicateurs/dpms_mltf-eng). In addition, FINTRAC's [Suspicious Transaction Guidance](/guidance-directives/guidance-directives-eng#s3) provides key considerations for determining whether DPMS should submit a suspicious transaction report to FINTRAC.
