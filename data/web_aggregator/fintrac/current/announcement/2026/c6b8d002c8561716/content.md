...
Operational alert: Professional money laundering through trade and money services businesses (PDF version, 150 KB)](oai-ml-eng.pdf)
...
To facilitate FINTRAC's disclosure process, please include the term **#pml** in Part G—Description of suspicious activity on the Suspicious Transaction Report. (See also [STR guidance](/guidance-directives/guidance-directives-eng#s3).)

## Contact FINTRAC

* **Email:** [guidelines-lignesdirectrices@fintrac-canafe.gc.ca](mailto:guidelines-lignesdirectrices@fintrac-canafe.gc.ca) (include Operational Alert 18/19-SIDEL-025) in the subject line)
