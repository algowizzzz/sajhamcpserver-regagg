...
* *[Regulations Amending Certain Regulations Made Under the Proceeds of Crime (Money Laundering) and Terrorist Financing Act, 2019 (SOR/2019-240)](https://gazette.gc.ca/rp-pr/p2/2019/2019-07-10/html/sor-dors240-eng.html)*
* *[Regulations Amending the Regulations Amending Certain Regulations Made Under the Proceeds of Crime (Money Laundering) and Terrorist Financing Act, 2019 (SOR/2020-112)](https://gazette.gc.ca/rp-pr/p2/2020/2020-06-10/html/sor-dors112-eng.html )*
...
From June 1, 2021 to March 31, 2022, FINTRAC will assess compliance with the regulatory requirements in effect prior to June 1, 2021. During this period, FINTRAC will also review REs' most up-to-date [compliance program elements](/guidance-directives/compliance-conformite/Guide4/4-eng). As REs must update their compliance program to reflect new regulatory requirements, this approach will provide REs with feedback to help them meet the requirements of the amended Regulations.
...
* The RE is the [**final recipient**](/guidance-directives/glossary-glossaire/1-eng#final) of an international EFT of $10,000 or more in a single transaction (the 24-hour rule may apply).
* The RE [**initiates**](/guidance-directives/glossary-glossaire/1-eng#initiation), at the request of a person or entity, an international EFT of $10,000 or more in a single transaction (the 24-hour rule may apply).
...
To declare non-compliance in reporting as described in the above-mentioned EFT scenarios, please complete the [VSDONC form](vsdonc-form-eng) and submit it to [VSDONC.ADVNC@fintrac-canafe.gc.ca](mailto:VSDONC.ADVNC@fintrac-canafe.gc.ca).

Below is an overview of the above-mentioned timelines.

![](images/timelines-eng.png)
...
However, should an RE not be compliant with the regulatory requirements that were in force prior to June 1, 2021 and remain in force under the amended Regulations, it must declare its non-compliance and submit a [VSDONC](/guidance-directives/exam-examen/vsdonc/1-eng) to FINTRAC as soon as possible, per the usual process.

## When will FINTRAC update its Assessment Manual?

The [FINTRAC Assessment Manual](/guidance-directives/exam-examen/cam/cams-eng ) will be updated later this year, and over the next several years to reflect the amendments to the Regulations. This will include updates following the rollout of the changes to the reporting forms, flexibility measures, and new or updated assessment methodologies. The first update will be published by March 31, 2022. Until that time, REs should continue to refer to the current assessment manual, as well as FINTRAC's guidance publications.
...
FINTRAC will update its [Harm done assessment guides](/pen/1-eng) in accordance with the amended Regulations by spring 2022.
