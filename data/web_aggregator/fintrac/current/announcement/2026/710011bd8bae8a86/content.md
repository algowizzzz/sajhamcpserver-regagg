...
## Summary of requirements for accountants

### Compliance program

Accountants **must** implement a compliance program. A strong compliance program will form the basis of meeting all your regulatory requirements.
...
Accountants **must** verify the identity of persons or entities for certain transactions and activities.
...
Accountants **must** verify the identity of persons and entities using the methods prescribed by the PCMLTFA and associated Regulations.
...
Accountants enter into a business relationship with a client the second time they are required to verify the identity of that client.
...
Accountants have ongoing monitoring requirements when they enter into a business relationship with a client.
...
Accountants must obtain and take reasonable measures to confirm the accuracy of beneficial ownership information for entities.
...
Accountants have third party determination requirements when they are required to submit certain reports and keep certain records.
...
Accountants are required to take reasonable measures to make PEP and HIO determinations for certain activities or transactions. If an accountant determines that a person is a PEP or a HIO then they have additional related requirements.
...
* [Money laundering and terrorist financing indicators — Accountants](/guidance-directives/transaction-operation/indicators-indicateurs/accts_mltf-eng )
...
Accountants have 24-hour rule requirements for Large Cash Transaction Reports and Large Virtual Currency Transaction Reports.
...
Accountants **must** keep certain records, including records related to transactions and client identification.

* [Record keeping requirements for accountants](/guidance-directives/recordkeeping-document/record/acc-eng)
