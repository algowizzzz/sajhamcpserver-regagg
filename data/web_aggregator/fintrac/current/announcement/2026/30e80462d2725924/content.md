...
2. [Violations related to keeping prescribed records](#s2)
   * 2.1 [Violations related to large cash transaction records](#s2-1)
   * 2.2 [Violation related to records on the purpose and intended nature of business relationships](#s2-2)
   * 2.3 [Violations related to client identification information records](#s2-3)
   * 2.4 [Violations related to third party information records](#s2-4)
   * 2.5 [Violation related to inter vivos trust information records](#s2-5)
   * 2.6 [Violation related to records on beneficial ownership information](#s2-6)
   * 2.7 [Violation related to records on not-for-profit entity determination](#s2-7)
   * 2.8 [Violations related to records for politically exposed persons and heads of international organizations](#s2-8)
   * 2.9 [Violations related to correspondent banking records](#s2-9)
   * 2.10 [Violations related to foreign branches or subsidiaries records](#s2-10)
   * 2.11 [Violations related to keeping a copy of a report submitted to FINTRAC](#s2-11)
   * 2.12 [Violations related to other prescribed records](#s2-12)
   * 2.13 [Harm done in the case of violations related to keeping prescribed records](#s2-13)
   * 2.14 [Penalty determination for violations related to keeping prescribed records](#s2-14)
   * 2.15 [Mitigating factors](#s2-15)
   * 2.16 [Non-compliance in the case of records that serve more than one purpose](#s2-16)
3. [Violations related to the retention period for prescribed records](#s3)
   * 3.1 [Harm done in the case of violations related to the retention period for prescribed records](#s3-1)
   * 3.2 [Penalty determination for violations related to the retention period for prescribed records](#s3-2)
4. [Violation related to the requirement to provide a record to an authorized person](#s4)
   * 4.1 [Harm done in the case of a violation related to the requirement to provide a record to an authorized person](#s4-1)
   * 4.2 [Penalty determination for a violation related to the requirement to provide a record to an authorized person](#s4-2)- [Repeated instances of a given violation](#s5)
...
| 6 | 13 | Failure to keep a large cash transaction record in respect of every amount in cash of $10,000 or more that is received from a client in the course of a single transaction | Minor $1-$1,000 |
| 6 | 18 |
| 6 | 22 |
| 6 | 29 |
| 6 | 33.2(2) |
...
| 6 | 41(1) |
| 6 | 48 |
| 6 | 19(1) | Failure of a life insurance company or life insurance broker or agent to keep a client information record in respect of every annuity or policy for which $10,000 or more is paid | Minor $1-$1,000 |
...
| Provision of the Act | Provision of the PCMLTFR | Description | Classification of violation |
| **6** | 52.1 | Failure to keep a record of the purpose and intended nature of a business relationship | Minor $1-$1,000 |
...
| Provision of the Act | Provision of the PCMLTFR | Description | Classification of violation |
| **6** | 11.1(5) | Failure to determine whether a not-for-profit organization is a prescribed entity and to keep a record of the determination | Minor $1-$1,000 |
...
Please refer to FINTRAC's published [guidance](/guidance-directives/guidance-directives-eng#s2) for more information on requirements related to politically-exposed persons and heads of international organizations.
...
| Provision of the Act | Provision of the PCMLTFR | Description | Classification of violation |
| **9.4(1)(a)** | 15.1(1) and (2) | Failure of a specified entity entering into a correspondent banking relationship with a prescribed foreign entity to keep a prescribed record | Minor $1-$1,000 |
...
| Provision of the Act | Provision of the PCMLTFR | Description | Classification of violation |
| **9.7(4)** | N/A | Failure to keep and retain a record of the fact that a foreign branch or foreign subsidiary cannot apply a policy and of the reasons why it cannot do so or to notify the Centre and the principal supervisory or regulating agency or body within a reasonable time | Minor $1-$1,000 |
...
| Provision of the Act | Provision of the PCMLTFR | Description | Classification of violation |
| **6** | 43 | Failure to keep prescribed records *(Note: specific to 43(g) for casino disbursement reports)* | Minor $1-$1,000 |
| **6** | 12.1 (STR Regulations[Footnote 3](#fn3)) | Failure of a person or entity to keep a copy of a report submitted to the Centre | Minor $1-$1,000 |
...
| Provision of the Act | Provision of the PCMLTFR | Description | Classification of Violation |
| 6 | 14 | Failure to keep prescribed records | Minor $1-$1,000 |
| 6 | 14.1 |
| 6 | 15 |
...
| Provision of the Act | Provision of the PCMLTFR | Description | Classification of violation |
| **6** | 69(1) | Failure of a person or entity that is required to obtain, keep or create records to retain those records for a period of at least five years | Minor $1-$1,000 |
| **6** | 12.3(1) (STR Regulations[Footnote 4](#fn4)) | Failure of a person or entity to keep a copy of a prescribed report for the prescribed period | Minor $1-$1,000 |
...
| Provision of the Act | Provision of the PCMLTFR | Description | Classification of violation |
| **6** | 70 | Failure to retain records in such a way that they can be provided to an authorized person within 30 days after their request | Minor $1-$1,000 |

### 4.1 Harm done in the case of a violation related to the requirement to provide a record to an authorized person

The Act and its regulations require records to be kept in a format that can be produced within 30 days when FINTRAC requests to examine it.[Footnote 5](#fn5) Failing to comply with this requirement interferes with
...
Footnote 5
:   Section 70 of the PCMLTFR specifies that the production of records within 30 days is for a request "made to examine it under section 62 of the Act", which is for compliance examination purposes.
