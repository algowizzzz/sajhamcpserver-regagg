...
changes compared to ICS Version 2.0 for the monitoring period.1 Only the text identified as Level 1 
...
4. Stakeholders are invited to provide rationale and/or evidence supporting the ir responses. 
...
• Include evidence , example s or references (eg to publicly available documents or data 
...
1 The Level 1 and Level 2 documents for ICS Version 2.0 for the monitoring period are available here: 
...
16. The IAIS publishe d a first version of the principles set forth in Table 1 in September 2014. 
Principles 3 and 6 were subsequently amended following the 2014 ICS CD. These principles h ave 
...
of systemic risk in the insurance sector.4 
...
4 See press release from the FSB, 9 December 2022, which noted that “The FSB decided to discontinue the annual identification 
...
circumstances in their respective jurisdictions.5 
 
  
 
5 While the IAIS as a standard setting body does not have any legal power to directly mandate the implementation of the ICS as 
a PCR in jurisdictions, Article 6(6)(b) of the IAIS By -Laws notes that IAIS Members commit to “imp lementing IAIS supervisory 
...
lines provided by the Basel III framework6. 
...
6 http://www.bis.org/publ/bcbs266.htm.
...
insurance holding comp any of an insurance group or financial holding company of a financial 
conglomerate. 
...
any Market-Adjusted Valuation ( MAV) adjustments, is the consolidated Gen erally Accepted 
...
as joint ventures7, a proportional consolidation method is used unless it is determined through 
...
as joint operations8 and reported by recognising its own assets, liabilities and transactions, 
...
L2-13. Adjustments related to non-voting interest entities9: 
a. A non-voting interest entity that has been determined under GAAP to be unconsolidated is 
consolidated if either the IAIG or its GWS assesses that it poses a material risk10 to the group, 
...
7 A joint venture is a joint arrangement whereby the parties that have joint control of the arrangement have rights to the net assets of the 
arrangement. 
8 A joint operation is a joint arrangement whereby the parties that have joint control of the arrangement have rights to the asset s, and 
obligations for the liabilities, relating to the arrangement.  
9 A non-voting interest entity is an entity where voting or similar rights are not the dominant factor in assessing control. Entities are often 
thinly capitalised or contain no capital a nd are designed for a specific purpose (eg, special purpose entities, structured entities, GP/LP 
structures, trusts and investment partnerships). 
10 Material risk in this case relates to the risks posed to the group. In considering what might significantly contribute to group risks, a firm 
...
addition, an assessment of all immaterial entities exceeding 5% of the group’s asset’s or re venue, in the aggregate, may indicate that 
other entities should be consolidated in order to avoid missing material risks.

Public 
underlying claim is settled and the risk to the non -life company is continge nt upon the life insurer 
...
on the nature of the liabilities , their predictability, the assets backing t hose liabilities and the cash-
...
b. Mortgages and loans  are adjusted to fair value us ing the fair value guidance under the 
...
the reporting date are adjusted to zero. Future acquis ition costs related to future premiums 
...
of the future cash -flows associated with insurance liabilities, discount ed using the yield curve 
...
to the risks insured, and profit parti cipation payments in particular, are taken into consideration for 
the calculation of the value of options and guarantees. 
L2-24. All options and guarantees are valued using arbitrage -free techniques 11 based on the 
...
L2-26. The likelihood that policyholders will exercise contractual options, including lapse s and 
...
actions; 
b. How beneficial the exercise of options would be to policyholder s under specific 
circumstances; and 
...
L2-28. The assumptions concern ing policyholder behaviour are consistent with the assumed 
...
11 This implies in particular that where relevant, path dependency is taken into account in the valuation of options and guarantees.

Public 
L1-24. The future premiums and associated claims and ex penses linked to those recognised 
...
L2-35. All obligations, including future premiums, re lating to a recognised contract are taken into 
...
entire portfolio in a way that fully refl ects the risks of the portfolio, the second condition above is 
...
realistic assumptions. The determinatio n of the current estimate is objective, comprehensive, and 
...
are objective, realistic and verifiable. Manag ement actions recognised in the calculation are not 
...
they apply. 
L2-43. The assumptions about future management actions take into account t he time needed to 
...
L1-35. For each currency, the LTFR is the sum of an expected real interest rat e and an inflation 
target. 
...
the relevant financial instruments for the r isk-free interest rates and what the LOT is. The DLT 
...
may need to be adapted in light of the specific circumstances of individual markets (eg less l iquid 
currencies). 
...
L2-48. The assessment start s from the analysi s of trade volume and trade frequency of 
...
L2-50. The DLT assessment of the relevant instruments inform s the choice of the instrument on 
...
L1-39. The ICS yield curves include an adjustment to the risk -free curves. This adj ustment is 
...
L2-66. The following spread over the LTFR is added to all LTFR c alculated according to 
...
relating to other business of the IAIG.12 
...
only a surrender option where the surrender value does not exceed the value of the ass ets 
...
from other business of the IAIG.12  
...
For the calculation of the total market value of assets, all ass ets identified for this portfolio 
...
but all corresp onding cash flows that are not at the discretion of the IAIG have to be 
unbundled and are subject to the General Bucket. 
 
12 For both the Top and Middle Buckets, the separate management of assets does not refer to a legal ring fencing but to a portfolio 
...
calculation is used. 
L2-79. The spread is adjusted for credit risk and any other r isk, using the same risk correction 
...
L2-83. The spread adjustment determined a ccording to this methodology is applied as a parallel 
...
adjustment. In case a rolling hedge strategy is in place, the cost of h edging is deducted from the 
...
and 
• 𝑠𝑝𝑟𝑒𝑎𝑑𝐼𝐶𝑆 𝑅𝐶𝑖 𝑎𝑓𝑡𝑒𝑟 𝑅𝐶(𝑡) is the spread after risk correction corresponding to debt instruments 
that belong to ICS rating category i. 
L2-92. 𝑤𝑔𝑜𝑣 and 𝑤𝐼𝐶𝑆 𝑅𝐶𝑖 are determined only considering eligible assets according to Table 3. 
...
curve is computed such that it is greater tha n or equal to the spread adjustment for the General 
Bucket (𝑆𝑝𝑟𝑒𝑎𝑑 𝐴𝑑𝑗𝐺𝐵(𝑡)) at each maturity 𝑡. 
𝑆𝑝𝑟𝑒𝑎𝑑 𝐴𝑑𝑗𝑀𝐵(𝑡) = max [
𝜔𝐺𝐵 ∗ 0.8 ∗ 𝑆𝑝𝑟𝑒𝑎𝑑 𝐴𝑑𝑗𝐺𝑟𝑜𝑠𝑠−𝐺𝐵(𝑡),
𝜔𝑀𝐵 ∗ (0.8 ∗ 𝑆𝑝𝑟𝑒𝑎𝑑 𝐴𝑑𝑗𝐺𝑟𝑜𝑠𝑠−𝐺𝐵(𝑡) ∗ (1 − 𝑇𝑂𝑀) + 0.9 ∗ 𝑊𝐴𝑀𝑃𝑠𝑝𝑟𝑒𝑎𝑑(𝑡) ∗ 𝑇𝑂𝑀)]
...
underpinning the risk -free rate. Where r isk-free rates are determined based on swap rates, risks 
...
factor. For Segm ents 2 and 3 of the adjusted yield curve, the same extrapolation methodology is 
...
which are sensitive to changes in credit spreads13, in the same currency spread bucket as the main 
...
13 This includes government bonds when the respective yield curve is based on swaps.
...
𝑃𝑉𝐵𝑃𝑈(𝑋) = 𝑃𝑉(𝑋) − 𝑃𝑉𝑢𝑝(𝑋), 
where 𝑃𝑉(𝑋) is the current price and 𝑃𝑉𝑢𝑝 the price obtained by applying a parallel shift of 
...
in the cash flows related to insurance obligations. As such, MOCE considers all un certainties 
...
L2-109. The cash flows associ ated with insurance liabilities are not considered to be reliably 
replicated when: 
...
of instruments issued pri or to the adoption of the ICS that fulfil all other Tier 1 Limited criteria. 
...
That limit, applicable at a legal entity level, has been de signed based on the principle that non -
...
activities and comprise q ualifying financial instruments and capital elements other than financial 
instruments. 
...
financial instruments. 
c. The instrument is perpetual (ie it does not have a maturity date). For mutual IAIGs 14, the 
requirement for an instrument to be perp etual is considered to be met if redemption at 
maturity (for a dated instrument) can be deferred subject to supervisory approval or a lock -
in15 feature, and where an instrument has an initial maturity of at least ten years. 
...
o Prior to or concurrent with the exercise of the call, the IA IG replaces the called 
...
14 Characteristics of a mutual group typically include the inability to issue substantial amounts of common equity and an ultimate 
parent within the group that cannot issue common equity. 
15 A lock-in feature is a requirement for the IAIG to suspend repayment or redemption if it is in breach of its applicable regulatory 
...
the replacement instrument is lower than the cost of keeping the existing instrum ent 
...
g. There is no t an expectation created by the IAIG, through the terms of the instrument or 
...
a determination that liabilities exceed assets constitutes a test of insolvency. 
n. The instrument does not possess features that hinder recapita lisation, such as provisions 
...
IAIG. 
c. The instrument has an initial maturity of at least five years with its effective mat urity date 
...
approval is required for any redemption prior to contractual maturity.16  
 
16 In the absence of a requirement for prior supervisory approval, this criterion is considered to be met if the following 
conditions are met: 
...
instrument, or that the repurchase or redemption will receive supervisory approval. 
h. The instrument does not have distributions that are linked to t he credit standing or financial 
condition of the IAIG or a related entity, such that those distributions may accelerate winding-
up. 
...
(eg it is issued out of an SPV), proceeds are made immediately available, without limitation, 
to an operating entity or the holding compa ny of the IAIG, through the issuance of an 
...
be fulfilled through supervisory approval 17 of dividends prior to their payment from an 
...
approval17 of dividends prior to their payment from an insurance subsidiary to the holding 
company. 
...
o. The IAIG and its GWS have determined that the proceeds of the instrument s, which have 
...
subsidiary of the holding company and the insurance subsidiary is loc ated in a jurisdiction 
whose regulatory regime proactively enforces structural subordination through appropriate 
regulatory/supervisory controls over distributions from insurance subsidiaries18. 
...
17 For structurally subordinated financial instruments, supervisory approval of ordinary dividends can be met if the supervisor has 
...
18 Supervisory controls over distributions from insurance subsidiaries refer to the supervisory review and/or prior supervisory 
...
g. The mutual IAIG is required to notify the supervisor of any changes of f act or circumstance 
...
increased to 15%, provided that the instruments in exce ss of the 10% limit possess a 
...
risk charge for each individual risk is determined as the decrease between t he amount of capital 
...
L1-78. The factor -based approach is determined by applying factors to specific e xposure 
measures. 
...
Catastrophe 
risk 
Unexpected changes 19 in the occurrence of low freque ncy 
...
L1-82. In order to promote good risk management and achieve an appropriate level of ri sk 
...
a. The proportion of the full term of the risk ex posure covered by the risk mitigation technique 
...
or operational risks compared to the risk mitig ation effect. If the instruments mitigating 
...
a. The renewal is consistent with previous business practice and documented strategy; 
b. The renewal is realistic with regards to availability of the arrangement and its cost20; and 
...
c. Any additional ris k stemming from the risk mitigation arrangement (eg Credit risk) is also 
...
22 ‘Other developed’ taken from IMF list of advanced economies minus countries mentioned in other regions 
as of April 2016. 
...
in Japan. Therefore, the calibration of the Mortali ty risk stress factor has been revised from 12.5% 
...
• Products providing a recurring amou nt of compensation for a period depending on 
the time spent in a given temporary health status, such as inability to work  or 
hospitalisation. 
d) Category 4: Long-term recurring payments 
• Products providing a fixed annuity in case of long -term/permanently deter iorated 
health status. 
...
24 A technical basis is considered similar to life when it involves the explicit use of biometric variables such as mortality, morbidity 
...
a) For benefit categories i = 1, 2 and 3, the stre ss is defined as an  instantaneous relative 
...
L2-162. When the calculation of the current estimate involves the use of a dynamic lapse function25, 
...
25 A dynamic lapse function varies the lapse rate used in the calculation of insurance liabilities depending on the difference between 
...
business. 
L1-102. The non-life risk charge comprises both Premium risk and Claims Reserve risk, whi ch are 
...
risk. 
L1-103. The non -life insurance risk charge is ca lculated using an aggregation approach that 
...
7.2.3.3 Aggregation 
L2-172. The c alculation of non -life risk charges for each ICS segment takes into account 
...
L1-107. Catastrophe risk is segmented at the risk/peril level. Per ils cover both naturally occurring 
...
earthquake) but also the secon dary perils associated with the primary peril. Secondary perils can 
...
are applied: 
a. Life and similar to life health business are included only for the pandemic and the t errorism 
scenarios; and 
...
largest geo graphical risk concentration partly or fully located within a radius of 500 metres. To 
...
inability to perform its contractual obligation. The penal sum re presents the maximum amount that 
...
below. The total net p otential loss amount assumes that the two largest net losses have occurred, 
...
they can establish whether their natural catastrophe model frame work is sound or whether 
...
• Safeguard 6 – Documentation standards: The documentation of the natural catastrop he 
...
Public 
L1-110. The market risk charge is calculated by aggregati ng, using the market risks correlation 
...
uses the interest rate as an input variable, the base lapse assumptions st ay unchanged under the 
...
• 𝐿𝑇𝑖 is a random variable encompassing the results of the level up, level down, twist up -to-
down and twist down-to-up scenarios for currency 𝑖, as specified in paragraph L2-207. 
...
• 𝑋𝑖 and 𝑌𝑖 are independent random variables following a standardised normal distribution. 
L2-208. In addition, the random variables 𝑋𝑖 and 𝑌𝑖 are such that: 
• For any 𝑖 ≠ 𝑗, 𝑐𝑜𝑟𝑟(𝑋𝑖, 𝑋𝑗) = 𝑐𝑜𝑟𝑟(𝑌𝑖, 𝑌𝑗) = 0.75; and 
• For any 𝑖 and 𝑗, 𝑐𝑜𝑟𝑟(𝑋𝑖, 𝑌𝑗) = 0. 
L2-209. For currency 𝑖, 𝑀𝑅𝑖, 𝐿𝑈𝑖, 𝐿𝐷𝑖, 𝑇𝑈𝑖 and 𝑇𝐷𝑖 correspond to the change in the IAIG’s Net Asset 
Value when recalculating the value of all relevant assets and liabilities usin g the mean reversion, 
...
• 𝜆 is the exponential decay rate of the Nelson Siegel model26 for the risk-free yield curve; 
• (
∆𝐿
∆𝑆
∆𝐶
...
26 As described in the article Diebold, F.X. and Li, C (2006) Forecasting the Term Structure of Government Bond Yields in Journal 
...
𝛽2𝑡
𝛽3𝑡
), where 𝛽1𝑡, 𝛽2𝑡 and 𝛽3𝑡 correspond to the Nelson Siegel parameters26 for the risk-
...
• 𝑒1 and 𝑒2 are the eigenvectors associated with the highest and second highest eigenvalues, 
respectively, of the matrix 𝑁𝑇𝑁 ; 
• 𝑁 = (
𝐿𝑂𝑇 0
𝑎
0 𝑏
...
L2-214. For each cu rrency, the stressed yield curve for the level down scenario is obtained by 
adding the following yield curve to the initial yield curve, up to the LOT: 
− 𝑠. 𝑁−1(0.995). [𝑠𝑙1. 𝐿𝑒𝑣𝑒𝑙 𝑐𝑢𝑟𝑣𝑒 + 𝑠𝑙2. 𝑆𝑙𝑜𝑝𝑒 𝑐𝑢𝑟𝑣𝑒 + 𝑠𝑙3. 𝐶𝑢𝑟𝑣𝑎𝑡𝑢𝑟𝑒 𝑐𝑢𝑟𝑣𝑒] 
...
resulting adjustment applied to the insurance liabilities take s into account the application ratio, the 
portfolio allocation and the modulation factor. The portfolio allocation is based on the portfolio 
backing the liabilities or the representative portf olio for the middle bucket or the general bucket 
respectively. 
...
with values sensitive to changes in the level or volatility of the fai r value of equities as specified in 
the Level 2 text. 
...
e. An instantaneous absolute increase by x% of the implied volatilities of all the asset cl asses 
...
estate prices, without distinguishing between commerci al, residential and real estate for own use 
...
for al l currencies other than the reporting currency. The net open position for  each currency is 
...
of the increase of each foreign currency relative to the reporting curr ency is found in the 
currency stress matrix in Table 21 below. 
...
Assets in separate accounts or where the investment risks fully flow-through27 to policyholders are 
...
exceed 100; 
• 𝐾𝑖
𝑒𝑞 is the Equity risk charge associated with counterpart y 𝑖, before diversification and 
management actions; 
• 𝐾𝑖
...
27 Not considering any guarantee to policyholders that may exist on the value of the overall investment fund(s) such as on variable 
annuity products

Public 
L2-242. Groups of connected counterparties are determined according to the definition provided by 
the Basel Committee on Banking Supervision (BCBS) 28. Specifically, two or more natural or legal 
...
provincial, state or municipal debt, are included within t he Asset Concentration risk charge 
...
a. Exposures to reinsurance counterparties are included on a pre-stress basis29; 
...
c. Exposures are based on a look -through app roach for investment funds and structured 
products; 
...
primary counterparty is then replaced by the exposure to the collater al or guarantor. This 
...
28 As specified in the BCBS publication Supervisory framework for measuring and controlling large exposures (April 2014), which 
also outlines criteria for assessing whether ‘control’ or ‘economic interdependence’ exists. 
29 The contingent risk associated with catastrophe scenarios is not included in the exposure.
...
assets relating to insurance act ivities. The net property exposures are calculated in line with 
...
classification of exposures between those categories, as well as the assoc iated stress factors, are 
...
pool of exposures und erlying a securitisation exposure is itself a securitisation, then the exposure 
...
are backed by either a governmental entity or jo intly by the insurance market. Cessions to these 
mandatory pools are subject to a separate calculation. 
L2-265. Reinsurance exposures include all credit recognise d in the ICS risk charges due to the 
...
from which the asset is due that crea tes a single legal obligation. As a result of such an 
...
to perform due to a ny of the following: default, bankruptcy, liquidation or similar 
circumstances.
...
method from Annex 4, section VII of the Basel Framework30. Under this method, the IAIG calculates 
...
30 Accessible at http://www.bis.org/publ/bcbs128.pdf
...
specified dates, the residual maturity is c onsidered to be the time until the next reset date. In the 
...
notional amount is leveraged or enhanced by the structure of the transactio n, the IAIG uses the 
...
or negative. 
L2-277. The IAIG may net contracts that are subject to novation31 or any other legally valid form of 
netting provided the following conditions are satisfied. 
a. The IAIG has executed a written, bilat eral netting contract or agreement with each 
...
31 Novation refers to a written bilateral contract between two counterparties under which any obligation to each other to deliver a 
...
jurisdiction or by a memorandum of law that addresses all relevant issues in a reasoned 
manner. 
c. The IAIG has internal procedures to ver ify that, prior to recogni sing a transaction as being 
...
L2-278. Any contract containing a walkaway clause 32 is not eligible to qualify for netting for the 
...
enforceable netting agreements in which notional principal is equivalent to cash flows, no tional 
...
currencies. This is calculated by netting all receivable and payable am ounts in the same currency 
...
32 A walkaway clause is a provision within the contract that permits a non-defaulting counterparty to make only limited payments, 
...
or that effectively provide for automatic cancellat ion due to deterioration in a borrower’s 
...
As for Method 1, c ategories CM6 and CM7 are for delinquent loans and loans in foreclosure, 
respectively. 
...
L2-292. For performing 33 residential mortgage loans for which repayment depends on in come 
...
33 The distinction between performing and non-performing is consistent with the Basel Committee’s definition, which es tablishes 
...
b. All documentation used in collateralised transacti ons are binding on all parties and legally 
...
out in the transaction documenta tion) of the counterparty (and, where applicable, of the 
...
is denominated, the amount of the exposure deemed to be prot ected is 80% of the amount of 
...
transaction. The guarantor make s one lump sum payment of all moni es under such 
...
ii. The bankruptcy, in solvency or inability of the obligor to pay its debts, or its failure or 
...
b. If the credit derivative covers obligations that do not include the un derlying obligation, point 
...
reference obligation specified in the credit derivative for purposes of c ash settlement is 
...
protection buyer has the right/ability to inform the protection provider of the occu rrence of a 
credit event. 
...
legal entity) and legally enforceable cross -default or cross -acceleration clauses are in 
place. 
i. Only credit default swaps and total return swaps that provide cre dit protection equivalent to 
...
record offsetting deterioration in the valu e of the asset that is protected (either through 
...
• 𝑡 is the lower of 𝑇 and the residual maturity of the credit protection a rrangement expressed 
in years. 
...
L2-322. Where a n IAIG  has multiple ty pes of risk mitigation arrangements covering a single 
...
Public 
access/transparency, disclosure, resour ces and credibility. Those criteria, as well as the required 
...
market segment, including rigorous back te sting that has been applied for at least one 
...
any cons traints that could arise in situations where the composition of the board of 
...
procedures, methodologies and assumptions for arriving at assessment s used by the 
...
v. Resources: A rating a gency has sufficient resources to carry out high quality credit 
...
Public 
L2-329. Where a particular security has one or more issue -specific rating, the ICS RC for th at 
...
requirement and 15% of three year average gross income. 34 At the group wide supervisor’s 
...
operational risk.35 If additional, material risks of the entity are not appropriately captured by 
...
or, at the group wide supervisor’s request, to the Operational Risk Capital Require ment as 
calculated under the Basel III calculation for operational risk.35  
c. For banking entities reported as an equity method investment it is equal to the proportional 
sectoral leverage ratio. 
d. For non -banking entities reported as an equity method investment it is e qual to the 
...
Basel III calculation for operational risk .35 If additional, material risks of the entity are not 
...
34 For asset managers, gross income relates only to third-party asset management, not the management of the IAIG’s own assets 
...
35 The Basel III calculation for operational risk capital requirement is specified in the following document: 
https://www.bis.org/basel_framework/chapter/OPE/25.htm?inforce=20230101&published=20221208&export=pdf

Public 
L2-342. For non-financial entities, the capital requirement is equal to the equity charge on the equity 
method or market value investment as described in paragraph L2-229, a) to d).
...
complexity without the benefit of accuracy for most jurisdictions. In add ition, the ICS 2.0 approach 
...
are used for the G-ETR calculation.36 
...
36 For example, a tax authority announces tax rate changes that would have a material impact for future periods. In such a case, 
the newly announced statutory tax rate is used in the G-ETR calculation.

Public 
c. GAAP DTL netted from assets deducted from Tier 1 capital res ources, as specified in 
paragraph L1-64; and 
...
𝐴𝑙𝑙𝑜𝑐𝑎𝑡𝑒𝑑 𝑛𝑜𝑡𝑖𝑜𝑛𝑎𝑙 𝑡𝑎𝑥 𝑒𝑓𝑓𝑒𝑐𝑡 𝑜𝑛 𝑖𝑛𝑠𝑢𝑟𝑎𝑛𝑐𝑒 𝑐𝑎𝑝𝑖𝑡𝑎𝑙 𝑟𝑒𝑞𝑢𝑖𝑟𝑒𝑚𝑒𝑛𝑡37)𝑇𝑎𝑥 𝑠𝑢𝑏−𝑔𝑟𝑜𝑢𝑝 𝑒𝑛𝑡𝑖𝑡𝑖𝑒𝑠⁄  
...
paragraph L2-358 – DTA for insurance-related activities on ICS balance sheet); and 
...
37 Allocated notional tax effect on insurance capital requirement – refer to paragraph L2-356.
...
related activities associated w ith assets subject to deduction from Tier 1 capital resources (see 
section 6.4.1). 
...
L2-359. A SOCCA process may be used for the calculation of the Credit risk charge for un rated 
...
outsourcing arrangement of the credit as sessment is held to the same standards of 
...
Public 
history in assessing the Credit risk of a large number of securities such that st atistical 
...
L1-154. The group -wide supervisor (GWS) consider s how the Balance Sheet, used  within the 
...
L1-156. The GWS sets up an internal model application process (IMAP). The IMAP enable s the 
...
for the use of an internal model to calculate its P CR and by stating, as the case may be, the basis 
...
The documents for the applic ation should be complete and allow a knowledgeable third party to 
...
L2-372. Also, the GWS approve s the allocation of the risks  in the internal model according to the 
...
L2-373. During the internal model approval process, the GWS keep s the supervisory college 
informed of the status of the process and collect relevant views from other involved supervisors, e.g., 
local specificities suc h as tax rules and product features. Whilst the GWS may consider any 
...
L2-376. If the application is unlikely to be approved, GWS commu nicates this to the IAIG so the 
...
L2-377. Before communicating the results to the IAIG, the GWS share s the results of its findings 
...
standard method. 
L2-378. After the review process is complete, the GWS send s a formal response to the IAIG 
...
L2-382. The IAIG cooperate s with the GWS to establish an appropriate policy rela ting to post -
...
policy 
L2-383. Moreover, the GWS ensure s that the IAIG establishes an appropriate policy relating to 
communication and public disclosure on model results and changes post-approval. 
L1-158. As part of the supervisory process t he GWS reviews the model post approval regularly to 
...
supervisory review. The GWS should engage in colla borative model review efforts with other 
...
model allows for changes in the risk profile over time adapt to foresee able risks, which can be 
...
is exposed.  
L2-401. Nonetheless, the model still allow s for outcomes not directly observed in past data but to 
...
L2-407. Parameterisation results are reasonable, up -to-date and validated. The IAIG define s 
...
out for the ICS standar d method, capital requirement calculations provide s evidence on how the 
...
GWS that policyholders are provided with a level of protecti on at least equivalent to VaR at 99.5% 
...
The model is widely used and play an impo rtant role in the system of governance of the IAIG and 
...
profile of the IAIG. 
L2-418. The risk managemen t function has Board delegated responsibility for the ongoing 
maintenance, use, application and validation of the internal model. 
L1-167. The model's governance structure is clearly defined and documented, and this include s 
...
L2-421. There are adequate and effectiv e controls in place in relation to the operation and 
...
L2-423. The IAIG demonstrate s that the model has been validated independently (externally or 
...
L1-171. Model documentation allow s a knowledgeable third party to understand the design and 
details of the internal model and form a sound judgment as to its compliance with regulatory 
requirements. 
L2-427. The documentation provide s a detailed description of the structure, scope, theory, data, 
...
the qualification of the experts, the appropriateness of the judgment bei ng made, the intended use 
...
L1-176. External models used in parts of the internal model adhere to the same standard s as the 
...
L2-439. Where external data is used, the IAIG demonstrate s an appropriate understanding of its 
...
Public 
L2-441. The IAIG develops benchmarking studies that allow them to monitor the e volution of the 
...
ICS standard method. 
L2-442. The persons who effectively run (Executive and Senior Management) the IAI G and staff 
...
L2-446. The IAIG explain s how the capital requirement resulting from the PIM reflects more 
appropriately the risk profile of the IAIG. 
L2-447. In cas e the model is partial in terms of business coverage, the explanation provided 
...
L2-448. When assessing an application for the use of a PIM, the GWS consider s at least the 
following:  
...
plans to extend the scope of the model to other risks, por tfolios or entities, in order to ensure that 
...
further aggregation in the internal model use. For instance, th e PIM could cover the market risk 
...
Importantly, these imp acts will be considered together with the objectives of the ICS and the 
...
to a limited pool of assets whose pri ce movements might then be magnified under specific 
...
original underlying portfolio or securities issued remains, or, for synthetic securitisation s, 
...
underlying exposures such that the pool’s credit quality is improved unless this is achie ved 
...
h. There must be no termination options/triggers ex cept eligible clean-up calls, termination for 
...
o Developed markets 
o Emerging markets and developing economies (EMDEs39) 
...
38 Look-through should be applied to investment funds to identify underlying infrastructure investments that are eligible, unless it 
can be shown that the fund as a whole meets all the definitions and criteria. 
39 Identified based on the World Bank classification of countries: all countries not classified as high income should be considered 
as EMDE.
...
standing40 or replaceable without a significant loss to equity investors. 
...
iv. Resilient demand. 
b. The infrastructure project can meet its financial obligations under sustained stres sed 
...
40 The contracted purchaser is assumed to be of good credit standing if it belongs to the following list: national gover nments, 
...
to be of good credit standing 41 or replaceable without a significant loss to equity 
investors; and 
...
i. A good expertise and a track record of t he sponsor of successfully overseeing 
...
L2-465. The purpose of the criteria below is to identify subset s of infrastructure debt investments 
that can be recognised as infrastructure debt under paragraph L2-251. 
 
41 The contracted purchaser is assumed to be of good credit standing if it belongs to the following list: national governments, 
multilateral development banks, supranational organisations, or other entities with an ICS RC 1-4.
...
protect investors against losses resulting from the termination of the project by the contracted 
purchaser of the goods or services, and require the contracted purchaser to be of good credit 
standing42 or replaceable without a significant loss to debt and equity investors. 
...
42 The contracted purchaser is assumed to be of good credit standing if it belongs to the following list: national governments, 
multilateral development banks, supranational organisations, or other entities with an ICS RC 1-4.
...
protect investors against losses resulting from the termination of the project by the 
contracted purchaser of the goods or services, and require the contracted purchaser 
to be of good credit standing 43 or replaceable without a significant loss to debt 
investors; 
ii. The infrastructure project has sufficient reserve funds or other financial arrangements 
...
43 The contracted purchaser is assumed to be of good credit standing if it belongs to the following list: national governments, 
multilateral development banks, supranational organisations, or other entities with an ICS RC 1-4.
